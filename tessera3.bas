...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("tessera3.bal")
	'PRWTO PANW aristera
pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
...
clv2.AddTextItem("Κατηγορία 4.3 ", "")
	clv2.AddTextItem("Εκρηκτικές και τοξικές ουσίες με μεγάλο κίνδυνο αυτανάφλεξης ", "")
clv2.AddTextItem("ΑΝΤΙΔΡΑΣΗ ΚΑΤΑ ΤΗΝ ΕΠΑΦΗ ΤΟΥΣ ΜΕ ΤΟ ΝΕΡΟ.ΓΙΝΟΝΤΕ ΕΚΡΗΚΤΙΚΕΣ ", "")
