...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("igropimeno.bal")
...
clv2.AddTextItem("Το φυσικό αέριο (un-1971) αποτελείται από μεθάνιο (CH4) 85-90% και 10-15% αιθάνιο, προπάνιο, βουτάνιο, άζωτο, διοξείδιο του άνθρακα. Το υγρό φυσικό αέριο αν έρθει σε επαφή με το δέρμα, προκαλεί ψυχρά εγκαύματα.", "")
 clv2.AddTextItem("Είναι άχρωμο, άοσμο, μη τοξικό, με μικρή διαλυτότητα στο νερό. Είναι ασφυξιογόνο σε χώρους που δεν αερίζονται. Για να ξεχωρίζει στην όσφρηση,προσθέτουν ουσία για τον έλεγχο διαρροής.", "")
 clv2.AddTextItem("Κατηγορία 2.1 ", "")
	clv2.AddTextItem("Εφλεκτα,πυροδυναμοτικα,δηλητηριώδη και τοξικα. ", "")
...
clv2.AddTextItem("Υπάρχει κίνδυνος ασφυξίας σε κλειστούς χώρους. ", "")
...
Sub pin1_Click
	Dim result As Int
result = Msgbox2("Επιστροφή στο μενού", "  ", "Ναί ", "", "Όχι ", LoadBitmap (File.DirAssets, "1971.png"))
...
Sub pin2_Click
	Dim result As Int
result = Msgbox2("Επιστροφή στο μενού", "  ", "Ναί ", "", "Όχι ", LoadBitmap (File.DirAssets, "1972.png"))
	If result = DialogResponse.Positive Then
	StartActivity("ousies")
	End If
End Sub
