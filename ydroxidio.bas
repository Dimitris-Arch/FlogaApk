...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("ydroxidio.bal")
...
clv2.AddTextItem("Το υδροξείδιο του νατρίου ή καυστική σόδα UN-1824 είναι στερεό,λευκού χρώματος,διαβρωτική ουσία ", "")
clv2.AddTextItem("Σε επαφή με το νερό απελευθερώνει θερμότητα.Προκαλεί σοβαρά εγκαύματα στο σώμα και στο αναπνευστικό προκαλλεί ερεθισμό.", "")
clv2.AddTextItem("Δεν είναι εύφλεκτο,ομώς λυώνει οταν θερμανθεί. Αντιδρά έντονα με οξέα.", "")
...
clv2.AddTextItem("ΔΙΑΒΡΩΤΙΚΕΣ ΟΥΣΙΕΣ ΚΑΙ ΤΟΞΙΚΕΣ", "")
		clv2.AddTextItem("Διαβρωτικές ουσίες με κίνδυνο φωτιάς.Προκαλούν μεγάλη βλάβη στην υγεία. ", "")
clv2.AddTextItem("Μερικές ουσίες είναι εκρηκτικές και δημιουργούνται τοξικά αέρια.Επίσης υπάρχει κίνδυνος αλυσιδωτής αντίδρασης", "")
