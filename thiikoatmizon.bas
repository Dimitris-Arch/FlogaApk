...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("thiikoatmos.bal")
     pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
pin1.Width  = 45%x
...
clv2.AddTextItem("Το θειικό οξύ,βιτριόλι ως ατμός UN-1831 είναι άοσμο, άχρωμο και είναι διαβρωτικό και τοξικό", "") 

clv2.AddTextItem("Το νερό δεν πρέπει να χρησιμοποιηθεί χωρίς την έγκριση ειδικών.", "")
clv2.AddTextItem("Σε επαφή του με το νερό παράγεται θερμότητα και εκτοξεύονται σταγόνες θερμού θεεικού οξέος,γιαυτο ποτέ δεν χρησιμοποιούμε νερό.", "")
clv2.AddTextItem("Δεν είναι εύφλεκτο όμως σε επαφή με διάφορα υλικά, απελευθερώνεται εύλεκτο υδρογόνο.", "")
clv2.AddTextItem("Έαν έρθει σε επαφη με το σώμα πλυνετε με άφθονο νερο.", "")
...
Sub pin1_Click
	Dim result As Int
result = Msgbox2("Επιστροφή στο μενού", "  ", "Ναί ", "", "Όχι ", LoadBitmap (File.DirAssets, "1830.png"))
...
Sub pin2_Click
	Dim result As Int
result = Msgbox2("Επιστροφή στο μενού", "  ", "Ναί ", "", "Όχι ", LoadBitmap (File.DirAssets, "1831.png"))
	If result = DialogResponse.Positive Then
	StartActivity("ousies")
	End If
End Sub
