...
Sub Activity_Create(FirstTime As Boolean)
	...
	If server.GetMyIP = "127.0.0.1" Then  'this is the local host address
		Msgbox("Δεν υπαρχει συνδεση στο διαδικτυο","")
	Else
...
Sub load
	...
	If Label22.Text = "9" Then
		Label22.Text = "10"
	End If
	If Label22.Text = "10" Then
		Label22.Text = "11"
	End If
	If Label22.Text = "11" Then
		Label22.Text = "12"
	End If
	If Label22.Text = "12" Then
		Label22.Text = "13"
	End If
	If Label22.Text = "13" Then
		Label22.Text = "14"
	End If
	If Label22.Text = "14" Then
		Label22.Text = "15"
	End If
	If Label22.Text = "15" Then
		Label22.Text = "16"
	End If
	If Label22.Text = "16" Then
		Label22.Text = "17"
	End If
	If Label22.Text = "17" Then
		Label22.Text = "18"
	End If
	If Label22.Text = "18" Then
		Label22.Text = "19"
	End If
	If Label22.Text = "19" Then
		Label22.Text = "20"
	End If
	If Label22.Text = "20" Then
		Label22.Text = "21"
	End If
	If Label22.Text = "21" Then
		Label22.Text = "22"
	End If
	If Label22.Text = "22" Then
		Label22.Text = "23"
	End If
	If Label22.Text = "23" Then
		Label22.Text = "24"
	End If
	If Label22.Text = "24" Then
		Label22.Text = "25"
	End If
	If Label22.Text = "25" Then
		Label22.Text = "26"
	End If
	If Label22.Text = "26" Then
		Label22.Text = "27"
	End If
	If Label22.Text = "27" Then
		Label22.Text = "28"
	End If
	If Label22.Text = "28" Then
		Label22.Text = "29"
	End If
	If Label22.Text = "29" Then
		Label22.Text = "30"
	End If

	'για καθε ενδεχομενο
	If Label22.Text = "01" Then
		Label22.Text = "02"
	End If
	If Label22.Text = "02" Then
		Label22.Text = "03"
	End If
	If Label22.Text = "03" Then
		Label22.Text = "04"
	End If
	If Label22.Text = "04" Then
		Label22.Text = "05"
	End If
	If Label22.Text = "05" Then
		Label22.Text = "06"
	End If
	If Label22.Text = "06" Then
		Label22.Text = "07"
	End If
	If Label22.Text = "07" Then
		Label22.Text = "08"
	End If
	If Label22.Text = "08" Then
		Label22.Text = "09"
	End If
	If Label22.Text = "09" Then
		Label22.Text = "10"
	End If
	'
