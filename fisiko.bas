...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("fisiko.bal")
...
clv2.AddTextItem("Το φυσικό αέριο UN-1971 αποτελείται από μεθάνιο (CH4) 85-90% και 10-15% αιθάνιο, προπάνιο, βουτάνιο, άζωτο, διοξείδιο του άνθρακα.", "")
 clv2.AddTextItem("Είναι άχρωμο, άοσμο. Είναι ασφυξιογόνο σε χώρους που δεν αερίζονται. Για να ξεχωρίζει στην όσφρηση,προσθέτουν ουσία για τον έλεγχο διαρροής.", "")
