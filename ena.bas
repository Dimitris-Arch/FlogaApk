...
clv2.AddTextItem("Γενικές πληροφορίες", "")
	clv2.AddTextItem("1.1 Κίνδυνος έκρηξης.", "")
	clv2.AddTextItem("1.2 Κίνδυνος εκτίναξης αλλα όχι έκρηξης.", "")
clv2.AddTextItem("1.3 Κίνδυνος και έκρηξης και εκτίναξης,όμως επίσης μεγάλη εκπομπή θερμότητας.", "")
