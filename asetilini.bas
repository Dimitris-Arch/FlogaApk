...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("asetilini.bal")
...
clv2.AddTextItem("To ακετυλένιο (ασετυλίνη) UN-1001 είναι υδρογονάνθρακας. Είναι άχρωμο, άοσμο. Είναι ασφυξιογόνο σε χώρους που δεν αερίζονται. Για να ξεχωρίζει στην όσφρηση,προσθέτουν ουσία για τον έλεγχο διαρροής.. Είναι εξαιρετικά εύφλεκτο αέριο,υπερβολικά εκρηκτικό και ασταθές.", "")
clv2.AddTextItem("Συνεχίστε να ψύχετε τις φυάλες-βυτία ακόμη και όταν η πυρκαγιά σβήσει.", "")
clv2.AddTextItem("ΜΗΝ ΣΒΗΝΕΤΕ ΤΗ ΦΛΟΓΑ ΤΟΥ ΔΙΑΡΡΕΟΝΤΟΣ ΑΕΡΙΟΥ ΕΚΤΟΣ ΚΑΙ ΑΝ ΕΙΝΑΙ ΑΠΟΛΥΤΑ ΑΝΑΓΚΑΙΟ.", "")
clv2.AddTextItem("Κατα την καύση του δημιουργεί θερμοκρασίες άνω των 3.000C.", "")
