...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("xlorio.bal")
pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
pin1.Width  = 45%x
...
clv2.AddTextItem("Το χλώριο UN-1017 είναι κιτρινοπράσινο αέριο πνιγηρό,δηλητηριώδες.", "")
clv2.AddTextItem("Το χλώριο είναι τοξικό και πολύ επικίνδυνο και για το περιβάλλον. Προκαλεί εγκαύματα με την επαφή. εισπνεόμενο προκαλλεί ακόμα και θάνατο.", "")
clv2.AddTextItem("ΧΡΗΣΙΜΟΠΟΙΗΣΤΕ ΣΤΟΛΗ ΧΗΜΙΚΗΣ ΠΡΟΣΤΑΣΙΑΣ ΚΛΕΙΣΤΟΥ ΤΥΠΟΥ ΜΕ ΠΛΗΡΗ ΑΠΟΜΟΝΩΣΗ.", "")
clv2.AddTextItem("Σταματήστε τη διαρροή αν μπορεί να γίνει με ασφάλεια.Αν αυτό δεν είναι δυνατό διασκορπίστε την διαρροή με βολή ομίχλης", "")
clv2.AddTextItem("Το χλώριο σε ένωση με το υδρογόνο δημιουργεί υδροχλώριο που παράγεται εκρηκτικά και είναι τοξικό .", "")
clv2.AddTextItem("Κατηγορία 2 ", "")
clv2.AddTextItem("Πυροδυναμωτικα,δηλητηριώδη και τοξικα. ", "")
