...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("pentebal.bal")
	'PRWTO PANW aristera
pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
...
clv2.AddTextItem("Κατηγορία 5.1 ", "")

	clv2.AddTextItem("Εκρηκτικές ουσίες και βλαβερές για την υγεία με μεγάλο κίνδυνο ανάφλεξης ή αυτανάφλεξης λόγο παρουσία οξυγόνου ", "")
