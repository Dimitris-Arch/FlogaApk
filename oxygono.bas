...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("oxygono.bal")
...
clv2.AddTextItem("Το οξυγόνο UN-1072 είναι πυροδυναμωτικό αέριο.Είναι αέριο άχρωμο, άοσμο.ΕΙΝΑΙ ΤΟ ΤΡΙΤΟ ΣΤΟΙΧΕΊΟ ΤΟΥ ΤΡΙΓΩΝΟΥ ΤΗΣ ΦΩΤΙΑΣ. ", "")
