...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("amonia.bal")
...
clv2.AddTextItem("Η αμμωνία UN-1005 είναι αέριο, άχρωμο,πνιγηρό, ελαφρύτερο του αέρα.Η υγρή αμμωνία είναι ψυκτικό υγρό και προκαλεί σοβαρά εγκαύματα.Η άνυδρη αμμωνία είναι διαβρωτικό και εξαιρετικά τοξικό για την υγεία και το σώμα. Σε χώρους που δεν αερίζονται καλά δημιουργεί εκρήξεις. ", "")
