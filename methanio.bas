...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("methanio.bal")
  pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
pin1.Width  = 45%x
...
clv2.AddTextItem("Το μεθάνιο (un-1972) δεν είναι τοξικό. Είναι όμως εξαιρετικά εύφλεκτο και μπορεί να προκαλέσει έκρηξη σε μίγματά του με τον αέρα .", "")
 ...
 clv2.AddTextItem("Κατηγορία 2.1 ", "")
	clv2.AddTextItem("Εφλεκτα,πυροδυναμωτικα,δηλητηριώδη και τοξικα. ", "")
