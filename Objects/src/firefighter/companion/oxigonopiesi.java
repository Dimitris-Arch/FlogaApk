...
public class oxigonopiesi extends Activity implements B4AActivity{
	public static oxigonopiesi mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.oxigonopiesi");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (oxigonopiesi).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.oxigonopiesi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.oxigonopiesi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (oxigonopiesi) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (oxigonopiesi) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (oxigonopiesi) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 46;BA.debugLine="Activity.LoadLayout(\"oxygonopiesi.bal\")";
mostCurrent._activity.LoadLayout("oxygonopiesi.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,oxigonopiesi.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"Το οξυγόνο UN-1073 είναι πυροδυν";
mostCurrent._clv2._addtextitem /*String*/ ("Το οξυγόνο UN-1073 είναι πυροδυναμωτικό αέριο.ΕΙΝΑΙ ΤΟ ΤΡΙΤΟ ΣΤΟΙΧΕΊΟ ΤΟΥ ΤΡΙΓΩΝΟΥ ΤΗΣ ΦΩΤΙΑΣ. ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"Σταματήστε τη διαρροή οξυγόνου α";
mostCurrent._clv2._addtextitem /*String*/ ("Σταματήστε τη διαρροή οξυγόνου αν μπορεί να γίνει με ασφάλεια.Αν αυτό δεν είναι δυνατό διασκορπίστε την διαρροή με βολή ομίχλης",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Σε κατάσταση ψύξης υπάρχει μεγάλ";
mostCurrent._clv2._addtextitem /*String*/ ("Σε κατάσταση ψύξης υπάρχει μεγάλος κίνδυνος εγκάυματος ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2 ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Εφλεκτα,πυροδυναμοτικα. \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Εφλεκτα,πυροδυναμοτικα. ",(Object)(""));
...
mostCurrent._clv2._addtextitem /*String*/ ("ΕΚΡΗΞΗ ΕΞΑΙΤΙΑΣ ΤΗΣ ΥΨΗΛΗΣ ΠΙΕΣΗΣ ΣΤΑ ΔΟΧΕΙΑ-ΒΥΤΙΑ ΠΟΥ ΒΡΙΣΚΟΝΤΑΙ. ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Έκρηξη σε περίπτωση διαρροής. \",";
mostCurrent._clv2._addtextitem /*String*/ ("Έκρηξη σε περίπτωση διαρροής. ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"ΠΟΛΥ ΥΨΗΛΟΣ ΚΙΝΔΥΝΟΣ ΑΠΌΤΟΜΗΣ Έ";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 202;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub ili_Click";
...
public static String  _ililabel_click() throws Exception{
 ...
 //BA.debugLineNum = 218;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 198;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 194;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 187;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 190;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 206;BA.debugLine="StartActivity(\"simanseis\")";
