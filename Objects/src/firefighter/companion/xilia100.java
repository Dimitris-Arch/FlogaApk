...
public class xilia100 extends Activity implements B4AActivity{
	public static xilia100 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.xilia100");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (xilia100).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.xilia100");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.xilia100", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (xilia100) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (xilia100) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (xilia100) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,xilia100.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"1001	ΚΑΤΗΓΟΡΙΑ 2	Ακετυλένιο , δ";
mostCurrent._clv2._addtextitem /*String*/ ("1001	ΚΑΤΗΓΟΡΙΑ 2	Ακετυλένιο , διαλυμένο	",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"1002	ΚΑΤΗΓΟΡΙΑ 2	Air , συμπιεσμέ";
mostCurrent._clv2._addtextitem /*String*/ ("1002	ΚΑΤΗΓΟΡΙΑ 2	Air , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"1003	ΚΑΤΗΓΟΡΙΑ 2	Air, κατεψυγμέν";
mostCurrent._clv2._addtextitem /*String*/ ("1003	ΚΑΤΗΓΟΡΙΑ 2	Air, κατεψυγμένο,κρυογονικο υγρό χωρίς πίεση	",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"1005	ΚΑΤΗΓΟΡΙΑ 2	Αμμωνία , άνυδρ";
mostCurrent._clv2._addtextitem /*String*/ ("1005	ΚΑΤΗΓΟΡΙΑ 2	Αμμωνία , άνυδρο	   ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"1006	ΚΑΤΗΓΟΡΙΑ 2	Αργόν , συμπιεσ";
mostCurrent._clv2._addtextitem /*String*/ ("1006	ΚΑΤΗΓΟΡΙΑ 2	Αργόν , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"1008	ΚΑΤΗΓΟΡΙΑ 2	Τριφθοριούχο βό";
mostCurrent._clv2._addtextitem /*String*/ ("1008	ΚΑΤΗΓΟΡΙΑ 2	Τριφθοριούχο βόριο , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"1009	ΚΑΤΗΓΟΡΙΑ 2	Βρωμοτρίφθορομε";
mostCurrent._clv2._addtextitem /*String*/ ("1009	ΚΑΤΗΓΟΡΙΑ 2	Βρωμοτρίφθορομεθάνιο ή ψυκτικό αέριο, Ε 13B1	 ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"1010	ΚΑΤΗΓΟΡΙΑ 2	Βουταδιένια , α";
mostCurrent._clv2._addtextitem /*String*/ ("1010	ΚΑΤΗΓΟΡΙΑ 2	Βουταδιένια , αναστέλλεται	   ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"1011	ΚΑΤΗΓΟΡΙΑ 2	Βουτάνιο Δείτε";
mostCurrent._clv2._addtextitem /*String*/ ("1011	ΚΑΤΗΓΟΡΙΑ 2	Βουτάνιο Δείτε επίσης αέρια πετρελαίου, υγροποιημένα	",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"1012	ΚΑΤΗΓΟΡΙΑ 2	Βουτυλένιο δείτ";
mostCurrent._clv2._addtextitem /*String*/ ("1012	ΚΑΤΗΓΟΡΙΑ 2	Βουτυλένιο δείτε επίσης αέρια πετρελαίου, υγροποιημένα",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"1013	ΚΑΤΗΓΟΡΙΑ 2	Διοξείδιο  άνθρ";
mostCurrent._clv2._addtextitem /*String*/ ("1013	ΚΑΤΗΓΟΡΙΑ 2	Διοξείδιο  άνθρακα	   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"1014	ΚΑΤΗΓΟΡΙΑ 2 Διοξείδιο  άνθρ";
mostCurrent._clv2._addtextitem /*String*/ ("1014	ΚΑΤΗΓΟΡΙΑ 2 Διοξείδιο  άνθρακα και οξυγόνο μείγματα, συμπιεσμένο",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"1015	ΚΑΤΗΓΟΡΙΑ 2	Διοξείδιο  άνθρ";
mostCurrent._clv2._addtextitem /*String*/ ("1015	ΚΑΤΗΓΟΡΙΑ 2	Διοξείδιο  άνθρακα και μίγματα υποξείδιο  αζώτου	   ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"1016	ΚΑΤΗΓΟΡΙΑ 2	Μονοξείδιο  άνθ";
mostCurrent._clv2._addtextitem /*String*/ ("1016	ΚΑΤΗΓΟΡΙΑ 2	Μονοξείδιο  άνθρακα , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"1017	ΚΑΤΗΓΟΡΙΑ 2	Χλώριο	   \" ,\"\"";
mostCurrent._clv2._addtextitem /*String*/ ("1017	ΚΑΤΗΓΟΡΙΑ 2	Χλώριο	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"1018	ΚΑΤΗΓΟΡΙΑ 2	Χλωροδιφθορομεθ";
mostCurrent._clv2._addtextitem /*String*/ ("1018	ΚΑΤΗΓΟΡΙΑ 2	Χλωροδιφθορομεθάνιο ή ψυκτικό αέριο R 22	",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"1020	ΚΑΤΗΓΟΡΙΑ 2	Χλωροπενταφθορο";
mostCurrent._clv2._addtextitem /*String*/ ("1020	ΚΑΤΗΓΟΡΙΑ 2	Χλωροπενταφθοροαιθανίου ή ψυκτικό αέριο R 115	   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"1021	ΚΑΤΗΓΟΡΙΑ 2	χλωρο-τετραφθορ";
mostCurrent._clv2._addtextitem /*String*/ ("1021	ΚΑΤΗΓΟΡΙΑ 2	χλωρο-τετραφθοροαιθάνιο ή το ψυκτικό αέριο R 124",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"1022	ΚΑΤΗΓΟΡΙΑ 2	Χλωροτριφθορομε";
mostCurrent._clv2._addtextitem /*String*/ ("1022	ΚΑΤΗΓΟΡΙΑ 2	Χλωροτριφθορομεθάνιο ή ψυκτικό αέριο R 13	",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"1023	ΚΑΤΗΓΟΡΙΑ 2	Ατμός , συμπιεσ";
mostCurrent._clv2._addtextitem /*String*/ ("1023	ΚΑΤΗΓΟΡΙΑ 2	Ατμός , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"1026	ΚΑΤΗΓΟΡΙΑ 2	Κυανογόνο	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("1026	ΚΑΤΗΓΟΡΙΑ 2	Κυανογόνο	   ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"1027	ΚΑΤΗΓΟΡΙΑ 2	Κυκλοπροπανιοκα";
mostCurrent._clv2._addtextitem /*String*/ ("1027	ΚΑΤΗΓΟΡΙΑ 2	Κυκλοπροπανιοκαρβοξυλικό	   ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"1028	ΚΑΤΗΓΟΡΙΑ 2	Διχλωροδιφθοριο";
mostCurrent._clv2._addtextitem /*String*/ ("1028	ΚΑΤΗΓΟΡΙΑ 2	Διχλωροδιφθοριομεθάνιο ή ψυκτικό αέριο R 12	   ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"1029	ΚΑΤΗΓΟΡΙΑ 2	Διχλωροφθορομεθ";
mostCurrent._clv2._addtextitem /*String*/ ("1029	ΚΑΤΗΓΟΡΙΑ 2	Διχλωροφθορομεθάνιο ή ψυκτικό αέριο R 21	",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"1030	ΚΑΤΗΓΟΡΙΑ 2	Διφθοροαιθανίο";
mostCurrent._clv2._addtextitem /*String*/ ("1030	ΚΑΤΗΓΟΡΙΑ 2	Διφθοροαιθανίο ή ψυκτικό αέριο R 152a	   ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"1032	ΚΑΤΗΓΟΡΙΑ 2	Διμεθυλαμίνη ,";
mostCurrent._clv2._addtextitem /*String*/ ("1032	ΚΑΤΗΓΟΡΙΑ 2	Διμεθυλαμίνη , άνυδρο	   ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"1033	ΚΑΤΗΓΟΡΙΑ 2	Διμεθυλαιθήρας";
mostCurrent._clv2._addtextitem /*String*/ ("1033	ΚΑΤΗΓΟΡΙΑ 2	Διμεθυλαιθήρας	   ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"1035	ΚΑΤΗΓΟΡΙΑ 2	Αιθάνιο	   \" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("1035	ΚΑΤΗΓΟΡΙΑ 2	Αιθάνιο	   ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"1036	ΚΑΤΗΓΟΡΙΑ 2	Αιθυλαμίνη	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("1036	ΚΑΤΗΓΟΡΙΑ 2	Αιθυλαμίνη	   ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"1037	ΚΑΤΗΓΟΡΙΑ 2	Αιθυλ χλωρίδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1037	ΚΑΤΗΓΟΡΙΑ 2	Αιθυλ χλωρίδιο	   ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"1038	ΚΑΤΗΓΟΡΙΑ 2	Αιθυλένιο , ψυγ";
mostCurrent._clv2._addtextitem /*String*/ ("1038	ΚΑΤΗΓΟΡΙΑ 2	Αιθυλένιο , ψυγείο υγρού κρυογονική υγρό",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"1039	ΚΑΤΗΓΟΡΙΑ 2	Αιθυλομεθυλο αι";
mostCurrent._clv2._addtextitem /*String*/ ("1039	ΚΑΤΗΓΟΡΙΑ 2	Αιθυλομεθυλο αιθέρα	   ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"1040	ΚΑΤΗΓΟΡΙΑ 2	Οξείδιο  αιθυλε";
mostCurrent._clv2._addtextitem /*String*/ ("1040	ΚΑΤΗΓΟΡΙΑ 2	Οξείδιο  αιθυλενίου ή οξείδιο  αιθυλενίου με άζωτο 	   ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"1041	ΚΑΤΗΓΟΡΙΑ 2	Μίγματα οξειδίο";
mostCurrent._clv2._addtextitem /*String*/ ("1041	ΚΑΤΗΓΟΡΙΑ 2	Μίγματα οξειδίου  αιθυλενίου και διοξειδίου  άνθρακα ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"1043	ΚΑΤΗΓΟΡΙΑ 2	Λιπασμάτων λύση";
mostCurrent._clv2._addtextitem /*String*/ ("1043	ΚΑΤΗΓΟΡΙΑ 2	Λιπασμάτων λύση αμμωνιοποίηση με ελεύθερη αμμωνία	",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"1044	ΚΑΤΗΓΟΡΙΑ 2	Οι πυροσβεστήρε";
mostCurrent._clv2._addtextitem /*String*/ ("1044	ΚΑΤΗΓΟΡΙΑ 2	Οι πυροσβεστήρες που περιέχουν συμπιεσμένα ή υγροποιημένα αέρια	   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"1045	ΚΑΤΗΓΟΡΙΑ 2	Φθόριο , συμπιε";
mostCurrent._clv2._addtextitem /*String*/ ("1045	ΚΑΤΗΓΟΡΙΑ 2	Φθόριο , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"1046	ΚΑΤΗΓΟΡΙΑ 2	Ήλιο , συμπιεσμ";
mostCurrent._clv2._addtextitem /*String*/ ("1046	ΚΑΤΗΓΟΡΙΑ 2	Ήλιο , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"1048	ΚΑΤΗΓΟΡΙΑ 2	Υδροβρώμιο , άν";
mostCurrent._clv2._addtextitem /*String*/ ("1048	ΚΑΤΗΓΟΡΙΑ 2	Υδροβρώμιο , άνυδρο	   ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"1049	ΚΑΤΗΓΟΡΙΑ 2	Υδρογόνο, συμπι";
mostCurrent._clv2._addtextitem /*String*/ ("1049	ΚΑΤΗΓΟΡΙΑ 2	Υδρογόνο, συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"1050	ΚΑΤΗΓΟΡΙΑ 2	Υδροχλώριο , άν";
mostCurrent._clv2._addtextitem /*String*/ ("1050	ΚΑΤΗΓΟΡΙΑ 2	Υδροχλώριο , άνυδρο	   ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"1051	ΚΑΤΗΓΟΡΙΑ 6.1	Υδροκυάνιο ,";
mostCurrent._clv2._addtextitem /*String*/ ("1051	ΚΑΤΗΓΟΡΙΑ 6.1	Υδροκυάνιο , σταθεροποιημένο με λιγότερο από 3 τοις εκατό νερό	",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"1052	ΚΑΤΗΓΟΡΙΑ 8	Υδροφθόριο , άν";
mostCurrent._clv2._addtextitem /*String*/ ("1052	ΚΑΤΗΓΟΡΙΑ 8	Υδροφθόριο , άνυδρο	   ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"1053	ΚΑΤΗΓΟΡΙΑ 2	Υδρόθειο	   \" ,";
mostCurrent._clv2._addtextitem /*String*/ ("1053	ΚΑΤΗΓΟΡΙΑ 2	Υδρόθειο	   ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"1055	ΚΑΤΗΓΟΡΙΑ 2	Ισοβουτυλένιο δ";
mostCurrent._clv2._addtextitem /*String*/ ("1055	ΚΑΤΗΓΟΡΙΑ 2	Ισοβουτυλένιο δείτε επίσης αέρια πετρελαίου, υγροποιημένα	   ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"1056	ΚΑΤΗΓΟΡΙΑ 2	Krypton , συμπι";
mostCurrent._clv2._addtextitem /*String*/ ("1056	ΚΑΤΗΓΟΡΙΑ 2	Krypton , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"1057	ΚΑΤΗΓΟΡΙΑ 2	Αναπτήρες ή τα";
mostCurrent._clv2._addtextitem /*String*/ ("1057	ΚΑΤΗΓΟΡΙΑ 2	Αναπτήρες ή τα ανταλλακτικά αναπτήρων τσιγάρων	",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"1058	ΚΑΤΗΓΟΡΙΑ 2	Υγροποιημένα αέ";
mostCurrent._clv2._addtextitem /*String*/ ("1058	ΚΑΤΗΓΟΡΙΑ 2	Υγροποιημένα αέρια, μη εύφλεκτο	   ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"1060	ΚΑΤΗΓΟΡΙΑ 2	Μεθυλακετυλένιο";
mostCurrent._clv2._addtextitem /*String*/ ("1060	ΚΑΤΗΓΟΡΙΑ 2	Μεθυλακετυλένιο και προπαδιένιο μίγματα, σταθεροποιημένα	   ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"1061	ΚΑΤΗΓΟΡΙΑ 2	Μεθυλαμίνη , άν";
mostCurrent._clv2._addtextitem /*String*/ ("1061	ΚΑΤΗΓΟΡΙΑ 2	Μεθυλαμίνη , άνυδρη	   ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"1062	ΚΑΤΗΓΟΡΙΑ 2	Το βρωμιούχο με";
mostCurrent._clv2._addtextitem /*String*/ ("1062	ΚΑΤΗΓΟΡΙΑ 2	Το βρωμιούχο μεθύλιο	   ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"1063	ΚΑΤΗΓΟΡΙΑ 2	Χλωριούχο μεθύλ";
mostCurrent._clv2._addtextitem /*String*/ ("1063	ΚΑΤΗΓΟΡΙΑ 2	Χλωριούχο μεθύλιο , ή ψυκτικό αέριο R 40	   ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"1064	ΚΑΤΗΓΟΡΙΑ 2	Μεθυλ μερκαπτάν";
mostCurrent._clv2._addtextitem /*String*/ ("1064	ΚΑΤΗΓΟΡΙΑ 2	Μεθυλ μερκαπτάνης	   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"1065	ΚΑΤΗΓΟΡΙΑ 2	Νέον , συμπιεσμ";
mostCurrent._clv2._addtextitem /*String*/ ("1065	ΚΑΤΗΓΟΡΙΑ 2	Νέον , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"1066	ΚΑΤΗΓΟΡΙΑ 2	Άζωτο , συμπιεσ";
mostCurrent._clv2._addtextitem /*String*/ ("1066	ΚΑΤΗΓΟΡΙΑ 2	Άζωτο , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"1067	ΚΑΤΗΓΟΡΙΑ 2	Τετροξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1067	ΚΑΤΗΓΟΡΙΑ 2	Τετροξείδιο	   ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"1069	ΚΑΤΗΓΟΡΙΑ 2	Νιτροζυλοχλωρίδ";
mostCurrent._clv2._addtextitem /*String*/ ("1069	ΚΑΤΗΓΟΡΙΑ 2	Νιτροζυλοχλωρίδιο χλωριούχο	   ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"1070	ΚΑΤΗΓΟΡΙΑ 2	Το πρωτοξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1070	ΚΑΤΗΓΟΡΙΑ 2	Το πρωτοξείδιο  αζώτου	   ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"1071	ΚΑΤΗΓΟΡΙΑ 2	Πετρελαίου εσωτ";
mostCurrent._clv2._addtextitem /*String*/ ("1071	ΚΑΤΗΓΟΡΙΑ 2	Πετρελαίου εσωτερικής καύσης , συμπιεσμένο",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"1072	ΚΑΤΗΓΟΡΙΑ 2	Οξυγόνο , συμπι";
mostCurrent._clv2._addtextitem /*String*/ ("1072	ΚΑΤΗΓΟΡΙΑ 2	Οξυγόνο , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"1073	ΚΑΤΗΓΟΡΙΑ 2	Οξυγόνου, κατεψ";
mostCurrent._clv2._addtextitem /*String*/ ("1073	ΚΑΤΗΓΟΡΙΑ 2	Οξυγόνου, κατεψυγμένου υγρού κρυογονική υγρό	   ",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"1075	ΚΑΤΗΓΟΡΙΑ 2	Αέρια πετρελαίο";
mostCurrent._clv2._addtextitem /*String*/ ("1075	ΚΑΤΗΓΟΡΙΑ 2	Αέρια πετρελαίου, υγροποιημένο αέριο ή υγραέριο	   ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"1076	ΚΑΤΗΓΟΡΙΑ 2	Φωσγένιο	   \" ,";
mostCurrent._clv2._addtextitem /*String*/ ("1076	ΚΑΤΗΓΟΡΙΑ 2	Φωσγένιο	   ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"1077	ΚΑΤΗΓΟΡΙΑ 2	Προπυλενίου βλέ";
mostCurrent._clv2._addtextitem /*String*/ ("1077	ΚΑΤΗΓΟΡΙΑ 2	Προπυλενίου βλέπε επίσης αέρια πετρελαίου, υγροποιημένα	   ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"1078	ΚΑΤΗΓΟΡΙΑ 2	Ψυκτικού αέρια,";
mostCurrent._clv2._addtextitem /*String*/ ("1078	ΚΑΤΗΓΟΡΙΑ 2	Ψυκτικού αέρια, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"1079	ΚΑΤΗΓΟΡΙΑ 2	Διοξείδιο  θείο";
mostCurrent._clv2._addtextitem /*String*/ ("1079	ΚΑΤΗΓΟΡΙΑ 2	Διοξείδιο  θείου	   ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"1080	ΚΑΤΗΓΟΡΙΑ 2	Το εξαφθοριούχο";
mostCurrent._clv2._addtextitem /*String*/ ("1080	ΚΑΤΗΓΟΡΙΑ 2	Το εξαφθοριούχο θείο	",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"1081	ΚΑΤΗΓΟΡΙΑ 2	Τετραφθοροαιθυλ";
mostCurrent._clv2._addtextitem /*String*/ ("1081	ΚΑΤΗΓΟΡΙΑ 2	Τετραφθοροαιθυλένιο , αναστέλλεται	 ",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"1082	ΚΑΤΗΓΟΡΙΑ 2	Trifluorochloro";
mostCurrent._clv2._addtextitem /*String*/ ("1082	ΚΑΤΗΓΟΡΙΑ 2	Trifluorochloroethylene , αναστέλλεται	   ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"1083	ΚΑΤΗΓΟΡΙΑ 2	Τριμεθυλαμίνη ,";
mostCurrent._clv2._addtextitem /*String*/ ("1083	ΚΑΤΗΓΟΡΙΑ 2	Τριμεθυλαμίνη , άνυδρη	   ",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"1085	ΚΑΤΗΓΟΡΙΑ 2	Βινυλοβρωμιδίου";
mostCurrent._clv2._addtextitem /*String*/ ("1085	ΚΑΤΗΓΟΡΙΑ 2	Βινυλοβρωμιδίου , αναστέλλεται	   ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"1086	ΚΑΤΗΓΟΡΙΑ 2	Χλωριούχο βινύλ";
mostCurrent._clv2._addtextitem /*String*/ ("1086	ΚΑΤΗΓΟΡΙΑ 2	Χλωριούχο βινύλιο , αναστέλλεται ή βινυλίου χλωρίδιο   ",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"1087	ΚΑΤΗΓΟΡΙΑ 2	Βινυλομεθυλαιθέ";
mostCurrent._clv2._addtextitem /*String*/ ("1087	ΚΑΤΗΓΟΡΙΑ 2	Βινυλομεθυλαιθέρα , παρεμπόδισε	   ",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"1088	ΚΑΤΗΓΟΡΙΑ 3	Ακετάλη	   \" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("1088	ΚΑΤΗΓΟΡΙΑ 3	Ακετάλη	   ",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="clv2.AddTextItem(\"1089	ΚΑΤΗΓΟΡΙΑ 3	Η ακεταλδεΰδη";
mostCurrent._clv2._addtextitem /*String*/ ("1089	ΚΑΤΗΓΟΡΙΑ 3	Η ακεταλδεΰδη	   ",(Object)(""));
 //BA.debugLineNum = 201;BA.debugLine="clv2.AddTextItem(\"1090	ΚΑΤΗΓΟΡΙΑ 3	Ακετόνη	   \" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("1090	ΚΑΤΗΓΟΡΙΑ 3	Ακετόνη	   ",(Object)(""));
 //BA.debugLineNum = 202;BA.debugLine="clv2.AddTextItem(\"1091	ΚΑΤΗΓΟΡΙΑ 3	Έλαια ακετόνη";
mostCurrent._clv2._addtextitem /*String*/ ("1091	ΚΑΤΗΓΟΡΙΑ 3	Έλαια ακετόνη	   ",(Object)(""));
 //BA.debugLineNum = 203;BA.debugLine="clv2.AddTextItem(\"1092	ΚΑΤΗΓΟΡΙΑ 6.1	Ακρολείνη , α";
mostCurrent._clv2._addtextitem /*String*/ ("1092	ΚΑΤΗΓΟΡΙΑ 6.1	Ακρολείνη , αναστέλλεται	   ",(Object)(""));
 //BA.debugLineNum = 204;BA.debugLine="clv2.AddTextItem(\"1093	ΚΑΤΗΓΟΡΙΑ 3	Ακρυλονιτρίλιο";
mostCurrent._clv2._addtextitem /*String*/ ("1093	ΚΑΤΗΓΟΡΙΑ 3	Ακρυλονιτρίλιο , αναστέλλεται	  ",(Object)(""));
 //BA.debugLineNum = 205;BA.debugLine="clv2.AddTextItem(\"1098	ΚΑΤΗΓΟΡΙΑ 6.1	Αλλυλ αλκοόλη";
mostCurrent._clv2._addtextitem /*String*/ ("1098	ΚΑΤΗΓΟΡΙΑ 6.1	Αλλυλ αλκοόλη	   ",(Object)(""));
 //BA.debugLineNum = 206;BA.debugLine="clv2.AddTextItem(\"1100	ΚΑΤΗΓΟΡΙΑ 3	Αλλυλοχλωρίδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1100	ΚΑΤΗΓΟΡΙΑ 3	Αλλυλοχλωρίδιο	 ",(Object)(""));
