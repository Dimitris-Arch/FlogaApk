...
public class triaxil600 extends Activity implements B4AActivity{
	public static triaxil600 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.triaxil600");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (triaxil600).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.triaxil600");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.triaxil600", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (triaxil600) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (triaxil600) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (triaxil600) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._simanseislabel.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (27.5),mostCurrent.activityBA));
 //BA.debugLineNum = 47;BA.debugLine="simanseislabel.Width  = 45%x";
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,triaxil600.getObject(),"clv2");
 //BA.debugLineNum = 113;BA.debugLine="Panel2.AddView(clv2.AsView, 0%x, 0%y,94%x ,57.5%y";
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 121;BA.debugLine="clv2.AddTextItem(\"3501	Κατηγορία 2.1	Χημική υπό πί";
mostCurrent._clv2._addtextitem /*String*/ ("3501	Κατηγορία 2.1	Χημική υπό πίεση, εύφλεκτα , μη προδιαγραφόμενα άλλως	   ",(Object)(""));
 //BA.debugLineNum = 122;BA.debugLine="clv2.AddTextItem(\"3502	Κατηγορία 2.2	Χημικά υπό πί";
mostCurrent._clv2._addtextitem /*String*/ ("3502	Κατηγορία 2.2	Χημικά υπό πίεση, τοξικά , δεν ορίζεται διαφορετικά	   ",(Object)(""));
 //BA.debugLineNum = 123;BA.debugLine="clv2.AddTextItem(\"3503	Κατηγορία 2.2	Χημική υπό πί";
mostCurrent._clv2._addtextitem /*String*/ ("3503	Κατηγορία 2.2	Χημική υπό πίεση, διαβρωτικά , μη προδιαγραφόμενα άλλως	   ",(Object)(""));
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"3504	Κατηγορία 2.1	Χημική υπό πί";
mostCurrent._clv2._addtextitem /*String*/ ("3504	Κατηγορία 2.1	Χημική υπό πίεση, εύφλεκτα, τοξικά, μη προδιαγραφόμενα άλλως	   ",(Object)(""));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"3505	Κατηγορία 2.1	Χημική υπό πί";
mostCurrent._clv2._addtextitem /*String*/ ("3505	Κατηγορία 2.1	Χημική υπό πίεση, εύφλεκτα, διαβρωτικά, μη προδιαγραφόμενα άλλως	   ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"3506	Κατηγορία 8	Ο υδράργυρος πο";
mostCurrent._clv2._addtextitem /*String*/ ("3506	Κατηγορία 8	Ο υδράργυρος που περιέχεται σε βιομηχανικά είδη	   ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"3507	Κατηγορία 8	Εξαφθοριούχο ου";
mostCurrent._clv2._addtextitem /*String*/ ("3507	Κατηγορία 8	Εξαφθοριούχο ουράνιο,Ραδιενεργό   ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"3508	Κατηγορία 9	Πυκνωτής 	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("3508	Κατηγορία 9	Πυκνωτής 	   ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"3509	Κατηγορία 9	Συσκευασία , απ";
mostCurrent._clv2._addtextitem /*String*/ ("3509	Κατηγορία 9	Συσκευασία , απορρίπτονται, κενά, ακαθάριστα προτεινόμενη είσοδος	   ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"3510	Κατηγορία 2.1	Το απορροφημέ";
mostCurrent._clv2._addtextitem /*String*/ ("3510	Κατηγορία 2.1	Το απορροφημένο αέριο , εύφλεκτο, δεν ορίζεται διαφορετικά προτεινόμενη είσοδος	",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"3511	Κατηγορία 2.2	Το απορροφημέ";
mostCurrent._clv2._addtextitem /*String*/ ("3511	Κατηγορία 2.2	Το απορροφημένο αέριο, δεν ορίζεται διαφορετικά προτεινόμενη είσοδος	   ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"3512	Κατηγορία 2.3	Το απορροφημέ";
mostCurrent._clv2._addtextitem /*String*/ ("3512	Κατηγορία 2.3	Το απορροφημένο αέριο, τοξικό, μη προδιαγραφόμενα άλλως	   ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"3513	Κατηγορία 2.2	Το απορροφημέ";
mostCurrent._clv2._addtextitem /*String*/ ("3513	Κατηγορία 2.2	Το απορροφημένο αέριο, οξειδωτικά , μη προδιαγραφόμενα άλλως	   ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"3514	Κατηγορία 2.3	Το απορροφημέ";
mostCurrent._clv2._addtextitem /*String*/ ("3514	Κατηγορία 2.3	Το απορροφημένο αέριο, τοξικά, εύφλεκτα, μη προδιαγραφόμενα άλλως	   ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"3515	Κατηγορία 2.3	Το απορροφημέ";
mostCurrent._clv2._addtextitem /*String*/ ("3515	Κατηγορία 2.3	Το απορροφημένο αέριο, τοξικά, εύφλεκτα, διαβρωτικά, μη προδιαγραφόμενα άλλως	   ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"3516	Κατηγορία 2.3	Το απορροφημέ";
mostCurrent._clv2._addtextitem /*String*/ ("3516	Κατηγορία 2.3	Το απορροφημένο αέριο, τοξικά, οξειδωτικά, μη προδιαγραφόμενα άλλως	   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"3517	Κατηγορία 2.3	Το απορροφημέ";
mostCurrent._clv2._addtextitem /*String*/ ("3517	Κατηγορία 2.3	Το απορροφημένο αέριο, τοξικά, οξειδωτικά, διαβρωτικά, μη προδιαγραφόμενα άλλως	  ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"3518	Κατηγορία 2.3	Το απορροφημέ";
mostCurrent._clv2._addtextitem /*String*/ ("3518	Κατηγορία 2.3	Το απορροφημένο αέριο, τοξικά, διαβρωτικά, μη προδιαγραφόμενα άλλως	",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 218;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 196;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 177;BA.debugLine="Sub ili_Click";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 211;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 212;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 213;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 192;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 206;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
 //BA.debugLineNum = 207;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 188;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 202;BA.debugLine="Sub listabel_Click";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 181;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 208;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 209;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 //BA.debugLineNum = 210;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Sub simanseislabel_Click";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="Sub simansi_Click";
