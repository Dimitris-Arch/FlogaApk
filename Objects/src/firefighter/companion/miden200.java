...
public class miden200 extends Activity implements B4AActivity{
	public static miden200 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.miden200");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (miden200).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.miden200");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.miden200", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (miden200) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (miden200) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (miden200) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,miden200.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 123;BA.debugLine="clv2.AddTextItem(\"0101	 Κατηγορία 1	Fuse , μη-εκρη";
mostCurrent._clv2._addtextitem /*String*/ ("0101	 Κατηγορία 1	Fuse , μη-εκρηκτικό (στιγμιαία ή quickmatch)	   ",(Object)(""));
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"0102	 Κατηγορία 1	Καλώδιο εκρηκτ";
mostCurrent._clv2._addtextitem /*String*/ ("0102	 Κατηγορία 1	Καλώδιο εκρηκτικού ή Fuse εκρηκτικό μέταλλα επιστρωμένα	     ",(Object)(""));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"0103	 Κατηγορία 1	Fuse, Αναφλεκτ";
mostCurrent._clv2._addtextitem /*String*/ ("0103	 Κατηγορία 1	Fuse, Αναφλεκτήρας σωληνοειδές μέταλλα επιστρωμένα	      ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"0104	 Κατηγορία 1	ΚΑΛΩΔΙΟ, ΕΚΡΗΚ";
mostCurrent._clv2._addtextitem /*String*/ ("0104	 Κατηγορία 1	ΚΑΛΩΔΙΟ, ΕΚΡΗΚΤΙΚΟ, ήπια επίδραση ή η ασφάλεια, έκρηξη, ήπια επίδραση μέταλλα επιστρωμένα	   ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"0105	 Κατηγορία 1	Ασφάλεια, ασφά";
mostCurrent._clv2._addtextitem /*String*/ ("0105	 Κατηγορία 1	Ασφάλεια, ασφάλεια	      ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"0106 	 Κατηγορία 1	Ασφάλειες, εκ";
mostCurrent._clv2._addtextitem /*String*/ ("0106 	 Κατηγορία 1	Ασφάλειες, εκρηκτικών	      ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"0110	 Κατηγορία 1	Χειροβομβίδες";
mostCurrent._clv2._addtextitem /*String*/ ("0110	 Κατηγορία 1	Χειροβομβίδες , πρακτική, χειρός ή όπλου	   ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"0113	 Κατηγορία 1	Γουανυλ nitros";
mostCurrent._clv2._addtextitem /*String*/ ("0113	 Κατηγορία 1	Γουανυλ nitrosaminoguanylidene υδραζίνης , βρεγμένο με όχι λιγότερο από 30 τοις εκατό νερό κατά μάζα	      ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"0114	 Κατηγορία 1	Γουανυλ nitros";
mostCurrent._clv2._addtextitem /*String*/ ("0114	 Κατηγορία 1	Γουανυλ nitrosaminoguanyltetrazene    ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"0118	 Κατηγορία 1	ΕΞΟΛΙΤΗΣ , ή Ε";
mostCurrent._clv2._addtextitem /*String*/ ("0118	 Κατηγορία 1	ΕΞΟΛΙΤΗΣ , ή ΕΞΠΤΟΛΗ ξηρός ή νωπός με λιγότερο από 15 τοις εκατό νερό κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"0121	 Κατηγορία 1	Αναφλεκτηρες";
mostCurrent._clv2._addtextitem /*String*/ ("0121	 Κατηγορία 1	Αναφλεκτηρες	      ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"0124	 Κατηγορία 1	Jet , διάτρηση";
mostCurrent._clv2._addtextitem /*String*/ ("0124	 Κατηγορία 1	Jet , διάτρηση όπλα, χρεώνεται το πετρέλαιο καλά, με / χωρίς πυροκροτητή   ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"0129	 Κατηγορία 1	Αζίδιο  μολύβδ";
mostCurrent._clv2._addtextitem /*String*/ ("0129	 Κατηγορία 1	Αζίδιο  μολύβδου , ??βρεγμένο με όχι λιγότερο από 20 τοις εκατό νερό ή μίγμα αλκοόλης και νερού, κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"0130	 Κατηγορία 1	Στυφνικός μόλυ";
mostCurrent._clv2._addtextitem /*String*/ ("0130	 Κατηγορία 1	Στυφνικός μόλυβδος , νωπό ή στυφνικού, βρεγμένο με όχι λιγότερο από 20	      ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"0131	 Κατηγορία 1	Αναπτήρες   \"";
mostCurrent._clv2._addtextitem /*String*/ ("0131	 Κατηγορία 1	Αναπτήρες   ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"0132	 Κατηγορία 1	Αναφλεγόμενη μ";
mostCurrent._clv2._addtextitem /*String*/ ("0132	 Κατηγορία 1	Αναφλεγόμενη μεταλλικά άλατα των αρωματικών νιτροπαραγώγων, ε.α.ο.	      ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"0133	 Κατηγορία 1	Εξανιτρική μαν";
mostCurrent._clv2._addtextitem /*String*/ ("0133	 Κατηγορία 1	Εξανιτρική μανιτόλη   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"0135	 Κατηγορία 1	Υδράργυρος κερ";
mostCurrent._clv2._addtextitem /*String*/ ("0135	 Κατηγορία 1	Υδράργυρος κεραυνοβολώ , βρεγμένο με όχι λιγότερο από 20 τοις εκατό νερό, ή ένα μίγμα αλκοόλης και νερού, κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"0136 	 Κατηγορία 1	Μεταλλεία με";
mostCurrent._clv2._addtextitem /*String*/ ("0136 	 Κατηγορία 1	Μεταλλεία με εκρηκτική γόμωση	      ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"0143	 Κατηγορία 1	Νιτρογλυκερίνη";
mostCurrent._clv2._addtextitem /*String*/ ("0143	 Κατηγορία 1	Νιτρογλυκερίνη   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"0144	 Κατηγορία 1	Νιτρογλυκερίνη";
mostCurrent._clv2._addtextitem /*String*/ ("0144	 Κατηγορία 1	Νιτρογλυκερίνη, διάλυμα σε αλκοόλη   ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"0146	 Κατηγορία 1	Nitrostarch ,";
mostCurrent._clv2._addtextitem /*String*/ ("0146	 Κατηγορία 1	Nitrostarch , ξηρός ή νωπός με λιγότερο από 20 τοις εκατό νερό κατά μάζα   ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"0147	 Κατηγορία 1	Nitro ουρία";
mostCurrent._clv2._addtextitem /*String*/ ("0147	 Κατηγορία 1	Nitro ουρία	      ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"0150	 Κατηγορία 1	Τετρανιτρικού,";
mostCurrent._clv2._addtextitem /*String*/ ("0150	 Κατηγορία 1	Τετρανιτρικού, νωπό ή Πενταερυθρίτης τετρανιτρική    ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"0151	 Κατηγορία 1	ΠΕΝΤΟΛΙΤΗΣ , ξ";
mostCurrent._clv2._addtextitem /*String*/ ("0151	 Κατηγορία 1	ΠΕΝΤΟΛΙΤΗΣ , ξηρός ή νωπός με λιγότερο από 15 τοις εκατό νερό κατά μάζα   ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"0153	 Κατηγορία 1	Trinitroanilin";
mostCurrent._clv2._addtextitem /*String*/ ("0153	 Κατηγορία 1	Trinitroaniline ή Picramide	      ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"0154	 Κατηγορία 1	Τρινιτροφαινόλ";
mostCurrent._clv2._addtextitem /*String*/ ("0154	 Κατηγορία 1	Τρινιτροφαινόλης ή πικρικό οξύ, ξηρός ή νωπός με λιγότερο από 30 τοις εκατό νερό κατά μάζα	      ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"0155	 Κατηγορία 1	Τρινιτροχλωροβ";
mostCurrent._clv2._addtextitem /*String*/ ("0155	 Κατηγορία 1	Τρινιτροχλωροβενζόλιο ή πικρυλοχλωρίδιο	      ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"0159	 Κατηγορία 1	Κέικ σε σκόνη,";
mostCurrent._clv2._addtextitem /*String*/ ("0159	 Κατηγορία 1	Κέικ σε σκόνη, νωπό ή πάστα σε σκόνη, βρεγμένο με όχι λιγότερο από 25 τοις εκατό νερό κατά μάζα   ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"0160 	 Κατηγορία 1	Σκόνη , άκαπν";
mostCurrent._clv2._addtextitem /*String*/ ("0160 	 Κατηγορία 1	Σκόνη , άκαπνη	      ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"0167   Κατηγορία 1	Βλήματα , με";
mostCurrent._clv2._addtextitem /*String*/ ("0167   Κατηγορία 1	Βλήματα , με εκρηκτική γόμωση	      ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"0171	 Κατηγορία 1	Πυρομαχικά , φ";
mostCurrent._clv2._addtextitem /*String*/ ("0171	 Κατηγορία 1	Πυρομαχικά , φωτίζοντας με ή χωρίς ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης   ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"0173	 Κατηγορία 1	Συσκευές απελε";
mostCurrent._clv2._addtextitem /*String*/ ("0173	 Κατηγορία 1	Συσκευές απελευθέρωσης, εκρηκτικά	      ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"0174	 Κατηγορία 1	Πριτσίνια , εκ";
mostCurrent._clv2._addtextitem /*String*/ ("0174	 Κατηγορία 1	Πριτσίνια , εκρηκτικά	      ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"0180 	 Κατηγορία 1	Ρόκετς, με εκ";
mostCurrent._clv2._addtextitem /*String*/ ("0180 	 Κατηγορία 1	Ρόκετς, με εκρηκτική γόμωση	      ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"0183	 Κατηγορία 1	Ρόκετς , με αδ";
mostCurrent._clv2._addtextitem /*String*/ ("0183	 Κατηγορία 1	Ρόκετς , με αδρανή κεφαλή	      ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"0186	 Κατηγορία 1	Πυραυλοκινητήρ";
mostCurrent._clv2._addtextitem /*String*/ ("0186	 Κατηγορία 1	Πυραυλοκινητήρες	   ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"0190	 Κατηγορία 1	Δείγματα, εκρη";
mostCurrent._clv2._addtextitem /*String*/ ("0190	 Κατηγορία 1	Δείγματα, εκρηκτικά, πλην έναρξη εκρηκτικά",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"0191	 Κατηγορία 1	Συσκευές σημα";
mostCurrent._clv2._addtextitem /*String*/ ("0191	 Κατηγορία 1	Συσκευές σηματοδότησης, χέρι",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"0192 	 Κατηγορία 1	Σήματα, σιδη";
mostCurrent._clv2._addtextitem /*String*/ ("0192 	 Κατηγορία 1	Σήματα, σιδηροδρομικών γραμμών, εκρηκτικά",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"0194 	 Κατηγορία 1	Σήματα, αγων";
mostCurrent._clv2._addtextitem /*String*/ ("0194 	 Κατηγορία 1	Σήματα, αγωνία, πλοίο",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"0196 	 Κατηγορία 1	Σήματα, καπν";
mostCurrent._clv2._addtextitem /*String*/ ("0196 	 Κατηγορία 1	Σήματα, καπνός",(Object)(""));
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 169;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 170;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 173;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 174;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 175;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 176;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 177;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 178;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 179;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 180;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 181;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 182;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 183;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 184;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 185;BA.debugLine="lbl.TextSize = 16";
...
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 187;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 188;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 189;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 190;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 191;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 223;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 205;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 238;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 239;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 240;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 218;BA.debugLine="Sub katigor_Click";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 232;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 233;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
 //BA.debugLineNum = 234;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 214;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 215;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 229;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 230;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
 //BA.debugLineNum = 231;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 208;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 235;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 236;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 //BA.debugLineNum = 237;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 210;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 211;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 226;BA.debugLine="Sub simanseislabel_Click";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 242;BA.debugLine="Sub simansi_Click";
