...
public class ygropimeno extends Activity implements B4AActivity{
	public static ygropimeno mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.ygropimeno");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ygropimeno).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.ygropimeno");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.ygropimeno", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ygropimeno) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ygropimeno) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ygropimeno) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,ygropimeno.getObject(),"clv2");
 //BA.debugLineNum = 120;BA.debugLine="Panel2.AddView(clv2.AsView, 0.5%x, 0%y,93%x ,57.5";
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Το φυσικό αέριο (un-1971) αποτελ";
mostCurrent._clv2._addtextitem /*String*/ ("Το φυσικό αέριο (un-1971) αποτελείται από μεθάνιο (CH4) 85-90% και 10-15% αιθάνιο, προπάνιο, βουτάνιο, άζωτο, διοξείδιο του άνθρακα. Το υγρό φυσικό αέριο αν έρθει σε επαφή με το δέρμα, προκαλεί ψυχρά εγκαύματα.",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Είναι άχρωμο, άοσμο, μη τοξικό,";
mostCurrent._clv2._addtextitem /*String*/ ("Είναι άχρωμο, άοσμο, μη τοξικό, με μικρή διαλυτότητα στο νερό. Είναι ασφυξιογόνο σε χώρους που δεν αερίζονται. Για να ξεχωρίζει στην όσφρηση,προσθέτουν ουσία για τον έλεγχο διαρροής.",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2.1 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2.1 ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Εφλεκτα,πυροδυναμοτικα,δηλητηρι";
mostCurrent._clv2._addtextitem /*String*/ ("Εφλεκτα,πυροδυναμοτικα,δηλητηριώδη και τοξικα. ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"ΕΚΡΗΞΗ ΕΞΑΙΤΙΑΣ ΤΗΣ ΥΨΗΛΗΣ ΠΙΕΣ";
...
mostCurrent._clv2._addtextitem /*String*/ ("Η προσβολή γίνετε απο την πλευρά που φυσάει ο άνεμος.Πάντα με την πλάτη στον άνεμο.Καλυφθείτε απο κάποιο εμπόδιο,τοίχο,όχημα ανάχωμα κτλ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"ΚΛΕΙΣΤΕ ΤΗΝ ΤΕΛΕΥΤΑΙΑ ΒΑΝΑ ΠΡΙΝ";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 242;BA.debugLine="Sub ililabel_Click";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 236;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 237;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 233;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 234;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
...
public static String  _ousia_click() throws Exception{
 ...
 //BA.debugLineNum = 214;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 239;BA.debugLine="Sub ousialabel_Click";
...
int _result = 0;
 //BA.debugLineNum = 196;BA.debugLine="Sub pin1_Click";
 //BA.debugLineNum = 197;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 198;BA.debugLine="result = Msgbox2(\"Επιστροφή στο μενού\", \"  \", \"Ναί";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Επιστροφή στο μενού"),BA.ObjectToCharSequence("  "),"Ναί ","","Όχι ",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"1971.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 199;BA.debugLine="If result = DialogResponse.Positive Then";
...
int _result = 0;
 //BA.debugLineNum = 203;BA.debugLine="Sub pin2_Click";
 //BA.debugLineNum = 204;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 205;BA.debugLine="result = Msgbox2(\"Επιστροφή στο μενού\", \"  \", \"Ναί";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Επιστροφή στο μενού"),BA.ObjectToCharSequence("  "),"Ναί ","","Όχι ",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"1972.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 206;BA.debugLine="If result = DialogResponse.Positive Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 207;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 };
