...
public class dyoxil1000 extends Activity implements B4AActivity{
	public static dyoxil1000 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dyoxil1000");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dyoxil1000).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dyoxil1000");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dyoxil1000", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dyoxil1000) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dyoxil1000) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dyoxil1000) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dyoxil1000.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"2901	Κατηγορία 2	Χλωριούχο βρώμ";
mostCurrent._clv2._addtextitem /*String*/ ("2901	Κατηγορία 2	Χλωριούχο βρώμιο	   ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"2902	Κατηγορία 6.1	Φυτοφάρμακα";
mostCurrent._clv2._addtextitem /*String*/ ("2902	Κατηγορία 6.1	Φυτοφάρμακα , υγρά, τοξικά, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"2903	Κατηγορία 6.1	Φυτοφάρμακα,";
mostCurrent._clv2._addtextitem /*String*/ ("2903	Κατηγορία 6.1	Φυτοφάρμακα, υγρό, τοξικό, εύφλεκτο, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	     ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"2904	Κατηγορία 8	Chlorophenolat";
mostCurrent._clv2._addtextitem /*String*/ ("2904	Κατηγορία 8	Chlorophenolates , υγρό ή φαινολικά, υγρό	     ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"2905	Κατηγορία 8	Chlorophenolat";
mostCurrent._clv2._addtextitem /*String*/ ("2905	Κατηγορία 8	Chlorophenolates, στερεά ή φαινολικά, στερεά	     ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"2907	Κατηγορία 4.1	Δινιτρικό ισ";
mostCurrent._clv2._addtextitem /*String*/ ("2907	Κατηγορία 4.1	Δινιτρικό ισοσορβίδιο μίγμα με όχι λιγότερο από 60 τοις εκατό γαλακτόζη, μαννόζη, άμυλο ή όξινο φωσφορικό ασβέστιο	     ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"2908	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2908	Κατηγορία 7	Ραδιενεργό υλικό , εξαιρούμενο κόλο - κενή συσκευασία	     ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"2909	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2909	Κατηγορία 7	Ραδιενεργό υλικό, εξαιρούμενο-είδη συσκευασίας που κατασκευάζονται από φυσικό ή εξαντλημένο ουράνιο ή φυσικό θόριο	  ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"2910	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2910	Κατηγορία 7	Ραδιενεργό υλικό, εξαιρούμενο ποσότητα πακέτο περιορισμένη υλικού	     ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"2911	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2911	Κατηγορία 7	Ραδιενεργό υλικό, εξαιρούμενο κόλο, όργανα ή είδη	     ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"2912	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2912	Κατηγορία 7	Ραδιενεργό υλικό, χαμηλή σχετική δραστικότητα (LSA-I) μη σχάσιμο ή σχάσιμο εξαιρούμενο  ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"2913	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2913	Κατηγορία 7	Ραδιενεργό υλικό, επιφανειακά μολυσμένα αντικείμενα (SCO-I ή SCO-II) μη σχάσιμο ή σχάσιμο εξαιρούμενο  ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"2915	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2915	Κατηγορία 7	Ραδιενεργό υλικό, πληκτρολογήστε ένα πακέτο μη-ειδικό έντυπο, μη σχάσιμο ή σχάσιμο εξαιρούμενο  ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"2916	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2916	Κατηγορία 7	Ραδιενεργό υλικό, κόλου Τύπου B (U) μη σχάσιμο ή σχάσιμο εξαιρούμενο  ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"2917	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2917	Κατηγορία 7	Ραδιενεργό υλικό, κόλου Τύπου B (M) μη σχάσιμο ή σχάσιμο εξαιρούμενο  ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"2918	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2918	Κατηγορία 7	Ραδιενεργό υλικό, σχάσιμο, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"2919	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2919	Κατηγορία 7	Ραδιενεργό υλικό, μεταφέρονται υπό ειδική ρύθμιση, μη σχάσιμο ή σχάσιμο εξαιρούμενο  ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"2920	Κατηγορία 8	Διαβρωτικά υγρ";
mostCurrent._clv2._addtextitem /*String*/ ("2920	Κατηγορία 8	Διαβρωτικά υγρά, εύφλεκτα, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"2921	Κατηγορία 8	Διαβρωτικά στε";
mostCurrent._clv2._addtextitem /*String*/ ("2921	Κατηγορία 8	Διαβρωτικά στερεά, εύφλεκτα, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"2922	Κατηγορία 8	Διαβρωτικά υγρ";
mostCurrent._clv2._addtextitem /*String*/ ("2922	Κατηγορία 8	Διαβρωτικά υγρά, τοξικά, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"2923	Κατηγορία 8	Διαβρωτικών στ";
mostCurrent._clv2._addtextitem /*String*/ ("2923	Κατηγορία 8	Διαβρωτικών στερεών, τοξικά, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"2924	Κατηγορία 3	Εύφλεκτα υγρά,";
mostCurrent._clv2._addtextitem /*String*/ ("2924	Κατηγορία 3	Εύφλεκτα υγρά, διαβρωτικά, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"2925	Κατηγορία 4.1	Εύφλεκτα στε";
mostCurrent._clv2._addtextitem /*String*/ ("2925	Κατηγορία 4.1	Εύφλεκτα στερεά, διαβρωτικά, οργανικά, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"2926	Κατηγορία 4.1	Εύφλεκτα στε";
mostCurrent._clv2._addtextitem /*String*/ ("2926	Κατηγορία 4.1	Εύφλεκτα στερεά, τοξικά, οργανικά, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"2927	Κατηγορία 6.1	Τοξικό υγρό,";
mostCurrent._clv2._addtextitem /*String*/ ("2927	Κατηγορία 6.1	Τοξικό υγρό, διαβρωτικό, οργανικά, ε.α.ο. ή τοξικό υγρό, διαβρωτικό, οργανικά, ε.α.ο. Εισπνοή κινδύνου, ομάδα συσκευασίας I, Ζώνη Α ή Β  ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"2928	Κατηγορία 6.1	Τοξικά στερε";
mostCurrent._clv2._addtextitem /*String*/ ("2928	Κατηγορία 6.1	Τοξικά στερεά, διαβρωτικά, οργανικά, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"2929	Κατηγορία 6.1	Τοξικό υγρό,";
mostCurrent._clv2._addtextitem /*String*/ ("2929	Κατηγορία 6.1	Τοξικό υγρό, εύφλεκτο, οργανικά, ε.α.ο. ή τοξικό υγρό, εύφλεκτο, οργανικά, ε.α.ο. Εισπνοή κινδύνου, ομάδα συσκευασίας I, Ζώνη Α ή Β	     ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"2930	Κατηγορία 6.1	Τοξικά στερε";
mostCurrent._clv2._addtextitem /*String*/ ("2930	Κατηγορία 6.1	Τοξικά στερεά, εύφλεκτα, οργανικά, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"2931	Κατηγορία 6.1	Θειικό βαναδ";
mostCurrent._clv2._addtextitem /*String*/ ("2931	Κατηγορία 6.1	Θειικό βαναδυλική	     ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"2933	Κατηγορία 3	Xλωροπροπιονικ";
mostCurrent._clv2._addtextitem /*String*/ ("2933	Κατηγορία 3	Xλωροπροπιονικό	     ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"2934	Κατηγορία 3.3	Ισοπροπυλ-χλ";
mostCurrent._clv2._addtextitem /*String*/ ("2934	Κατηγορία 3.3	Ισοπροπυλ-χλωροπροπιονικό	     ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"2935	Κατηγορία 3.3	Αιθύλιο χλωρ";
mostCurrent._clv2._addtextitem /*String*/ ("2935	Κατηγορία 3.3	Αιθύλιο χλωροπροπιονικό	     ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"2936	Κατηγορία 6.1	Θειογαλακτικ";
mostCurrent._clv2._addtextitem /*String*/ ("2936	Κατηγορία 6.1	Θειογαλακτικό οξύ	     ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"2937	Κατηγορία 6.1	άλφα-μεθυλοβ";
mostCurrent._clv2._addtextitem /*String*/ ("2937	Κατηγορία 6.1	άλφα-μεθυλοβενζυλο αλκοόλη	     ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"2940	Κατηγορία 4.2	Roanilines";
mostCurrent._clv2._addtextitem /*String*/ ("2940	Κατηγορία 4.2	Roanilines	  ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"2942	Κατηγορία 6.1	Tριφθορομεθυ";
mostCurrent._clv2._addtextitem /*String*/ ("2942	Κατηγορία 6.1	Tριφθορομεθυλανιλίνη	  ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"2943	Κατηγορία 3.3	Τετραϋδροφου";
mostCurrent._clv2._addtextitem /*String*/ ("2943	Κατηγορία 3.3	Τετραϋδροφουρφουρυλαμίνης	     ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"2945	Κατηγορία 8	Ν-μεθυλοβουτυλ";
mostCurrent._clv2._addtextitem /*String*/ ("2945	Κατηγορία 8	Ν-μεθυλοβουτυλαμίνη	     ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"2946	Κατηγορία 6.1	Κατηγορία 2-";
mostCurrent._clv2._addtextitem /*String*/ ("2946	Κατηγορία 6.1	Κατηγορία 2-αμινο-Κατηγορία 5-diethylaminopentane  ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"2947	Κατηγορία 3.3	Ισοπροπυλική";
mostCurrent._clv2._addtextitem /*String*/ ("2947	Κατηγορία 3.3	Ισοπροπυλική χλωροξικόν	     ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"2948	Κατηγορία 6.1	Κατηγορία 3-";
mostCurrent._clv2._addtextitem /*String*/ ("2948	Κατηγορία 6.1	Κατηγορία 3-τριφθορομεθυλανιλίνη	     ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"2949	Κατηγορία 8	Θειούχο νάτριο";
mostCurrent._clv2._addtextitem /*String*/ ("2949	Κατηγορία 8	Θειούχο νάτριο , με όχι λιγότερο από 25 τοις εκατό νερό κρυστάλλωσης	    ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"2950	Κατηγορία 4.3	Μαγνήσιο κοκ";
mostCurrent._clv2._addtextitem /*String*/ ("2950	Κατηγορία 4.3	Μαγνήσιο κοκκία, επικαλυμμένα όχι μέγεθος σωματιδίων μικρότερο από 149 μικρόμετρα  ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"2956	Κατηγορία 4.1	Κατηγορία 5-";
mostCurrent._clv2._addtextitem /*String*/ ("2956	Κατηγορία 4.1	Κατηγορία 5-τριτ-βουτυλο-Κατηγορία 2,Κατηγορία 4,Κατηγορία 6-τρινιτρο-μ-ξυλόλιο ή μοσχοξυλόλιο	  ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"2965	Κατηγορία 4.3	Τριφθοριούχο";
mostCurrent._clv2._addtextitem /*String*/ ("2965	Κατηγορία 4.3	Τριφθοριούχο βόριο αιθερικό διμεθυλο	     ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"2966	Κατηγορία 6.1	Thiogylcol";
mostCurrent._clv2._addtextitem /*String*/ ("2966	Κατηγορία 6.1	Thiogylcol	     ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"2967	Κατηγορία 8	Σουλφαμικό οξύ";
mostCurrent._clv2._addtextitem /*String*/ ("2967	Κατηγορία 8	Σουλφαμικό οξύ	     ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"2968	Κατηγορία 4.3	Maneb σταθερ";
mostCurrent._clv2._addtextitem /*String*/ ("2968	Κατηγορία 4.3	Maneb σταθεροποιηθεί ή παρασκευάσματα Maneb, σταθεροποιημένο έναντι της αυτο-θέρμανσης  ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"2969	Κατηγορία 9	Castor φασόλια";
mostCurrent._clv2._addtextitem /*String*/ ("2969	Κατηγορία 9	Castor φασόλια ή Castor γεύμα ή Castor ελαιοπυρήνα ή Castor νιφάδα	      ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"2974	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2974	Κατηγορία 7	Ραδιενεργό υλικό, ειδική μορφή, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"2975	Κατηγορία 7	Θόριο μέταλλο,";
mostCurrent._clv2._addtextitem /*String*/ ("2975	Κατηγορία 7	Θόριο μέταλλο, πυροφορικά	     ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"2976	Κατηγορία 7	Νιτρικό θόριο";
mostCurrent._clv2._addtextitem /*String*/ ("2976	Κατηγορία 7	Νιτρικό θόριο , στερεό	     ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"2977	Κατηγορία 7	Εξαφθοριούχο ο";
mostCurrent._clv2._addtextitem /*String*/ ("2977	Κατηγορία 7	Εξαφθοριούχο ουράνιο ,  εξαφθοριούχο ουράνιο, σχάσιμο	  ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"2978	Κατηγορία 7	Εξαφθοριούχο ο";
mostCurrent._clv2._addtextitem /*String*/ ("2978	Κατηγορία 7	Εξαφθοριούχο ουράνιο,  εξαφθοριούχο ουράνιο μη σχάσιμο ή σχάσιμο εξαιρούμενο  ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"2979	Κατηγορία 7	Ουράνιο μέταλλ";
mostCurrent._clv2._addtextitem /*String*/ ("2979	Κατηγορία 7	Ουράνιο μέταλλο, πυροφορικά	     ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"2980	Κατηγορία 7	Νιτρικού ουραν";
mostCurrent._clv2._addtextitem /*String*/ ("2980	Κατηγορία 7	Νιτρικού ουρανυλίου λύση εξαϋδρίτου	     ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"2981	Κατηγορία 7	Νιτρικό ουρανύ";
mostCurrent._clv2._addtextitem /*String*/ ("2981	Κατηγορία 7	Νιτρικό ουρανύλιο, στερεό	     ",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"2982	Κατηγορία 7	Ραδιενεργό υλι";
mostCurrent._clv2._addtextitem /*String*/ ("2982	Κατηγορία 7	Ραδιενεργό υλικό, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"2983	Κατηγορία 3.1	Οξείδιο  αιθ";
mostCurrent._clv2._addtextitem /*String*/ ("2983	Κατηγορία 3.1	Οξείδιο  αιθυλενίου και οξειδίου  προπυλενίου μίγματα με όχι περισσότερο από 30 τοις εκατό αιθυλενοξειδίου	     ",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"2984	Κατηγορία 5.2	Υπεροξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("2984	Κατηγορία 5.2	Υπεροξείδιο  υδρογόνου   ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"2985	Κατηγορία 3.2	Χλωροσιλάνι";
mostCurrent._clv2._addtextitem /*String*/ ("2985	Κατηγορία 3.2	Χλωροσιλάνι , εύφλεκτα, διαβρωτικά, ε.α.ο.	  ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"2986	Κατηγορία 3	Χλωροσιλάνι, δ";
mostCurrent._clv2._addtextitem /*String*/ ("2986	Κατηγορία 3	Χλωροσιλάνι, διαβρωτικές, εύφλεκτες, ε.α.ο.	  ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"2987	Κατηγορία 8	Χλωροσιλάνι, δ";
mostCurrent._clv2._addtextitem /*String*/ ("2987	Κατηγορία 8	Χλωροσιλάνι, διαβρωτικά, ε.α.ο.	     ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"2988	Κατηγορία 4.3	Χλωροσιλανίω";
mostCurrent._clv2._addtextitem /*String*/ ("2988	Κατηγορία 4.3	Χλωροσιλανίων, αντιδρούν με  νερό, εύφλεκτα, διαβρωτικά, ε.α.ο.	  ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"2989	Κατηγορία 4.1	Μόλυβδος φωσ";
mostCurrent._clv2._addtextitem /*String*/ ("2989	Κατηγορία 4.1	Μόλυβδος φωσφίτης , διβασικό	     ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"2990	Κατηγορία 9	Σωστικά, φουσκ";
mostCurrent._clv2._addtextitem /*String*/ ("2990	Κατηγορία 9	Σωστικά, φουσκώνει	     ",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"2991	Κατηγορία 3	Καρβαμιδικό πα";
mostCurrent._clv2._addtextitem /*String*/ ("2991	Κατηγορία 3	Καρβαμιδικό παρασιτοκτόνο , υγρό, τοξικό, εύφλεκτο, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	     ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"2992	Κατηγορία 6.1	Καρβαμικού π";
mostCurrent._clv2._addtextitem /*String*/ ("2992	Κατηγορία 6.1	Καρβαμικού παρασιτοκτόνα, υγρά, τοξικά	     ",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"2993	Κατηγορία 3	Αρσενικού παρα";
mostCurrent._clv2._addtextitem /*String*/ ("2993	Κατηγορία 3	Αρσενικού παρασιτοκτόνα, υγρά, τοξικά, εύφλεκτα, σημείο ανάφλεξης όχι μικρότερο από 23 ° C  ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"2994	Κατηγορία 6.1	Αρσενικού πα";
mostCurrent._clv2._addtextitem /*String*/ ("2994	Κατηγορία 6.1	Αρσενικού παρασιτοκτόνα, υγρά, τοξικά	     ",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"2995	Κατηγορία 6.1	Οργανοχλωριω";
mostCurrent._clv2._addtextitem /*String*/ ("2995	Κατηγορία 6.1	Οργανοχλωριωμένα παρασιτοκτόνα, υγρά, τοξικά, εύφλεκτα, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	     ",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"2996	Κατηγορία 6.1	Οργανοχλωριω";
mostCurrent._clv2._addtextitem /*String*/ ("2996	Κατηγορία 6.1	Οργανοχλωριωμένα παρασιτοκτόνο, υγρό, τοξικό	     ",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="clv2.AddTextItem(\"2997	Κατηγορία 6.1	Τριαζίνης πα";
mostCurrent._clv2._addtextitem /*String*/ ("2997	Κατηγορία 6.1	Τριαζίνης παρασιτοκτόνα, υγρά, τοξικά, εύφλεκτα, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	     ",(Object)(""));
 //BA.debugLineNum = 201;BA.debugLine="clv2.AddTextItem(\"2998	Κατηγορία 6.1	Παρασιτοκτόν";
mostCurrent._clv2._addtextitem /*String*/ ("2998	Κατηγορία 6.1	Παρασιτοκτόνα τριαζίνης, υγρό, toxick  ",(Object)(""));
 //BA.debugLineNum = 203;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 282;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 206;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 209;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 210;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 211;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 212;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 213;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 214;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 215;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 216;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 217;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 218;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 219;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 220;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 221;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 222;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 223;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 224;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 225;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 226;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 227;BA.debugLine="Return p";
if (true) return _p;
