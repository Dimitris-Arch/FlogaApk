...
public class dyoxil800 extends Activity implements B4AActivity{
	public static dyoxil800 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dyoxil800");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dyoxil800).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dyoxil800");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dyoxil800", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dyoxil800) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dyoxil800) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dyoxil800) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dyoxil800.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"2705	Κατηγορία 8	Κατηγορία 1-πεν";
mostCurrent._clv2._addtextitem /*String*/ ("2705	Κατηγορία 8	Κατηγορία 1-πεντόλης	    ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"2707	Κατηγορία 3	Dimethyldioxane";
mostCurrent._clv2._addtextitem /*String*/ ("2707	Κατηγορία 3	Dimethyldioxanes	    ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"2709	Κατηγορία 3	Βουτύλιο βενζέν";
mostCurrent._clv2._addtextitem /*String*/ ("2709	Κατηγορία 3	Βουτύλιο βενζένια	    ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"2710	Κατηγορία 3	Διπροπυλο κετόν";
mostCurrent._clv2._addtextitem /*String*/ ("2710	Κατηγορία 3	Διπροπυλο κετόνη	    ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"2713	Κατηγορία 6.1	Ακριδίνη";
mostCurrent._clv2._addtextitem /*String*/ ("2713	Κατηγορία 6.1	Ακριδίνη	    ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"2714	Κατηγορία 4.1	Αβιετικός ψευ";
mostCurrent._clv2._addtextitem /*String*/ ("2714	Κατηγορία 4.1	Αβιετικός ψευδαργύρου	    ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"2715	Κατηγορία 4.1	Αβιετικός Αλο";
mostCurrent._clv2._addtextitem /*String*/ ("2715	Κατηγορία 4.1	Αβιετικός Αλουμινίου	    ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"2716	Κατηγορία 6.1	Butynediol";
mostCurrent._clv2._addtextitem /*String*/ ("2716	Κατηγορία 6.1	Butynediol	    ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"2717	Κατηγορία 4.1	Καμφορά , συν";
mostCurrent._clv2._addtextitem /*String*/ ("2717	Κατηγορία 4.1	Καμφορά , συνθετική	 ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"2719	Κατηγορία 5.1	Βάριο βρωμικό";
mostCurrent._clv2._addtextitem /*String*/ ("2719	Κατηγορία 5.1	Βάριο βρωμικό	    ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"2720	Κατηγορία 5.1	Νιτρικό χρώμι";
mostCurrent._clv2._addtextitem /*String*/ ("2720	Κατηγορία 5.1	Νιτρικό χρώμιο	    ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"2721	Κατηγορία 5.1	Χλωρικό χαλκο";
mostCurrent._clv2._addtextitem /*String*/ ("2721	Κατηγορία 5.1	Χλωρικό χαλκού	    ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"2722	Κατηγορία 5.1	Νιτρικό λίθιο";
mostCurrent._clv2._addtextitem /*String*/ ("2722	Κατηγορία 5.1	Νιτρικό λίθιο	 ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"2723	Κατηγορία 5.1	Χλωρικό μαγνή";
mostCurrent._clv2._addtextitem /*String*/ ("2723	Κατηγορία 5.1	Χλωρικό μαγνήσιο	    ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"2724	Κατηγορία 5.1	Μαγγάνιο νιτρ";
mostCurrent._clv2._addtextitem /*String*/ ("2724	Κατηγορία 5.1	Μαγγάνιο νιτρικό	    ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"2725	Κατηγορία 5.1	Νιτρικού νικε";
mostCurrent._clv2._addtextitem /*String*/ ("2725	Κατηγορία 5.1	Νιτρικού νικελίου	    ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"2726	Κατηγορία 5.1	Νιτρώδες νικε";
mostCurrent._clv2._addtextitem /*String*/ ("2726	Κατηγορία 5.1	Νιτρώδες νικελίου	    ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"2727	Κατηγορία 6.1	Νιτρικό θάλλι";
mostCurrent._clv2._addtextitem /*String*/ ("2727	Κατηγορία 6.1	Νιτρικό θάλλιο	    ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"2728	Κατηγορία 5.1	Νιτρικό ζιρκό";
mostCurrent._clv2._addtextitem /*String*/ ("2728	Κατηγορία 5.1	Νιτρικό ζιρκόνιο	    ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"2729	Κατηγορία 6.1	Εξαχλωροβενζό";
mostCurrent._clv2._addtextitem /*String*/ ("2729	Κατηγορία 6.1	Εξαχλωροβενζόλιο	    ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"2730	Κατηγορία 6.1	Νιτροανισόλης";
mostCurrent._clv2._addtextitem /*String*/ ("2730	Κατηγορία 6.1	Νιτροανισόλης	    ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"2732	Κατηγορία 6.1	Nitrobromoben";
mostCurrent._clv2._addtextitem /*String*/ ("2732	Κατηγορία 6.1	Nitrobromobenzenes υγρά ή στερεά Nitrobromobenzenes	   ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"2733	Κατηγορία 3	Αμίνες , εύφλεκ";
mostCurrent._clv2._addtextitem /*String*/ ("2733	Κατηγορία 3	Αμίνες , εύφλεκτα, διαβρωτικά, ε.α.ο. ή πολυαμίνες, εύφλεκτες, διαβρωτικές, ε.α.ο.	 ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"2734	Κατηγορία 8	Αμίνες, υγρά, δ";
mostCurrent._clv2._addtextitem /*String*/ ("2734	Κατηγορία 8	Αμίνες, υγρά, διαβρωτικά, εύφλεκτα, ε.α.ο. ή πολυαμίνες, υγρές, διαβρωτικές, εύφλεκτες, ε.α.ο.	 ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"2735	Κατηγορία 8	Αμίνες, υγρά, δ";
mostCurrent._clv2._addtextitem /*String*/ ("2735	Κατηγορία 8	Αμίνες, υγρά, διαβρωτικά, ε.α.ο. ή πολυαμίνες, υγρές, διαβρωτικές, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"2739	Κατηγορία 8.1	Βουτυρικού αν";
mostCurrent._clv2._addtextitem /*String*/ ("2739	Κατηγορία 8.1	Βουτυρικού ανυδρίτη	    ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"2740	Κατηγορία 6.1	χλωρομυρμηκικ";
mostCurrent._clv2._addtextitem /*String*/ ("2740	Κατηγορία 6.1	χλωρομυρμηκικού κ-προπυλεστέρα	    ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"2741	Κατηγορία 5.1	Βάριο υποχλωρ";
mostCurrent._clv2._addtextitem /*String*/ ("2741	Κατηγορία 5.1	Βάριο υποχλωριώδες με περισσότερα από 22 τοις εκατό διαθέσιμο χλώριο	 ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"2742	Κατηγορία 6.1	Χλωρομυρμηκικ";
mostCurrent._clv2._addtextitem /*String*/ ("2742	Κατηγορία 6.1	Χλωρομυρμηκικούς , τοξικά, διαβρωτικά, εύφλεκτα ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"2743	Κατηγορία 6.1	χλωροφορμικό";
mostCurrent._clv2._addtextitem /*String*/ ("2743	Κατηγορία 6.1	χλωροφορμικό η-Βουτυλ	    ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"2744	Κατηγορία 6.1	Χλωροφορμικό";
mostCurrent._clv2._addtextitem /*String*/ ("2744	Κατηγορία 6.1	Χλωροφορμικό Κυκλοβουτυλο	    ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"2745	Κατηγορία 6.1	Χλωροφορμικό";
mostCurrent._clv2._addtextitem /*String*/ ("2745	Κατηγορία 6.1	Χλωροφορμικό χλωρομεθύλιο	    ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"2746	Κατηγορία 6.1	Φαινυλ-χλωροφ";
mostCurrent._clv2._addtextitem /*String*/ ("2746	Κατηγορία 6.1	Φαινυλ-χλωροφορμικό	    ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"2747	Κατηγορία 6.1	τριτο-Butylcy";
mostCurrent._clv2._addtextitem /*String*/ ("2747	Κατηγορία 6.1	τριτο-Butylcyclohexylchloroformate	    ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"2748	Κατηγορία 6.1	Χλωρομυρμηκικ";
mostCurrent._clv2._addtextitem /*String*/ ("2748	Κατηγορία 6.1	Χλωρομυρμηκικού Κατηγορία 2-αιθυλεξυλεστέρα	   ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"2749	Κατηγορία 3	Τετραμεθυλσιλαν";
mostCurrent._clv2._addtextitem /*String*/ ("2749	Κατηγορία 3	Τετραμεθυλσιλανίου	    ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"2750	Κατηγορία 6.1	Κατηγορία 1,Κ";
mostCurrent._clv2._addtextitem /*String*/ ("2750	Κατηγορία 6.1	Κατηγορία 1,Κατηγορία 3-διχλωροπροπαν-Κατηγορία 2-όλη	      ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"2751	Κατηγορία 8	Διαιθυλθειοφωσφ";
mostCurrent._clv2._addtextitem /*String*/ ("2751	Κατηγορία 8	Διαιθυλθειοφωσφορυλ χλωριούχο	      ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"2752	Κατηγορία 3	Κατηγορία 1,Κατ";
mostCurrent._clv2._addtextitem /*String*/ ("2752	Κατηγορία 3	Κατηγορία 1,Κατηγορία 2-εποξυ-Κατηγορία 3-ethoxypropane	      ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"2753	Κατηγορία 6.1	Ν-Ethylbenzyl";
mostCurrent._clv2._addtextitem /*String*/ ("2753	Κατηγορία 6.1	Ν-Ethylbenzyltoluidines υγρό ή Ν-Ethylbenzyltoluidines στερεά	   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"2754	Κατηγορία 6.1	Ν-Ethyltoluid";
mostCurrent._clv2._addtextitem /*String*/ ("2754	Κατηγορία 6.1	Ν-Ethyltoluidines	      ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"2757	Κατηγορία 6.1	Καρβαμιδικό π";
mostCurrent._clv2._addtextitem /*String*/ ("2757	Κατηγορία 6.1	Καρβαμιδικό παρασιτοκτόνα , στερεά, τοξικά	      ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"2758	Κατηγορία 3	Καρβαμιδικό παρ";
mostCurrent._clv2._addtextitem /*String*/ ("2758	Κατηγορία 3	Καρβαμιδικό παρασιτοκτόνα, υγρά, εύφλεκτα, τοξικά, σημείο ανάφλεξης μικρότερο από 23 ° C	      ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"2759	Κατηγορία 6.1	Αρσενικού παρ";
mostCurrent._clv2._addtextitem /*String*/ ("2759	Κατηγορία 6.1	Αρσενικού παρασιτοκτόνα, στερεά, τοξικά	      ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"2760	Κατηγορία 3	Αρσενικού παρασ";
mostCurrent._clv2._addtextitem /*String*/ ("2760	Κατηγορία 3	Αρσενικού παρασιτοκτόνα, υγρά, εύφλεκτα, τοξικά, σημείο ανάφλεξης μικρότερο από 23 ° C	     ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"2761	Κατηγορία 6.1	Οργανοχλωριωμ";
mostCurrent._clv2._addtextitem /*String*/ ("2761	Κατηγορία 6.1	Οργανοχλωριωμένα παρασιτοκτόνα, στερεά, τοξικά	      ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"2762	Κατηγορία 3	Οργανοχλωριωμέν";
mostCurrent._clv2._addtextitem /*String*/ ("2762	Κατηγορία 3	Οργανοχλωριωμένα παρασιτοκτόνα υγρό, εύφλεκτο, τοξικό, σημείο ανάφλεξης μικρότερο από 23 ° C	   ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"2763	Κατηγορία 6.1	Τριαζίνης παρ";
mostCurrent._clv2._addtextitem /*String*/ ("2763	Κατηγορία 6.1	Τριαζίνης παρασιτοκτόνα, στερεά, τοξικά	      ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"2764	Κατηγορία 3	Παρασιτοκτόνα τ";
mostCurrent._clv2._addtextitem /*String*/ ("2764	Κατηγορία 3	Παρασιτοκτόνα τριαζίνης, υγρά, εύφλεκτα, τοξικά, σημείο ανάφλεξης μικρότερο από 23 ° C	      ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"2771	Κατηγορία 6.1	Θειοκαρβαμικο";
mostCurrent._clv2._addtextitem /*String*/ ("2771	Κατηγορία 6.1	Θειοκαρβαμικού παρασιτοκτόνα, στερεά, τοξικά	      ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"2772	Κατηγορία 3	Θειοκαρβαμιδικό";
mostCurrent._clv2._addtextitem /*String*/ ("2772	Κατηγορία 3	Θειοκαρβαμιδικό παρασιτοκτόνο, υγρό, εύφλεκτο, τοξικό, σημείο ανάφλεξης μικρότερο από 23 ° C	   ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"2775	Κατηγορία 6.1	Χαλκός φυτοφά";
mostCurrent._clv2._addtextitem /*String*/ ("2775	Κατηγορία 6.1	Χαλκός φυτοφάρμακα βάση, στερεά, τοξικά	         ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"2776	Κατηγορία 3	Χαλκός φυτοφάρμ";
mostCurrent._clv2._addtextitem /*String*/ ("2776	Κατηγορία 3	Χαλκός φυτοφάρμακα βάση, υγρό, εύφλεκτο, τοξικό, σημείο ανάφλεξης μικρότερο από 23 ° C	      ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"2777	Κατηγορία 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("2777	Κατηγορία 6.1	Ο υδράργυρος φυτοφάρμακα που βασίζονται, στερεά, τοξικά	         ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"2778	Κατηγορία 3	Ο υδράργυρος φυ";
mostCurrent._clv2._addtextitem /*String*/ ("2778	Κατηγορία 3	Ο υδράργυρος φυτοφάρμακα που βασίζονται, υγρό, εύφλεκτο, τοξικό, σημείο ανάφλεξης μικρότερο από 23 ° C	   ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"2779	Κατηγορία 6.1	Υποκαταστημέν";
mostCurrent._clv2._addtextitem /*String*/ ("2779	Κατηγορία 6.1	Υποκαταστημένα νιτροφαινόλη φυτοφάρμακα, στερεά, τοξικά	      ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"2780	Κατηγορία 3	Υποκατεστημένοι";
mostCurrent._clv2._addtextitem /*String*/ ("2780	Κατηγορία 3	Υποκατεστημένοι φυτοφάρμακα νιτροφαινόλης, υγρά, εύφλεκτα, τοξικά, σημείο ανάφλεξης μικρότερο από 23 ° C	   ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"2781	Κατηγορία 6.1	Bipyridilium";
mostCurrent._clv2._addtextitem /*String*/ ("2781	Κατηγορία 6.1	Bipyridilium παρασιτοκτόνα, στερεά, τοξικά	      ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"2782	Κατηγορία 3	Bipyridilium πα";
mostCurrent._clv2._addtextitem /*String*/ ("2782	Κατηγορία 3	Bipyridilium παρασιτοκτόνα, υγρά, εύφλεκτα, τοξικά, σημείο ανάφλεξης μικρότερο από 23 ° C	      ",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"2783	Κατηγορία 6.1	Οργανοφωσφορι";
mostCurrent._clv2._addtextitem /*String*/ ("2783	Κατηγορία 6.1	Οργανοφωσφορικές φυτοφάρμακα, στερεά, τοξικά	      ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"2784	Κατηγορία 3	Οργανοφωσφορικέ";
mostCurrent._clv2._addtextitem /*String*/ ("2784	Κατηγορία 3	Οργανοφωσφορικές φυτοφάρμακα, υγρά, εύφλεκτα, τοξικά, σημείο ανάφλεξης μικρότερο από 23 ° C	   ",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"2785	Κατηγορία 6.1	Thiapentanal";
mostCurrent._clv2._addtextitem /*String*/ ("2785	Κατηγορία 6.1	Thiapentanal	      ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"2786	Κατηγορία 6.1	Οργανοκασσιτε";
mostCurrent._clv2._addtextitem /*String*/ ("2786	Κατηγορία 6.1	Οργανοκασσιτερικές φυτοφάρμακα, στερεά, τοξικά	      ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"2787	Κατηγορία 6.1	Οργανοκασσιτε";
mostCurrent._clv2._addtextitem /*String*/ ("2787	Κατηγορία 6.1	Οργανοκασσιτερικές φυτοφάρμακα, υγρά, εύφλεκτα, τοξικά, σημείο ανάφλεξης μικρότερο από 23 ° C	   ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"2788	Κατηγορία 6.1	Οργανοκασσιτε";
mostCurrent._clv2._addtextitem /*String*/ ("2788	Κατηγορία 6.1	Οργανοκασσιτερικές ενώσεις, υγρές, ε.α.ο.	      ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"2789	Κατηγορία 8	Οξικό οξύ , παγ";
mostCurrent._clv2._addtextitem /*String*/ ("2789	Κατηγορία 8	Οξικό οξύ , παγόμορφο διάλυμα ή οξικό οξύ, με περισσότερο από 80 τοις εκατό οξύ, κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"2790	Κατηγορία 8	Διάλυμα οξικού";
mostCurrent._clv2._addtextitem /*String*/ ("2790	Κατηγορία 8	Διάλυμα οξικού οξέος, όχι λιγότερο από 50 τοις εκατό αλλά όχι περισσότερο από 80 τοις εκατό οξύ,   ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"2793	Κατηγορία 4.2	Σιδηρούχων με";
mostCurrent._clv2._addtextitem /*String*/ ("2793	Κατηγορία 4.2	Σιδηρούχων μετάλλων    ",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"2794	Κατηγορία 8	Μπαταρίες , υγρ";
mostCurrent._clv2._addtextitem /*String*/ ("2794	Κατηγορία 8	Μπαταρίες , υγρό, γεμάτο με οξύ, ηλεκτρικής συσσώρευσης	      ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"2795	Κατηγορία 8	Μπαταρίες, υγρό";
mostCurrent._clv2._addtextitem /*String*/ ("2795	Κατηγορία 8	Μπαταρίες, υγρό, γεμάτο με αλκάλια, ηλεκτρική αποθήκευση	      ",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"2796	Κατηγορία 8	Υγρό μπαταρίας,";
mostCurrent._clv2._addtextitem /*String*/ ("2796	Κατηγορία 8	Υγρό μπαταρίας, οξύ ή θειικό οξύ με όχι περισσότερο από 51 τοις εκατό οξύ	   ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"2797	Κατηγορία 8	Το υγρό της μπα";
mostCurrent._clv2._addtextitem /*String*/ ("2797	Κατηγορία 8	Το υγρό της μπαταρίας, αλκαλικά	      ",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"2798	Κατηγορία 8	Phenylphosphoru";
mostCurrent._clv2._addtextitem /*String*/ ("2798	Κατηγορία 8	Phenylphosphorus Διχλωριδίου	      ",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"2799	Κατηγορία 8	Phenylphosphoru";
mostCurrent._clv2._addtextitem /*String*/ ("2799	Κατηγορία 8	Phenylphosphorus Thiodichloride	      ",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="clv2.AddTextItem(\"2800	Κατηγορία 8	Μπαταρίες, υγρ";
mostCurrent._clv2._addtextitem /*String*/ ("2800	Κατηγορία 8	Μπαταρίες, υγρή, μη διαρροή, ηλεκτρικής συσσώρευσης   ",(Object)(""));
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 205;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 208;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 209;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 210;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 211;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 212;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 213;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 214;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 215;BA.debugLine="chk.Initialize(\"\")";
...
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 218;BA.debugLine="lbl.Gravity = Bit.OR(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 219;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 220;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 221;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 222;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 223;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 224;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 225;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 226;BA.debugLine="Return p";
if (true) return _p;
