...
public class dyoxil500 extends Activity implements B4AActivity{
	public static dyoxil500 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dyoxil500");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dyoxil500).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dyoxil500");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dyoxil500", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dyoxil500) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dyoxil500) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dyoxil500) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dyoxil500.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"2401	Κατηγορία 8	Πιπεριδίνη";
mostCurrent._clv2._addtextitem /*String*/ ("2401	Κατηγορία 8	Πιπεριδίνη	    ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"2402	Κατηγορία 3	Propanethiols";
mostCurrent._clv2._addtextitem /*String*/ ("2402	Κατηγορία 3	Propanethiols	    ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"2403	Κατηγορία 3	Οξικό ισοπροπεν";
mostCurrent._clv2._addtextitem /*String*/ ("2403	Κατηγορία 3	Οξικό ισοπροπενυλεστέρα	    ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"2404	Κατηγορία 3	Προπιονιτρίλιον";
mostCurrent._clv2._addtextitem /*String*/ ("2404	Κατηγορία 3	Προπιονιτρίλιον	    ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"2405	Κατηγορία 3	Ισοπροπυλική βο";
mostCurrent._clv2._addtextitem /*String*/ ("2405	Κατηγορία 3	Ισοπροπυλική βουτυρικό	    ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"2406	Κατηγορία 3	Ισοπροπυλική ισ";
mostCurrent._clv2._addtextitem /*String*/ ("2406	Κατηγορία 3	Ισοπροπυλική ισοβουτυρικής	    ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"2407	Κατηγορία 6.1	Χλωρομυρμηκικ";
mostCurrent._clv2._addtextitem /*String*/ ("2407	Κατηγορία 6.1	Χλωρομυρμηκικού ισοπροπυλεστέρα	    ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"2409	Κατηγορία 3	Ισοπροπυλική πρ";
mostCurrent._clv2._addtextitem /*String*/ ("2409	Κατηγορία 3	Ισοπροπυλική προπιονικό	    ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"2410	Κατηγορία 3	Κατηγορία 1,Κατ";
mostCurrent._clv2._addtextitem /*String*/ ("2410	Κατηγορία 3	Κατηγορία 1,Κατηγορία 2,Κατηγορία 3,Κατηγορία 6-τετραϋδροπυριδίνη	    ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"2411	Κατηγορία 3	Βουτυρονιτρίλιο";
mostCurrent._clv2._addtextitem /*String*/ ("2411	Κατηγορία 3	Βουτυρονιτρίλιου	    ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"2412	Κατηγορία 3	Τετραϋδροθειοφα";
mostCurrent._clv2._addtextitem /*String*/ ("2412	Κατηγορία 3	Τετραϋδροθειοφαίνη	    ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"2413	Κατηγορία 3	Tetrapropylorth";
mostCurrent._clv2._addtextitem /*String*/ ("2413	Κατηγορία 3	Tetrapropylorthotitanate	   SΘειοφαίνιο	    ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"2416	Κατηγορία 3	Βορικού τριμεθυ";
mostCurrent._clv2._addtextitem /*String*/ ("2416	Κατηγορία 3	Βορικού τριμεθυλίου	    ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"2417	Κατηγορία 2	Carbonyl fluori";
mostCurrent._clv2._addtextitem /*String*/ ("2417	Κατηγορία 2	Carbonyl fluoride , συμπιεσμένο	    ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"2418	Κατηγορία 2	Θείο τετραφθορι";
mostCurrent._clv2._addtextitem /*String*/ ("2418	Κατηγορία 2	Θείο τετραφθοριούχος	    ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"2419	Κατηγορία 2	Bromotrifluoroe";
mostCurrent._clv2._addtextitem /*String*/ ("2419	Κατηγορία 2	Bromotrifluoroethylene	    ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"2420	Κατηγορία 2	Εξαφθοροακετόνη";
mostCurrent._clv2._addtextitem /*String*/ ("2420	Κατηγορία 2	Εξαφθοροακετόνης	    ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"2421	Κατηγορία 2	Άζωτο τριοξείδι";
mostCurrent._clv2._addtextitem /*String*/ ("2421	Κατηγορία 2	Άζωτο τριοξείδιο	    ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"2422	Κατηγορία 2	Octafluorobut-Κ";
mostCurrent._clv2._addtextitem /*String*/ ("2422	Κατηγορία 2	Octafluorobut-Κατηγορία 2-ένιο ή ψυκτικό αέριο R 1318	    ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"2424	Κατηγορία 2	Οκταφθοροπροπαν";
mostCurrent._clv2._addtextitem /*String*/ ("2424	Κατηγορία 2	Οκταφθοροπροπανίου ή ψυκτικό αέριο R 218	    ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"2426	Κατηγορία 5.1	Νιτρικό αμμών";
mostCurrent._clv2._addtextitem /*String*/ ("2426	Κατηγορία 5.1	Νιτρικό αμμώνιο , υγρό (θερμό συμπυκνωμένο διάλυμα)	    ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"2427	Κατηγορία 5.1	Χλωρικό κάλιο";
mostCurrent._clv2._addtextitem /*String*/ ("2427	Κατηγορία 5.1	Χλωρικό κάλιο , υδατικό διάλυμα	    ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"2428	Κατηγορία 5.1	Χλωρικό νάτρι";
mostCurrent._clv2._addtextitem /*String*/ ("2428	Κατηγορία 5.1	Χλωρικό νάτριο , υδατικό διάλυμα	    ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"2429	Κατηγορία 5.1	Ασβέστιο χλωρ";
mostCurrent._clv2._addtextitem /*String*/ ("2429	Κατηγορία 5.1	Ασβέστιο χλωρικό υδατικό διάλυμα	    ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"2430	Κατηγορία 8	Αλκυλοφαινόλες";
mostCurrent._clv2._addtextitem /*String*/ ("2430	Κατηγορία 8	Αλκυλοφαινόλες , στερεές, ε.α.ο. (συμπεριλαμβανομένων C2-C12 ομολόγων)	    ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"2431	Κατηγορία 6.1	Ανισιδίνες";
mostCurrent._clv2._addtextitem /*String*/ ("2431	Κατηγορία 6.1	Ανισιδίνες	    ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"2432	Κατηγορία 6.1	Ν, Ν-διαιθυλα";
mostCurrent._clv2._addtextitem /*String*/ ("2432	Κατηγορία 6.1	Ν, Ν-διαιθυλανιλίνη	    ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"2433	Κατηγορία 6.1	Chloronitroto";
mostCurrent._clv2._addtextitem /*String*/ ("2433	Κατηγορία 6.1	Chloronitrotoluenes υγρά ή στερεά Chloronitrotoluenes	    ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"2434	Κατηγορία 8	Dibenzyldichlor";
mostCurrent._clv2._addtextitem /*String*/ ("2434	Κατηγορία 8	Dibenzyldichlorosilane	    ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"2435	Κατηγορία 8	Ethylphenyldich";
mostCurrent._clv2._addtextitem /*String*/ ("2435	Κατηγορία 8	Ethylphenyldichlorosilane	    ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"2436	Κατηγορία 3	Θειοξικό οξύ";
mostCurrent._clv2._addtextitem /*String*/ ("2436	Κατηγορία 3	Θειοξικό οξύ	    ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"2437	Κατηγορία 8	Methylphenyldic";
mostCurrent._clv2._addtextitem /*String*/ ("2437	Κατηγορία 8	Methylphenyldichlorosilane	    ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"2438	Κατηγορία 6.1	Τριμεθυλακετυ";
mostCurrent._clv2._addtextitem /*String*/ ("2438	Κατηγορία 6.1	Τριμεθυλακετυλοχλωρίδιο	    ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"2439	Κατηγορία 8	Hydrogendifluor";
mostCurrent._clv2._addtextitem /*String*/ ("2439	Κατηγορία 8	Hydrogendifluoride νατρίου , στερεό ή νάτριο hydrogendifluoride ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"2440	Κατηγορία 8	Χλωριούχου κασσ";
mostCurrent._clv2._addtextitem /*String*/ ("2440	Κατηγορία 8	Χλωριούχου κασσιτέρου , πενταϋδρίτη	    ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"2441	Κατηγορία 4.2	Τριχλωριούχο";
mostCurrent._clv2._addtextitem /*String*/ ("2441	Κατηγορία 4.2	Τριχλωριούχο τιτάνιο , πυροφορικό ή μείγματα τριχλωριούχου τιτανίου, πυροφορικά ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"2442	Κατηγορία 8	Τριχλωρακετυλοχ";
mostCurrent._clv2._addtextitem /*String*/ ("2442	Κατηγορία 8	Τριχλωρακετυλοχλωρίδιο	    ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"2443	Κατηγορία 8	Οξυτριχλωριούχο";
mostCurrent._clv2._addtextitem /*String*/ ("2443	Κατηγορία 8	Οξυτριχλωριούχο βανάδιο	    ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"2444	Κατηγορία 8	Βαναδίου τετραχ";
mostCurrent._clv2._addtextitem /*String*/ ("2444	Κατηγορία 8	Βαναδίου τετραχλωριούχου	    ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"2445	Κατηγορία 4.2	Αλκύλια λιθίο";
mostCurrent._clv2._addtextitem /*String*/ ("2445	Κατηγορία 4.2	Αλκύλια λιθίου	    ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"2446	Κατηγορία 6.1	Νιτροκρεσόλες";
mostCurrent._clv2._addtextitem /*String*/ ("2446	Κατηγορία 6.1	Νιτροκρεσόλες	    ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"2447	Κατηγορία 4.2	Λευκού φωσφόρ";
mostCurrent._clv2._addtextitem /*String*/ ("2447	Κατηγορία 4.2	Λευκού φωσφόρου , λιωμένο	    ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"2448	Κατηγορία 4.1	Θείο , λιωμέν";
mostCurrent._clv2._addtextitem /*String*/ ("2448	Κατηγορία 4.1	Θείο , λιωμένο	    ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"2451	Κατηγορία 2	Τριφθοριούχο άζ";
mostCurrent._clv2._addtextitem /*String*/ ("2451	Κατηγορία 2	Τριφθοριούχο άζωτο , συμπιεσμένο	    ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"2452	Κατηγορία 2	Αιθυλακετυλενίο";
mostCurrent._clv2._addtextitem /*String*/ ("2452	Κατηγορία 2	Αιθυλακετυλενίου , αναστέλλεται	    ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"2453	Κατηγορία 2	Αιθυλική φθορίο";
mostCurrent._clv2._addtextitem /*String*/ ("2453	Κατηγορία 2	Αιθυλική φθορίου ή ψυκτικό αέριο R 161	    ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"2454	Κατηγορία 2	Φθοριούχο μεθύλ";
mostCurrent._clv2._addtextitem /*String*/ ("2454	Κατηγορία 2	Φθοριούχο μεθύλιο , ή ψυκτικό αέριο R 41	    ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"2456	Κατηγορία 3	Κατηγορία 2-χλω";
mostCurrent._clv2._addtextitem /*String*/ ("2456	Κατηγορία 3	Κατηγορία 2-χλωροπροπένιο	    ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"2457	Κατηγορία 3	Κατηγορία 2,Κατ";
mostCurrent._clv2._addtextitem /*String*/ ("2457	Κατηγορία 3	Κατηγορία 2,Κατηγορία 3 διμεθυλοβουτάνιου	    ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"2458	Κατηγορία 3	Εξαδιένια	    \"";
mostCurrent._clv2._addtextitem /*String*/ ("2458	Κατηγορία 3	Εξαδιένια	    ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"2459	Κατηγορία 3	Κατηγορία 2-μεθ";
mostCurrent._clv2._addtextitem /*String*/ ("2459	Κατηγορία 3	Κατηγορία 2-μεθυλ-Κατηγορία 1-βουτένιο	    ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"2460	Κατηγορία 3	Κατηγορία 2-μεθ";
mostCurrent._clv2._addtextitem /*String*/ ("2460	Κατηγορία 3	Κατηγορία 2-μεθυλ-Κατηγορία 2-βουτένιο	    ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"2461	Κατηγορία 3	Methylpentadien";
mostCurrent._clv2._addtextitem /*String*/ ("2461	Κατηγορία 3	Methylpentadienes	    ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"2463	Κατηγορία 4.3	Υδρίδιο αργιλ";
mostCurrent._clv2._addtextitem /*String*/ ("2463	Κατηγορία 4.3	Υδρίδιο αργιλίου	    ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"2464	Κατηγορία 5.1	Νιτρικό βηρύλ";
mostCurrent._clv2._addtextitem /*String*/ ("2464	Κατηγορία 5.1	Νιτρικό βηρύλλιο	    ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"2465	Κατηγορία 5.1	Διχλωροϊσοκυα";
mostCurrent._clv2._addtextitem /*String*/ ("2465	Κατηγορία 5.1	Διχλωροϊσοκυανουρικού οξέος , άλατα ξηρό ή διχλωροϊσοκυανουρικού οξέος	    ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"2466	Κατηγορία 5.1	Υπεροξειδίου";
mostCurrent._clv2._addtextitem /*String*/ ("2466	Κατηγορία 5.1	Υπεροξειδίου καλίου	    ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"2468	Κατηγορία 5.1	Τριχλωροϊσοκυ";
mostCurrent._clv2._addtextitem /*String*/ ("2468	Κατηγορία 5.1	Τριχλωροϊσοκυανουρικό οξύ , ξηρό	    ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"2469	Κατηγορία 5.1	Βρωμικό ψευδα";
mostCurrent._clv2._addtextitem /*String*/ ("2469	Κατηγορία 5.1	Βρωμικό ψευδαργύρου	    ",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"2470	Κατηγορία 6.1	Φαινυλακετονι";
mostCurrent._clv2._addtextitem /*String*/ ("2470	Κατηγορία 6.1	Φαινυλακετονιτρίλιο , υγρό	    ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"2471	Κατηγορία 6.1	Τετροξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("2471	Κατηγορία 6.1	Τετροξείδιο  οσμίου	    ",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"2473	Κατηγορία 6.1	Arsanilate νά";
mostCurrent._clv2._addtextitem /*String*/ ("2473	Κατηγορία 6.1	Arsanilate νάτριο	    ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"2474	Κατηγορία 6.1	Θειοφωσγένιον";
mostCurrent._clv2._addtextitem /*String*/ ("2474	Κατηγορία 6.1	Θειοφωσγένιον	    ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"2475	Κατηγορία 8	Τριχλωριούχου β";
mostCurrent._clv2._addtextitem /*String*/ ("2475	Κατηγορία 8	Τριχλωριούχου βαναδίου	    ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"2477	Κατηγορία 6.1	Ισοθειοκυανικ";
mostCurrent._clv2._addtextitem /*String*/ ("2477	Κατηγορία 6.1	Ισοθειοκυανικού μεθυλεστέρα	    ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"2478	Κατηγορία 3	Ισοκυανικά , εύ";
mostCurrent._clv2._addtextitem /*String*/ ("2478	Κατηγορία 3	Ισοκυανικά , εύφλεκτα, τοξικά    ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"2480	Κατηγορία 6.1	Ισοκυανικό με";
mostCurrent._clv2._addtextitem /*String*/ ("2480	Κατηγορία 6.1	Ισοκυανικό μεθύλιο	    ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"2481	Κατηγορία 3	Ισοκυανικός αιθ";
mostCurrent._clv2._addtextitem /*String*/ ("2481	Κατηγορία 3	Ισοκυανικός αιθυλεστέρας	    ",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"2482	Κατηγορία 6.1	ισοκυανικό κ-";
mostCurrent._clv2._addtextitem /*String*/ ("2482	Κατηγορία 6.1	ισοκυανικό κ-Προπυλ	    ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"2483	Κατηγορία 3	Ισοκυανικού ισο";
mostCurrent._clv2._addtextitem /*String*/ ("2483	Κατηγορία 3	Ισοκυανικού ισοπροπυλεστέρα	    ",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"2484	Κατηγορία 6.1	ισοκυανικό τρ";
mostCurrent._clv2._addtextitem /*String*/ ("2484	Κατηγορία 6.1	ισοκυανικό τριτ-Βουτυλ	    ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"2485	Κατηγορία 6.1	ισοκυανικού η";
mostCurrent._clv2._addtextitem /*String*/ ("2485	Κατηγορία 6.1	ισοκυανικού η-Βουτυλ	    ",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"2486	Κατηγορία 3	Ισοκυανικό Ισοβ";
mostCurrent._clv2._addtextitem /*String*/ ("2486	Κατηγορία 3	Ισοκυανικό Ισοβουτυλ	    ",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"2487	Κατηγορία 6.1	Ισοκυανικό φα";
mostCurrent._clv2._addtextitem /*String*/ ("2487	Κατηγορία 6.1	Ισοκυανικό φαινυλεστέρα	    ",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="clv2.AddTextItem(\"2488	Κατηγορία 6.1	Ισοκυανικό κυ";
mostCurrent._clv2._addtextitem /*String*/ ("2488	Κατηγορία 6.1	Ισοκυανικό κυκλοεξυλεστέρα	    ",(Object)(""));
 //BA.debugLineNum = 201;BA.debugLine="clv2.AddTextItem(\"2490	Κατηγορία 6.1	Dichlorodisop";
mostCurrent._clv2._addtextitem /*String*/ ("2490	Κατηγορία 6.1	Dichlorodisopropyl αιθέρα	    ",(Object)(""));
 //BA.debugLineNum = 202;BA.debugLine="clv2.AddTextItem(\"2491	Κατηγορία 8	Αιθανολαμίνη ή";
mostCurrent._clv2._addtextitem /*String*/ ("2491	Κατηγορία 8	Αιθανολαμίνη ή αιθανολαμίνη  ",(Object)(""));
 //BA.debugLineNum = 203;BA.debugLine="clv2.AddTextItem(\"2493	Κατηγορία 3	Εξαμεθυλενιμίνη";
mostCurrent._clv2._addtextitem /*String*/ ("2493	Κατηγορία 3	Εξαμεθυλενιμίνης	     ",(Object)(""));
 //BA.debugLineNum = 204;BA.debugLine="clv2.AddTextItem(\"2495	Κατηγορία 5.1	Ιώδιο πενταφθ";
mostCurrent._clv2._addtextitem /*String*/ ("2495	Κατηγορία 5.1	Ιώδιο πενταφθοριούχο	 ",(Object)(""));
 //BA.debugLineNum = 205;BA.debugLine="clv2.AddTextItem(\"2496	Κατηγορία 8	Προπιονικού ανυ";
mostCurrent._clv2._addtextitem /*String*/ ("2496	Κατηγορία 8	Προπιονικού ανυδρίτη	 ",(Object)(""));
 //BA.debugLineNum = 206;BA.debugLine="clv2.AddTextItem(\"2498	Κατηγορία 3	Κατηγορία 1,Κατ";
mostCurrent._clv2._addtextitem /*String*/ ("2498	Κατηγορία 3	Κατηγορία 1,Κατηγορία 2,Κατηγορία 3,Κατηγορία 6-Tetrahydrobenzaldehyde	 ",(Object)(""));
 //BA.debugLineNum = 208;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 286;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
