...
public class tria extends Activity implements B4AActivity{
	public static tria mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.tria");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tria).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.tria");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.tria", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tria) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tria) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (tria) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 51;BA.debugLine="Activity.LoadLayout(\"tria.bal\")";
mostCurrent._activity.LoadLayout("tria.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,tria.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 3 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 3 ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Κίνδυνος ανάφλεξης από σπινθήρα";
mostCurrent._clv2._addtextitem /*String*/ ("Κίνδυνος ανάφλεξης από σπινθήρα ή στατικό ηλεκτρισμό.",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Ασφυξία σε χώρους που δεν αερίζο";
mostCurrent._clv2._addtextitem /*String*/ ("Ασφυξία σε χώρους που δεν αερίζονται.Οι περισσότερες ουσίες είναι βαρύτερες από τον αέρα.",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Ακόμα και τα άδεια δοχεία-βυτία";
mostCurrent._clv2._addtextitem /*String*/ ("Ακόμα και τα άδεια δοχεία-βυτία είναι επικίνδυνα.",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑ";
