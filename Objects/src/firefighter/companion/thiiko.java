...
public class thiiko extends Activity implements B4AActivity{
	public static thiiko mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.thiiko");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (thiiko).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.thiiko");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.thiiko", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (thiiko) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (thiiko) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (thiiko) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._simansi.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (45),mostCurrent.activityBA));
 //BA.debugLineNum = 56;BA.debugLine="pin1.BringToFront";
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,thiiko.getObject(),"clv2");
 //BA.debugLineNum = 119;BA.debugLine="Panel2.AddView(clv2.AsView, 0.5%x, 0%y,93%x ,57.5";
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Το θειικό οξύ-βιτριόλι UN-1830 ε";
mostCurrent._clv2._addtextitem /*String*/ ("Το θειικό οξύ-βιτριόλι UN-1830 είναι παχύρευστο υγρό, άοσμο, άχρωμο και είναι διαβρωτικό και τοξικό",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Το νερό δεν πρέπει να χρησιμοποι";
mostCurrent._clv2._addtextitem /*String*/ ("Το νερό δεν πρέπει να χρησιμοποιηθεί χωρίς έγκριση ειδικού.",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Σε επαφή του με το νερό παράγετα";
mostCurrent._clv2._addtextitem /*String*/ ("Σε επαφή του με το νερό παράγεται θερμότητα και εκτοξεύονται σταγόνες θερμού θεεικού οξέος,γιαυτο ποτέ δεν χρησιμοποιούμε νερό.",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Δεν είναι εύφλεκτο όμως σε επαφή";
mostCurrent._clv2._addtextitem /*String*/ ("Δεν είναι εύφλεκτο όμως σε επαφή με διάφορα υλικά, απελευθερώνεται εύλεκτο υδρογόνο.",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Έαν έρθει σε επαφη με το σώμα πλ";
mostCurrent._clv2._addtextitem /*String*/ ("Έαν έρθει σε επαφη με το σώμα πλυνετε με άφθονο νερο.",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Η αντιμετώπηση συμβάντων με θειι";
...
mostCurrent._clv2._addtextitem /*String*/ ("ΔΙΑΒΡΩΤΙΚΕΣ ΟΥΣΙΕΣ ΚΑΙ ΤΟΞΙΚΕΣ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"Προκαλούν μεγάλη βλάβη στην υγ";
mostCurrent._clv2._addtextitem /*String*/ ("Προκαλούν μεγάλη βλάβη στην υγεία. ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"Υπάρχει κίνδυνος αλυσιδωτής αντί";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 217;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 219;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 201;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 202;BA.debugLine="End Sub";
return "";
}
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 232;BA.debugLine="Sub ililabel_Click";
...
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 214;BA.debugLine="Sub katigor_Click";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 226;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 227;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
 //BA.debugLineNum = 228;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 210;BA.debugLine="Sub lista_Click";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 224;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
 //BA.debugLineNum = 225;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 204;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 229;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 230;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
...
int _result = 0;
 //BA.debugLineNum = 186;BA.debugLine="Sub pin1_Click";
...
int _result = 0;
 //BA.debugLineNum = 193;BA.debugLine="Sub pin2_Click";
 //BA.debugLineNum = 194;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 195;BA.debugLine="result = Msgbox2(\"Επιστροφή στο μενού\", \"  \", \"Ναί";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Επιστροφή στο μενού"),BA.ObjectToCharSequence("  "),"Ναί ","","Όχι ",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"1831.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 196;BA.debugLine="If result = DialogResponse.Positive Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 207;BA.debugLine="StartActivity(\"pixida\")";
