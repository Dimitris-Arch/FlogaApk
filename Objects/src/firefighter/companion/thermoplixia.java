...
public class thermoplixia extends Activity implements B4AActivity{
	public static thermoplixia mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.thermoplixia");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (thermoplixia).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.thermoplixia");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.thermoplixia", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (thermoplixia) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (thermoplixia) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (thermoplixia) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._panel2.AddView((android.view.View)(mostCurrent._clv2._asview /*anywheresoftware.b4a.objects.ConcreteViewWrapper*/ ().getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0.5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (93),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 139;BA.debugLine="Panel2.Top = 33%y";
mostCurrent._panel2.setTop(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 140;BA.debugLine="Panel2.Left = 3%x";
mostCurrent._panel2.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (3),mostCurrent.activityBA));
 //BA.debugLineNum = 141;BA.debugLine="Panel2.Width = 94%x";
mostCurrent._panel2.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (94),mostCurrent.activityBA));
 //BA.debugLineNum = 142;BA.debugLine="Panel2.Height = 57.5%y";
mostCurrent._panel2.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 143;BA.debugLine="clv2.DefaultTextBackgroundColor = Colors.DarkGray";
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Η θερμοπληξία είναι η υπερθέρμαν";
mostCurrent._clv2._addtextitem /*String*/ ("Η θερμοπληξία είναι η υπερθέρμανση  του σώματος, δηλαδή αύξηση της θερμοκρασίας του η οποία μπορεί να ανέβει σε υψηλά και επικίνδυνα επίπεδα.Είναι σοβαρή για την υγεία κατάσταση",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Τα συμπτώματα της θερμοπληξία";
mostCurrent._clv2._addtextitem /*String*/ ("Τα συμπτώματα της θερμοπληξίας μπορεί να μοιάζουν με αυτά της καρδιακής προσβολής ή του εγκεφαλικού επεισοδίου. Η αντιμετώπιση της θερμοπληξίας απαιτεί γρήγορο δρόσισμα του σώματος για να χαμηλώσει η υψηλή θερμοκρασία",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Κόκκινο και ζεστό πρόσωπο, γρ";
mostCurrent._clv2._addtextitem /*String*/ ("Κόκκινο και ζεστό πρόσωπο, γρήγορος και δυνατός παλμός, πόνος στο κεφάλι, αδυναμία, ζαλάδα, ίλιγγος, παραισθήσεις και παραλήρημα     ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Επίσης πολύ συχνά το θύμα κάν";
mostCurrent._clv2._addtextitem /*String*/ ("Επίσης πολύ συχνά το θύμα κάνει εμετό, εχει υψηλό πυρετό",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Σε βαριές περιπτώσεις, εμφανίζον";
mostCurrent._clv2._addtextitem /*String*/ ("Σε βαριές περιπτώσεις, εμφανίζονται σπασμοί και απώλεια συνείδησης, ο σφυγμός γίνετε έντονος και η θερμοκρασία σώματος άνω των 40 βαθμών",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Αντιμετώπηση της θερμοπληξίας";
mostCurrent._clv2._addtextitem /*String*/ ("Αντιμετώπηση της θερμοπληξίας γίνετε • Πρέπει να γίνει άμεση μετακίνηση του θερμόπληκτου σε δροσερό μέρος και να του αφαιρεθούν όλα τα ρούχα, εκτός των εσωρούχων.",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Καλέστε αμέσως το 166\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Καλέστε αμέσως το 166",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"Αντιμετώπιση Θερμοπληξίας:\",";
mostCurrent._clv2._addtextitem /*String*/ ("Αντιμετώπιση Θερμοπληξίας:",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"Ανασήκωση ελαφρά τοης κεφαλής, Δ";
mostCurrent._clv2._addtextitem /*String*/ ("Ανασήκωση ελαφρά τοης κεφαλής, Δροσίστε το κεφάλι και τον αυχένα με δροσερό νερό",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"Τοποθετούμε ψυχρά επιθέματα στο";
mostCurrent._clv2._addtextitem /*String*/ ("Τοποθετούμε ψυχρά επιθέματα στο πρόσωπο και στο κεφάλι του.",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"Αν μπορεί να πιει(οχι αν είναι λ";
mostCurrent._clv2._addtextitem /*String*/ ("Αν μπορεί να πιει(οχι αν είναι λυπόθυμο), κρύα ποτά (όχι οινοπνευματώδη) ή χυμούς φρούτων και μικρές ποσότητες αλατιού",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"Μεταφέρτε τον θερμόπληκτο σε μέρ";
mostCurrent._clv2._addtextitem /*String*/ ("Μεταφέρτε τον θερμόπληκτο σε μέρος δροσερό, ευάερο, σκιερό.Αφαιρέστε ταχέως τα ρούχα ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"Η χρήση πάγου είναι καλό να αποφ";
mostCurrent._clv2._addtextitem /*String*/ ("Η χρήση πάγου είναι καλό να αποφεύγεται αλλά θα πρέπει να επιχειρείται αν η θερμοκρασία δεν πέφτει.",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"Μπορείτε να τυλίξετε το θύμα με";
mostCurrent._clv2._addtextitem /*String*/ ("Μπορείτε να τυλίξετε το θύμα με ένα κρύο υγρό σεντόνι, το οποίο πρέπει να διατηρείται συνεχώς υγρό, έτσι ώστε να μειωθεί η θερμοκρασία του σώματος και να φθάσει στους 38 βαθμούς. Παράλληλα, επιθυμητό θα ήταν κάποιος να του κάνει αέρα (όχι ανεμιστήρας). ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 210;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 211;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 189;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 171;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub ililabel_Click";
...
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 185;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 181;BA.debugLine="StartActivity(\"thlefona\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 195;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 196;BA.debugLine="StartActivity(\"thlefona\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("thlefona"));
 //BA.debugLineNum = 197;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 173;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 174;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 201;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 202;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
 //BA.debugLineNum = 203;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 177;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 192;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 193;BA.debugLine="StartActivity(\"karpa\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 208;BA.debugLine="StartActivity(\"karpa\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("karpa"));
