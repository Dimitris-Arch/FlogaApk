...
public class ypothermia extends Activity implements B4AActivity{
	public static ypothermia mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.ypothermia");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ypothermia).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.ypothermia");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.ypothermia", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ypothermia) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ypothermia) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ypothermia) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 68;BA.debugLine="Activity.LoadLayout(\"ypothermia.bal\")";
mostCurrent._activity.LoadLayout("ypothermia.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,ypothermia.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Υποθερμία είναι η κατάσταση κατά";
mostCurrent._clv2._addtextitem /*String*/ ("Υποθερμία είναι η κατάσταση κατά την οποίο το σώμα χάνει θερμότητα με μεγαλύτερο ρυθμό από ό,τι παράγει.",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Αυτό έχει σαν αποτέλεσμα η θερ";
mostCurrent._clv2._addtextitem /*String*/ ("Αυτό έχει σαν αποτέλεσμα η θερμοκρασία του σώματος σταδιακά να πέσει κάτω από τα φυσιολογικά όρια(κάτω από 35 βαθμούς Κελσίου), με μοιραίες, μερικές φορές, συνέπειες για τον άνθρωπο",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Τα συμπτώματα της υποθερμίας ε";
mostCurrent._clv2._addtextitem /*String*/ ("Τα συμπτώματα της υποθερμίας είναι το ανεξέλεγκτο ρίγος,δυσκολία στην ομιλία με μπέρδεμα του λόγου, ασυνήθιστα χαμηλή συχνότητα αναπνοής, κρύο και χλωμό δέρμα, απώλεια συντονισμού των κινήσεων, απώλεια συνείδησης, λιποθυμία αδύναμος σφυγμός ή ακανόνιστος",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Η άμεση αντιμετώπιση της υποθερμ";
mostCurrent._clv2._addtextitem /*String*/ ("Η άμεση αντιμετώπιση της υποθερμίας, περιλαμβάνει το ζέσταμα του σώματος για να προληφθούν επιπλοκές ή ανεπανόρθωτες βλάβες στον οργανισμό.",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Βγάλτε όλα τα βρεγμένα ρούχα.Τ";
mostCurrent._clv2._addtextitem /*String*/ ("Βγάλτε όλα τα βρεγμένα ρούχα.Το άτομο με υποθερμία πρέπει να μεταφέρεται άμεσα σε εσωτερικούς χώρους",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Στις περιπτώσεις που αυτό δεν";
mostCurrent._clv2._addtextitem /*String*/ ("Στις περιπτώσεις που αυτό δεν είναι δυνατό, πρέπει να προστατεύεται το σώμα του από τον άνεμο, να καλύπτεται το κεφάλι και με κουβέρτες να απομονώνεται από το κρύο.",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Δεν πρέπει να τοποθετείται άμε";
mostCurrent._clv2._addtextitem /*String*/ ("Δεν πρέπει να τοποθετείται άμεση πηγή θερμότητας όπως ζεστό νερό ή λάμπα θέρμανσης. Επίσης πρέπει να αποφεύγετε να θερμαίνετε πρώτα τα άκρα του σώματος δηλαδή τα πόδια και τα χέρια.",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"Αποφεύγετε το τρίψιμο ή το μασ";
mostCurrent._clv2._addtextitem /*String*/ ("Αποφεύγετε το τρίψιμο ή το μασάζ του θύματος της υποθερμίας. Στα θύματα υποθερμίας ΔΕΝ δίνεται αλκοόλ. Αντίθετα να δίνονται γουλιές ζεστών, μη αλκοολικών ροφημάτων όπως το τσάι με ζάχαρο το οποίο κυκλοφορώντας άμεσα στο αίμα θα προσφέρει ενέργεια και θερμότητα.",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
...
mostCurrent._imageview9 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 56;BA.debugLine="Dim clv2 As CustomListView";
mostCurrent._clv2 = new firefighter.companion.customlistview();
 //BA.debugLineNum = 58;BA.debugLine="Dim Panel2 As Panel";
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 65;BA.debugLine="End Sub";
return "";
}
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 165;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 166;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 200;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
 //BA.debugLineNum = 201;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 180;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 194;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
 //BA.debugLineNum = 195;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 175;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 176;BA.debugLine="StartActivity(\"thlefona\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 190;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 191;BA.debugLine="StartActivity(\"thlefona\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("thlefona"));
 //BA.debugLineNum = 192;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 168;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 169;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 196;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 197;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
 //BA.debugLineNum = 198;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 172;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 188;BA.debugLine="StartActivity(\"karpa\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 202;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 203;BA.debugLine="StartActivity(\"karpa\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("karpa"));
