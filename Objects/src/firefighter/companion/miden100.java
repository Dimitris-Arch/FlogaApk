...
public class miden100 extends Activity implements B4AActivity{
	public static miden100 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.miden100");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (miden100).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.miden100");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.miden100", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (miden100) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (miden100) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (miden100) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,miden100.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"0004	Κατηγορία 1.1D	Πικρικό αμμώ";
mostCurrent._clv2._addtextitem /*String*/ ("0004	Κατηγορία 1.1D	Πικρικό αμμώνιο , ξηρός ή νωπός με λιγότερο από Κατηγορία 10 τοις εκατό νερό, κατά βάρος	     ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"0005	Κατηγορία 1.1E	Φυσίγγια για";
mostCurrent._clv2._addtextitem /*String*/ ("0005	Κατηγορία 1.1E	Φυσίγγια για όπλα, με εκρηκτική γόμωση	     ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"0009	Κατηγορία 1	Πυρομαχικά , εμ";
mostCurrent._clv2._addtextitem /*String*/ ("0009	Κατηγορία 1	Πυρομαχικά , εμπρηστικά με ή χωρίς ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	     ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"0012	 Κατηγορία 1	Φυσίγγια για ό";
mostCurrent._clv2._addtextitem /*String*/ ("0012	 Κατηγορία 1	Φυσίγγια για όπλα, αδρανούς βλήματος ή Φυσίγγια, μικρών όπλων	     ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"0014	 Κατηγορία 1	Φυσίγγια για ό";
mostCurrent._clv2._addtextitem /*String*/ ("0014	 Κατηγορία 1	Φυσίγγια για όπλα, κενό ή Φυσίγγια, μικρών όπλων, κενό	     ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"0015 	 Κατηγορία 1	Πυρομαχικά, κ";
mostCurrent._clv2._addtextitem /*String*/ ("0015 	 Κατηγορία 1	Πυρομαχικά, καπνό, με ή χωρίς ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	     ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"0018	 Κατηγορία 1	Πυρομαχικά, δά";
mostCurrent._clv2._addtextitem /*String*/ ("0018	 Κατηγορία 1	Πυρομαχικά, δάκρυ-παραγωγή με ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	     ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"0020 	 Κατηγορία 1	Πυρομαχικά, τ";
mostCurrent._clv2._addtextitem /*String*/ ("0020 	 Κατηγορία 1	Πυρομαχικά, τοξικά με ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	     ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"0027	 Κατηγορία 1	Μαύρη σκόνη ή";
mostCurrent._clv2._addtextitem /*String*/ ("0027	 Κατηγορία 1	Μαύρη σκόνη ή Μπαρούτι, κοκκώδης ή ως ένα γεύμα	     ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"0028	 Κατηγορία 1	Μαύρη σκόνη, σ";
mostCurrent._clv2._addtextitem /*String*/ ("0028	 Κατηγορία 1	Μαύρη σκόνη, συμπιεσμένα ή Μπαρούτι, συμπιεσμένα ή Μαύρη σκόνη, σε σφαιρίδια ή Μπαρούτι, σε σφαιρίδια	     ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"0029 	 Κατηγορία 1	Πυροκροτητές";
mostCurrent._clv2._addtextitem /*String*/ ("0029 	 Κατηγορία 1	Πυροκροτητές , ηλεκτρικά είδη, μη ηλεκτρικά, για ανατινάξεις	     ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"0033 	 Κατηγορία 1	Βόμβες , με ε";
mostCurrent._clv2._addtextitem /*String*/ ("0033 	 Κατηγορία 1	Βόμβες , με εκρηκτική γόμωση	     ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"0037 	 Κατηγορία 1	ΒΟΜΒΕΣ, φλας";
mostCurrent._clv2._addtextitem /*String*/ ("0037 	 Κατηγορία 1	ΒΟΜΒΕΣ, φλας	     ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"0042	 Κατηγορία 1	Ενισχυτές , χω";
mostCurrent._clv2._addtextitem /*String*/ ("0042	 Κατηγορία 1	Ενισχυτές , χωρίς πυροκροτητή  ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"0043	 Κατηγορία 1	Γάμα , εκρηκτι";
mostCurrent._clv2._addtextitem /*String*/ ("0043	 Κατηγορία 1	Γάμα , εκρηκτικά	     ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"0044	 Κατηγορία 1	Αστάρια , τύπο";
mostCurrent._clv2._addtextitem /*String*/ ("0044	 Κατηγορία 1	Αστάρια , τύπος καπάκι	     ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"0048	 Κατηγορία 1	Χρεώσεις , κατ";
mostCurrent._clv2._addtextitem /*String*/ ("0048	 Κατηγορία 1	Χρεώσεις , κατεδάφιση	     ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"0049	 Κατηγορία 1	Φυσίγγια, φλα";
mostCurrent._clv2._addtextitem /*String*/ ("0049	 Κατηγορία 1	Φυσίγγια, φλας	     ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"0054	 Κατηγορία 1	Φυσίγγια, σήμα";
mostCurrent._clv2._addtextitem /*String*/ ("0054	 Κατηγορία 1	Φυσίγγια, σήμα	     ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"0055	 Κατηγορία 1	Θήκες, φυσιγγί";
mostCurrent._clv2._addtextitem /*String*/ ("0055	 Κατηγορία 1	Θήκες, φυσιγγίων, άδειο, με αστάρι	  ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"0056	 Κατηγορία 1	Χρεώσεις, το β";
mostCurrent._clv2._addtextitem /*String*/ ("0056	 Κατηγορία 1	Χρεώσεις, το βάθος	     ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"0059	 Κατηγορία 1	Χρεώσεις, σχήμ";
mostCurrent._clv2._addtextitem /*String*/ ("0059	 Κατηγορία 1	Χρεώσεις, σχήμα, χωρίς πυροκροτητή	  ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"0060	 Κατηγορία 1	Χρεώσεις, συμπ";
mostCurrent._clv2._addtextitem /*String*/ ("0060	 Κατηγορία 1	Χρεώσεις, συμπληρωματική εκρηκτικά	     ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"0065	 Κατηγορία 1	Καλώδιο , εκρη";
mostCurrent._clv2._addtextitem /*String*/ ("0065	 Κατηγορία 1	Καλώδιο , εκρηκτικών, ευέλικτη	     ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"0066	 Κατηγορία 1	Καλώδιο, ανάφλ";
mostCurrent._clv2._addtextitem /*String*/ ("0066	 Κατηγορία 1	Καλώδιο, ανάφλεξη	       ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"0070	 Κατηγορία 1	Κόφτες, καλώδι";
mostCurrent._clv2._addtextitem /*String*/ ("0070	 Κατηγορία 1	Κόφτες, καλώδιο, εκρηκτικά  ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"0072	 Κατηγορία 1	Κυκλοτριμεθυλε";
mostCurrent._clv2._addtextitem /*String*/ ("0072	 Κατηγορία 1	Κυκλοτριμεθυλενοτρινιτραμίνη   ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"0073	 Κατηγορία 1	Πυροκροτητές γ";
mostCurrent._clv2._addtextitem /*String*/ ("0073	 Κατηγορία 1	Πυροκροτητές για τα πυρομαχικά	  ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"0074	 Κατηγορία 1	Diazodinitroph";
mostCurrent._clv2._addtextitem /*String*/ ("0074	 Κατηγορία 1	Diazodinitrophenol , βρεγμένο με όχι λιγότερο από 40 τοις εκατό νερό ή μίγμα αλκοόλης και νερού, κατά βάρος	  ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"0075	 Κατηγορία 1	Διαιθυλενογλυκ";
mostCurrent._clv2._addtextitem /*String*/ ("0075	 Κατηγορία 1	Διαιθυλενογλυκόλη δινιτρικό  ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"0076	 Κατηγορία 1	Δινιτροφαινόλη";
mostCurrent._clv2._addtextitem /*String*/ ("0076	 Κατηγορία 1	Δινιτροφαινόλης , ξηρός ή νωπός με λιγότερο από Κατηγορία 15 τοις εκατό νερό κατά μάζα	     ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"0077	 Κατηγορία 1	Dinitrophenola";
mostCurrent._clv2._addtextitem /*String*/ ("0077	 Κατηγορία 1	Dinitrophenolates αλκαλικά μέταλλα , ξηρός ή νωπός με λιγότερο από Κατηγορία 15 τοις εκατό νερό κατά μάζα  ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"0078	 Κατηγορία 1	Dinitroresorci";
mostCurrent._clv2._addtextitem /*String*/ ("0078	 Κατηγορία 1	Dinitroresorcinol , ξηρός ή νωπός με λιγότερο από Κατηγορία 15 τοις εκατό νερό κατά μάζα	     ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"0079	 Κατηγορία 1	Hexanitrodiphe";
mostCurrent._clv2._addtextitem /*String*/ ("0079	 Κατηγορία 1	Hexanitrodiphenylamine ή Dipicrylamine ή Hexyl	     ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"0081	 Κατηγορία 1	Εκρηκτικό , αν";
mostCurrent._clv2._addtextitem /*String*/ ("0081	 Κατηγορία 1	Εκρηκτικό , ανατινάξεις, τύπου Α	     ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"0082	 Κατηγορία 1	Εκρηκτικό, ανα";
mostCurrent._clv2._addtextitem /*String*/ ("0082	 Κατηγορία 1	Εκρηκτικό, ανατινάξεις, τύπου Β	  ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"0083	 Κατηγορία 1	Εκρηκτικό, ανα";
mostCurrent._clv2._addtextitem /*String*/ ("0083	 Κατηγορία 1	Εκρηκτικό, ανατινάξεις, τύπου C	  ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"0084	 Κατηγορία 1	Εκρηκτικό, ανα";
mostCurrent._clv2._addtextitem /*String*/ ("0084	 Κατηγορία 1	Εκρηκτικό, ανατινάξεις, τύπου D	  ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"0092	 Κατηγορία 1	Φωτοβολίδες ,";
mostCurrent._clv2._addtextitem /*String*/ ("0092	 Κατηγορία 1	Φωτοβολίδες , επιφάνεια	     ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"0093	 Κατηγορία 1	Φωτοβολίδες, ε";
mostCurrent._clv2._addtextitem /*String*/ ("0093	 Κατηγορία 1	Φωτοβολίδες, εναέρια	     ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"0094	 Κατηγορία 1	Blitzlichtpulv";
mostCurrent._clv2._addtextitem /*String*/ ("0094	 Κατηγορία 1	Blitzlichtpulver (Flash σκόνη, π.χ. για μια ντεμοντέ φλας της φωτογραφικής μηχανής)	  ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"0099	 Κατηγορία 1	Συσκευές, εκρη";
mostCurrent._clv2._addtextitem /*String*/ ("0099	 Κατηγορία 1	Συσκευές, εκρηκτικά, θραύση χωρίς πυροκροτητές για πετρελαιοπηγές	   ",(Object)(""));
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 172;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 175;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 176;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 177;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 178;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 179;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 180;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 181;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 182;BA.debugLine="chk.Initialize(\"\")";
...
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 185;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 186;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 187;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 188;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 189;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 190;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 191;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 192;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 193;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 225;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 207;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 240;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 241;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 242;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 221;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 217;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 231;BA.debugLine="Sub listabel_Click";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 209;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 210;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 237;BA.debugLine="Sub ousialabel_Click";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub pixi_Click";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 228;BA.debugLine="Sub simanseislabel_Click";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 244;BA.debugLine="Sub simansi_Click";
