...
public class xilia500 extends Activity implements B4AActivity{
	public static xilia500 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.xilia500");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (xilia500).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.xilia500");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.xilia500", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (xilia500) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (xilia500) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (xilia500) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._panel2.AddView((android.view.View)(mostCurrent._clv2._asview /*anywheresoftware.b4a.objects.ConcreteViewWrapper*/ ().getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (94),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 124;BA.debugLine="Panel2.Top = 33%y";
mostCurrent._panel2.setTop(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 125;BA.debugLine="Panel2.Left = 3%x";
mostCurrent._panel2.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (3),mostCurrent.activityBA));
 //BA.debugLineNum = 126;BA.debugLine="Panel2.Width = 94%x";
mostCurrent._panel2.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (94),mostCurrent.activityBA));
 //BA.debugLineNum = 127;BA.debugLine="Panel2.Height = 57.5%y";
mostCurrent._panel2.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 128;BA.debugLine="clv2.DefaultTextBackgroundColor = Colors.DarkGray";
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"1401	ΚΑΤΗΓΟΡΙΑ 4.3	Ασβέστιο";
mostCurrent._clv2._addtextitem /*String*/ ("1401	ΚΑΤΗΓΟΡΙΑ 4.3	Ασβέστιο	   ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"1402	ΚΑΤΗΓΟΡΙΑ 4.3	Καρβίδιο ασβ";
mostCurrent._clv2._addtextitem /*String*/ ("1402	ΚΑΤΗΓΟΡΙΑ 4.3	Καρβίδιο ασβεστίου",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"1403	ΚΑΤΗΓΟΡΙΑ 4.3	Ασβεστοκυανα";
mostCurrent._clv2._addtextitem /*String*/ ("1403	ΚΑΤΗΓΟΡΙΑ 4.3	Ασβεστοκυαναμίδιο με περισσότερα από 0,1 τοις εκατό του καρβιδίου του ασβεστίου	 ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"1404	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδιο ασβε";
mostCurrent._clv2._addtextitem /*String*/ ("1404	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδιο ασβεστίου	   ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"1405	ΚΑΤΗΓΟΡΙΑ 4.3	Πυριτιούχο α";
mostCurrent._clv2._addtextitem /*String*/ ("1405	ΚΑΤΗΓΟΡΙΑ 4.3	Πυριτιούχο ασβέστιο	   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"1407	ΚΑΤΗΓΟΡΙΑ 4.3	Καίσιο   \" ,";
mostCurrent._clv2._addtextitem /*String*/ ("1407	ΚΑΤΗΓΟΡΙΑ 4.3	Καίσιο   ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"1408	ΚΑΤΗΓΟΡΙΑ 4.3	Σιδηροπυρίτι";
mostCurrent._clv2._addtextitem /*String*/ ("1408	ΚΑΤΗΓΟΡΙΑ 4.3	Σιδηροπυρίτιο , με 30 τοις εκατό ή περισσότερο αλλά λιγότερο από το 90 τοις εκατό του πυριτίου	",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"1409	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδια μετά";
mostCurrent._clv2._addtextitem /*String*/ ("1409	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδια μετάλλων , αντιδρώντα με νερό, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"1410	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδιο λιθί";
mostCurrent._clv2._addtextitem /*String*/ ("1410	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδιο λιθίου αργιλίου	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"1411	ΚΑΤΗΓΟΡΙΑ 4.3	Λίθιο αργίλι";
mostCurrent._clv2._addtextitem /*String*/ ("1411	ΚΑΤΗΓΟΡΙΑ 4.3	Λίθιο αργίλιο υδρίδιο, αιθερικό	   ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"1413	ΚΑΤΗΓΟΡΙΑ 4.3	Βοροϋδρίδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1413	ΚΑΤΗΓΟΡΙΑ 4.3	Βοροϋδρίδιο του λιθίου	   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"1414	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδιο λιθί";
mostCurrent._clv2._addtextitem /*String*/ ("1414	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδιο λιθίου	   ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"1415	ΚΑΤΗΓΟΡΙΑ 4.3	Λίθιο	   \" ,";
mostCurrent._clv2._addtextitem /*String*/ ("1415	ΚΑΤΗΓΟΡΙΑ 4.3	Λίθιο	   ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"1417	ΚΑΤΗΓΟΡΙΑ 4.3	Πυριτίου λιθ";
mostCurrent._clv2._addtextitem /*String*/ ("1417	ΚΑΤΗΓΟΡΙΑ 4.3	Πυριτίου λιθίου	   ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"1418	ΚΑΤΗΓΟΡΙΑ 4.3	Μαγνήσιο , σ";
mostCurrent._clv2._addtextitem /*String*/ ("1418	ΚΑΤΗΓΟΡΙΑ 4.3	Μαγνήσιο , σκόνη ή κραμάτων μαγνησίου, σκόνη	   ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"1419	ΚΑΤΗΓΟΡΙΑ 4.3	Μαγνήσιο φωσ";
mostCurrent._clv2._addtextitem /*String*/ ("1419	ΚΑΤΗΓΟΡΙΑ 4.3	Μαγνήσιο φωσφορούχο αργίλιο	   ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"1420	ΚΑΤΗΓΟΡΙΑ 4.3	Κάλιο , μετα";
mostCurrent._clv2._addtextitem /*String*/ ("1420	ΚΑΤΗΓΟΡΙΑ 4.3	Κάλιο , μεταλλικά κράματα	   ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"1421	ΚΑΤΗΓΟΡΙΑ 4.3	Αλκαλικών με";
mostCurrent._clv2._addtextitem /*String*/ ("1421	ΚΑΤΗΓΟΡΙΑ 4.3	Αλκαλικών μετάλλων κράματα, υγρό, nos	   ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"1422	ΚΑΤΗΓΟΡΙΑ 4.3	Κάλιο νάτριο";
mostCurrent._clv2._addtextitem /*String*/ ("1422	ΚΑΤΗΓΟΡΙΑ 4.3	Κάλιο νάτριο κράματα	   ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"1423	ΚΑΤΗΓΟΡΙΑ 4.3	Ρουβίνιο";
mostCurrent._clv2._addtextitem /*String*/ ("1423	ΚΑΤΗΓΟΡΙΑ 4.3	Ρουβίνιο	   ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"1426	ΚΑΤΗΓΟΡΙΑ 4.3	Βοροϋδρίδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1426	ΚΑΤΗΓΟΡΙΑ 4.3	Βοροϋδρίδιο νατρίου	   ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"1427	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδιο του";
mostCurrent._clv2._addtextitem /*String*/ ("1427	ΚΑΤΗΓΟΡΙΑ 4.3	Υδρίδιο του νατρίου	   ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"1428	ΚΑΤΗΓΟΡΙΑ 4.3	Νάτριο	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("1428	ΚΑΤΗΓΟΡΙΑ 4.3	Νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"1431	ΚΑΤΗΓΟΡΙΑ 4.2	Μεθυλικό νάτ";
mostCurrent._clv2._addtextitem /*String*/ ("1431	ΚΑΤΗΓΟΡΙΑ 4.2	Μεθυλικό νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"1432	ΚΑΤΗΓΟΡΙΑ 4.3	Φωσφορούχο ν";
mostCurrent._clv2._addtextitem /*String*/ ("1432	ΚΑΤΗΓΟΡΙΑ 4.3	Φωσφορούχο νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"1433	ΚΑΤΗΓΟΡΙΑ 4.3	Κασσιτερικά";
mostCurrent._clv2._addtextitem /*String*/ ("1433	ΚΑΤΗΓΟΡΙΑ 4.3	Κασσιτερικά φωσφορούχο	   ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"1435	ΚΑΤΗΓΟΡΙΑ 4.3	Ψευδάργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1435	ΚΑΤΗΓΟΡΙΑ 4.3	Ψευδάργυρος στάχτες	   ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"1436	ΚΑΤΗΓΟΡΙΑ 4.3	Σκόνη ψευδαρ";
mostCurrent._clv2._addtextitem /*String*/ ("1436	ΚΑΤΗΓΟΡΙΑ 4.3	Σκόνη ψευδαργύρου ή σκόνη ψευδαργύρου	   ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"1437	ΚΑΤΗΓΟΡΙΑ 4.1	Ζιρκόνιο υδρ";
mostCurrent._clv2._addtextitem /*String*/ ("1437	ΚΑΤΗΓΟΡΙΑ 4.1	Ζιρκόνιο υδριδίου	   ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"1438	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό αργί";
mostCurrent._clv2._addtextitem /*String*/ ("1438	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό αργίλιο	   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"1439	ΚΑΤΗΓΟΡΙΑ 5.1	Διχρωμικό αμ";
mostCurrent._clv2._addtextitem /*String*/ ("1439	ΚΑΤΗΓΟΡΙΑ 5.1	Διχρωμικό αμμώνιο",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"1442	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικό";
mostCurrent._clv2._addtextitem /*String*/ ("1442	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικό αμμώνιο	   ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"1444	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερθετικό α";
mostCurrent._clv2._addtextitem /*String*/ ("1444	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερθετικό αμμώνιο	   ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"1445	ΚΑΤΗΓΟΡΙΑ 5.1	Βάριο χλωρικ";
mostCurrent._clv2._addtextitem /*String*/ ("1445	ΚΑΤΗΓΟΡΙΑ 5.1	Βάριο χλωρικό	   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"1446	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό βάρι";
mostCurrent._clv2._addtextitem /*String*/ ("1446	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό βάριο	   ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"1447	ΚΑΤΗΓΟΡΙΑ 5.1	Βάριο υπερχλ";
mostCurrent._clv2._addtextitem /*String*/ ("1447	ΚΑΤΗΓΟΡΙΑ 5.1	Βάριο υπερχλωρικό	   ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"1448	ΚΑΤΗΓΟΡΙΑ 5.1	Βάριο υπερμα";
mostCurrent._clv2._addtextitem /*String*/ ("1448	ΚΑΤΗΓΟΡΙΑ 5.1	Βάριο υπερμαγγανικού	   ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"1449	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1449	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο του βαρίου	   ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"1450	ΚΑΤΗΓΟΡΙΑ 5.1	Βρωμικών , α";
mostCurrent._clv2._addtextitem /*String*/ ("1450	ΚΑΤΗΓΟΡΙΑ 5.1	Βρωμικών , ανόργανα, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"1451	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό καίσ";
mostCurrent._clv2._addtextitem /*String*/ ("1451	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό καίσιο ή νιτρικό καίσιο	   ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"1452	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωρικό ασβέ";
mostCurrent._clv2._addtextitem /*String*/ ("1452	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωρικό ασβέστιο	   	   ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"1454	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό ασβέ";
mostCurrent._clv2._addtextitem /*String*/ ("1454	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό ασβέστιο	   ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"1455	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικό";
mostCurrent._clv2._addtextitem /*String*/ ("1455	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικό ασβέστιο	   ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"1456	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερμαγγανικ";
mostCurrent._clv2._addtextitem /*String*/ ("1456	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερμαγγανικό ασβεστίου",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"1457	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1457	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο ασβεστίου	   ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"1458	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωρικό και";
mostCurrent._clv2._addtextitem /*String*/ ("1458	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωρικό και βορικού μείγματα	   ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"1459	ΚΑΤΗΓΟΡΙΑ 5.1	Chlorat und M";
mostCurrent._clv2._addtextitem /*String*/ ("1459	ΚΑΤΗΓΟΡΙΑ 5.1	Chlorat und Magnesiumchlorid, Mischung	   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"1461	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωρικά, ανό";
mostCurrent._clv2._addtextitem /*String*/ ("1461	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωρικά, ανόργανα, ε.α.ο.",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"1462	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωριώδεις ,";
mostCurrent._clv2._addtextitem /*String*/ ("1462	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωριώδεις , ανόργανα, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"1463	ΚΑΤΗΓΟΡΙΑ 5.1	Τριοξείδιο τ";
mostCurrent._clv2._addtextitem /*String*/ ("1463	ΚΑΤΗΓΟΡΙΑ 5.1	Τριοξείδιο του χρωμίου , άνυδρο	   ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"1465	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό διδύ";
mostCurrent._clv2._addtextitem /*String*/ ("1465	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό διδύμιον	   ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"1466	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό σίδη";
mostCurrent._clv2._addtextitem /*String*/ ("1466	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό σίδηρο",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"1467	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό Γουα";
mostCurrent._clv2._addtextitem /*String*/ ("1467	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό Γουανιδίνη	   ",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"1469	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικού μολ";
mostCurrent._clv2._addtextitem /*String*/ ("1469	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικού μολύβδου	   ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"1470	ΚΑΤΗΓΟΡΙΑ 5.1	Μόλυβδος υπε";
mostCurrent._clv2._addtextitem /*String*/ ("1470	ΚΑΤΗΓΟΡΙΑ 5.1	Μόλυβδος υπερχλωρικό , στερεά ή μόλυβδο, υπερχλωρικό λύση	   ",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"1471	ΚΑΤΗΓΟΡΙΑ 5.1	Το υποχλωριώ";
mostCurrent._clv2._addtextitem /*String*/ ("1471	ΚΑΤΗΓΟΡΙΑ 5.1	Το υποχλωριώδες λίθιο , ξηρό ή μείγματα υποχλωριώδους λιθίου, ξηρό	   ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"1472	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1472	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο του λιθίου	   ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"1473	ΚΑΤΗΓΟΡΙΑ 5.1	Βρωμικό μαγν";
mostCurrent._clv2._addtextitem /*String*/ ("1473	ΚΑΤΗΓΟΡΙΑ 5.1	Βρωμικό μαγνήσιο	   ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"1474	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό μαγν";
mostCurrent._clv2._addtextitem /*String*/ ("1474	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό μαγνήσιο",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"1475	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικό";
mostCurrent._clv2._addtextitem /*String*/ ("1475	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικό μαγνήσιο	   ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"1476	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1476	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο μαγνησίου	   ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"1477	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικά άλατ";
mostCurrent._clv2._addtextitem /*String*/ ("1477	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικά άλατα , ανόργανα, ε.α.ο.	   .",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"1481	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικές";
mostCurrent._clv2._addtextitem /*String*/ ("1481	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικές , ανόργανα, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"1482	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερμαγγανικ";
mostCurrent._clv2._addtextitem /*String*/ ("1482	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερμαγγανικά , ανόργανα, ε.α.ο.",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"1484	ΚΑΤΗΓΟΡΙΑ 5.1	Βρωμικό κάλι";
mostCurrent._clv2._addtextitem /*String*/ ("1484	ΚΑΤΗΓΟΡΙΑ 5.1	Βρωμικό κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"1485	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωρικό κάλι";
mostCurrent._clv2._addtextitem /*String*/ ("1485	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωρικό κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"1486	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό κάλι";
mostCurrent._clv2._addtextitem /*String*/ ("1486	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό κάλιο",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"1487	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό κάλι";
mostCurrent._clv2._addtextitem /*String*/ ("1487	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό κάλιο και νιτρώδες νάτριο μείγματα	   ",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="clv2.AddTextItem(\"1488	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρώδες κάλ";
mostCurrent._clv2._addtextitem /*String*/ ("1488	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρώδες κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 201;BA.debugLine="clv2.AddTextItem(\"1489	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικό";
mostCurrent._clv2._addtextitem /*String*/ ("1489	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερχλωρικό κάλιο , στερεά ή κάλιο, υπερχλωρικό διάλυμα",(Object)(""));
 //BA.debugLineNum = 202;BA.debugLine="clv2.AddTextItem(\"1490	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερμαγγανικ";
mostCurrent._clv2._addtextitem /*String*/ ("1490	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερμαγγανικό κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 203;BA.debugLine="clv2.AddTextItem(\"1491	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1491	ΚΑΤΗΓΟΡΙΑ 5.1	Υπεροξείδιο του καλίου",(Object)(""));
 //BA.debugLineNum = 204;BA.debugLine="clv2.AddTextItem(\"1492	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερθειικό κ";
mostCurrent._clv2._addtextitem /*String*/ ("1492	ΚΑΤΗΓΟΡΙΑ 5.1	Υπερθειικό κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 205;BA.debugLine="clv2.AddTextItem(\"1493	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικού αργ";
mostCurrent._clv2._addtextitem /*String*/ ("1493	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικού αργύρου",(Object)(""));
 //BA.debugLineNum = 206;BA.debugLine="clv2.AddTextItem(\"1494	ΚΑΤΗΓΟΡΙΑ 5.1	Βρώμικο νάτρ";
mostCurrent._clv2._addtextitem /*String*/ ("1494	ΚΑΤΗΓΟΡΙΑ 5.1	Βρώμικο νάτριο	   	   ",(Object)(""));
 //BA.debugLineNum = 207;BA.debugLine="clv2.AddTextItem(\"1496	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωριούχο νά";
mostCurrent._clv2._addtextitem /*String*/ ("1496	ΚΑΤΗΓΟΡΙΑ 5.1	Χλωριούχο νάτριο",(Object)(""));
 //BA.debugLineNum = 208;BA.debugLine="clv2.AddTextItem(\"1498	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό νάτρ";
mostCurrent._clv2._addtextitem /*String*/ ("1498	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 209;BA.debugLine="clv2.AddTextItem(\"1499	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό νάτρ";
mostCurrent._clv2._addtextitem /*String*/ ("1499	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρικό νάτριο και νιτρικό κάλιο μείγματα	   ",(Object)(""));
 //BA.debugLineNum = 210;BA.debugLine="clv2.AddTextItem(\"1500	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρώδες νάτ";
mostCurrent._clv2._addtextitem /*String*/ ("1500	ΚΑΤΗΓΟΡΙΑ 5.1	Νιτρώδες νάτριο	",(Object)(""));
