...
public class miden400 extends Activity implements B4AActivity{
	public static miden400 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.miden400");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (miden400).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.miden400");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.miden400", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (miden400) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (miden400) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (miden400) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,miden400.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"0301	 Κατηγορία 3	Πυρομαχικά , δ";
mostCurrent._clv2._addtextitem /*String*/ ("0301	 Κατηγορία 3	Πυρομαχικά , δάκρυ-παραωή με ρήμα, διαρροή όμωσης ή προωθητικής όμωσης	",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"0303	 Κατηγορία 3	Πυρομαχικά, κα";
mostCurrent._clv2._addtextitem /*String*/ ("0303	 Κατηγορία 3	Πυρομαχικά, καπνό, με ή χωρίς ρήμα, διαρροή όμωσης ή προωθητικής όμωσης	   ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"0305	 Κατηγορία 3	Πούδρα λάμψης";
mostCurrent._clv2._addtextitem /*String*/ ("0305	 Κατηγορία 3	Πούδρα λάμψης	   ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"0306	 Κατηγορία 3	Ιχνηλάτες ια τ";
mostCurrent._clv2._addtextitem /*String*/ ("0306	 Κατηγορία 3	Ιχνηλάτες ια τα πυρομαχικά	   ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"0312	 Κατηγορία 3	Φυσίια , σήμα";
mostCurrent._clv2._addtextitem /*String*/ ("0312	 Κατηγορία 3	Φυσίια , σήμα	   ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"0313	 Κατηγορία 2. 3	Σήματα, καπ";
mostCurrent._clv2._addtextitem /*String*/ ("0313	 Κατηγορία 2. 3	Σήματα, καπνός	   ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"0314	 Κατηγορία 2.3	Αναφλεκτηρες";
mostCurrent._clv2._addtextitem /*String*/ ("0314	 Κατηγορία 2.3	Αναφλεκτηρες	   ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"0315	 Κατηγορία 3	Αναφλεκτηρες";
mostCurrent._clv2._addtextitem /*String*/ ("0315	 Κατηγορία 3	Αναφλεκτηρες	   ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"0316	 Κατηγορία 3	Ασφάλειες, πυρ";
mostCurrent._clv2._addtextitem /*String*/ ("0316	 Κατηγορία 3	Ασφάλειες, πυροδοτώντας	   ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"0317	 Κατηγορία 3	Ασφάλειες, πυρ";
mostCurrent._clv2._addtextitem /*String*/ ("0317	 Κατηγορία 3	Ασφάλειες, πυροδοτώντας	   ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"0318	 Κατηγορία 3	Χειροομίδες, π";
mostCurrent._clv2._addtextitem /*String*/ ("0318	 Κατηγορία 3	Χειροομίδες, πρακτική, χειρός ή όπλου	   ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"0319	 Κατηγορία 3	Αστάρια, σωλην";
mostCurrent._clv2._addtextitem /*String*/ ("0319	 Κατηγορία 3	Αστάρια, σωληνοειδή	   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"0320	 Κατηγορία 3	Αστάρια, σωλην";
mostCurrent._clv2._addtextitem /*String*/ ("0320	 Κατηγορία 3	Αστάρια, σωληνοειδή	   ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"0321	 Κατηγορία 1. 2	ΦΥΣΥΓΚΙΑ, Ο";
mostCurrent._clv2._addtextitem /*String*/ ("0321	 Κατηγορία 1. 2	ΦΥΣΥΓΚΙΑ, ΟΠΛΑ, με εκρηκτική όμωση	   ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"0322	 Κατηγορία 2	Πυραυλοκινητήρ";
mostCurrent._clv2._addtextitem /*String*/ ("0322	 Κατηγορία 2	Πυραυλοκινητήρες με υπερολικών υρά με ή χωρίς διαρροή όμωσης	   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"0323	 Κατηγορία 4	Φυσίια, συσκευ";
mostCurrent._clv2._addtextitem /*String*/ ("0323	 Κατηγορία 4	Φυσίια, συσκευή ηλεκτρικής ενέρειας	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"0324	 Κατηγορία 4	ΛΗΜΑΤΑ, με εκρ";
mostCurrent._clv2._addtextitem /*String*/ ("0324	 Κατηγορία 4	ΛΗΜΑΤΑ, με εκρηκτική όμωση	   ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"0325	 Κατηγορία 3	Αναφλεκτηρες";
mostCurrent._clv2._addtextitem /*String*/ ("0325	 Κατηγορία 3	Αναφλεκτηρες	   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"0326	 Κατηγορία 1.1	Φυσιγγια όπλ";
mostCurrent._clv2._addtextitem /*String*/ ("0326	 Κατηγορία 1.1	Φυσιγγια όπλα, κενό	   ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"0327	 Κατηγορία 1.3	Φυσιγγια όπλ";
mostCurrent._clv2._addtextitem /*String*/ ("0327	 Κατηγορία 1.3	Φυσιγγια όπλα, κενό ή Φυσίια, μικρών όπλων, κενό	   ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"0328	 Κατηγορία 1.2	Φυσιγγια όπλ";
mostCurrent._clv2._addtextitem /*String*/ ("0328	 Κατηγορία 1.2	Φυσιγγια όπλα, αδρανούς λήματος	   ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"0329	Κατηγορία 1.1	Τορπίλες με ε";
mostCurrent._clv2._addtextitem /*String*/ ("0329	Κατηγορία 1.1	Τορπίλες με εκρηκτική όμωση	      ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"0330	 Κατηγορία 1.1	Τορπίλες με";
mostCurrent._clv2._addtextitem /*String*/ ("0330	 Κατηγορία 1.1	Τορπίλες με εκρηκτική όμωση	      ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"0331	 Κατηγορία 1.5	Εκρηκτικό, α";
mostCurrent._clv2._addtextitem /*String*/ ("0331	 Κατηγορία 1.5	Εκρηκτικό, ανατινάξεις, τύπου  (εκπρόσωπος, ανατινάξεις τύπου )   ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"0332	 Κατηγορία 1.5	Εκρηκτικό, α";
mostCurrent._clv2._addtextitem /*String*/ ("0332	 Κατηγορία 1.5	Εκρηκτικό, ανατινάξεις, τύπου Ε (εκπρόσωπος, ανατινάξεις, τύπου Ε)	   ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"0333	 Κατηγορία 1.1	Πυροτεχνήματ";
mostCurrent._clv2._addtextitem /*String*/ ("0333	 Κατηγορία 1.1	Πυροτεχνήματα	      ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"0334	 Κατηγορία 2.3	Πυροτεχνήματ";
mostCurrent._clv2._addtextitem /*String*/ ("0334	 Κατηγορία 2.3	Πυροτεχνήματα	      ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"0335	 Κατηγορία 3	Πυροτεχνήματα";
mostCurrent._clv2._addtextitem /*String*/ ("0335	 Κατηγορία 3	Πυροτεχνήματα	      ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"0336,	 Κατηγορία 3	Πυροτεχνήματ";
mostCurrent._clv2._addtextitem /*String*/ ("0336,	 Κατηγορία 3	Πυροτεχνήματα	      ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"0337	 Κατηγορία 4	Πυροτεχνήματα";
mostCurrent._clv2._addtextitem /*String*/ ("0337	 Κατηγορία 4	Πυροτεχνήματα	      ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"0338	 Κατηγορία 1.4	Φυσιγγια όπλ";
mostCurrent._clv2._addtextitem /*String*/ ("0338	 Κατηγορία 1.4	Φυσιγγια όπλα, κενό ή Φυσίια, μικρών όπλων, κενό	      ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"0339	 Κατηγορία 1.4	Φυσιγγια όπλ";
mostCurrent._clv2._addtextitem /*String*/ ("0339	 Κατηγορία 1.4	Φυσιγγια όπλα, αδρανούς λήματος ή Φυσίια, μικρών όπλων	      ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"0340	Κατηγορία 1.1	Νιτροκυτταρίν";
mostCurrent._clv2._addtextitem /*String*/ ("0340	Κατηγορία 1.1	Νιτροκυτταρίνη , ξηρός ή νωπός με λιότερο από 25 τοις εκατό νερό (ή οινόπνευμα), με μάζα	    ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"0341	Κατηγορία 1.1	Νιτροκυτταρίν";
mostCurrent._clv2._addtextitem /*String*/ ("0341	Κατηγορία 1.1	Νιτροκυτταρίνη, μη τροποποιημένα ή πλαστικοποιημένο      ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"0342	 Κατηγορία 1.3	Νιτροκυτταρί";
mostCurrent._clv2._addtextitem /*String*/ ("0342	 Κατηγορία 1.3	Νιτροκυτταρίνη, ρεμένο με όχι λιότερο από 25 τοις εκατό αλκοόλη, κατά άρος	      ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"0343	 Κατηγορία 1.3	Νιτροκυτταρί";
mostCurrent._clv2._addtextitem /*String*/ ("0343	 Κατηγορία 1.3	Νιτροκυτταρίνη, πλαστικοποιημένο με όχι λιότερο από 18 τοις εκατό πλαστικοποίησης ουσία, κατά μάζα	      ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"0344	 Κατηγορία 1.4	ΛΗΜΑΤΑ, με ε";
mostCurrent._clv2._addtextitem /*String*/ ("0344	 Κατηγορία 1.4	ΛΗΜΑΤΑ, με εκρηκτική όμωση	   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"0345	 Κατηγορία 4	λήματα, αδρανή";
mostCurrent._clv2._addtextitem /*String*/ ("0345	 Κατηγορία 4	λήματα, αδρανή με ιχνηθέτη",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"0346	 Κατηγορία 1.2	ΛΗΜΑΤΑ, με δ";
mostCurrent._clv2._addtextitem /*String*/ ("0346	 Κατηγορία 1.2	ΛΗΜΑΤΑ, με διαρρήκτη ή διαρροή όμωσης",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"0347	 Κατηγορία 1.4	ΛΗΜΑΤΑ, με δ";
mostCurrent._clv2._addtextitem /*String*/ ("0347	 Κατηγορία 1.4	ΛΗΜΑΤΑ, με διαρρήκτη ή διαρροή όμωσης",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"0348	 Κατηγορία 1.4	ΦΥΣΙΙΑ ΙΑ ΟΠ";
mostCurrent._clv2._addtextitem /*String*/ ("0348	 Κατηγορία 1.4	ΦΥΣΙΙΑ ΙΑ ΟΠΛΑ, με εκρηκτική όμωση",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"0349	 Κατηγορία 4	Άρθρα, εκρηκτι";
mostCurrent._clv2._addtextitem /*String*/ ("0349	 Κατηγορία 4	Άρθρα, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"0350	 Κατηγορία 1.4	Άρθρα, εκρηκ";
mostCurrent._clv2._addtextitem /*String*/ ("0350	 Κατηγορία 1.4	Άρθρα, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"0351	 Κατηγορία 1.4	Άρθρα, εκρηκ";
mostCurrent._clv2._addtextitem /*String*/ ("0351	 Κατηγορία 1.4	Άρθρα, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"0352	 Κατηγορία 1.4	Άρθρα, εκρηκ";
mostCurrent._clv2._addtextitem /*String*/ ("0352	 Κατηγορία 1.4	Άρθρα, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"0353	 Κατηγορία 3	Άρθρα, εκρηκτι";
mostCurrent._clv2._addtextitem /*String*/ ("0353	 Κατηγορία 3	Άρθρα, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"0354	 Κατηγορία 1.1	Άρθρα, εκρηκ";
mostCurrent._clv2._addtextitem /*String*/ ("0354	 Κατηγορία 1.1	Άρθρα, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"0355	 Κατηγορία 2	Άρθρα, εκρηκτι";
mostCurrent._clv2._addtextitem /*String*/ ("0355	 Κατηγορία 2	Άρθρα, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"0356	 Κατηγορία 1.3	Άρθρα, εκρηκ";
mostCurrent._clv2._addtextitem /*String*/ ("0356	 Κατηγορία 1.3	Άρθρα, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"0357	 Κατηγορία 1.1	Ουσίες, εκρη";
mostCurrent._clv2._addtextitem /*String*/ ("0357	 Κατηγορία 1.1	Ουσίες, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"0358	 Κατηγορία 2	Ουσίες, εκρηκτ";
mostCurrent._clv2._addtextitem /*String*/ ("0358	 Κατηγορία 2	Ουσίες, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"0359	 Κατηγορία 1.3	Ουσίες, εκρη";
mostCurrent._clv2._addtextitem /*String*/ ("0359	 Κατηγορία 1.3	Ουσίες, εκρηκτικά, NOS",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"0360	 Κατηγορία 1.1	Συνδεσμολοίε";
mostCurrent._clv2._addtextitem /*String*/ ("0360	 Κατηγορία 1.1	Συνδεσμολοίες πυροκροτητών, μη ηλεκτρικές ια ανατινάξεις",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"0361	 Κατηγορία 1.4	Συνδεσμολοίε";
mostCurrent._clv2._addtextitem /*String*/ ("0361	 Κατηγορία 1.4	Συνδεσμολοίες πυροκροτητών, μη ηλεκτρικές ια ανατινάξεις",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"0362	 Κατηγορία 3	Πυρομαχικά, πρ";
mostCurrent._clv2._addtextitem /*String*/ ("0362	 Κατηγορία 3	Πυρομαχικά, πρακτική",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"0363	 Κατηγορία 3	Πυρομαχικά, απ";
mostCurrent._clv2._addtextitem /*String*/ ("0363	 Κατηγορία 3	Πυρομαχικά, απόδειξη",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"0364	 Κατηγορία 1.2	Πυροκροτητές";
mostCurrent._clv2._addtextitem /*String*/ ("0364	 Κατηγορία 1.2	Πυροκροτητές ια τα πυρομαχικά",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"0365	 Κατηγορία 1.4	Πυροκροτητές";
mostCurrent._clv2._addtextitem /*String*/ ("0365	 Κατηγορία 1.4	Πυροκροτητές ια τα πυρομαχικά",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"0366	 Κατηγορία 4	Πυροκροτητές ι";
mostCurrent._clv2._addtextitem /*String*/ ("0366	 Κατηγορία 4	Πυροκροτητές ια τα πυρομαχικά",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"0367	 Κατηγορία 4	Ασφάλειες, εκρ";
mostCurrent._clv2._addtextitem /*String*/ ("0367	 Κατηγορία 4	Ασφάλειες, εκρηκτικών",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"0368	 Κατηγορία 4	Ασφάλειες, ανά";
mostCurrent._clv2._addtextitem /*String*/ ("0368	 Κατηγορία 4	Ασφάλειες, ανάφλεξη",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"0369	 Κατηγορία 1.1	Κεφαλές , ρό";
mostCurrent._clv2._addtextitem /*String*/ ("0369	 Κατηγορία 1.1	Κεφαλές , ρόκα με εκρηκτική όμωση",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"0370	 Κατηγορία 1.4	Κεφαλές, ρόκ";
mostCurrent._clv2._addtextitem /*String*/ ("0370	 Κατηγορία 1.4	Κεφαλές, ρόκα με διαρρήκτη ή διαρροή όμωσης",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"0371	 Κατηγορία 1.4	Κεφαλές, ρόκ";
mostCurrent._clv2._addtextitem /*String*/ ("0371	 Κατηγορία 1.4	Κεφαλές, ρόκα με διαρρήκτη ή διαρροή όμωσης",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"0373	 Κατηγορία 4	Συσκευές σηματ";
mostCurrent._clv2._addtextitem /*String*/ ("0373	 Κατηγορία 4	Συσκευές σηματοδότησης, χέρι",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"0374	 Κατηγορία 1.1	Υροδείκτες,";
mostCurrent._clv2._addtextitem /*String*/ ("0374	 Κατηγορία 1.1	Υροδείκτες, εκρηκτικά",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"0375	 Κατηγορία 1.2	Υροδείκτες,";
mostCurrent._clv2._addtextitem /*String*/ ("0375	 Κατηγορία 1.2	Υροδείκτες, εκρηκτικά",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"0376	 Κατηγορία 4	Αστάρια, σωλην";
mostCurrent._clv2._addtextitem /*String*/ ("0376	 Κατηγορία 4	Αστάρια, σωληνοειδή",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"0377	 Κατηγορία 1.1	Αστάρια, τύπ";
mostCurrent._clv2._addtextitem /*String*/ ("0377	 Κατηγορία 1.1	Αστάρια, τύπος καπάκι",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"0378	 Κατηγορία 1.4	Αστάρια, τύπ";
mostCurrent._clv2._addtextitem /*String*/ ("0378	 Κατηγορία 1.4	Αστάρια, τύπος καπάκι",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"0379	 Κατηγορία 1.4	Θήκες, φυσίι";
mostCurrent._clv2._addtextitem /*String*/ ("0379	 Κατηγορία 1.4	Θήκες, φυσίια, άδειο, με αστάρι",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"0380	 Κατηγορία 2	Άρθρα, πυροφορ";
mostCurrent._clv2._addtextitem /*String*/ ("0380	 Κατηγορία 2	Άρθρα, πυροφορικά",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"0381	 Κατηγορία 1.2	Φυσίια, συσκ";
mostCurrent._clv2._addtextitem /*String*/ ("0381	 Κατηγορία 1.2	Φυσίια, συσκευή ηλεκτρικής ενέρειας",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"0382	 Κατηγορία 1.2	Εξαρτήματα,";
mostCurrent._clv2._addtextitem /*String*/ ("0382	 Κατηγορία 1.2	Εξαρτήματα, εκρηκτικών, NOS	   ",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"0383	 Κατηγορία 1.4	Εξαρτήματα,";
mostCurrent._clv2._addtextitem /*String*/ ("0383	 Κατηγορία 1.4	Εξαρτήματα, εκρηκτικών, NOS",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="clv2.AddTextItem(\"0384	 Κατηγορία 4	Εξαρτήματα, εκ";
mostCurrent._clv2._addtextitem /*String*/ ("0384	 Κατηγορία 4	Εξαρτήματα, εκρηκτικών, NOS",(Object)(""));
 //BA.debugLineNum = 201;BA.debugLine="clv2.AddTextItem(\"0385	Κατηγορία 1.1	5-Nitrobnzotr";
mostCurrent._clv2._addtextitem /*String*/ ("0385	Κατηγορία 1.1	5-Nitrobnzotriazo",(Object)(""));
 //BA.debugLineNum = 202;BA.debugLine="clv2.AddTextItem(\"0386	Κατηγορία 1.1	Τρινιτροενζολ";
mostCurrent._clv2._addtextitem /*String*/ ("0386	Κατηγορία 1.1	Τρινιτροενζολοσουλφονικό οξύ",(Object)(""));
 //BA.debugLineNum = 203;BA.debugLine="clv2.AddTextItem(\"0387	Κατηγορία 1.1	Τρινιτροφθορε";
mostCurrent._clv2._addtextitem /*String*/ ("0387	Κατηγορία 1.1	Τρινιτροφθορενόνη",(Object)(""));
 //BA.debugLineNum = 204;BA.debugLine="clv2.AddTextItem(\"0388	Κατηγορία 1.1	Τρινιτροτολου";
mostCurrent._clv2._addtextitem /*String*/ ("0388	Κατηγορία 1.1	Τρινιτροτολουένιο (TNT) και τρινιτροενζενίου μείμα ή τρινιτροτολουολίου (TNT) και μίμα hxanitrostibn",(Object)(""));
 //BA.debugLineNum = 205;BA.debugLine="clv2.AddTextItem(\"0389	Κατηγορία 1.1	Τρινιτροτολου";
mostCurrent._clv2._addtextitem /*String*/ ("0389	Κατηγορία 1.1	Τρινιτροτολουολίου (TNT) που περιέχει τρινιτροενζολο και Hxanitrostibn",(Object)(""));
 //BA.debugLineNum = 206;BA.debugLine="clv2.AddTextItem(\"0390	Κατηγορία 1.1	ΤΡΙΤΟΝΑΛΗ\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("0390	Κατηγορία 1.1	ΤΡΙΤΟΝΑΛΗ",(Object)(""));
 //BA.debugLineNum = 207;BA.debugLine="clv2.AddTextItem(\"0391	Κατηγορία 1.1	Κυκλοτριμεθυλ";
mostCurrent._clv2._addtextitem /*String*/ ("0391	Κατηγορία 1.1	Κυκλοτριμεθυλενοτρινιτραμίνη",(Object)(""));
 //BA.debugLineNum = 208;BA.debugLine="clv2.AddTextItem(\"0392	Κατηγορία 1.1	Hxanitrostibn";
mostCurrent._clv2._addtextitem /*String*/ ("0392	Κατηγορία 1.1	Hxanitrostibn",(Object)(""));
 //BA.debugLineNum = 209;BA.debugLine="clv2.AddTextItem(\"0393	Κατηγορία 1.1	ΕΞΟΤΟΝΑΛΗ\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("0393	Κατηγορία 1.1	ΕΞΟΤΟΝΑΛΗ",(Object)(""));
 //BA.debugLineNum = 210;BA.debugLine="clv2.AddTextItem(\"0394	Κατηγορία 1.1	Trinitrorsori";
mostCurrent._clv2._addtextitem /*String*/ ("0394	Κατηγορία 1.1	Trinitrorsorino (στυφνικό οξύ)",(Object)(""));
 //BA.debugLineNum = 211;BA.debugLine="clv2.AddTextItem(\"0396	 Κατηγορία 1.3J	Πυραυλοκινη";
mostCurrent._clv2._addtextitem /*String*/ ("0396	 Κατηγορία 1.3J	Πυραυλοκινητήρες, υρό τροφοδοτείται",(Object)(""));
 //BA.debugLineNum = 212;BA.debugLine="clv2.AddTextItem(\"0397	 Κατηγορία 1.1J	Πύραυλοι, υ";
mostCurrent._clv2._addtextitem /*String*/ ("0397	 Κατηγορία 1.1J	Πύραυλοι, υρό τροφοδοτούνται με εκρηκτική γόμωση",(Object)(""));
 //BA.debugLineNum = 213;BA.debugLine="clv2.AddTextItem(\"0398	 Κατηγορία 1.2J	Πύραυλοι, υ";
mostCurrent._clv2._addtextitem /*String*/ ("0398	 Κατηγορία 1.2J	Πύραυλοι, υρό τροφοδοτούνται με εκρηκτική γόμωση",(Object)(""));
 //BA.debugLineNum = 214;BA.debugLine="clv2.AddTextItem(\"0399	 Κατηγορία 1.1J	όμες με εύφ";
mostCurrent._clv2._addtextitem /*String*/ ("0399	 Κατηγορία 1.1J	όμες με εύφλεκτο υρό, με εκρηκτική γόμωση",(Object)(""));
 //BA.debugLineNum = 215;BA.debugLine="clv2.AddTextItem(\"0400	 Κατηγορία 1.2J	όμες με εύφ";
mostCurrent._clv2._addtextitem /*String*/ ("0400	 Κατηγορία 1.2J	όμες με εύφλεκτο υρό, με εκρηκτική γόμωση",(Object)(""));
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 //BA.debugLineNum = 250;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
...
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 246;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 248;BA.debugLine="End Sub";
return "";
}
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 219;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 220;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 223;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 224;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 225;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 226;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 227;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 228;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 229;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 230;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 231;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 232;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 233;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 234;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 235;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 236;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 237;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 238;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 239;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 240;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 241;BA.debugLine="Return p";
if (true) return _p;
