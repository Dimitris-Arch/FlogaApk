...
public class thiikoatmizon extends Activity implements B4AActivity{
	public static thiikoatmizon mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.thiikoatmizon");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (thiikoatmizon).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.thiikoatmizon");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.thiikoatmizon", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (thiikoatmizon) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (thiikoatmizon) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (thiikoatmizon) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._simansi.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (45),mostCurrent.activityBA));
 //BA.debugLineNum = 55;BA.debugLine="pin1.BringToFront";
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,thiikoatmizon.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"Το θειικό οξύ,βιτριόλι ως ατμός";
mostCurrent._clv2._addtextitem /*String*/ ("Το θειικό οξύ,βιτριόλι ως ατμός UN-1831 είναι άοσμο, άχρωμο και είναι διαβρωτικό και τοξικό",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"Το νερό δεν πρέπει να χρησιμοποι";
mostCurrent._clv2._addtextitem /*String*/ ("Το νερό δεν πρέπει να χρησιμοποιηθεί χωρίς την έγκριση ειδικών.",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Σε επαφή του με το νερό παράγετα";
mostCurrent._clv2._addtextitem /*String*/ ("Σε επαφή του με το νερό παράγεται θερμότητα και εκτοξεύονται σταγόνες θερμού θεεικού οξέος,γιαυτο ποτέ δεν χρησιμοποιούμε νερό.",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Δεν είναι εύφλεκτο όμως σε επαφή";
mostCurrent._clv2._addtextitem /*String*/ ("Δεν είναι εύφλεκτο όμως σε επαφή με διάφορα υλικά, απελευθερώνεται εύλεκτο υδρογόνο.",(Object)(""));
...
mostCurrent._clv2._addtextitem /*String*/ ("Έαν έρθει σε επαφη με το σώμα πλυνετε με άφθονο νερο.",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Η αντιμετώπηση συμβάντων με θειι";
mostCurrent._clv2._addtextitem /*String*/ ("Η αντιμετώπηση συμβάντων με θειικό οξύ,γίνετε μόνο απο ειδικά οχήματα.",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 8 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 8 ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"ΔΙΑΒΡΩΤΙΚΕΣ ΟΥΣΙΕΣ ΚΑΙ ΤΟΞΙΚΕΣ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΔΙΑΒΡΩΤΙΚΕΣ ΟΥΣΙΕΣ ΚΑΙ ΤΟΞΙΚΕΣ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"Προκαλούν μεγάλη βλάβη στην υγ";
mostCurrent._clv2._addtextitem /*String*/ ("Προκαλούν μεγάλη βλάβη στην υγεία. ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"Υπάρχει κίνδυνος αλυσιδωτής αντί";
mostCurrent._clv2._addtextitem /*String*/ ("Υπάρχει κίνδυνος αλυσιδωτής αντίδρασης",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑ";
mostCurrent._clv2._addtextitem /*String*/ ("ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑΣ",(Object)(""));
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 147;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 148;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 151;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 152;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 153;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 154;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 155;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 156;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 157;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 158;BA.debugLine="chk.Initialize(\"\")";
...
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 161;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 162;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 163;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 164;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 165;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 166;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 167;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 168;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
...
int _result = 0;
 //BA.debugLineNum = 182;BA.debugLine="Sub pin1_Click";
...
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Επιστροφή στο μενού"),BA.ObjectToCharSequence("  "),"Ναί ","","Όχι ",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"1830.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 185;BA.debugLine="If result = DialogResponse.Positive Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 186;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 };
...
int _result = 0;
 //BA.debugLineNum = 189;BA.debugLine="Sub pin2_Click";
 //BA.debugLineNum = 190;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 191;BA.debugLine="result = Msgbox2(\"Επιστροφή στο μενού\", \"  \", \"Ναί";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Επιστροφή στο μενού"),BA.ObjectToCharSequence("  "),"Ναί ","","Όχι ",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"1831.png").getObject()),mostCurrent.activityBA);
