...
public class rssdyo extends Activity implements B4AActivity{
	public static rssdyo mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.rssdyo");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (rssdyo).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.rssdyo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.rssdyo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (rssdyo) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (rssdyo) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (rssdyo) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
uk.co.martinpearman.b4a.webviewextras.WebViewExtras _webviewextras1 = null;
 ...
 //BA.debugLineNum = 36;BA.debugLine="Activity.LoadLayout(\"rssdyo\")";
mostCurrent._activity.LoadLayout("rssdyo",mostCurrent.activityBA);
...
_job1._initialize /*String*/ (processBA,"Job1",rssdyo.getObject());
 //BA.debugLineNum = 79;BA.debugLine="job1.Download(\"http://www.google.com\")";
_job1._download /*String*/ ("http://www.google.com");
 //BA.debugLineNum = 81;BA.debugLine="HTML = File.GetText(File.DirAssets, \"twit.html\")";
mostCurrent._html = anywheresoftware.b4a.keywords.Common.File.GetText(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"twit.html");
...
anywheresoftware.b4a.keywords.Common.LogImpl("73407877",_job._getstring /*String*/ (),0);
 }else {
...
public static String  _simanseislabel_click() throws Exception{
 ...
 //BA.debugLineNum = 176;BA.debugLine="StartActivity(\"rss\")";
