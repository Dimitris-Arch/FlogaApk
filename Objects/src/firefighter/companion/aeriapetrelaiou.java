...
public class aeriapetrelaiou extends Activity implements B4AActivity{
	public static aeriapetrelaiou mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.aeriapetrelaiou");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (aeriapetrelaiou).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.aeriapetrelaiou");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.aeriapetrelaiou", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (aeriapetrelaiou) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (aeriapetrelaiou) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (aeriapetrelaiou) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            aeriapetrelaiou mc = mostCurrent;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 48;BA.debugLine="Activity.LoadLayout(\"aeriapetrelaiou.bal\")";
mostCurrent._activity.LoadLayout("aeriapetrelaiou.bal",mostCurrent.activityBA);
...
mostCurrent._mple.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 120;BA.debugLine="clv2.Initialize(Me, \"clv2\")";
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,aeriapetrelaiou.getObject(),"clv2");
 //BA.debugLineNum = 121;BA.debugLine="Panel2.AddView(clv2.AsView, 0.5%x, 0%y,93%x ,57.5";
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"To υγραέριο είναι μίγμα υδρογονα";
mostCurrent._clv2._addtextitem /*String*/ ("To υγραέριο είναι μίγμα υδρογονανθράκων, αποτελείται από πολλές ουσίες και μίγματα αυτών. Προπάνιο, βουτάνιο, μίγμα προπάνιου-βουτανίου και αέρια πετρελαίου είναι μερικές",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"• Αέρια πετρελαίου υγροποιημένα";
mostCurrent._clv2._addtextitem /*String*/ ("• Αέρια πετρελαίου υγροποιημένα UN-1075",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Το υγραέριο είναι άοσμο και άχρ";
mostCurrent._clv2._addtextitem /*String*/ ("Το υγραέριο είναι άοσμο και άχρωμο, εύφλεκτο και σε χώρους που δεν αερίζονται υπάρχει κίνδυνος ασφυξίας.",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Είναι βαρύτερο του αέρα και συγκ";
mostCurrent._clv2._addtextitem /*String*/ ("Είναι βαρύτερο του αέρα και συγκεντρώνεται χαμηλά Για να ξεχωρίζει στην όσφρηση, προσθέτουν ουσία για τον έλεγχο διαρροής. ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2.1 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2.1 ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"Ευφλεκτα,πυροδυναμωτικα,δηλητηρ";
mostCurrent._clv2._addtextitem /*String*/ ("Ευφλεκτα,πυροδυναμωτικα,δηλητηριώδη και τοξικα. ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"ΕΚΡΗΞΗ ΕΞΑΙΤΙΑΣ ΤΗΣ ΥΨΗΛΗΣ ΠΙΕΣ";
mostCurrent._clv2._addtextitem /*String*/ ("ΕΚΡΗΞΗ ΕΞΑΙΤΙΑΣ ΤΗΣ ΥΨΗΛΗΣ ΠΙΕΣΗΣ ΣΤΑ ΔΟΧΕΙΑ-ΒΥΤΙΑ ΠΟΥ ΒΡΙΣΚΟΝΤΑΙ. ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"Σε χώρους που δεν αερίζονται υπά";
mostCurrent._clv2._addtextitem /*String*/ ("Σε χώρους που δεν αερίζονται υπάρχει κίνδυνος ασφυξίας. ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"Έκρηξη σε περίπτωση διαρροής. \",";
mostCurrent._clv2._addtextitem /*String*/ ("Έκρηξη σε περίπτωση διαρροής. ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"ΠΟΛΥ ΥΨΗΛΟΣ ΚΙΝΔΥΝΟΣ ΑΠΌΤΟΜΗΣ Έ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΟΛΥ ΥΨΗΛΟΣ ΚΙΝΔΥΝΟΣ ΑΠΌΤΟΜΗΣ ΈΚΡΗΞΗΣ,ΔΟΧΕΊΩΝ Ή ΒΥΤΙΩΝ ΣΕ ΠΕΡΊΠΤΩΣΗ ΑΝΑΡΡΌΦΗΣΗΣ ΟΤΑΝ ΑΔΙΑΖΟΥΝ ΚΑΙ Η ΕΞΩΤΕΡΙΚΗ ΠΙΕΣΗ ΕΙΝΑΙ ΜΕΓΑΛΥΤΕΡΗ ΤΗΣ ΕΣΩΤΕΡΙΚΗΣ ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑ";
mostCurrent._clv2._addtextitem /*String*/ ("ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑΣ.Αυλοί οροφής,εδάφους  ή άλλοι τηλεκατευθυνόμενοι έιναι ιδανικοί",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"Άμεσος αποκλεισμός του χώρου σε";
mostCurrent._clv2._addtextitem /*String*/ ("Άμεσος αποκλεισμός του χώρου σε απόσταση 100 εώς 800 μέτρων σε μικρή πυρκαγιά και σε περίπτωση μεγάλης απόσταση 1600 μέτρων",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράν";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράνος,περισκελίδα,επενδύτη,γαντια και αναπνευστική συσκευή",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Φορέστε στολή χημικής προστασίας";
mostCurrent._clv2._addtextitem /*String*/ ("Φορέστε στολή χημικής προστασίας με αναπνευστική συσκευή (πλήρης απομόνωση από το εξωτερικό περιβάλλον)  ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Τα εργαλεία που χρησιμοποιούνται";
mostCurrent._clv2._addtextitem /*String*/ ("Τα εργαλεία που χρησιμοποιούνται δεν θα πρέπει να προκαλούν σπινθήρες ή στατικό ηλεκτρισμό.Μην χρησιμοποιείτε κοντά στην φωτιά κινητά τηλέφωνα ή ασύρματο",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Η προσβολή γίνεται απο την πλευρ";
mostCurrent._clv2._addtextitem /*String*/ ("Η προσβολή γίνεται απο την πλευρά που φυσάει ο άνεμος.Πάντα με την πλάτη στον άνεμο.Καλυφθείτε απο κάποιο εμπόδιο,τοίχο,όχημα ανάχωμα κτλ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"ΚΛΕΙΣΤΕ ΤΗΝ ΤΕΛΕΥΤΑΙΑ ΒΑΝΑ ΠΡΙΝ";
mostCurrent._clv2._addtextitem /*String*/ ("ΚΛΕΙΣΤΕ ΤΗΝ ΤΕΛΕΥΤΑΙΑ ΒΑΝΑ ΠΡΙΝ ΑΠΟ ΤΗΝ ΔΙΑΡΡΟΗ.Ψύψετε όλους τους σωλήνες. Επιχειρήστε αποκοπή της φλόγας με υψηλή πίεση στο σημείο διαρροής.",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Μήν διασκορπίζετε την πυρκαγιά μ";
mostCurrent._clv2._addtextitem /*String*/ ("Μήν διασκορπίζετε την πυρκαγιά με συμπαγή βολή,Αν είναι δυνατό καλύψτε με C02,ξηρά σκόνη ή αφρό",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Κατάσβεση όλων των πηγών ανάφλεξ";
mostCurrent._clv2._addtextitem /*String*/ ("Κατάσβεση όλων των πηγών ανάφλεξης, ακόμα και τις μικρότερες.Επίσης πρέπει να επιχειρείται μείωση της θερμοκρασίας",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Σταματήστε και απομακρυνθείτε εά";
mostCurrent._clv2._addtextitem /*String*/ ("Σταματήστε και απομακρυνθείτε εάν η φωτιά φτάσει στο βυτίο-δεξαμενή ή υπάρχει μεγάλη θερμοκρασία δίπλα που δεν εξουδετερώνεται ,υπάρχει μεγάλος κίνδυνος έκρηξης",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Προσπαθήστε να περιορίσετε την ε";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 239;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 240;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 161;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 165;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 166;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 167;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 168;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 169;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 170;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 171;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 172;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 173;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 174;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 175;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 176;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 177;BA.debugLine="lbl.TextSize = 16";
...
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 179;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 180;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 181;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 182;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 183;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 218;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 219;BA.debugLine="StartActivity(\"simanseis\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Sub simansi_Click";
