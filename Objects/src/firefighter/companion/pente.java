...
public class pente extends Activity implements B4AActivity{
	public static pente mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.pente");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (pente).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.pente");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.pente", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (pente) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (pente) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (pente) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 51;BA.debugLine="Activity.LoadLayout(\"pentebal.bal\")";
mostCurrent._activity.LoadLayout("pentebal.bal",mostCurrent.activityBA);
...
mostCurrent._mple.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 117;BA.debugLine="pin1.BringToFront";
mostCurrent._pin1.BringToFront();
 //BA.debugLineNum = 122;BA.debugLine="clv2.Initialize(Me, \"clv2\")";
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,pente.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 5.1 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 5.1 ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Εκρηκτικές ουσίες και βλαβερές";
mostCurrent._clv2._addtextitem /*String*/ ("Εκρηκτικές ουσίες και βλαβερές για την υγεία με μεγάλο κίνδυνο ανάφλεξης ή αυτανάφλεξης λόγο παρουσία οξυγόνου ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑ";
mostCurrent._clv2._addtextitem /*String*/ ("ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑΣ.Αυλοί οροφής,εδάφους  ή άλλοι τηλεκατευθυνόμενοι έιναι ιδανικοί",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Άμεσος αποκλεισμός του χώρου σε";
mostCurrent._clv2._addtextitem /*String*/ ("Άμεσος αποκλεισμός του χώρου σε απόσταση 100 εώς 800 μέτρων σε μικρή πυρκαγιά και σε περίπτωση μεγάλης απόσταση 1600 μέτρων",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράν";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράνος,περισκελίδα,επενδύτη,γαντια και αναπνευστική συσκευή",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"Φορέστε στολή χημικής προστασίας";
mostCurrent._clv2._addtextitem /*String*/ ("Φορέστε στολή χημικής προστασίας με αναπνευστική συσκευή (πλήρης απομόνωση από το εξωτερικό περιβάλλον)  ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"Τα εργαλεία που χρησιμοποιούνται";
mostCurrent._clv2._addtextitem /*String*/ ("Τα εργαλεία που χρησιμοποιούνται δεν θα πρέπει να προκαλούν σπινθήρες ή στατικό ηλεκτρισμό.Μην χρησιμοποιείτε κοντά στην φωτιά κινητά τηλέφωνα ή ασύρματο",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"Η προσβολή γίνετε απο την πλευρά";
mostCurrent._clv2._addtextitem /*String*/ ("Η προσβολή γίνετε απο την πλευρά που φυσάει ο άνεμος.Πάντα με την πλάτη στον άνεμο.Καλυφθείτε απο κάποιο εμπόδιο,τοίχο,όχημα ανάχωμα κτλ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"Μήν διασκορπίζετε την πυρκαγιά μ";
mostCurrent._clv2._addtextitem /*String*/ ("Μήν διασκορπίζετε την πυρκαγιά με συμπαγή βολή,Αν είναι δυνατό καλύψτε με C02,ξηρά σκόνη ή αφρό",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"Κατάσβεση όλων των πηγών ανάφλεξ";
mostCurrent._clv2._addtextitem /*String*/ ("Κατάσβεση όλων των πηγών ανάφλεξης, ακόμα και τις μικρότερες.Επίσης πρέπει να επιχειρείται μείωση της θερμοκρασίας",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"Σταματήστε και απομακρυνθείτε εά";
mostCurrent._clv2._addtextitem /*String*/ ("Σταματήστε και απομακρυνθείτε εάν η φωτιά φτάσει στο βυτίο-δεξαμενή ή υπάρχει μεγάλη θερμοκρασία δίπλα που δεν εξουδετερώνεται ,υπάρχει μεγάλος κίνδυνος έκρηξης σε πολλές ουσίες της κατηγορίας",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"Προσπαθήστε να περιορίσετε την ε";
