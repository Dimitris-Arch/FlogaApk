...
public class dyoxil100 extends Activity implements B4AActivity{
	public static dyoxil100 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dyoxil100");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dyoxil100).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dyoxil100");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dyoxil100", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dyoxil100) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dyoxil100) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dyoxil100) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dyoxil100.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"2001	Κατηγορία 4.1	Ναφθενικά κοβ";
mostCurrent._clv2._addtextitem /*String*/ ("2001	Κατηγορία 4.1	Ναφθενικά κοβαλτίου , σε σκόνη	   ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"2002	Κατηγορία 4.2	Ταρταρούγα ,";
mostCurrent._clv2._addtextitem /*String*/ ("2002	Κατηγορία 4.2	Ταρταρούγα , ξύστε	   ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"2003	Κατηγορία 4.2	Μεταλλικά αλκ";
mostCurrent._clv2._addtextitem /*String*/ ("2003	Κατηγορία 4.2	Μεταλλικά αλκύλια , αντιδρώντα με νερό, ε.α.ο. ή αρύλια μετάλλων, αντιδρώντα με νερό, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"2004	Κατηγορία 4.2	Διαμιδο μαγνή";
mostCurrent._clv2._addtextitem /*String*/ ("2004	Κατηγορία 4.2	Διαμιδο μαγνήσιο	   ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"2005	Κατηγορία 4.2	Διφαινυλαιθέρ";
mostCurrent._clv2._addtextitem /*String*/ ("2005	Κατηγορία 4.2	Διφαινυλαιθέρες μαγνήσιο	     ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"2006	Κατηγορία 4.2	Πλαστικά , νι";
mostCurrent._clv2._addtextitem /*String*/ ("2006	Κατηγορία 4.2	Πλαστικά , νιτροκυτταρίνη που βασίζονται, αυτο-θέρμανσης, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"2008	Κατηγορία 4.2	Ζιρκόνιο σε σ";
mostCurrent._clv2._addtextitem /*String*/ ("2008	Κατηγορία 4.2	Ζιρκόνιο σε σκόνη, ξηρό	   ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"2009	Κατηγορία 4.2	Ζιρκόνιο, ξηρ";
mostCurrent._clv2._addtextitem /*String*/ ("2009	Κατηγορία 4.2	Ζιρκόνιο, ξηρό, τα τελικά φύλλα, ταινίες ή τυλιγμένου σύρματος	   ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"2010	Κατηγορία 4.3	Υδρίδιο  μαγν";
mostCurrent._clv2._addtextitem /*String*/ ("2010	Κατηγορία 4.3	Υδρίδιο  μαγνησίου	   ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"2011	Κατηγορία 4.3	Φωσφορούχο μα";
mostCurrent._clv2._addtextitem /*String*/ ("2011	Κατηγορία 4.3	Φωσφορούχο μαγνήσιο	   ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"2012	Κατηγορία 4.3	Φωσφορούχο κά";
mostCurrent._clv2._addtextitem /*String*/ ("2012	Κατηγορία 4.3	Φωσφορούχο κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"2013	Κατηγορία 4.3	Στρόντιο φωσφ";
mostCurrent._clv2._addtextitem /*String*/ ("2013	Κατηγορία 4.3	Στρόντιο φωσφορούχο	   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"2014	Κατηγορία 5.1	Υπεροξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("2014	Κατηγορία 5.1	Υπεροξείδιο  υδρογόνου	   ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"2016	Κατηγορία 6.1	Πυρομαχικά ,";
mostCurrent._clv2._addtextitem /*String*/ ("2016	Κατηγορία 6.1	Πυρομαχικά , τοξικά, μη-εκρηκτικά χωρίς ρήγμα ή διαρροή γόμωσης, μη-τηγμένου	   ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"2017	Κατηγορία 6.1	Πυρομαχικά, δ";
mostCurrent._clv2._addtextitem /*String*/ ("2017	Κατηγορία 6.1	Πυρομαχικά, δακρυγόνο, μη-εκρηκτικά χωρίς ρήγμα ή διαρροή γόμωσης, μη-τηγμένου	   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"2018	Κατηγορία 6.1	Χλωροανιλίνες";
mostCurrent._clv2._addtextitem /*String*/ ("2018	Κατηγορία 6.1	Χλωροανιλίνες , στερεά	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"2019	Κατηγορία 6.1	Χλωροανιλίνες";
mostCurrent._clv2._addtextitem /*String*/ ("2019	Κατηγορία 6.1	Χλωροανιλίνες, υγρό	   ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"2020	Κατηγορία 6.1	Χλωροφαινόλες";
mostCurrent._clv2._addtextitem /*String*/ ("2020	Κατηγορία 6.1	Χλωροφαινόλες , στερεά	   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"2021	Κατηγορία 6.1	Χλωροφαινόλες";
mostCurrent._clv2._addtextitem /*String*/ ("2021	Κατηγορία 6.1	Χλωροφαινόλες, υγρό	   ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"2022	Κατηγορία 6.1	Κρεσόλη	   \",";
mostCurrent._clv2._addtextitem /*String*/ ("2022	Κατηγορία 6.1	Κρεσόλη	   ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"2023	Κατηγορία 6.1	Επιχλωρυδρίνη";
mostCurrent._clv2._addtextitem /*String*/ ("2023	Κατηγορία 6.1	Επιχλωρυδρίνη	   ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"2024	Κατηγορία 6.1	Υδράργυρος εν";
mostCurrent._clv2._addtextitem /*String*/ ("2024	Κατηγορία 6.1	Υδράργυρος ενώσεις, υγρό, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"2025	Κατηγορία 6.1	Οι ενώσεις υδ";
mostCurrent._clv2._addtextitem /*String*/ ("2025	Κατηγορία 6.1	Οι ενώσεις υδραργύρου, στερεές, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"2026	Κατηγορία 6.1	Φαινυλυδράργυ";
mostCurrent._clv2._addtextitem /*String*/ ("2026	Κατηγορία 6.1	Φαινυλυδράργυρο ενώσεις, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"2027	Κατηγορία 6.1	Arsenite νατρ";
mostCurrent._clv2._addtextitem /*String*/ ("2027	Κατηγορία 6.1	Arsenite νατρίου , στερεό	   ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"2028	Κατηγορία 8	Βόμβες , καπνός";
mostCurrent._clv2._addtextitem /*String*/ ("2028	Κατηγορία 8	Βόμβες , καπνός, μη-εκρηκτικά, με διαβρωτικό υγρό, χωρίς συσκευή έναρξη",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"2029	Κατηγορία 8	Υδραζίνη , άνυδ";
mostCurrent._clv2._addtextitem /*String*/ ("2029	Κατηγορία 8	Υδραζίνη , άνυδρη	   ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"2030	Κατηγορία 8	Η υδραζίνη υδατ";
mostCurrent._clv2._addtextitem /*String*/ ("2030	Κατηγορία 8	Η υδραζίνη υδατικό διάλυμα, με περισσότερο από 37 τοις εκατό υδραζίνη, κατά μάζα	",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"2031	Κατηγορία 8	Νιτρικό οξύ , ε";
mostCurrent._clv2._addtextitem /*String*/ ("2031	Κατηγορία 8	Νιτρικό οξύ , εκτός από  κόκκινο ατμίζον",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"2032	Κατηγορία 8	Το νιτρικό οξύ,";
mostCurrent._clv2._addtextitem /*String*/ ("2032	Κατηγορία 8	Το νιτρικό οξύ, ερυθρό ατμίζον	   ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"2033	Κατηγορία 8	Μονοξείδιο  καλ";
mostCurrent._clv2._addtextitem /*String*/ ("2033	Κατηγορία 8	Μονοξείδιο  καλίου	   ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"2034	Κατηγορία 2	Υδρογόνο και με";
mostCurrent._clv2._addtextitem /*String*/ ("2034	Κατηγορία 2	Υδρογόνο και μεθάνιο μείγματα, συμπιεσμένο	  ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"2035	Κατηγορία 2	Κατηγορία 1,Κατ";
mostCurrent._clv2._addtextitem /*String*/ ("2035	Κατηγορία 2	Κατηγορία 1,Κατηγορία 1,Κατηγορία 1-τριφθοροαιθάνιο , Ε 143α συμπιεσμένο ή ψυκτικό αέριο",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"2036	Κατηγορία 2	Προβολείς Xenon";
mostCurrent._clv2._addtextitem /*String*/ ("2036	Κατηγορία 2	Προβολείς Xenon , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"2037	Κατηγορία 2	Φυσίγγια αερίου";
mostCurrent._clv2._addtextitem /*String*/ ("2037	Κατηγορία 2	Φυσίγγια αερίου (εύφλεκτο) χωρίς συσκευή απελευθέρωσης",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"2038	Κατηγορία 6.1	Dinitrotoluen";
mostCurrent._clv2._addtextitem /*String*/ ("2038	Κατηγορία 6.1	Dinitrotoluenes , υγρό ή Dinitrotoluenes, στερεά	   ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"2044	Κατηγορία 2	Κατηγορία 2,Κατ";
mostCurrent._clv2._addtextitem /*String*/ ("2044	Κατηγορία 2	Κατηγορία 2,Κατηγορία 2-διμεθυλπροπάνιο	   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"2045	Κατηγορία 3	Ισοβουτυραλδεΰδ";
mostCurrent._clv2._addtextitem /*String*/ ("2045	Κατηγορία 3	Ισοβουτυραλδεΰδη ή ισοβουτυλαλδεΰδη	   ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"2046	Κατηγορία 3	Cymenes	   \", \"";
mostCurrent._clv2._addtextitem /*String*/ ("2046	Κατηγορία 3	Cymenes	   ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"2047	Κατηγορία 3	Dichloropropene";
mostCurrent._clv2._addtextitem /*String*/ ("2047	Κατηγορία 3	Dichloropropenes",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"2048	Κατηγορία 3	Δικυκλοπενταδιέ";
mostCurrent._clv2._addtextitem /*String*/ ("2048	Κατηγορία 3	Δικυκλοπενταδιένιο	   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"2049	Κατηγορία 3	Διαιθυλβενζολίο";
mostCurrent._clv2._addtextitem /*String*/ ("2049	Κατηγορία 3	Διαιθυλβενζολίου	   ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"2050	Κατηγορία 3	Διϊσοβουτυλένιο";
mostCurrent._clv2._addtextitem /*String*/ ("2050	Κατηγορία 3	Διϊσοβουτυλένιο , ισομερείς ενώσεις",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"2051	Κατηγορία 8	Κατηγορία 2-διμ";
mostCurrent._clv2._addtextitem /*String*/ ("2051	Κατηγορία 8	Κατηγορία 2-διμεθυλαμινοαιθανόλη	",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"2052	Κατηγορία 3	Διπεντενίου";
mostCurrent._clv2._addtextitem /*String*/ ("2052	Κατηγορία 3	Διπεντενίου	   ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"2053	Κατηγορία 3	Μεθυλο-ισοβουτυ";
mostCurrent._clv2._addtextitem /*String*/ ("2053	Κατηγορία 3	Μεθυλο-ισοβουτυλο-καρβινόλη",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"2054	Κατηγορία 3	Μορφολίνη	   \",";
mostCurrent._clv2._addtextitem /*String*/ ("2054	Κατηγορία 3	Μορφολίνη	   ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"2055	Κατηγορία 8	Το στυρένιο μον";
mostCurrent._clv2._addtextitem /*String*/ ("2055	Κατηγορία 8	Το στυρένιο μονομερές, αναστέλλεται",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"2056	Κατηγορία 3	Τετραϋδροφουράν";
mostCurrent._clv2._addtextitem /*String*/ ("2056	Κατηγορία 3	Τετραϋδροφουράνη	   ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"2057	Κατηγορία 3	Τριπροπυλενίου";
mostCurrent._clv2._addtextitem /*String*/ ("2057	Κατηγορία 3	Τριπροπυλενίου	   ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"2058	Κατηγορία 3	Βαλεραλδεΰδη";
mostCurrent._clv2._addtextitem /*String*/ ("2058	Κατηγορία 3	Βαλεραλδεΰδη	   ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"2059	Κατηγορία 3	Νιτροκυτταρίνη,";
mostCurrent._clv2._addtextitem /*String*/ ("2059	Κατηγορία 3	Νιτροκυτταρίνη, διάλυμα, εύφλεκτο με όχι λιγότερο από 12%",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"2074	Κατηγορία 6.1	Το ακρυλαμίδι";
mostCurrent._clv2._addtextitem /*String*/ ("2074	Κατηγορία 6.1	Το ακρυλαμίδιο , Στερεά	   ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"2075	Κατηγορία 6.1	Χλωράλη , άνυ";
mostCurrent._clv2._addtextitem /*String*/ ("2075	Κατηγορία 6.1	Χλωράλη , άνυδρο, αναστέλλεται	",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"2076	Κατηγορία 6.1	Κρεζόλες	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("2076	Κατηγορία 6.1	Κρεζόλες	   ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"2077	Κατηγορία 6.1	άλφα-ναφθιλαμ";
mostCurrent._clv2._addtextitem /*String*/ ("2077	Κατηγορία 6.1	άλφα-ναφθιλαμίνη	",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"2078	Κατηγορία 6.1	Διισοκυανικό";
mostCurrent._clv2._addtextitem /*String*/ ("2078	Κατηγορία 6.1	Διισοκυανικό τολουόλιο",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"2079	Κατηγορία 8	Diethylenetriam";
mostCurrent._clv2._addtextitem /*String*/ ("2079	Κατηγορία 8	Diethylenetriamine	 ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 261;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 262;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
