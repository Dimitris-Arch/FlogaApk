...
public class tessera2 extends Activity implements B4AActivity{
	public static tessera2 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.tessera2");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tessera2).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.tessera2");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.tessera2", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tessera2) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tessera2) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (tessera2) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 49;BA.debugLine="Activity.LoadLayout(\"tessera2.bal\")";
mostCurrent._activity.LoadLayout("tessera2.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,tessera2.getObject(),"clv2");
...
mostCurrent._panel2.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 126;BA.debugLine="clv2.DefaultTextBackgroundColor = Colors.Red";
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 4.2 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 4.2 ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"Εκρηκτικές ουσίες που αναδύουν τ";
mostCurrent._clv2._addtextitem /*String*/ ("Εκρηκτικές ουσίες που αναδύουν τοξικά αέρια κατά την καύση ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Κίνδυνος αυτανάφλεξης κατα την ε";
mostCurrent._clv2._addtextitem /*String*/ ("Κίνδυνος αυτανάφλεξης κατα την επαφή τους με τον ατμοσφαιρικό αέρα.Δεν απαιτείται θερμότητα ή φλόγα ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Κίνδυνος κατά την επαφή τους με";
mostCurrent._clv2._addtextitem /*String*/ ("Κίνδυνος κατά την επαφή τους με το νερό ",(Object)(""));
...
mostCurrent._clv2._addtextitem /*String*/ ("Η προσβολή γίνετε απο την πλευρά που φυσάει ο άνεμος.Πάντα με την πλάτη στον άνεμο.Καλυφθείτε απο κάποιο εμπόδιο,τοίχο,όχημα ανάχωμα κτλ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"Μήν διασκορπίζετε την πυρκαγιά μ";
mostCurrent._clv2._addtextitem /*String*/ ("Μήν διασκορπίζετε την πυρκαγιά με συμπαγή βολή,Αν είναι δυνατό καλύψτε με C02,ξηρά σκόνη ή αφρό",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"Κατάσβεση όλων των πηγών ανάφλεξ";
mostCurrent._clv2._addtextitem /*String*/ ("Κατάσβεση όλων των πηγών ανάφλεξης, ακόμα και τις μικρότερες.Επίσης πρέπει να επιχειρείται μείωση της θερμοκρασίας",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"Σταματήστε και απομακρυνθείτε εά";
mostCurrent._clv2._addtextitem /*String*/ ("Σταματήστε και απομακρυνθείτε εάν η φωτιά φτάσει στο βυτίο-δεξαμενή ή υπάρχει μεγάλη θερμοκρασία δίπλα που δεν εξουδετερώνεται ,υπάρχει μεγάλος κίνδυνος έκρηξης σε πολλές ουσίες της κατηγορίας",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"Προσπαθήστε να περιορίσετε την ε";
...
mostCurrent._pin1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 45;BA.debugLine="Dim Panel2 As Panel";
