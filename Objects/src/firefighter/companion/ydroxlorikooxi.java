...
public class ydroxlorikooxi extends Activity implements B4AActivity{
	public static ydroxlorikooxi mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.ydroxlorikooxi");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ydroxlorikooxi).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.ydroxlorikooxi");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.ydroxlorikooxi", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ydroxlorikooxi) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ydroxlorikooxi) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ydroxlorikooxi) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="Activity.LoadLayout(\"ydroxlorikooxi.bal\")";
mostCurrent._activity.LoadLayout("ydroxlorikooxi.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,ydroxlorikooxi.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"Το υδροχλωρικό οξύ UN-1789 είναι";
mostCurrent._clv2._addtextitem /*String*/ ("Το υδροχλωρικό οξύ UN-1789 είναι πνιγηρό,δηλητηριώδες.",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Είναι τοξικό και πολύ επικίνδυνο";
mostCurrent._clv2._addtextitem /*String*/ ("Είναι τοξικό και πολύ επικίνδυνο και για το περιβάλλον. Προκαλεί εγκαύματα με την επαφή. εισπνεόμενο προκαλλεί ακόμα και θάνατο.",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"ΧΡΗΣΙΜΟΠΟΙΗΣΤΕ ΣΤΟΛΗ ΧΗΜΙΚΗΣ ΠΡΟ";
mostCurrent._clv2._addtextitem /*String*/ ("ΧΡΗΣΙΜΟΠΟΙΗΣΤΕ ΣΤΟΛΗ ΧΗΜΙΚΗΣ ΠΡΟΣΤΑΣΙΑΣ ΚΛΕΙΣΤΟΥ ΤΥΠΟΥ ΜΕ ΠΛΗΡΗ ΑΠΟΜΟΝΩΣΗ.",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Σταματήστε τη διαρροή αν μπορεί";
mostCurrent._clv2._addtextitem /*String*/ ("Σταματήστε τη διαρροή αν μπορεί να γίνει με ασφάλεια.Αν αυτό δεν είναι δυνατό διασκορπίστε την διαρροή με βολή ομίχλης",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Το χλώριο σε ένωση με το υδρογόν";
mostCurrent._clv2._addtextitem /*String*/ ("Το χλώριο σε ένωση με το υδρογόνο δημιουργεί υδροχλώριο που παράγεται εκρηκτικά και είναι τοξικό .",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2 ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Πυροδυναμωτικα,δηλητηριώδη και τ";
mostCurrent._clv2._addtextitem /*String*/ ("Πυροδυναμωτικα,δηλητηριώδη και τοξικα. ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Σε χώρους που δεν αερίζονται υπά";
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 146;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 150;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 151;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 152;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 153;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 154;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 155;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 156;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 157;BA.debugLine="chk.Initialize(\"\")";
...
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 160;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 161;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 162;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 163;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 164;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 165;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 166;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 167;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 168;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 200;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub ili_Click";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 216;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 195;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 196;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 209;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 192;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub listabel_Click";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 185;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub ousialabel_Click";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Sub pixi_Click";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 204;BA.debugLine="StartActivity(\"simanseis\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 219;BA.debugLine="Sub simansi_Click";
