...
public class xilia700 extends Activity implements B4AActivity{
	public static xilia700 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.xilia700");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (xilia700).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.xilia700");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.xilia700", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (xilia700) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (xilia700) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (xilia700) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,xilia700.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 123;BA.debugLine="clv2.AddTextItem(\"1601	ΚΑΤΗΓΟΡΙΑ 6.1	Απολυμαντικά";
mostCurrent._clv2._addtextitem /*String*/ ("1601	ΚΑΤΗΓΟΡΙΑ 6.1	Απολυμαντικά , στερεά, τοξικά, ",(Object)(""));
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"1602	ΚΑΤΗΓΟΡΙΑ 6.1	Βαφές , υγρά,";
mostCurrent._clv2._addtextitem /*String*/ ("1602	ΚΑΤΗΓΟΡΙΑ 6.1	Βαφές , υγρά, τοξικά	   ",(Object)(""));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"1603	ΚΑΤΗΓΟΡΙΑ 6.1	Αιθυλ βρωμοοξ";
mostCurrent._clv2._addtextitem /*String*/ ("1603	ΚΑΤΗΓΟΡΙΑ 6.1	Αιθυλ βρωμοοξικό	   ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"1604	ΚΑΤΗΓΟΡΙΑ 8	Αιθυλενοδιαμίνη";
mostCurrent._clv2._addtextitem /*String*/ ("1604	ΚΑΤΗΓΟΡΙΑ 8	Αιθυλενοδιαμίνης	   ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"1605	ΚΑΤΗΓΟΡΙΑ 6.1	Αιθυλενοδιβρω";
mostCurrent._clv2._addtextitem /*String*/ ("1605	ΚΑΤΗΓΟΡΙΑ 6.1	Αιθυλενοδιβρωμιδίου	   ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"1606	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικός σίδ";
mostCurrent._clv2._addtextitem /*String*/ ("1606	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικός σίδηρος	   ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"1607	ΚΑΤΗΓΟΡΙΑ 6.1	Σίδηρος arsen";
mostCurrent._clv2._addtextitem /*String*/ ("1607	ΚΑΤΗΓΟΡΙΑ 6.1	Σίδηρος arsenite	   ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"1608	ΚΑΤΗΓΟΡΙΑ 6.1	Σιδηρούχα Αρσ";
mostCurrent._clv2._addtextitem /*String*/ ("1608	ΚΑΤΗΓΟΡΙΑ 6.1	Σιδηρούχα Αρσενικικό	   ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"1611	ΚΑΤΗΓΟΡΙΑ 6.1	Hexaethyl τετ";
mostCurrent._clv2._addtextitem /*String*/ ("1611	ΚΑΤΗΓΟΡΙΑ 6.1	Hexaethyl τετραφωσφορεστέρα 	   ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"1612	ΚΑΤΗΓΟΡΙΑ 2	Hexaethyl τετρα";
mostCurrent._clv2._addtextitem /*String*/ ("1612	ΚΑΤΗΓΟΡΙΑ 2	Hexaethyl τετραφωσφορικό και μείγματα    ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"1613	ΚΑΤΗΓΟΡΙΑ 6.1	Υδροκυάνιο \",";
mostCurrent._clv2._addtextitem /*String*/ ("1613	ΚΑΤΗΓΟΡΙΑ 6.1	Υδροκυάνιο ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"1614	ΚΑΤΗΓΟΡΙΑ 6.1	Υδροκυάνιο ,";
mostCurrent._clv2._addtextitem /*String*/ ("1614	ΚΑΤΗΓΟΡΙΑ 6.1	Υδροκυάνιο , σταθεροποιημένο   ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"1616	ΚΑΤΗΓΟΡΙΑ 6.1	Οξικός μόλυβδ";
mostCurrent._clv2._addtextitem /*String*/ ("1616	ΚΑΤΗΓΟΡΙΑ 6.1	Οξικός μόλυβδος	   ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"1617	ΚΑΤΗΓΟΡΙΑ 6.1	Μόλυβδος αρσε";
mostCurrent._clv2._addtextitem /*String*/ ("1617	ΚΑΤΗΓΟΡΙΑ 6.1	Μόλυβδος αρσενικικών	   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"1618	ΚΑΤΗΓΟΡΙΑ 6.1	Μόλυβδος αρσε";
mostCurrent._clv2._addtextitem /*String*/ ("1618	ΚΑΤΗΓΟΡΙΑ 6.1	Μόλυβδος αρσενιάτες	   ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"1620	ΚΑΤΗΓΟΡΙΑ 6.1	Μόλυβδος κυαν";
mostCurrent._clv2._addtextitem /*String*/ ("1620	ΚΑΤΗΓΟΡΙΑ 6.1	Μόλυβδος κυανίου	   ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"1621	ΚΑΤΗΓΟΡΙΑ 6.1	Λονδίνο μωβ";
mostCurrent._clv2._addtextitem /*String*/ ("1621	ΚΑΤΗΓΟΡΙΑ 6.1	Λονδίνο μωβ	   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"1622	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικικό μα";
mostCurrent._clv2._addtextitem /*String*/ ("1622	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικικό μαγνήσιο	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"1623	ΚΑΤΗΓΟΡΙΑ 6.1	Υδράργυρος Αρ";
mostCurrent._clv2._addtextitem /*String*/ ("1623	ΚΑΤΗΓΟΡΙΑ 6.1	Υδράργυρος Αρσενικικό	   ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"1624	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωριούχο υδρ";
mostCurrent._clv2._addtextitem /*String*/ ("1624	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωριούχο υδράργυρο	   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"1625	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτρικό υδράρ";
mostCurrent._clv2._addtextitem /*String*/ ("1625	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτρικό υδράργυρο	   ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"1626	ΚΑΤΗΓΟΡΙΑ 6.1	Υδραργύρου κυ";
mostCurrent._clv2._addtextitem /*String*/ ("1626	ΚΑΤΗΓΟΡΙΑ 6.1	Υδραργύρου κυανιούχο κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"1627	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτρικού υδρα";
mostCurrent._clv2._addtextitem /*String*/ ("1627	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτρικού υδραργύρου	   ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"1629	ΚΑΤΗΓΟΡΙΑ 6.1	Από οξικό υδρ";
mostCurrent._clv2._addtextitem /*String*/ ("1629	ΚΑΤΗΓΟΡΙΑ 6.1	Από οξικό υδράργυρο	   ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"1630	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1630	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος χλωριούχο αμμώνιο	",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"1631	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1631	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος βενζοϊκό	   ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"1634	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1634	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος βρωμιούχα	   ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"1636	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1636	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος κυανίου	",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"1637	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1637	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος γλυκονικό	   ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"1638	ΚΑΤΗΓΟΡΙΑ 6.1	Ιωδιούχο υδρά";
mostCurrent._clv2._addtextitem /*String*/ ("1638	ΚΑΤΗΓΟΡΙΑ 6.1	Ιωδιούχο υδράργυρος 	   ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"1639	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1639	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος nucleate	   ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"1640	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1640	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος ελαϊκό	   ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"1641	ΚΑΤΗΓΟΡΙΑ 6.1	Οξειδίου  υδρ";
mostCurrent._clv2._addtextitem /*String*/ ("1641	ΚΑΤΗΓΟΡΙΑ 6.1	Οξειδίου  υδραργύρου	   ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"1642	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1642	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος οξυκυανιούχος	   ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"1643 	ΚΑΤΗΓΟΡΙΑ 6.1	Ιωδιούχο κάλ";
mostCurrent._clv2._addtextitem /*String*/ ("1643 	ΚΑΤΗΓΟΡΙΑ 6.1	Ιωδιούχο κάλιο υδράργυρος	   ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"1644	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1644	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος σαλικυλικό	   ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"1645	ΚΑΤΗΓΟΡΙΑ 6.1	Θειικά υδράργ";
mostCurrent._clv2._addtextitem /*String*/ ("1645	ΚΑΤΗΓΟΡΙΑ 6.1	Θειικά υδράργυρος	   ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"1646	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος";
mostCurrent._clv2._addtextitem /*String*/ ("1646	ΚΑΤΗΓΟΡΙΑ 6.1	Ο υδράργυρος θειοκυανικός	   ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"1647	ΚΑΤΗΓΟΡΙΑ 6.1	Το βρωμιούχο";
mostCurrent._clv2._addtextitem /*String*/ ("1647	ΚΑΤΗΓΟΡΙΑ 6.1	Το βρωμιούχο μεθύλιο και αιθυλενοδιβρωμίδιο μείγματα   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"1648	ΚΑΤΗΓΟΡΙΑ 3	Ακετονιτρίλιο";
mostCurrent._clv2._addtextitem /*String*/ ("1648	ΚΑΤΗΓΟΡΙΑ 3	Ακετονιτρίλιο	   ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"1649	ΚΑΤΗΓΟΡΙΑ 6.1	Motor καυσίμο";
mostCurrent._clv2._addtextitem /*String*/ ("1649	ΚΑΤΗΓΟΡΙΑ 6.1	Motor καυσίμου μείγματα    ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"1650	ΚΑΤΗΓΟΡΙΑ 6.1	βήτα-ναφθιλαμ";
mostCurrent._clv2._addtextitem /*String*/ ("1650	ΚΑΤΗΓΟΡΙΑ 6.1	βήτα-ναφθιλαμίνη	   ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"1651	ΚΑΤΗΓΟΡΙΑ 6.1	Ναφθυλοθειοου";
mostCurrent._clv2._addtextitem /*String*/ ("1651	ΚΑΤΗΓΟΡΙΑ 6.1	Ναφθυλοθειοουρία	   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"1652	ΚΑΤΗΓΟΡΙΑ 6.1	Ναφθυλουρίας";
mostCurrent._clv2._addtextitem /*String*/ ("1652	ΚΑΤΗΓΟΡΙΑ 6.1	Ναφθυλουρίας	   ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"1653	ΚΑΤΗΓΟΡΙΑ 6.1	Νικέλιο κυανί";
mostCurrent._clv2._addtextitem /*String*/ ("1653	ΚΑΤΗΓΟΡΙΑ 6.1	Νικέλιο κυανίου	   ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"1654	ΚΑΤΗΓΟΡΙΑ 6.1	Νικοτίνη	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("1654	ΚΑΤΗΓΟΡΙΑ 6.1	Νικοτίνη	   ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"1655	ΚΑΤΗΓΟΡΙΑ 6.1	Νικοτίνη ενώσ";
mostCurrent._clv2._addtextitem /*String*/ ("1655	ΚΑΤΗΓΟΡΙΑ 6.1	Νικοτίνη ενώσεις	   ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"1656	ΚΑΤΗΓΟΡΙΑ 6.1	Υδροχλωρική ν";
mostCurrent._clv2._addtextitem /*String*/ ("1656	ΚΑΤΗΓΟΡΙΑ 6.1	Υδροχλωρική νικοτίνη ή διάλυμα υδροχλωρικής νικοτίνης	   ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"1657	ΚΑΤΗΓΟΡΙΑ 6.1	Σαλικυλική νι";
mostCurrent._clv2._addtextitem /*String*/ ("1657	ΚΑΤΗΓΟΡΙΑ 6.1	Σαλικυλική νικοτίνη	   ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"1658	ΚΑΤΗΓΟΡΙΑ 6.1	Θειική νικοτί";
mostCurrent._clv2._addtextitem /*String*/ ("1658	ΚΑΤΗΓΟΡΙΑ 6.1	Θειική νικοτίνη , στερεά ή θειική νικοτίνη, διάλυμα	   ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"1659	ΚΑΤΗΓΟΡΙΑ 6.1	Τρυγική νικοτ";
mostCurrent._clv2._addtextitem /*String*/ ("1659	ΚΑΤΗΓΟΡΙΑ 6.1	Τρυγική νικοτίνη	   ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"1660	ΚΑΤΗΓΟΡΙΑ 2	Οξείδιο  αζώ ,";
mostCurrent._clv2._addtextitem /*String*/ ("1660	ΚΑΤΗΓΟΡΙΑ 2	Οξείδιο  αζώ , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"1661	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτροανιλινών";
mostCurrent._clv2._addtextitem /*String*/ ("1661	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτροανιλινών  ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"1662	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτροβενζόλιο";
mostCurrent._clv2._addtextitem /*String*/ ("1662	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτροβενζόλιο	   ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"1663	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτροφαινολών";
mostCurrent._clv2._addtextitem /*String*/ ("1663	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτροφαινολών 	   ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"1664	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτροτολουόλι";
mostCurrent._clv2._addtextitem /*String*/ ("1664	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτροτολουόλια 	   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"1665	ΚΑΤΗΓΟΡΙΑ 6.1	Nitroxylenes";
mostCurrent._clv2._addtextitem /*String*/ ("1665	ΚΑΤΗΓΟΡΙΑ 6.1	Nitroxylenes	   ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"1669	ΚΑΤΗΓΟΡΙΑ 6.1	Πενταχλωροαιθ";
mostCurrent._clv2._addtextitem /*String*/ ("1669	ΚΑΤΗΓΟΡΙΑ 6.1	Πενταχλωροαιθάνιο	   ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"1670	ΚΑΤΗΓΟΡΙΑ 6.1	Υπερχλωρομεθύ";
mostCurrent._clv2._addtextitem /*String*/ ("1670	ΚΑΤΗΓΟΡΙΑ 6.1	Υπερχλωρομεθύλιο μερκαπτάνη",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"1671	ΚΑΤΗΓΟΡΙΑ 6.1	Η φαινόλη , σ";
mostCurrent._clv2._addtextitem /*String*/ ("1671	ΚΑΤΗΓΟΡΙΑ 6.1	Η φαινόλη , στερεά	   ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"1672	ΚΑΤΗΓΟΡΙΑ 6.1	Phenylcarbyla";
mostCurrent._clv2._addtextitem /*String*/ ("1672	ΚΑΤΗΓΟΡΙΑ 6.1	Phenylcarbylamine χλωριούχο	   ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"1673	ΚΑΤΗΓΟΡΙΑ 6.1	Φαινυλενοδιαμ";
mostCurrent._clv2._addtextitem /*String*/ ("1673	ΚΑΤΗΓΟΡΙΑ 6.1	Φαινυλενοδιαμίνες	   ",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"1674	ΚΑΤΗΓΟΡΙΑ 6.1	Οξικός φαινυλ";
mostCurrent._clv2._addtextitem /*String*/ ("1674	ΚΑΤΗΓΟΡΙΑ 6.1	Οξικός φαινυλυδράργυρος	   ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"1677	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικικό κά";
mostCurrent._clv2._addtextitem /*String*/ ("1677	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικικό κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"1678	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικικώδου";
mostCurrent._clv2._addtextitem /*String*/ ("1678	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικικώδους κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"1679	ΚΑΤΗΓΟΡΙΑ 6.1	Cuprocyanide";
mostCurrent._clv2._addtextitem /*String*/ ("1679	ΚΑΤΗΓΟΡΙΑ 6.1	Cuprocyanide κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"1680	ΚΑΤΗΓΟΡΙΑ 6.1	Κυανιούχο κάλ";
mostCurrent._clv2._addtextitem /*String*/ ("1680	ΚΑΤΗΓΟΡΙΑ 6.1	Κυανιούχο κάλιο	   ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"1683	ΚΑΤΗΓΟΡΙΑ 6.1	Ασημένια arse";
mostCurrent._clv2._addtextitem /*String*/ ("1683	ΚΑΤΗΓΟΡΙΑ 6.1	Ασημένια arsenite	   ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"1684	ΚΑΤΗΓΟΡΙΑ 6.1	Κυανιούχου αρ";
mostCurrent._clv2._addtextitem /*String*/ ("1684	ΚΑΤΗΓΟΡΙΑ 6.1	Κυανιούχου αργύρου	   ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"1685	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικικού ν";
mostCurrent._clv2._addtextitem /*String*/ ("1685	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικικού νατρίου	   ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"1686	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικώδες ν";
mostCurrent._clv2._addtextitem /*String*/ ("1686	ΚΑΤΗΓΟΡΙΑ 6.1	Αρσενικώδες νάτριο , υδατικά διαλύματα	   ",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"1687	ΚΑΤΗΓΟΡΙΑ 6.1	Το αζίδιο  να";
mostCurrent._clv2._addtextitem /*String*/ ("1687	ΚΑΤΗΓΟΡΙΑ 6.1	Το αζίδιο  νατρίου	   ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"1688	ΚΑΤΗΓΟΡΙΑ 6.1	Κακοδυλικό νά";
mostCurrent._clv2._addtextitem /*String*/ ("1688	ΚΑΤΗΓΟΡΙΑ 6.1	Κακοδυλικό νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"1689	ΚΑΤΗΓΟΡΙΑ 6.1	Κυανιούχο νάτ";
mostCurrent._clv2._addtextitem /*String*/ ("1689	ΚΑΤΗΓΟΡΙΑ 6.1	Κυανιούχο νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"1690	ΚΑΤΗΓΟΡΙΑ 6.1	Φθοριούχο νάτ";
mostCurrent._clv2._addtextitem /*String*/ ("1690	ΚΑΤΗΓΟΡΙΑ 6.1	Φθοριούχο νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"1691	ΚΑΤΗΓΟΡΙΑ 6.1	Στρόντιο αρσε";
mostCurrent._clv2._addtextitem /*String*/ ("1691	ΚΑΤΗΓΟΡΙΑ 6.1	Στρόντιο αρσενιατικού	   ",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"1692	ΚΑΤΗΓΟΡΙΑ 6.1	Στρυχνίνη ή σ";
mostCurrent._clv2._addtextitem /*String*/ ("1692	ΚΑΤΗΓΟΡΙΑ 6.1	Στρυχνίνη ή στρυχνίνη άλατα	   ",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="clv2.AddTextItem(\"1693	ΚΑΤΗΓΟΡΙΑ 6.1	Δακρυγόνα ουσ";
mostCurrent._clv2._addtextitem /*String*/ ("1693	ΚΑΤΗΓΟΡΙΑ 6.1	Δακρυγόνα ουσίες, υγρά 	   ",(Object)(""));
 //BA.debugLineNum = 201;BA.debugLine="clv2.AddTextItem(\"1694	ΚΑΤΗΓΟΡΙΑ 6.1	Βρωμοβενζυλο";
mostCurrent._clv2._addtextitem /*String*/ ("1694	ΚΑΤΗΓΟΡΙΑ 6.1	Βρωμοβενζυλο κυανιούχα    ",(Object)(""));
 //BA.debugLineNum = 202;BA.debugLine="clv2.AddTextItem(\"1695	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωροακετόνης";
mostCurrent._clv2._addtextitem /*String*/ ("1695	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωροακετόνης , σταθεροποιημένο	",(Object)(""));
 //BA.debugLineNum = 203;BA.debugLine="clv2.AddTextItem(\"1697	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωροακετοφαι";
mostCurrent._clv2._addtextitem /*String*/ ("1697	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωροακετοφαινόνης 	   ",(Object)(""));
 //BA.debugLineNum = 204;BA.debugLine="clv2.AddTextItem(\"1698	ΚΑΤΗΓΟΡΙΑ 6.1	Diphenylamine";
mostCurrent._clv2._addtextitem /*String*/ ("1698	ΚΑΤΗΓΟΡΙΑ 6.1	Diphenylaminechloroarsine	   ",(Object)(""));
 //BA.debugLineNum = 205;BA.debugLine="clv2.AddTextItem(\"1699	ΚΑΤΗΓΟΡΙΑ 6.1	Diphenylchlor";
mostCurrent._clv2._addtextitem /*String*/ ("1699	ΚΑΤΗΓΟΡΙΑ 6.1	Diphenylchloroarsine	",(Object)(""));
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 209;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 213;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 214;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 215;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 216;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 217;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 218;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 219;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 220;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 221;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 222;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 223;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 224;BA.debugLine="lbl.Text = Text";
...
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 227;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 228;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 229;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 230;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
