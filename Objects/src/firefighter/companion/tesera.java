...
public class tesera extends Activity implements B4AActivity{
	public static tesera mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.tesera");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tesera).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.tesera");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.tesera", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tesera) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tesera) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (tesera) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 52;BA.debugLine="Activity.LoadLayout(\"teserabal.bal\")";
mostCurrent._activity.LoadLayout("teserabal.bal",mostCurrent.activityBA);
...
mostCurrent._mple.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 111;BA.debugLine="pin1.BringToFront";
mostCurrent._pin1.BringToFront();
 //BA.debugLineNum = 124;BA.debugLine="clv2.Initialize(Me, \"clv2\")";
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,tesera.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 4.1 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 4.1 ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Πολύ εύφλεκτα στερεά, εκρηκτικά";
mostCurrent._clv2._addtextitem /*String*/ ("Πολύ εύφλεκτα στερεά, εκρηκτικά ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Κίνδυνος ανάφλεξης με τριβή με θ";
mostCurrent._clv2._addtextitem /*String*/ ("Κίνδυνος ανάφλεξης με τριβή με θερμότητα ή ακτινοβολία",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Πιθανή αυτανάφλεξη\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Πιθανή αυτανάφλεξη",(Object)(""));
