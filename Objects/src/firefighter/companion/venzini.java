...
public class venzini extends Activity implements B4AActivity{
	public static venzini mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.venzini");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (venzini).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.venzini");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.venzini", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (venzini) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (venzini) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (venzini) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._simansi.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (45),mostCurrent.activityBA));
 //BA.debugLineNum = 58;BA.debugLine="pin1.BringToFront";
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,venzini.getObject(),"clv2");
...
mostCurrent._panel2.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 129;BA.debugLine="clv2.DefaultTextBackgroundColor = Colors.DarkGray";
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 3 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 3 ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"H βενζίνη UN-1203 είναι μίγμα υ";
mostCurrent._clv2._addtextitem /*String*/ ("H βενζίνη UN-1203 είναι μίγμα υδρογονανθράκων μαζί με διάφορες προσθήκες.",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Πολύ διαδεδομένη ουσία.\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Πολύ διαδεδομένη ουσία.",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Η βενζίνη και οι ατμοί της ειναι";
mostCurrent._clv2._addtextitem /*String*/ ("Η βενζίνη και οι ατμοί της ειναι εξαιρετικά εύφλεκτη  ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"Κίνδυνος ανάφλεξης από σπινθήρα";
mostCurrent._clv2._addtextitem /*String*/ ("Κίνδυνος ανάφλεξης από σπινθήρα ή στατικό ηλεκτρισμό.",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"Προσπαθήστε απομόνωση των αερίων";
mostCurrent._clv2._addtextitem /*String*/ ("Προσπαθήστε απομόνωση των αερίων απο το οξυγόνο καλύπτοντας με αφρό",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"Έκρηξη σε περίπτωση διαρροής. \",";
mostCurrent._clv2._addtextitem /*String*/ ("Έκρηξη σε περίπτωση διαρροής. ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑ";
mostCurrent._clv2._addtextitem /*String*/ ("ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑΣ.Αυλοί οροφής,εδάφους  ή άλλοι τηλεκατευθυνόμενοι έιναι ιδανικοί",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"Άμεσος αποκλεισμός του χώρου σε";
mostCurrent._clv2._addtextitem /*String*/ ("Άμεσος αποκλεισμός του χώρου σε απόσταση 100 εώς 800 μέτρων σε μικρή πυρκαγιά και σε περίπτωση μεγάλης απόσταση 1600 μέτρων",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράν";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράνος,περισκελίδα,επενδύτη,γαντια και αναπνευστική συσκευή",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"Φορέστε στολή χημικής προστασίας";
...
mostCurrent._clv2._addtextitem /*String*/ ("Τα εργαλεία που χρησιμοποιούνται δεν θα πρέπει να προκαλούν σπινθήρες ή στατικό ηλεκτρισμό.Μην χρησιμοποιείτε κοντά στην φωτιά κινητά τηλέφωνα ή ασύρματο",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Η προσβολή γίνεται απο την πλευρ";
...
public static String  _ad_adscreendismissed() throws Exception{
 //BA.debugLineNum = 237;BA.debugLine="Sub Ad_AdScreenDismissed";
 //BA.debugLineNum = 238;BA.debugLine="Log(\"screen dismissed\")";
anywheresoftware.b4a.keywords.Common.LogImpl("759441153","screen dismissed",0);
 //BA.debugLineNum = 239;BA.debugLine="End Sub";
return "";
}
public static String  _ad_failedtoreceivead(String _errorcode) throws Exception{
 //BA.debugLineNum = 231;BA.debugLine="Sub Ad_FailedToReceiveAd (ErrorCode As String)";
 //BA.debugLineNum = 232;BA.debugLine="Log(\"failed: \" & ErrorCode)";
anywheresoftware.b4a.keywords.Common.LogImpl("759310081","failed: "+_errorcode,0);
 //BA.debugLineNum = 233;BA.debugLine="End Sub";
return "";
}
public static String  _ad_receivead() throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Sub Ad_ReceiveAd";
 //BA.debugLineNum = 235;BA.debugLine="Log(\"received\")";
anywheresoftware.b4a.keywords.Common.LogImpl("759375617","received",0);
 //BA.debugLineNum = 236;BA.debugLine="End Sub";
return "";
}
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 156;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 159;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 160;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 161;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 162;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 163;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 164;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 165;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 166;BA.debugLine="chk.Initialize(\"\")";
...
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 169;BA.debugLine="lbl.Gravity = Bit.OR(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 170;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 171;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 172;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 173;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 174;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 175;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 176;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
...
mostCurrent._clv2 = new firefighter.companion.customlistview();
 //BA.debugLineNum = 43;BA.debugLine="Dim Panel2 As Panel";
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 44;BA.debugLine="End Sub";
return "";
}
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 209;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 190;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 191;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 192;BA.debugLine="End Sub";
return "";
}
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 222;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 223;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 224;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 205;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 217;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
 //BA.debugLineNum = 218;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 201;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 213;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 214;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
 //BA.debugLineNum = 215;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 194;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 219;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 220;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 //BA.debugLineNum = 221;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 196;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 197;BA.debugLine="StartActivity(\"pixida\")";
