...
public class searchun extends Activity implements B4AActivity{
	public static searchun mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.searchun");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (searchun).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.searchun");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.searchun", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (searchun) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (searchun) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (searchun) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._delete.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 118;BA.debugLine="sv.Initialize(Me, \"sv\")";
mostCurrent._sv._initialize /*String*/ (mostCurrent.activityBA,searchun.getObject(),"sv");
 //BA.debugLineNum = 119;BA.debugLine="sv.AddToParent(Activity, 3%x, 33%y,94%x ,57.5%y)";
...
if (_firsttime) { 
 //BA.debugLineNum = 122;BA.debugLine="Dim cities As List";
_cities = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 123;BA.debugLine="cities = File.ReadList(File.DirAssets, \"uns.txt\"";
_cities = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"uns.txt");
 //BA.debugLineNum = 124;BA.debugLine="index = sv.SetItems(cities)";
_index = mostCurrent._sv._setitems /*Object*/ (_cities);
 }else {
 //BA.debugLineNum = 126;BA.debugLine="sv.SetIndex(index)";
...
public static String  _delete_click() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Sub delete_Click";
 //BA.debugLineNum = 198;BA.debugLine="sv.ClearSearchBox";
mostCurrent._sv._clearsearchbox /*String*/ ();
 //BA.debugLineNum = 199;BA.debugLine="StartActivity(searchunDELL)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._searchundell.getObject()));
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 165;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 167;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 148;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 149;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 183;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 184;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 162;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 163;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 177;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
 //BA.debugLineNum = 178;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 159;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 173;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 174;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
 //BA.debugLineNum = 175;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 151;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 152;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 180;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 //BA.debugLineNum = 181;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 154;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 155;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 171;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 172;BA.debugLine="End Sub";
return "";
}
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub simansi_Click";
...
public static String  _sv_itemclick(String _value) throws Exception{
 //BA.debugLineNum = 134;BA.debugLine="Sub sv_ItemClick(Value As String)";
 //BA.debugLineNum = 135;BA.debugLine="ToastMessageShow(Value, True)";
