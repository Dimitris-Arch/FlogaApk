...
public class pnigmos extends Activity implements B4AActivity{
	public static pnigmos mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.pnigmos");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (pnigmos).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.pnigmos");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.pnigmos", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (pnigmos) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (pnigmos) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (pnigmos) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="Activity.LoadLayout(\"pnigmos.bal\")";
mostCurrent._activity.LoadLayout("pnigmos.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,pnigmos.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Σε περίπτωση πνιγμού το θύμα";
mostCurrent._clv2._addtextitem /*String*/ ("Σε περίπτωση πνιγμού το θύμα δεν μπορεί βήξει , να μιλήσει ή να αναπνεύσει",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Μετά τον έλεγχο της σκηνής και τ";
mostCurrent._clv2._addtextitem /*String*/ ("Μετά τον έλεγχο της σκηνής και του τραυματισμένού ή άρρωστο άτομο.Ζητήστε από κάποιον να καλέσει το 166 .",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Προσπαθήστε να δείτε εάν είναι δ";
mostCurrent._clv2._addtextitem /*String*/ ("Προσπαθήστε να δείτε εάν είναι δυνατόν να απομακρυνθεί το αντικείμενο που φράζει τον αεραγωγό, με τα δάχτυλα και με προσοχή να μην εισχωρήσει βαθύτερα το αντικείμενο ή σας κάνει ζήμία στα δάχτυλα,σε περίπτωση που σφίξει τα δόντια του",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Εάν δεν έχει καθαρίσει ο αεραγωγ";
mostCurrent._clv2._addtextitem /*String*/ ("Εάν δεν έχει καθαρίσει ο αεραγωγός, αγκαλιάστε το θύμα απο την πλάτη με το ένα χέρι να πίανει τον ώμο και το άλλο ελέυθερο",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Λυγίστε το πρόσωπο προς τα εμπρό";
mostCurrent._clv2._addtextitem /*String*/ ("Λυγίστε το πρόσωπο προς τα εμπρός στη μέση και κάντε 5 χτυπήματα μεταξύ του ώμου με το κάτω μέρος της παλάμης,στην βάση του αντίχειρα .",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Έπειτα αγγαλίαστε με τα δύο χέρι";
mostCurrent._clv2._addtextitem /*String*/ ("Έπειτα αγγαλίαστε με τα δύο χέρια στο ύψος του αφαλού",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"■ Κλείστε την γροθιά σας και με";
mostCurrent._clv2._addtextitem /*String*/ ("■ Κλείστε την γροθιά σας και με την εσωτερική πλευρά .",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"■ Καλύψτε τη γροθιά σας με το άλ";
mostCurrent._clv2._addtextitem /*String*/ ("■ Καλύψτε τη γροθιά σας με το άλλο χέρι.",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"■ Δώστε 5 γρήγορες , ανοδικές ωθ";
mostCurrent._clv2._addtextitem /*String*/ ("■ Δώστε 5 γρήγορες , ανοδικές ωθήσεις στην κοιλιά του ατόμου, λίγο πάνω από τον ομφαλό ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"ΔΕΝ ΣΤΑΜΑΤΑΜΕ, παρά μόνο στις ακ";
mostCurrent._clv2._addtextitem /*String*/ ("ΔΕΝ ΣΤΑΜΑΤΑΜΕ, παρά μόνο στις ακόλουθες περιπτώσεις",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"■Το αντικειμένο να βγεί έξω .\",";
mostCurrent._clv2._addtextitem /*String*/ ("■Το αντικειμένο να βγεί έξω .",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"■Το άτομο μπορεί να βήξει δυνατά";
mostCurrent._clv2._addtextitem /*String*/ ("■Το άτομο μπορεί να βήξει δυνατά ή να αναπνεύσει .",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"■ Το θύμα χάσει τις αισθήσεις το";
mostCurrent._clv2._addtextitem /*String*/ ("■ Το θύμα χάσει τις αισθήσεις του ",(Object)(""));
...
mostCurrent._textpin6 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 43;BA.debugLine="Private ImageView0 As ImageView";
...
mostCurrent._imageview2 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 46;BA.debugLine="Private ImageView3 As ImageView";
mostCurrent._imageview3 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 47;BA.debugLine="Private ImageView4 As ImageView";
mostCurrent._imageview4 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 48;BA.debugLine="Private ImageView5 As ImageView";
mostCurrent._imageview5 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 49;BA.debugLine="Private ImageView6 As ImageView";
mostCurrent._imageview6 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 50;BA.debugLine="Private ImageView7 As ImageView";
mostCurrent._imageview7 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 51;BA.debugLine="Private ImageView8 As ImageView";
mostCurrent._imageview8 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 52;BA.debugLine="Private ImageView9 As ImageView";
mostCurrent._imageview9 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 58;BA.debugLine="Dim clv2 As CustomListView";
mostCurrent._clv2 = new firefighter.companion.customlistview();
 //BA.debugLineNum = 60;BA.debugLine="Dim Panel2 As Panel";
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 64;BA.debugLine="End Sub";
return "";
}
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 190;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 192;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 173;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 174;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 208;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
 //BA.debugLineNum = 209;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 188;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 201;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(\"thlefona\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 199;BA.debugLine="StartActivity(\"thlefona\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("thlefona"));
 //BA.debugLineNum = 200;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 177;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub ousialabel_Click";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Sub pixi_Click";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 195;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 196;BA.debugLine="StartActivity(\"karpa\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 210;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 211;BA.debugLine="StartActivity(\"karpa\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("karpa"));
