...
public class listaousies extends Activity implements B4AActivity{
	public static listaousies mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.listaousies");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (listaousies).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.listaousies");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.listaousies", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (listaousies) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (listaousies) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (listaousies) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 42;BA.debugLine="Activity.LoadLayout(\"sadr.bal\")";
mostCurrent._activity.LoadLayout("sadr.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,listaousies.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 0000 εώς 0100\" ,";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 0000 εώς 0100",(Object)("miden100"));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 0100 εώς 0200\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 0100 εώς 0200",(Object)("miden200"));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 0200 εώς 0300\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 0200 εώς 0300",(Object)("miden300"));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 0300 εώς 0400\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 0300 εώς 0400",(Object)("miden400"));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 0400 εώς 0500\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 0400 εώς 0500",(Object)("miden500"));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 0500 εώς 0600\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 0500 εώς 0600",(Object)("miden600"));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1000 εώς 1100\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1000 εώς 1100",(Object)("xilia100"));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1100 εώς 1200\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1100 εώς 1200",(Object)("xilia200"));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1200 εώς 1300\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1200 εώς 1300",(Object)("xilia300"));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1300 εώς 1400\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1300 εώς 1400",(Object)("xilia400"));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1400 εώς 1500\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1400 εώς 1500",(Object)("xilia500"));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1500 εώς 1600\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1500 εώς 1600",(Object)("xilia600"));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1600 εώς 1700\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1600 εώς 1700",(Object)("xilia700"));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1700 εώς 1800\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1700 εώς 1800",(Object)("xilia800"));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1800 εώς 1900\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1800 εώς 1900",(Object)("xilia900"));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 1900 εώς 2000\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 1900 εώς 2000",(Object)("xilia1000"));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2000 εώς 2100\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2000 εώς 2100",(Object)("dyoxil100"));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2100 εώς 2200\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2100 εώς 2200",(Object)("dyoxil200"));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2200 εώς 2300\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2200 εώς 2300",(Object)("dyoxil300"));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2300 εώς 2400\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2300 εώς 2400",(Object)("dyoxil400"));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2400 εώς 2500\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2400 εώς 2500",(Object)("dyoxil500"));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2500 εώς 2600\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2500 εώς 2600",(Object)("dyoxil600"));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2600 εώς 2700\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2600 εώς 2700",(Object)("dyoxil700"));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2700 εώς 2800\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2700 εώς 2800",(Object)("dyoxil800"));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2800 εώς 2900\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2800 εώς 2900",(Object)("dyoxil900"));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 2900 εώς 3000\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 2900 εώς 3000",(Object)("dyoxil1000"));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 3000 εώς 3100\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 3000 εώς 3100",(Object)("triaxil100"));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 3100 εώς 3200\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 3100 εώς 3200",(Object)("triaxil200"));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 3200 εώς 3300\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 3200 εώς 3300",(Object)("triaxil300"));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 3300 εώς 3400\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 3300 εώς 3400",(Object)("triaxil400"));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 3400 εώς 3500\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 3400 εώς 3500",(Object)("triaxil500"));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"Αριθμοί UN απο 3500 εώς 3600\" ,\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αριθμοί UN απο 3500 εώς 3600",(Object)("triaxil600"));
 //BA.debugLineNum = 158;BA.debugLine="simanseislabel.BringToFront";
mostCurrent._simanseislabel.BringToFront();
 //BA.debugLineNum = 159;BA.debugLine="listabel.BringToFront";
mostCurrent._listabel.BringToFront();
 //BA.debugLineNum = 160;BA.debugLine="katigorlabel.BringToFront";
mostCurrent._katigorlabel.BringToFront();
 //BA.debugLineNum = 161;BA.debugLine="ousialabel.BringToFront";
mostCurrent._ousialabel.BringToFront();
 //BA.debugLineNum = 162;BA.debugLine="ililabel.BringToFront";
...
public static String  _clv2_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 168;BA.debugLine="Sub clv2_ItemClick (index As Int, Value As Object)";
 //BA.debugLineNum = 172;BA.debugLine="If Value =\"miden100\" Then";
if ((_value).equals((Object)("miden100"))) { 
 //BA.debugLineNum = 173;BA.debugLine="StartActivity(\"miden100\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("miden100"));
 };
 //BA.debugLineNum = 176;BA.debugLine="If Value = \"miden200\" Then";
if ((_value).equals((Object)("miden200"))) { 
 //BA.debugLineNum = 177;BA.debugLine="StartActivity(\"miden200\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("miden200"));
 };
 //BA.debugLineNum = 179;BA.debugLine="If Value = \"miden300\" Then";
if ((_value).equals((Object)("miden300"))) { 
 //BA.debugLineNum = 180;BA.debugLine="StartActivity(\"miden300\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("miden300"));
 };
 //BA.debugLineNum = 182;BA.debugLine="If Value = \"miden400\" Then";
if ((_value).equals((Object)("miden400"))) { 
 //BA.debugLineNum = 183;BA.debugLine="StartActivity(\"miden400\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("miden400"));
 };
 //BA.debugLineNum = 185;BA.debugLine="If Value = \"miden500\" Then";
if ((_value).equals((Object)("miden500"))) { 
 //BA.debugLineNum = 186;BA.debugLine="StartActivity(\"miden500\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("miden500"));
 };
 //BA.debugLineNum = 188;BA.debugLine="If Value = \"miden600\" Then";
if ((_value).equals((Object)("miden600"))) { 
 //BA.debugLineNum = 189;BA.debugLine="StartActivity(\"miden600\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("miden600"));
 };
 //BA.debugLineNum = 194;BA.debugLine="If Value = \"xilia100\" Then";
if ((_value).equals((Object)("xilia100"))) { 
 //BA.debugLineNum = 195;BA.debugLine="StartActivity(\"xilia100\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia100"));
 };
 //BA.debugLineNum = 197;BA.debugLine="If Value = \"xilia200\" Then";
if ((_value).equals((Object)("xilia200"))) { 
 //BA.debugLineNum = 198;BA.debugLine="StartActivity(\"xilia200\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia200"));
 };
 //BA.debugLineNum = 200;BA.debugLine="If Value = \"xilia300\" Then";
if ((_value).equals((Object)("xilia300"))) { 
 //BA.debugLineNum = 201;BA.debugLine="StartActivity(\"xilia300\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia300"));
 };
 //BA.debugLineNum = 203;BA.debugLine="If Value = \"xilia400\" Then";
if ((_value).equals((Object)("xilia400"))) { 
 //BA.debugLineNum = 204;BA.debugLine="StartActivity(\"xilia400\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia400"));
 };
 //BA.debugLineNum = 206;BA.debugLine="If Value = \"xilia500\" Then";
if ((_value).equals((Object)("xilia500"))) { 
 //BA.debugLineNum = 207;BA.debugLine="StartActivity(\"xilia500\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia500"));
 };
 //BA.debugLineNum = 209;BA.debugLine="If Value = \"xilia600\" Then";
if ((_value).equals((Object)("xilia600"))) { 
 //BA.debugLineNum = 210;BA.debugLine="StartActivity(\"xilia600\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia600"));
 };
 //BA.debugLineNum = 212;BA.debugLine="If Value = \"xilia700\" Then";
if ((_value).equals((Object)("xilia700"))) { 
 //BA.debugLineNum = 213;BA.debugLine="StartActivity(\"xilia700\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia700"));
 };
 //BA.debugLineNum = 215;BA.debugLine="If Value = \"xilia800\" Then";
if ((_value).equals((Object)("xilia800"))) { 
 //BA.debugLineNum = 216;BA.debugLine="StartActivity(\"xilia800\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia800"));
 };
 //BA.debugLineNum = 218;BA.debugLine="If Value = \"xilia900\" Then";
if ((_value).equals((Object)("xilia900"))) { 
 //BA.debugLineNum = 219;BA.debugLine="StartActivity(\"xilia900\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia900"));
 };
 //BA.debugLineNum = 221;BA.debugLine="If Value = \"xilia1000\" Then";
if ((_value).equals((Object)("xilia1000"))) { 
 //BA.debugLineNum = 222;BA.debugLine="StartActivity(\"xilia1000\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("xilia1000"));
 };
 //BA.debugLineNum = 227;BA.debugLine="If Value = \"dyoxil100\" Then";
if ((_value).equals((Object)("dyoxil100"))) { 
 //BA.debugLineNum = 228;BA.debugLine="StartActivity(\"dyoxil100\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil100"));
 };
 //BA.debugLineNum = 231;BA.debugLine="If Value = \"dyoxil200\" Then";
if ((_value).equals((Object)("dyoxil200"))) { 
 //BA.debugLineNum = 232;BA.debugLine="StartActivity(\"dyoxil200\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil200"));
 };
 //BA.debugLineNum = 234;BA.debugLine="If Value = \"dyoxil300\" Then";
if ((_value).equals((Object)("dyoxil300"))) { 
 //BA.debugLineNum = 235;BA.debugLine="StartActivity(\"dyoxil300\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil300"));
 };
 //BA.debugLineNum = 237;BA.debugLine="If Value = \"dyoxil400\" Then";
if ((_value).equals((Object)("dyoxil400"))) { 
 //BA.debugLineNum = 238;BA.debugLine="StartActivity(\"dyoxil400\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil400"));
 };
 //BA.debugLineNum = 240;BA.debugLine="If Value = \"dyoxil500\" Then";
if ((_value).equals((Object)("dyoxil500"))) { 
 //BA.debugLineNum = 241;BA.debugLine="StartActivity(\"dyoxil500\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil500"));
 };
 //BA.debugLineNum = 243;BA.debugLine="If Value = \"dyoxil600\" Then";
if ((_value).equals((Object)("dyoxil600"))) { 
 //BA.debugLineNum = 244;BA.debugLine="StartActivity(\"dyoxil600\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil600"));
 };
 //BA.debugLineNum = 246;BA.debugLine="If Value = \"dyoxil700\" Then";
if ((_value).equals((Object)("dyoxil700"))) { 
 //BA.debugLineNum = 247;BA.debugLine="StartActivity(\"dyoxil700\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil700"));
 };
 //BA.debugLineNum = 249;BA.debugLine="If Value = \"dyoxil800\" Then";
if ((_value).equals((Object)("dyoxil800"))) { 
 //BA.debugLineNum = 250;BA.debugLine="StartActivity(\"dyoxil800\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil800"));
 };
 //BA.debugLineNum = 252;BA.debugLine="If Value = \"dyoxil900\" Then";
if ((_value).equals((Object)("dyoxil900"))) { 
 //BA.debugLineNum = 253;BA.debugLine="StartActivity(\"dyoxil900\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil900"));
 };
 //BA.debugLineNum = 255;BA.debugLine="If Value = \"dyoxil1000\" Then";
if ((_value).equals((Object)("dyoxil1000"))) { 
 //BA.debugLineNum = 256;BA.debugLine="StartActivity(\"dyoxil1000\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dyoxil1000"));
 };
 //BA.debugLineNum = 258;BA.debugLine="If Value = \"triaxil100\" Then";
if ((_value).equals((Object)("triaxil100"))) { 
 //BA.debugLineNum = 259;BA.debugLine="StartActivity(\"triaxil100\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("triaxil100"));
 };
 //BA.debugLineNum = 261;BA.debugLine="If Value = \"triaxil200\" Then";
if ((_value).equals((Object)("triaxil200"))) { 
 //BA.debugLineNum = 262;BA.debugLine="StartActivity(\"triaxil200\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("triaxil200"));
 };
 //BA.debugLineNum = 264;BA.debugLine="If Value = \"triaxil300\" Then";
if ((_value).equals((Object)("triaxil300"))) { 
 //BA.debugLineNum = 265;BA.debugLine="StartActivity(\"triaxil300\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("triaxil300"));
 };
 //BA.debugLineNum = 267;BA.debugLine="If Value = \"triaxil400\" Then";
if ((_value).equals((Object)("triaxil400"))) { 
 //BA.debugLineNum = 268;BA.debugLine="StartActivity(\"triaxil400\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("triaxil400"));
 };
 //BA.debugLineNum = 270;BA.debugLine="If Value = \"triaxil500\" Then";
if ((_value).equals((Object)("triaxil500"))) { 
 //BA.debugLineNum = 271;BA.debugLine="StartActivity(\"triaxil500\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("triaxil500"));
 };
 //BA.debugLineNum = 273;BA.debugLine="If Value = \"triaxil600\" Then";
if ((_value).equals((Object)("triaxil600"))) { 
 //BA.debugLineNum = 274;BA.debugLine="StartActivity(\"triaxil600\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("triaxil600"));
 };
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 281;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 282;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 283;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 284;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 285;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 286;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 287;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 288;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 289;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 290;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 291;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 292;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 293;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 294;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 295;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 296;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 297;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 298;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 333;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 335;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 311;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 312;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 355;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 356;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
...
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 329;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 330;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 347;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 348;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 324;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 325;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 343;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 344;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 315;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 316;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 351;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 352;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 319;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 320;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 339;BA.debugLine="Sub simanseislabel_Click";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 360;BA.debugLine="Sub simansi_Click";
