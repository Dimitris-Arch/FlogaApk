...
public class tessera3 extends Activity implements B4AActivity{
	public static tessera3 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.tessera3");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tessera3).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.tessera3");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.tessera3", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tessera3) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tessera3) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (tessera3) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 52;BA.debugLine="Activity.LoadLayout(\"tessera3.bal\")";
mostCurrent._activity.LoadLayout("tessera3.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,tessera3.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 4.3 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 4.3 ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Εκρηκτικές και τοξικές ουσίες μ";
mostCurrent._clv2._addtextitem /*String*/ ("Εκρηκτικές και τοξικές ουσίες με μεγάλο κίνδυνο αυτανάφλεξης ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"ΑΝΤΙΔΡΑΣΗ ΚΑΤΑ ΤΗΝ ΕΠΑΦΗ ΤΟΥΣ ΜΕ";
mostCurrent._clv2._addtextitem /*String*/ ("ΑΝΤΙΔΡΑΣΗ ΚΑΤΑ ΤΗΝ ΕΠΑΦΗ ΤΟΥΣ ΜΕ ΤΟ ΝΕΡΟ.ΓΙΝΟΝΤΕ ΕΚΡΗΚΤΙΚΕΣ ",(Object)(""));
...
mostCurrent._clv2._addtextitem /*String*/ ("Τα εργαλεία που χρησιμοποιούνται δεν θα πρέπει να προκαλούν σπινθήρες ή στατικό ηλεκτρισμό.Μην χρησιμοποιείτε κοντά στην φωτιά κινητά τηλέφωνα ή ασύρματο",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"Η προσβολή γίνετε απο την πλευρά";
...
public static String  _ili_click() throws Exception{
 ...
 //BA.debugLineNum = 195;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 196;BA.debugLine="End Sub";
return "";
}
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 226;BA.debugLine="Sub ililabel_Click";
...
public static String  _katigor_click() throws Exception{
 ...
 //BA.debugLineNum = 209;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 ...
 //BA.debugLineNum = 205;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 217;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 218;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
...
public static String  _ousia_click() throws Exception{
 ...
 //BA.debugLineNum = 198;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Sub ousialabel_Click";
...
int _result = 0;
 //BA.debugLineNum = 183;BA.debugLine="Sub pin4_Click";
 //BA.debugLineNum = 184;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 185;BA.debugLine="result = Msgbox2(\"Επιστροφή στο μενού\", \"  \", \"Ναί";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Επιστροφή στο μενού"),BA.ObjectToCharSequence("  "),"Ναί ","  ","Όχι ",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"1.6.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 186;BA.debugLine="If result = DialogResponse.Positive Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 187;BA.debugLine="StartActivity(\"ilika\")";
