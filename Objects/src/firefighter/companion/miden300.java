...
public class miden300 extends Activity implements B4AActivity{
	public static miden300 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.miden300");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (miden300).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.miden300");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.miden300", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (miden300) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (miden300) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (miden300) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,miden300.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"0204	 Κατηγορία 1	Υγροδείκτες ,";
mostCurrent._clv2._addtextitem /*String*/ ("0204	 Κατηγορία 1	Υγροδείκτες , εκρηκτικά	",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"0207	 Κατηγορία 1	Τετρανιτροανιλ";
mostCurrent._clv2._addtextitem /*String*/ ("0207	 Κατηγορία 1	Τετρανιτροανιλίνη	   ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"0208	 Κατηγορία 1	Trinitrophenyl";
mostCurrent._clv2._addtextitem /*String*/ ("0208	 Κατηγορία 1	Trinitrophenylmethylnitramine ή τετρύλη	   ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"0209	 Κατηγορία 1	Τρινιτροτολουό";
mostCurrent._clv2._addtextitem /*String*/ ("0209	 Κατηγορία 1	Τρινιτροτολουόλιο ή TNT, ξηρός ή νωπός με λιγότερο από 30 τοις εκατό νερό κατά μάζα	",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"0212	 Κατηγορία 1	Ιχνηλάτες για";
mostCurrent._clv2._addtextitem /*String*/ ("0212	 Κατηγορία 1	Ιχνηλάτες για τα πυρομαχικά	   ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"0213	 Κατηγορία 1	Trinitroanisol";
mostCurrent._clv2._addtextitem /*String*/ ("0213	 Κατηγορία 1	Trinitroanisole	   ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"0214	 Κατηγορία 1	Τρινιτροβενζόλ";
mostCurrent._clv2._addtextitem /*String*/ ("0214	 Κατηγορία 1	Τρινιτροβενζόλιο , ξηρός ή νωπός με λιγότερο από 30 τοις εκατό νερό κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"0214	 Κατηγορία 4	Trinitrobenzen";
mostCurrent._clv2._addtextitem /*String*/ ("0214	 Κατηγορία 4	Trinitrobenzen, angefeuchtet mit mindestens 10 Masse-% Wasser	   ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"0215	 Κατηγορία 1	Τρινιτροβενζοϊ";
mostCurrent._clv2._addtextitem /*String*/ ("0215	 Κατηγορία 1	Τρινιτροβενζοϊκό οξύ , ξηρός ή νωπός με λιγότερο από 30 τοις εκατό νερό κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"0216	 Κατηγορία 1	Τρινιτρο-μετα-";
mostCurrent._clv2._addtextitem /*String*/ ("0216	 Κατηγορία 1	Τρινιτρο-μετα-κρεσόλη	   ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"0217	 Κατηγορία 1	Trinitronaphth";
mostCurrent._clv2._addtextitem /*String*/ ("0217	 Κατηγορία 1	Trinitronaphthalene	   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"0218	 Κατηγορία 1	Trinitrophenet";
mostCurrent._clv2._addtextitem /*String*/ ("0218	 Κατηγορία 1	Trinitrophenetole	   ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"0219	 Κατηγορία 1	Trinitroresorc";
mostCurrent._clv2._addtextitem /*String*/ ("0219	 Κατηγορία 1	Trinitroresorcinol ή στυφνικό οξύ, ξηρός ή νωπός με λιγότερο από 20 τοις εκατό νερό, ή μείγμα αλκοόλης και νερού, κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"0220	 Κατηγορία 1	Νιτρικό Ουρία";
mostCurrent._clv2._addtextitem /*String*/ ("0220	 Κατηγορία 1	Νιτρικό Ουρία , ξηρός ή νωπός με λιγότερο από 20 τοις εκατό νερό κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"0221	 Κατηγορία 1	Κεφαλές , τορπ";
mostCurrent._clv2._addtextitem /*String*/ ("0221	 Κατηγορία 1	Κεφαλές , τορπίλη με εκρηκτική γόμωση	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"0224	 Κατηγορία 1	Αζίδιο  βαρίου";
mostCurrent._clv2._addtextitem /*String*/ ("0224	 Κατηγορία 1	Αζίδιο  βαρίου , ξηρός ή νωπός με λιγότερο από 50 τοις εκατό νερό κατά μάζα	",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"0225	 Κατηγορία 1	Ενισχυτές με π";
mostCurrent._clv2._addtextitem /*String*/ ("0225	 Κατηγορία 1	Ενισχυτές με πυροκροτητή	   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"0226	 Κατηγορία 1	Cyclotetrameth";
mostCurrent._clv2._addtextitem /*String*/ ("0226	 Κατηγορία 1	Cyclotetramethylenetetranitramine, νωπό ή HMX	",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"0234	 Κατηγορία 1	Natriumdinitro";
mostCurrent._clv2._addtextitem /*String*/ ("0234	 Κατηγορία 1	Natriumdinitroorthocresolat , trocken oder angefeuchtet mit weniger ALS 15 Masse-% Wasser	   ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"0234	 Κατηγορία 4	Νάτριο δινιτρο";
mostCurrent._clv2._addtextitem /*String*/ ("0234	 Κατηγορία 4	Νάτριο δινιτρο-ο-κρεζολικό , ξηρός ή νωπός με λιγότερο από 15 τοις εκατό νερό κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"0235	 Κατηγορία 1	Picramate νάτρ";
mostCurrent._clv2._addtextitem /*String*/ ("0235	 Κατηγορία 1	Picramate νάτριο , ξηρός ή νωπός με λιγότερο από 20 τοις εκατό νερό κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"0236	 Κατηγορία 1	Ζιρκόνιο picra";
mostCurrent._clv2._addtextitem /*String*/ ("0236	 Κατηγορία 1	Ζιρκόνιο picramate , ξηρός ή νωπός λιγότερο από 20 τοις εκατό νερό κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"0237	 Κατηγορία 1	Χρεώσεις, σχήμ";
mostCurrent._clv2._addtextitem /*String*/ ("0237	 Κατηγορία 1	Χρεώσεις, σχήμα, ευέλικτο, γραμμική	   ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"0238 	 Κατηγορία 1	Πύραυλοι, γρα";
mostCurrent._clv2._addtextitem /*String*/ ("0238 	 Κατηγορία 1	Πύραυλοι, γραμμή ρίψης	   ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"0241	 Κατηγορία 1	Εκρηκτικό, ανα";
mostCurrent._clv2._addtextitem /*String*/ ("0241	 Κατηγορία 1	Εκρηκτικό, ανατινάξεις, τύπου Ε	   ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"0242	 Κατηγορία 1	Χρεώσεις, πρόω";
mostCurrent._clv2._addtextitem /*String*/ ("0242	 Κατηγορία 1	Χρεώσεις, πρόωσης για κανόνια	   ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"0243 	 Κατηγορία 1	Πυρομαχικά,";
mostCurrent._clv2._addtextitem /*String*/ ("0243 	 Κατηγορία 1	Πυρομαχικά, εμπρηστικά, λευκού φωσφόρου, με ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"0245 	 Κατηγορία 1	Καπνού Πυρομα";
mostCurrent._clv2._addtextitem /*String*/ ("0245 	 Κατηγορία 1	Καπνού Πυρομαχικά, λευκού φωσφόρου με ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	   ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"0247	 Κατηγορία 1	Πυρομαχικά, εμ";
mostCurrent._clv2._addtextitem /*String*/ ("0247	 Κατηγορία 1	Πυρομαχικά, εμπρηστικά υγρό ή γέλη, με ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	   ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"0248 	 Κατηγορία 1	Επινοήσεις, ε";
mostCurrent._clv2._addtextitem /*String*/ ("0248 	 Κατηγορία 1	Επινοήσεις, ενεργοποιείται με το νερό, με ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	   ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"0250	 Κατηγορία 1	Πυραυλοκινητήρ";
mostCurrent._clv2._addtextitem /*String*/ ("0250	 Κατηγορία 1	Πυραυλοκινητήρες με υπεργολικών υγρών, με ή χωρίς διαρροή γόμωσης	   ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"0254	 Κατηγορία 1	Πυρομαχικά, φω";
mostCurrent._clv2._addtextitem /*String*/ ("0254	 Κατηγορία 1	Πυρομαχικά, φωτίζοντας με ή χωρίς ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	 ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"0255	 Κατηγορία 1	Πυροκροτητές,";
mostCurrent._clv2._addtextitem /*String*/ ("0255	 Κατηγορία 1	Πυροκροτητές, ΗΛΕΚΤΡΙΚΟΙ, για ανατινάξεις	   ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"0257	 Κατηγορία 1	Ασφάλειες, εκρ";
mostCurrent._clv2._addtextitem /*String*/ ("0257	 Κατηγορία 1	Ασφάλειες, εκρηκτικών	   ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"0266	 Κατηγορία 1	ΟΚΤΟΛΙΤΗΣ ή ΟΚ";
mostCurrent._clv2._addtextitem /*String*/ ("0266	 Κατηγορία 1	ΟΚΤΟΛΙΤΗΣ ή ΟΚΤΟΛΗ, ξηρός ή νωπός με λιγότερο από 15 τοις εκατό νερό κατά μάζα	",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"0267	 Κατηγορία 1	Πυροκροτητές,";
mostCurrent._clv2._addtextitem /*String*/ ("0267	 Κατηγορία 1	Πυροκροτητές, μη ηλεκτρικά, για ανατινάξεις	   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"0268	 Κατηγορία 1	Ενισχυτές με π";
mostCurrent._clv2._addtextitem /*String*/ ("0268	 Κατηγορία 1	Ενισχυτές με πυροκροτητή	   ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"0271 	 Κατηγορία 1	Χρεώσεις, προ";
mostCurrent._clv2._addtextitem /*String*/ ("0271 	 Κατηγορία 1	Χρεώσεις, προωθητική	   ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"0275 	 Κατηγορία 1	Φυσίγγια, συσ";
mostCurrent._clv2._addtextitem /*String*/ ("0275 	 Κατηγορία 1	Φυσίγγια, συσκευή ηλεκτρικής ενέργειας	   ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"0277 	 Κατηγορία 1	Φυσίγγια, πετ";
mostCurrent._clv2._addtextitem /*String*/ ("0277 	 Κατηγορία 1	Φυσίγγια, πετρελαιοπηγή	   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"0279	 Κατηγορία 1	Χρεώσεις, πρόω";
mostCurrent._clv2._addtextitem /*String*/ ("0279	 Κατηγορία 1	Χρεώσεις, πρόωσης για κανόνια	   ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"0280 	 Κατηγορία 1	Πυραυλοκινητή";
mostCurrent._clv2._addtextitem /*String*/ ("0280 	 Κατηγορία 1	Πυραυλοκινητήρες	   ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"0282	 Κατηγορία 1	Νιτρογουανιδίν";
mostCurrent._clv2._addtextitem /*String*/ ("0282	 Κατηγορία 1	Νιτρογουανιδίνη ή Picrite, ξηρός ή νωπός με λιγότερο από 20 τοις εκατό νερό κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"0283	 Κατηγορία 1	Ενισχυτές, χωρ";
mostCurrent._clv2._addtextitem /*String*/ ("0283	 Κατηγορία 1	Ενισχυτές, χωρίς πυροκροτητή	   ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"0284 	 Κατηγορία 1	Χειροβομβίδες";
mostCurrent._clv2._addtextitem /*String*/ ("0284 	 Κατηγορία 1	Χειροβομβίδες, χειρός ή όπλου, με εκρηκτική γόμωση	   ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"0286	 Κατηγορία 1	Κεφαλές, ρόκα";
mostCurrent._clv2._addtextitem /*String*/ ("0286	 Κατηγορία 1	Κεφαλές, ρόκα με εκρηκτική γόμωση	   ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"0288	 Κατηγορία 1	Χρεώσεις, σχήμ";
mostCurrent._clv2._addtextitem /*String*/ ("0288	 Κατηγορία 1	Χρεώσεις, σχήμα, ευέλικτο, γραμμική	   ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"0289	 Κατηγορία 1	ΚΑΛΩΔΙΟ, ΕΚΡΗΚ";
mostCurrent._clv2._addtextitem /*String*/ ("0289	 Κατηγορία 1	ΚΑΛΩΔΙΟ, ΕΚΡΗΚΤΙΚΟ, εύκαμπτο	   ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"0290	 Κατηγορία 1	Καλώδιο, εκρηκ";
mostCurrent._clv2._addtextitem /*String*/ ("0290	 Κατηγορία 1	Καλώδιο, εκρηκτικού ή Fuse, εκρηκτικό μέταλλα επιστρωμένα	   ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"0291	 Κατηγορία 1	Βόμβες, με εκρ";
mostCurrent._clv2._addtextitem /*String*/ ("0291	 Κατηγορία 1	Βόμβες, με εκρηκτική γόμωση	   ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"0292 	 Κατηγορία 1	Χειροβομβίδες";
mostCurrent._clv2._addtextitem /*String*/ ("0292 	 Κατηγορία 1	Χειροβομβίδες, χειρός ή όπλου, με εκρηκτική γόμωση	",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"0294	 Κατηγορία 1	Μεταλλεία με ε";
mostCurrent._clv2._addtextitem /*String*/ ("0294	 Κατηγορία 1	Μεταλλεία με εκρηκτική γόμωση	   ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"0295	 Κατηγορία 1	Ρόκετς, με εκρ";
mostCurrent._clv2._addtextitem /*String*/ ("0295	 Κατηγορία 1	Ρόκετς, με εκρηκτική γόμωση	   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"0296	 Κατηγορία 1	Υγροδείκτες, ε";
mostCurrent._clv2._addtextitem /*String*/ ("0296	 Κατηγορία 1	Υγροδείκτες, εκρηκτικά	   ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"0297	 Κατηγορία 1	Πυρομαχικά, φω";
mostCurrent._clv2._addtextitem /*String*/ ("0297	 Κατηγορία 1	Πυρομαχικά, φωτίζοντας με ή χωρίς ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	   ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"0299	 Κατηγορία 1	ΒΟΜΒΕΣ, φλας";
mostCurrent._clv2._addtextitem /*String*/ ("0299	 Κατηγορία 1	ΒΟΜΒΕΣ, φλας	   ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"0300	 Κατηγορία 1	Πυρομαχικά, εμ";
mostCurrent._clv2._addtextitem /*String*/ ("0300	 Κατηγορία 1	Πυρομαχικά, εμπρηστικά με ή χωρίς ρήγμα, διαρροή γόμωσης ή προωθητικής γόμωσης	 ",(Object)(""));
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 187;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 190;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 191;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 192;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 193;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 194;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 195;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 196;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 197;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 198;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 199;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 200;BA.debugLine="lbl.Gravity = Bit.OR(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 201;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 202;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 203;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 204;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 205;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 206;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 207;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 208;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 237;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 239;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 221;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 254;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 255;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 256;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 235;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 248;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 231;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 245;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 246;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
 //BA.debugLineNum = 247;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 224;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 251;BA.debugLine="Sub ousialabel_Click";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 226;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 227;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 242;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 243;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 244;BA.debugLine="End Sub";
return "";
}
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 258;BA.debugLine="Sub simansi_Click";
