...
public class pixida extends Activity implements B4AActivity{
	public static pixida mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.pixida");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (pixida).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.pixida");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.pixida", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (pixida) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (pixida) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (pixida) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static anywheresoftware.b4a.objects.Timer _tmrupdater = null;
public anywheresoftware.b4a.objects.PanelWrapper _pnlrose = null;
public anywheresoftware.b4a.objects.AnimationWrapper _rotation = null;
public static double _dblangle = 0;
public anywheresoftware.b4a.objects.PanelWrapper _pnlneedle = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 60;BA.debugLine="Activity.LoadLayout(\"pixida\")";
mostCurrent._activity.LoadLayout("pixida",mostCurrent.activityBA);
 //BA.debugLineNum = 62;BA.debugLine="Activity.Color = Colors.Black";
...
mostCurrent._mple.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 121;BA.debugLine="pw.KeepAlive(True)";
mostCurrent._pw.KeepAlive(processBA,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 122;BA.debugLine="simanseislabel.BringToFront";
mostCurrent._simanseislabel.BringToFront();
 //BA.debugLineNum = 123;BA.debugLine="listabel.BringToFront";
mostCurrent._listabel.BringToFront();
 //BA.debugLineNum = 124;BA.debugLine="katigorlabel.BringToFront";
mostCurrent._katigorlabel.BringToFront();
 //BA.debugLineNum = 125;BA.debugLine="ousialabel.BringToFront";
mostCurrent._ousialabel.BringToFront();
 //BA.debugLineNum = 126;BA.debugLine="ililabel.BringToFront";
mostCurrent._ililabel.BringToFront();
 //BA.debugLineNum = 130;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bmpclear = null;
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 255;BA.debugLine="Dim bmpClear As Bitmap";
_bmpclear = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 256;BA.debugLine="bmpClear.InitializeMutable(1,1)";
_bmpclear.InitializeMutable((int) (1),(int) (1));
 //BA.debugLineNum = 257;BA.debugLine="pnlRose.SetBackgroundImage(bmpClear)";
mostCurrent._pnlrose.SetBackgroundImageNew((android.graphics.Bitmap)(_bmpclear.getObject()));
 //BA.debugLineNum = 258;BA.debugLine="pnlNeedle.SetBackgroundImage(bmpClear)";
mostCurrent._pnlneedle.SetBackgroundImageNew((android.graphics.Bitmap)(_bmpclear.getObject()));
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bmpclear = null;
 ...
 //BA.debugLineNum = 148;BA.debugLine="Dim bmpClear As Bitmap";
_bmpclear = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 149;BA.debugLine="bmpClear.InitializeMutable(1,1)";
_bmpclear.InitializeMutable((int) (1),(int) (1));
 //BA.debugLineNum = 150;BA.debugLine="pnlRose.SetBackgroundImage(bmpClear)";
mostCurrent._pnlrose.SetBackgroundImageNew((android.graphics.Bitmap)(_bmpclear.getObject()));
 //BA.debugLineNum = 151;BA.debugLine="pnlNeedle.SetBackgroundImage(bmpClear)";
mostCurrent._pnlneedle.SetBackgroundImageNew((android.graphics.Bitmap)(_bmpclear.getObject()));
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 134;BA.debugLine="dblAngle = 0";
_dblangle = 0;
 //BA.debugLineNum = 135;BA.debugLine="pnlRose.SetBackgroundImage(LoadBitmapSample(File.";
mostCurrent._pnlrose.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"compass.png",mostCurrent._pnlrose.getWidth(),mostCurrent._pnlrose.getWidth()).getObject()));
 //BA.debugLineNum = 136;BA.debugLine="pnlNeedle.SetBackgroundImage(LoadBitmapSample(Fil";
mostCurrent._pnlneedle.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"needle.png",(int) (mostCurrent._pnlrose.getWidth()/(double)9.6),mostCurrent._pnlrose.getWidth()).getObject()));
 //BA.debugLineNum = 137;BA.debugLine="Rotation.InitializeRotateCenter(\"Animation\", dblA";
mostCurrent._rotation.InitializeRotateCenter(mostCurrent.activityBA,"Animation",(float) (_dblangle),(float) (_dblangle),(android.view.View)(mostCurrent._pnlneedle.getObject()));
 //BA.debugLineNum = 138;BA.debugLine="Rotation.Duration = 20000";
mostCurrent._rotation.setDuration((long) (20000));
 //BA.debugLineNum = 139;BA.debugLine="tmrUpdater.Initialize(\"tmrUpdater\",100)";
_tmrupdater.Initialize(processBA,"tmrUpdater",(long) (100));
 //BA.debugLineNum = 140;BA.debugLine="Orientation.StartListening(\"Orientation\")";
_orientation.StartListening(processBA,"Orientation");
 //BA.debugLineNum = 141;BA.debugLine="tmrUpdater.Enabled = True";
_tmrupdater.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 142;BA.debugLine="Label1.BringToFront";
mostCurrent._label1.BringToFront();
 //BA.debugLineNum = 144;BA.debugLine="End Sub";
return "";
}
public static String  _animation_animationend() throws Exception{
 //BA.debugLineNum = 154;BA.debugLine="Sub Animation_AnimationEnd";
 //BA.debugLineNum = 155;BA.debugLine="Try";
try { //BA.debugLineNum = 156;BA.debugLine="Rotation.Start(pnlNeedle)";
mostCurrent._rotation.Start((android.view.View)(mostCurrent._pnlneedle.getObject()));
 } 
       catch (Exception e4) {
			processBA.setLastException(e4); //BA.debugLineNum = 158;BA.debugLine="Log(LastException.Message)";
anywheresoftware.b4a.keywords.Common.LogImpl("742663940",anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 19;BA.debugLine="Dim pnlRose As Panel";
mostCurrent._pnlrose = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Dim Rotation As Animation";
mostCurrent._rotation = new anywheresoftware.b4a.objects.AnimationWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim dblAngle As Double";
_dblangle = 0;
 //BA.debugLineNum = 22;BA.debugLine="Dim pnlNeedle As Panel";
mostCurrent._pnlneedle = new anywheresoftware.b4a.objects.PanelWrapper();
...
mostCurrent._label2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 53;BA.debugLine="Private Label3 As Label";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 232;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 213;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 214;BA.debugLine="StartActivity(\"firstaid\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 247;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 248;BA.debugLine="StartActivity(\"firstaid\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("firstaid"));
 //BA.debugLineNum = 249;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 227;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 228;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 241;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 242;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
 //BA.debugLineNum = 243;BA.debugLine="End Sub";
return "";
}
public static String  _label1_click() throws Exception{
 //BA.debugLineNum = 267;BA.debugLine="Sub Label1_Click";
 //BA.debugLineNum = 268;BA.debugLine="Msgbox(\"\",\"Μοίρες απο τον βορρά\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence(""),BA.ObjectToCharSequence("Μοίρες απο τον βορρά"),mostCurrent.activityBA);
 //BA.debugLineNum = 269;BA.debugLine="End Sub";
return "";
}
public static String  _label2_click() throws Exception{
 //BA.debugLineNum = 271;BA.debugLine="Sub Label2_Click";
 //BA.debugLineNum = 272;BA.debugLine="Msgbox(\"Για ακριβεστερη ένδειξη κουνήστε την συσκ";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Για ακριβεστερη ένδειξη κουνήστε την συσκευή πάνω κάτω και γύρω γύρω"),BA.ObjectToCharSequence(""),mostCurrent.activityBA);
 //BA.debugLineNum = 273;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 224;BA.debugLine="StartActivity(\"thlefona\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 238;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 239;BA.debugLine="StartActivity(\"thlefona\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("thlefona"));
 //BA.debugLineNum = 240;BA.debugLine="End Sub";
return "";
}
public static String  _orientation_orientationchanged(float _azimuth,float _pitch,float _roll) throws Exception{
 //BA.debugLineNum = 162;BA.debugLine="Sub Orientation_OrientationChanged (Azimuth As Flo";
 //BA.debugLineNum = 163;BA.debugLine="dblAngle = -Azimuth";
_dblangle = -_azimuth;
 //BA.debugLineNum = 164;BA.debugLine="Label1.Text = Round2( 360 -  (dblAngle + 360), 1)";
mostCurrent._label1.setText(BA.ObjectToCharSequence(BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(360-(_dblangle+360),(int) (1)))+"°"));
 //BA.debugLineNum = 166;BA.debugLine="Label4.Text =  360 -  (dblAngle + 360)";
mostCurrent._label4.setText(BA.ObjectToCharSequence(360-(_dblangle+360)));
 //BA.debugLineNum = 168;BA.debugLine="If Label4.Text > 0 And Label4.Text < 90 Then";
if ((double)(Double.parseDouble(mostCurrent._label4.getText()))>0 && (double)(Double.parseDouble(mostCurrent._label4.getText()))<90) { 
 //BA.debugLineNum = 169;BA.debugLine="Label3.textColor = Colors.Green";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Green);
 //BA.debugLineNum = 170;BA.debugLine="Label3.Text = \"ΒΑ\"";
mostCurrent._label3.setText(BA.ObjectToCharSequence("ΒΑ"));
 };
 //BA.debugLineNum = 172;BA.debugLine="If Label4.Text > 90 And Label4.Text < 180 Then";
if ((double)(Double.parseDouble(mostCurrent._label4.getText()))>90 && (double)(Double.parseDouble(mostCurrent._label4.getText()))<180) { 
 //BA.debugLineNum = 173;BA.debugLine="Label3.textColor = Colors.red";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 174;BA.debugLine="Label3.Text = \"NA\"";
mostCurrent._label3.setText(BA.ObjectToCharSequence("NA"));
 };
 //BA.debugLineNum = 176;BA.debugLine="If Label4.Text > 180 And Label4.Text < 270 Then";
if ((double)(Double.parseDouble(mostCurrent._label4.getText()))>180 && (double)(Double.parseDouble(mostCurrent._label4.getText()))<270) { 
 //BA.debugLineNum = 177;BA.debugLine="Label3.textColor = Colors.Blue";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Blue);
 //BA.debugLineNum = 178;BA.debugLine="Label3.Text = \"NΔ\"";
mostCurrent._label3.setText(BA.ObjectToCharSequence("NΔ"));
 };
 //BA.debugLineNum = 180;BA.debugLine="If Label4.Text > 270 And Label4.Text < 360 Then";
if ((double)(Double.parseDouble(mostCurrent._label4.getText()))>270 && (double)(Double.parseDouble(mostCurrent._label4.getText()))<360) { 
 //BA.debugLineNum = 181;BA.debugLine="Label3.textColor = Colors.Yellow";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 182;BA.debugLine="Label3.Text = \"BΔ\"";
mostCurrent._label3.setText(BA.ObjectToCharSequence("BΔ"));
 };
 //BA.debugLineNum = 186;BA.debugLine="If Label4.Text = 0.0 Then";
if ((mostCurrent._label4.getText()).equals(BA.NumberToString(0.0))) { 
 //BA.debugLineNum = 187;BA.debugLine="Label3.textColor = Colors.Green";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Green);
 //BA.debugLineNum = 188;BA.debugLine="Label3.Text = \"B\"";
mostCurrent._label3.setText(BA.ObjectToCharSequence("B"));
 };
 //BA.debugLineNum = 190;BA.debugLine="If Label4.Text = 90.0 Then";
if ((mostCurrent._label4.getText()).equals(BA.NumberToString(90.0))) { 
 //BA.debugLineNum = 191;BA.debugLine="Label3.textColor = Colors.red";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 192;BA.debugLine="Label3.text = \"A\"";
mostCurrent._label3.setText(BA.ObjectToCharSequence("A"));
 };
 //BA.debugLineNum = 194;BA.debugLine="If Label4.Text = 180.0 Then";
if ((mostCurrent._label4.getText()).equals(BA.NumberToString(180.0))) { 
 //BA.debugLineNum = 195;BA.debugLine="Label3.textColor = Colors.Blue";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Blue);
 //BA.debugLineNum = 196;BA.debugLine="Label3.text = \"N\"";
mostCurrent._label3.setText(BA.ObjectToCharSequence("N"));
 };
 //BA.debugLineNum = 198;BA.debugLine="If Label4.Text = 270.0 Then";
if ((mostCurrent._label4.getText()).equals(BA.NumberToString(270.0))) { 
 //BA.debugLineNum = 199;BA.debugLine="Label3.textColor = Colors.Yellow";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 200;BA.debugLine="Label3.text = \"Δ\"";
mostCurrent._label3.setText(BA.ObjectToCharSequence("Δ"));
 };
 //BA.debugLineNum = 202;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 217;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 244;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 245;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
 //BA.debugLineNum = 246;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 219;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 220;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Dim Orientation As PhoneOrientation";
_orientation = new anywheresoftware.b4a.phone.Phone.PhoneOrientation();
 //BA.debugLineNum = 12;BA.debugLine="Dim tmrUpdater As Timer";
_tmrupdater = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 14;BA.debugLine="End Sub";
return "";
}
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 235;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 236;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 237;BA.debugLine="End Sub";
return "";
}
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 250;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 251;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 252;BA.debugLine="End Sub";
return "";
}
public static String  _tmrupdater_tick() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub tmrUpdater_Tick";
 //BA.debugLineNum = 205;BA.debugLine="Rotation.InitializeRotateCenter(\"Animation\", dblA";
mostCurrent._rotation.InitializeRotateCenter(mostCurrent.activityBA,"Animation",(float) (_dblangle),(float) (_dblangle),(android.view.View)(mostCurrent._pnlneedle.getObject()));
 //BA.debugLineNum = 206;BA.debugLine="Rotation.Duration = 20000";
mostCurrent._rotation.setDuration((long) (20000));
 //BA.debugLineNum = 207;BA.debugLine="Rotation.Start(pnlNeedle)";
mostCurrent._rotation.Start((android.view.View)(mostCurrent._pnlneedle.getObject()));
