...
public class dyo extends Activity implements B4AActivity{
	public static dyo mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dyo");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dyo).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dyo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dyo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dyo) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dyo) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dyo) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 51;BA.debugLine="Activity.LoadLayout(\"dyobal.bal\")";
mostCurrent._activity.LoadLayout("dyobal.bal",mostCurrent.activityBA);
...
mostCurrent._mple.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 110;BA.debugLine="pin1.BringToFront";
mostCurrent._pin1.BringToFront();
 //BA.debugLineNum = 123;BA.debugLine="clv2.Initialize(Me, \"clv2\")";
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dyo.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2.1 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2.1 ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Εφλεκτα,πυροδυναμοτικα,δηλητηρι";
mostCurrent._clv2._addtextitem /*String*/ ("Εφλεκτα,πυροδυναμοτικα,δηλητηριώδη και τοξικα. ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"ΕΚΡΗΞΗ ΕΞΑΙΤΙΑΣ ΤΗΣ ΥΨΗΛΗΣ ΠΙΕΣ";
mostCurrent._clv2._addtextitem /*String*/ ("ΕΚΡΗΞΗ ΕΞΑΙΤΙΑΣ ΤΗΣ ΥΨΗΛΗΣ ΠΙΕΣΗΣ ΣΤΑ ΔΟΧΕΙΑ-ΒΥΤΙΑ ΠΟΥ ΒΡΙΣΚΟΝΤΑΙ. ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Σε χώρους που δεν αερίζονται υπά";
mostCurrent._clv2._addtextitem /*String*/ ("Σε χώρους που δεν αερίζονται υπάρχει κίνδυνος ασφυξίας. ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Υπάρχει κίνδυνος ασφυξίας σε κλε";
mostCurrent._clv2._addtextitem /*String*/ ("Υπάρχει κίνδυνος ασφυξίας σε κλειστούς χώρους. ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"Έκρηξη σε περίπτωση διαρροής. \",";
mostCurrent._clv2._addtextitem /*String*/ ("Έκρηξη σε περίπτωση διαρροής. ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"ΠΟΛΥ ΥΨΗΛΟΣ ΚΙΝΔΥΝΟΣ ΑΠΌΤΟΜΗΣ Έ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΟΛΥ ΥΨΗΛΟΣ ΚΙΝΔΥΝΟΣ ΑΠΌΤΟΜΗΣ ΈΚΡΗΞΗΣ,ΔΟΧΕΊΩΝ Ή ΒΥΤΙΩΝ ΣΕ ΠΕΡΊΠΤΩΣΗ ΑΝΑΡΡΌΦΗΣΗΣ ΟΤΑΝ ΑΔΙΑΖΟΥΝ ΚΑΙ Η ΕΞΩΤΕΡΙΚΗ ΠΙΕΣΗ ΕΙΝΑΙ ΜΕΓΑΛΥΤΕΡΗ ΤΗΣ ΕΣΩΤΕΡΙΚΗΣ ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑ";
