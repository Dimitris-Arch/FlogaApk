...
public class asetilini extends Activity implements B4AActivity{
	public static asetilini mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.asetilini");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (asetilini).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.asetilini");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.asetilini", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (asetilini) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (asetilini) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (asetilini) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 44;BA.debugLine="Activity.LoadLayout(\"asetilini.bal\")";
mostCurrent._activity.LoadLayout("asetilini.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,asetilini.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"To ακετυλένιο (ασετυλίνη) UN-100";
mostCurrent._clv2._addtextitem /*String*/ ("To ακετυλένιο (ασετυλίνη) UN-1001 είναι υδρογονάνθρακας. Είναι άχρωμο, άοσμο. Είναι ασφυξιογόνο σε χώρους που δεν αερίζονται. Για να ξεχωρίζει στην όσφρηση,προσθέτουν ουσία για τον έλεγχο διαρροής.. Είναι εξαιρετικά εύφλεκτο αέριο,υπερβολικά εκρηκτικό και ασταθές.",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Συνεχίστε να ψύχετε τις φυάλες-β";
mostCurrent._clv2._addtextitem /*String*/ ("Συνεχίστε να ψύχετε τις φυάλες-βυτία ακόμη και όταν η πυρκαγιά σβήσει.",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"ΜΗΝ ΣΒΗΝΕΤΕ ΤΗ ΦΛΟΓΑ ΤΟΥ ΔΙΑΡΡΕΟ";
mostCurrent._clv2._addtextitem /*String*/ ("ΜΗΝ ΣΒΗΝΕΤΕ ΤΗ ΦΛΟΓΑ ΤΟΥ ΔΙΑΡΡΕΟΝΤΟΣ ΑΕΡΙΟΥ ΕΚΤΟΣ ΚΑΙ ΑΝ ΕΙΝΑΙ ΑΠΟΛΥΤΑ ΑΝΑΓΚΑΙΟ.",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Κατα την καύση του δημιουργεί θε";
mostCurrent._clv2._addtextitem /*String*/ ("Κατα την καύση του δημιουργεί θερμοκρασίες άνω των 3.000C.",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2 ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Ευφλεκτα,πυροδυναμωτικα,δηλητηρι";
...
mostCurrent._clv2._addtextitem /*String*/ ("Τα εργαλεία που χρησιμοποιούνται δεν θα πρέπει να προκαλούν σπινθήρες ή στατικό ηλεκτρισμό.Μην χρησιμοποιείτε κοντά στην φωτιά κινητά τηλέφωνα ή ασύρματο",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"Η προσβολή γίνεται απο την πλευρ";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 207;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub ili_Click";
...
public static String  _ililabel_click() throws Exception{
 ...
 //BA.debugLineNum = 221;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 222;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 202;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 203;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 199;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 192;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub pixi_Click";
