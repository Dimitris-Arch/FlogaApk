...
public class dyoxil600 extends Activity implements B4AActivity{
	public static dyoxil600 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dyoxil600");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dyoxil600).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dyoxil600");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dyoxil600", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dyoxil600) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dyoxil600) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dyoxil600) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dyoxil600.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"2501	Κατηγορία 6.1	Τρις- (Κατηγο";
mostCurrent._clv2._addtextitem /*String*/ ("2501	Κατηγορία 6.1	Τρις- (Κατηγορία 1-αζιριδινυλο) φωσφινοξείδιο , διάλυμα	    ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"2502	Κατηγορία 8	Βαλερυλο χλωριο";
mostCurrent._clv2._addtextitem /*String*/ ("2502	Κατηγορία 8	Βαλερυλο χλωριούχο	    ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"2503	Κατηγορία 8	Τετραχλωριούχου";
mostCurrent._clv2._addtextitem /*String*/ ("2503	Κατηγορία 8	Τετραχλωριούχου ζιρκονίου	    ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"2504	Κατηγορία 6.1	Tetrabromoeth";
mostCurrent._clv2._addtextitem /*String*/ ("2504	Κατηγορία 6.1	Tetrabromoethane	    ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"2505	Κατηγορία 6.1	Φθοριούχο αμμ";
mostCurrent._clv2._addtextitem /*String*/ ("2505	Κατηγορία 6.1	Φθοριούχο αμμώνιο	    ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"2506	Κατηγορία 8	Θειικό αμμώνιο";
mostCurrent._clv2._addtextitem /*String*/ ("2506	Κατηγορία 8	Θειικό αμμώνιο υδρογόνο	    ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"2507	Κατηγορία 8	Χλωρολευκοχρυσι";
mostCurrent._clv2._addtextitem /*String*/ ("2507	Κατηγορία 8	Χλωρολευκοχρυσικό οξύ , στερεό	    ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"2508	Κατηγορία 8	Μολυβδαίνιο Πεν";
mostCurrent._clv2._addtextitem /*String*/ ("2508	Κατηγορία 8	Μολυβδαίνιο Πενταχλωριούχος	    ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"2509	Κατηγορία 8	Όξινου θειικού";
mostCurrent._clv2._addtextitem /*String*/ ("2509	Κατηγορία 8	Όξινου θειικού καλίου	    ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"2511	Κατηγορία 8	Κατηγορία 2-χλω";
mostCurrent._clv2._addtextitem /*String*/ ("2511	Κατηγορία 8	Κατηγορία 2-χλωροπροπιονικού οξέος	    ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"2512	Κατηγορία 6.1	Αμινοφαινολών";
mostCurrent._clv2._addtextitem /*String*/ ("2512	Κατηγορία 6.1	Αμινοφαινολών  ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"2513	Κατηγορία 8	Βρωμιούχο βρωμο";
mostCurrent._clv2._addtextitem /*String*/ ("2513	Κατηγορία 8	Βρωμιούχο βρωμοακετυλιο	    ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"2514	Κατηγορία 3	Βρωμοβενζινο";
mostCurrent._clv2._addtextitem /*String*/ ("2514	Κατηγορία 3	Βρωμοβενζινο	    ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"2515	Κατηγορία 6.1	Βρωμοφόρμιο";
mostCurrent._clv2._addtextitem /*String*/ ("2515	Κατηγορία 6.1	Βρωμοφόρμιο	    ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"2516	Κατηγορία 6.1	Τετραβρωμάνθρ";
mostCurrent._clv2._addtextitem /*String*/ ("2516	Κατηγορία 6.1	Τετραβρωμάνθρακα	    ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"2517	Κατηγορία 2	Χλωρο-Κατηγορία";
mostCurrent._clv2._addtextitem /*String*/ ("2517	Κατηγορία 2	Χλωρο-Κατηγορία 1,Κατηγορία 1-διφθοροαιθάνιο ή ψυκτικό αέριο R 142b	 ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"2520	Κατηγορία 3	Cyclooctadienes";
mostCurrent._clv2._addtextitem /*String*/ ("2520	Κατηγορία 3	Cyclooctadienes	    ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"2521	Κατηγορία 6.1	Δικετένιο , α";
mostCurrent._clv2._addtextitem /*String*/ ("2521	Κατηγορία 6.1	Δικετένιο , αναστέλλεται	    ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"2522	Κατηγορία 6.1	Μεθακρυλικό Κ";
mostCurrent._clv2._addtextitem /*String*/ ("2522	Κατηγορία 6.1	Μεθακρυλικό Κατηγορία 2-διμεθυλαμινοαιθυλ	 ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"2524	Κατηγορία 3	Ορθομυρμηκικό α";
mostCurrent._clv2._addtextitem /*String*/ ("2524	Κατηγορία 3	Ορθομυρμηκικό αιθυλεστέρα	    ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"2525	Κατηγορία 6.1	Ethyl οξαλικό";
mostCurrent._clv2._addtextitem /*String*/ ("2525	Κατηγορία 6.1	Ethyl οξαλικό	    ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"2526	Κατηγορία 3	Φουρφουρυλαμίνη";
mostCurrent._clv2._addtextitem /*String*/ ("2526	Κατηγορία 3	Φουρφουρυλαμίνη	    ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"2527	Κατηγορία 3	Ακρυλικό ισοβου";
mostCurrent._clv2._addtextitem /*String*/ ("2527	Κατηγορία 3	Ακρυλικό ισοβουτυλεστέρα  ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"2528	Κατηγορία 3	Ισοβουτυρικός ι";
mostCurrent._clv2._addtextitem /*String*/ ("2528	Κατηγορία 3	Ισοβουτυρικός ισοβουτυλ	 ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"2529	Κατηγορία 3	Ισοβουτυρικό οξ";
mostCurrent._clv2._addtextitem /*String*/ ("2529	Κατηγορία 3	Ισοβουτυρικό οξύ	    ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"2530	Κατηγορία 3	Ισοβουτυρικό αν";
mostCurrent._clv2._addtextitem /*String*/ ("2530	Κατηγορία 3	Ισοβουτυρικό ανυδρίτη	    ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"2531	Κατηγορία 8	Μεθακρυλικό οξύ";
mostCurrent._clv2._addtextitem /*String*/ ("2531	Κατηγορία 8	Μεθακρυλικό οξύ , αναστέλλεται	 ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"2533	Κατηγορία 6.1	Τριχλωροξικό";
mostCurrent._clv2._addtextitem /*String*/ ("2533	Κατηγορία 6.1	Τριχλωροξικό μεθυλεστέρα	    ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"2534	Κατηγορία 2	Methylchlorosil";
mostCurrent._clv2._addtextitem /*String*/ ("2534	Κατηγορία 2	Methylchlorosilane	    ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"2535	Κατηγορία 3	Κατηγορία 4-μεθ";
mostCurrent._clv2._addtextitem /*String*/ ("2535	Κατηγορία 3	Κατηγορία 4-μεθυλμορφολίνη ή Ν-μεθυλομορφολίνη ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"2536	Κατηγορία 3	Μεθυλοτετραϋδρο";
mostCurrent._clv2._addtextitem /*String*/ ("2536	Κατηγορία 3	Μεθυλοτετραϋδροφουράνης	    ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"2538	Κατηγορία 4.1	Nitronaphthal";
mostCurrent._clv2._addtextitem /*String*/ ("2538	Κατηγορία 4.1	Nitronaphthalene	    ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"2541	Κατηγορία 3	Τερπινολένιο";
mostCurrent._clv2._addtextitem /*String*/ ("2541	Κατηγορία 3	Τερπινολένιο	    ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"2542	Κατηγορία 6.1	Τριβουτυλαμίν";
mostCurrent._clv2._addtextitem /*String*/ ("2542	Κατηγορία 6.1	Τριβουτυλαμίνη	    ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"2545	Κατηγορία 4.2	Άφνιο σκόνη,";
mostCurrent._clv2._addtextitem /*String*/ ("2545	Κατηγορία 4.2	Άφνιο σκόνη, ξηρό	    ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"2546	Κατηγορία 4.2	Τιτάνιο σκόνη";
mostCurrent._clv2._addtextitem /*String*/ ("2546	Κατηγορία 4.2	Τιτάνιο σκόνη, ξηρό	    ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"2547	Κατηγορία 5.1	Υπεροξειδίου";
mostCurrent._clv2._addtextitem /*String*/ ("2547	Κατηγορία 5.1	Υπεροξειδίου  νατρίου	    ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"2548	Κατηγορία 2	Χλώριο πενταφθο";
mostCurrent._clv2._addtextitem /*String*/ ("2548	Κατηγορία 2	Χλώριο πενταφθοριούχο	    ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"2552	Κατηγορία 6.1	Ένυδρο εξαφθο";
mostCurrent._clv2._addtextitem /*String*/ ("2552	Κατηγορία 6.1	Ένυδρο εξαφθοροακετόνης	    ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"2554	Κατηγορία 3	Χλωριούχο μεθύλ";
mostCurrent._clv2._addtextitem /*String*/ ("2554	Κατηγορία 3	Χλωριούχο μεθύλιο αλλυλ	    ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"2555	Κατηγορία 4.1	Νιτροκυτταρίν";
mostCurrent._clv2._addtextitem /*String*/ ("2555	Κατηγορία 4.1	Νιτροκυτταρίνη με νερό με όχι λιγότερο από 25 τοις εκατό νερό, κατά βάρος	 ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"2556	Κατηγορία 4.1	Νιτροκυτταρίν";
mostCurrent._clv2._addtextitem /*String*/ ("2556	Κατηγορία 4.1	Νιτροκυτταρίνη, με αλκοόλη με όχι λιγότερο από 25 τοις εκατό αλκοόλη ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"2557	Κατηγορία 4.1	Νιτροκυτταρίν";
mostCurrent._clv2._addtextitem /*String*/ ("2557	Κατηγορία 4.1	Νιτροκυτταρίνη, με όχι περισσότερο από 12,Κατηγορία 6 τοις εκατό άζωτο ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"2558	Κατηγορία 6.1	Επιβρωμοϋδρίν";
mostCurrent._clv2._addtextitem /*String*/ ("2558	Κατηγορία 6.1	Επιβρωμοϋδρίνη	    ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"2560	Κατηγορία 3	Μεθυλπεντανιο\",";
mostCurrent._clv2._addtextitem /*String*/ ("2560	Κατηγορία 3	Μεθυλπεντανιο",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"2561	Κατηγορία 3	Βουτένιο	    \",";
mostCurrent._clv2._addtextitem /*String*/ ("2561	Κατηγορία 3	Βουτένιο	    ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"2564	Κατηγορία 8	Τριχλωροξικό οξ";
mostCurrent._clv2._addtextitem /*String*/ ("2564	Κατηγορία 8	Τριχλωροξικό οξύ , διάλυμα	    ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"2565	Κατηγορία 8	Δικυκλοεξυλαμίν";
mostCurrent._clv2._addtextitem /*String*/ ("2565	Κατηγορία 8	Δικυκλοεξυλαμίνη	    ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"2567	Κατηγορία 6.1	Πενταχλωροφαι";
mostCurrent._clv2._addtextitem /*String*/ ("2567	Κατηγορία 6.1	Πενταχλωροφαινόλης	    ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"2570	Κατηγορία 6.1	Κάδμιο ενώσει";
mostCurrent._clv2._addtextitem /*String*/ ("2570	Κατηγορία 6.1	Κάδμιο ενώσεις	    ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"2571	Κατηγορία 8	Alkylsulfuric ο";
mostCurrent._clv2._addtextitem /*String*/ ("2571	Κατηγορία 8	Alkylsulfuric οξέα	    ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"2572	Κατηγορία 6.1	Φαινυλυδραζιν";
mostCurrent._clv2._addtextitem /*String*/ ("2572	Κατηγορία 6.1	Φαινυλυδραζινικού	    ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"2573	Κατηγορία 5.1	Θάλλιο χλωρικ";
mostCurrent._clv2._addtextitem /*String*/ ("2573	Κατηγορία 5.1	Θάλλιο χλωρικό	    ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"2574	Κατηγορία 6.1	Φωσφορικό τρι";
mostCurrent._clv2._addtextitem /*String*/ ("2574	Κατηγορία 6.1	Φωσφορικό τρικρεσυλεστέρα με περισσότερα από Κατηγορία 3 τοις εκατό ορθο ισομερές ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"2576	Κατηγορία 8	Οξυβρωμιούχου φ";
mostCurrent._clv2._addtextitem /*String*/ ("2576	Κατηγορία 8	Οξυβρωμιούχου φωσφόρου , λιωμένο	    ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"2577	Κατηγορία 8	Φαινυλακετυλ χλ";
mostCurrent._clv2._addtextitem /*String*/ ("2577	Κατηγορία 8	Φαινυλακετυλ χλωρίδιο	    ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"2578	Κατηγορία 8	Φώσφορος τριοξε";
mostCurrent._clv2._addtextitem /*String*/ ("2578	Κατηγορία 8	Φώσφορος τριοξείδιο	 ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"2579	Κατηγορία 8	Πιπεραζινική";
mostCurrent._clv2._addtextitem /*String*/ ("2579	Κατηγορία 8	Πιπεραζινική	    ",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"2580	Κατηγορία 8	Βρωμιούχο αργίλ";
mostCurrent._clv2._addtextitem /*String*/ ("2580	Κατηγορία 8	Βρωμιούχο αργίλιο , διάλυμα	    ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"2581	Κατηγορία 8	Χλωριούχο αργίλ";
mostCurrent._clv2._addtextitem /*String*/ ("2581	Κατηγορία 8	Χλωριούχο αργίλιο , διάλυμα	    ",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"2582	Κατηγορία 8	Χλωριούχου σιδή";
mostCurrent._clv2._addtextitem /*String*/ ("2582	Κατηγορία 8	Χλωριούχου σιδήρου , διάλυμα	    ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"2583	Κατηγορία 8	Αλκύλ σουλφονικ";
mostCurrent._clv2._addtextitem /*String*/ ("2583	Κατηγορία 8	Αλκύλ σουλφονικά οξέα	    ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"2587	Κατηγορία 6.1	Βενζοκινόνη";
mostCurrent._clv2._addtextitem /*String*/ ("2587	Κατηγορία 6.1	Βενζοκινόνη	    ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"2588	Κατηγορία 6.1	Φυτοφάρμακα ,";
mostCurrent._clv2._addtextitem /*String*/ ("2588	Κατηγορία 6.1	Φυτοφάρμακα , στερεά, τοξικά ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"2589	Κατηγορία 6.1	Vinyl χλωροξι";
mostCurrent._clv2._addtextitem /*String*/ ("2589	Κατηγορία 6.1	Vinyl χλωροξικόν	    ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"2590	Κατηγορία 9	Λευκό αμίαντο (";
mostCurrent._clv2._addtextitem /*String*/ ("2590	Κατηγορία 9	Λευκό αμίαντο ( χρυσοτίλη , ακτινολίτης , ανθοφυλλίτης , τρεμόλιθος ) ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"2591	Κατηγορία 2	Προβολείς Xenon";
mostCurrent._clv2._addtextitem /*String*/ ("2591	Κατηγορία 2	Προβολείς Xenon , κατεψυγμένου υγρού (κρυογονική υγρά)	    ",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"2599	Κατηγορία 2	Χλωροτριφθορομε";
mostCurrent._clv2._addtextitem /*String*/ ("2599	Κατηγορία 2	Χλωροτριφθορομεθάνιο και τριφθορομεθάνιου	    ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"2600	Κατηγορία 2	Μονοξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("2600	Κατηγορία 2	Μονοξείδιο  άνθρακα και υδρογόνο μίγμα, συμπιέζεται ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 276;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 277;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 200;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 203;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 204;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 205;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 206;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 207;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 208;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 209;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 210;BA.debugLine="chk.Initialize(\"\")";
...
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 213;BA.debugLine="lbl.Gravity = Bit.OR(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 214;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 215;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 216;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 217;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 218;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 219;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 220;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 221;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 251;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 253;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 235;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 268;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 269;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 270;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 248;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 249;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 262;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 244;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 245;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 259;BA.debugLine="Sub listabel_Click";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 237;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 238;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 265;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 266;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 //BA.debugLineNum = 267;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 240;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 241;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 256;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 257;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 258;BA.debugLine="End Sub";
return "";
}
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 272;BA.debugLine="Sub simansi_Click";
