...
public class efragma extends Activity implements B4AActivity{
	public static efragma mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.efragma");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (efragma).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.efragma");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.efragma", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (efragma) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (efragma) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (efragma) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,efragma.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"Έφραγμα συμβαίνει συνήθως, όταν";
mostCurrent._clv2._addtextitem /*String*/ ("Έφραγμα συμβαίνει συνήθως, όταν θρόμβος του αίματος φράζει τη ροή του αίματος μέσα σε μία στεφανιαία αρτηρία:",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Συμπτώματα εφράγματος:\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Συμπτώματα εφράγματος:",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Ένα έντονο αίσθημα πίεσης στο στ";
mostCurrent._clv2._addtextitem /*String*/ ("Ένα έντονο αίσθημα πίεσης στο στήθος μπορεί να αποτελεί το βασικό σύμπτωμα.",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Έντονος, παρατεταμένος πόνος στο";
mostCurrent._clv2._addtextitem /*String*/ ("Έντονος, παρατεταμένος πόνος στο στήθος (μεγάλη πίεση).",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Πόνος που εκτείνεται πέρα από το";
mostCurrent._clv2._addtextitem /*String*/ ("Πόνος που εκτείνεται πέρα από το στήθος, στον αριστερό ώμο και στο χέρι, στην πλάτη και ακόμα και στα δόντια και στη γνάθο.",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Παρατεταμένος πόνος στην άνω κοι";
mostCurrent._clv2._addtextitem /*String*/ ("Παρατεταμένος πόνος στην άνω κοιλιακή χώρα και επίσης δύσπνοια,απώλεια αισθήσεων,ναυτία και έμετος,εφίδρωση.",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Συχνές κρίσεις στηθάγχης που δεν";
mostCurrent._clv2._addtextitem /*String*/ ("Συχνές κρίσεις στηθάγχης που δεν οφείλονται σε σωματική κόπωση..",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Το έμφραγμα μερικές φορές εσφαλμ";
mostCurrent._clv2._addtextitem /*String*/ ("Το έμφραγμα μερικές φορές εσφαλμένα μπορεί να μπερδευτεί με δυσπεψία.",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Ο πόνος μπορεί να είναι συνεχόμε";
mostCurrent._clv2._addtextitem /*String*/ ("Ο πόνος μπορεί να είναι συνεχόμενος ή να έρχεται και να φεύγει.",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"Σε άτομα με διαβήτη δεν είναι ασ";
mostCurrent._clv2._addtextitem /*String*/ ("Σε άτομα με διαβήτη δεν είναι ασυνήθιστο να έχουν έμφραγμα χωρίς συμπτώματα",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"Αντιμετώπηση εφράγματος\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Αντιμετώπηση εφράγματος",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"Βάζουμε τον πάσχοντα να καθίσει";
mostCurrent._clv2._addtextitem /*String*/ ("Βάζουμε τον πάσχοντα να καθίσει άνετα.  ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"Με το κεφάλι και τους ώμους υποσ";
mostCurrent._clv2._addtextitem /*String*/ ("Με το κεφάλι και τους ώμους υποστηριζόμενα και τα πόδια λυγισμένα ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"Δώστε στο θύμα, υπογλώσσιο χαπι";
mostCurrent._clv2._addtextitem /*String*/ ("Δώστε στο θύμα, υπογλώσσιο χαπι ή να μασήσει μία ασπιρίνη",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"Διατηρείστε τους αεραγωγούς ανοι";
mostCurrent._clv2._addtextitem /*String*/ ("Διατηρείστε τους αεραγωγούς ανοικτούς:",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"Κρατήστε τον ασθενή ζεστό, σκεπά";
mostCurrent._clv2._addtextitem /*String*/ ("Κρατήστε τον ασθενή ζεστό, σκεπάζοντας τον με μια κουβέρτα ή παλτό.",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"Μην δίνετε φαγητό ή ποτό.\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Μην δίνετε φαγητό ή ποτό.",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"Γρήγορη μεταφορά του θύματος σε";
mostCurrent._clv2._addtextitem /*String*/ ("Γρήγορη μεταφορά του θύματος σε εξειδικευμένο κέντρο ή καλέστε το 166",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"Εάν χάσει τις αισθήσεις του, αρχ";
mostCurrent._clv2._addtextitem /*String*/ ("Εάν χάσει τις αισθήσεις του, αρχίστε την παροχή πρώτων βοηθειών ΚΑΡΠΑ",(Object)(""));
...
mostCurrent._imageview7 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 54;BA.debugLine="Dim clv2 As CustomListView";
mostCurrent._clv2 = new firefighter.companion.customlistview();
 //BA.debugLineNum = 56;BA.debugLine="Dim Panel2 As Panel";
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 64;BA.debugLine="End Sub";
return "";
}
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 193;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 175;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 208;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 209;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
 //BA.debugLineNum = 210;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 189;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 202;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 203;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
 //BA.debugLineNum = 204;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 185;BA.debugLine="StartActivity(\"thlefona\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 200;BA.debugLine="StartActivity(\"thlefona\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("thlefona"));
 //BA.debugLineNum = 201;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 177;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 178;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 206;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
 //BA.debugLineNum = 207;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 181;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 196;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 197;BA.debugLine="StartActivity(\"karpa\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 211;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 212;BA.debugLine="StartActivity(\"karpa\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("karpa"));
