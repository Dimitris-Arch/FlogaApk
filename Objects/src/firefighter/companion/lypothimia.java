...
public class lypothimia extends Activity implements B4AActivity{
	public static lypothimia mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.lypothimia");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (lypothimia).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.lypothimia");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.lypothimia", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (lypothimia) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (lypothimia) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (lypothimia) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 68;BA.debugLine="Activity.LoadLayout(\"lipothimia.bal\")";
mostCurrent._activity.LoadLayout("lipothimia.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,lypothimia.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Ο βασικότερος λόγος της λιποθ";
mostCurrent._clv2._addtextitem /*String*/ ("Ο βασικότερος λόγος της λιποθυμίας είναι η αιφνίδια μείωση της παροχής αίματος στον εγκέφαλο ή πτώση του σακχάρου",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Έπειτα το θύμά έχει υποτονία και";
mostCurrent._clv2._addtextitem /*String*/ ("Έπειτα το θύμά έχει υποτονία και  απώλεια συνείδησης, συνήθως για σύντομο χρονικό διάστημα",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Συμπτώματα της λιποθυμίας είναι";
mostCurrent._clv2._addtextitem /*String*/ ("Συμπτώματα της λιποθυμίας είναι η μυηκή αδυναμία με έντονη εφίδρωση, ωχρότητα του προσώπου, ναυτία και ταχυκαρδία με επιτάχυνση της αναπνοής",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Οι αιτίες λιποθυμίας είναι η υπο";
mostCurrent._clv2._addtextitem /*String*/ ("Οι αιτίες λιποθυμίας είναι η υπογλυκαιμία, η αφυδάτωση, ο τραυματισμός της κεφαλής, και οι καρδιολογικές παθήσεις ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Αντιμετώπηση της λυποθυμίας\", \"\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αντιμετώπηση της λυποθυμίας",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Διαπιστώστε ότι δεν υπάρχει απόφ";
mostCurrent._clv2._addtextitem /*String*/ ("Διαπιστώστε ότι δεν υπάρχει απόφραξη αεροφόρων οδών από τη γλώσσα που δεν είναι γυρισμένη προς τα πίσω και ότι δεν υπάρχει τροφή ή εμέσματα στο στόμα.",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Χαλαρώστε τα ρούχα, γραβάτες, ζώ";
mostCurrent._clv2._addtextitem /*String*/ ("Χαλαρώστε τα ρούχα, γραβάτες, ζώνες, που μπορούν να εμποδίζουν τη φυσιολογική αναπνοή.",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Εάν η λυποθυμία ή τα σύμπτώματα";
mostCurrent._clv2._addtextitem /*String*/ ("Εάν η λυποθυμία ή τα σύμπτώματα της οφείλοντε σε έντονο ψυχικό στρες-κρίση πανικού, προσπαθείστε να το ηρεμήσετε και καθησυχάστε το",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"Σήκωστε τα πόδια του πάνω από το";
mostCurrent._clv2._addtextitem /*String*/ ("Σήκωστε τα πόδια του πάνω από το επίπεδο της καρδιάς.",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"Κράτηστέ το θύμα ξαπλωμένο για τ";
mostCurrent._clv2._addtextitem /*String*/ ("Κράτηστέ το θύμα ξαπλωμένο για τουλάχιστον 10 – 15 λεπτά.",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"Χαλάρωσε τα ρούχα του γύρω από τ";
mostCurrent._clv2._addtextitem /*String*/ ("Χαλάρωσε τα ρούχα του γύρω από το λαιμό και την κοιλιά.",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"Έλεγξε την αναπνοή και τον σφυγμ";
mostCurrent._clv2._addtextitem /*String*/ ("Έλεγξε την αναπνοή και τον σφυγμό του. ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"Μη δώσετε νερό ή τροφής, καφέ κα";
mostCurrent._clv2._addtextitem /*String*/ ("Μη δώσετε νερό ή τροφής, καφέ και αλκοόλ σε κάποιον ενώ είναι λιπόθυμος. Περιμένετε να συνέλθει και δώστε χυμό.",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"Αν για τη λιποθυμία ευθύνεται η";
mostCurrent._clv2._addtextitem /*String*/ ("Αν για τη λιποθυμία ευθύνεται η ζέστη φρόντιστε να μεταφερθεί σε δροσερό μέρος και να δροσιστεί με βρεγμένα πανιά.",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"Ακόμα και εάν δεν πρόκειται για";
mostCurrent._clv2._addtextitem /*String*/ ("Ακόμα και εάν δεν πρόκειται για επείγουσα κατάσταση, το θύμα θα πρέπει εξεταστελι απο γιατρό ειδικά αν έχει λιποθυμήσει ξανά στο παρελθόν",(Object)(""));
...
mostCurrent._textpin9 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 45;BA.debugLine="Private ImageView0 As ImageView";
...
mostCurrent._imageview6 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 52;BA.debugLine="Private ImageView7 As ImageView";
