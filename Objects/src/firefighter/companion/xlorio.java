...
public class xlorio extends Activity implements B4AActivity{
	public static xlorio mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.xlorio");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (xlorio).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.xlorio");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.xlorio", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (xlorio) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (xlorio) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (xlorio) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 45;BA.debugLine="Activity.LoadLayout(\"xlorio.bal\")";
mostCurrent._activity.LoadLayout("xlorio.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,xlorio.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"Το χλώριο UN-1017 είναι κιτρινοπ";
mostCurrent._clv2._addtextitem /*String*/ ("Το χλώριο UN-1017 είναι κιτρινοπράσινο αέριο πνιγηρό,δηλητηριώδες.",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"Το χλώριο είναι τοξικό και πολύ";
mostCurrent._clv2._addtextitem /*String*/ ("Το χλώριο είναι τοξικό και πολύ επικίνδυνο και για το περιβάλλον. Προκαλεί εγκαύματα με την επαφή. εισπνεόμενο προκαλλεί ακόμα και θάνατο.",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"ΧΡΗΣΙΜΟΠΟΙΗΣΤΕ ΣΤΟΛΗ ΧΗΜΙΚΗΣ ΠΡΟ";
mostCurrent._clv2._addtextitem /*String*/ ("ΧΡΗΣΙΜΟΠΟΙΗΣΤΕ ΣΤΟΛΗ ΧΗΜΙΚΗΣ ΠΡΟΣΤΑΣΙΑΣ ΚΛΕΙΣΤΟΥ ΤΥΠΟΥ ΜΕ ΠΛΗΡΗ ΑΠΟΜΟΝΩΣΗ.",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"Σταματήστε τη διαρροή αν μπορεί";
mostCurrent._clv2._addtextitem /*String*/ ("Σταματήστε τη διαρροή αν μπορεί να γίνει με ασφάλεια.Αν αυτό δεν είναι δυνατό διασκορπίστε την διαρροή με βολή ομίχλης",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Το χλώριο σε ένωση με το υδρογόν";
mostCurrent._clv2._addtextitem /*String*/ ("Το χλώριο σε ένωση με το υδρογόνο δημιουργεί υδροχλώριο που παράγεται εκρηκτικά και είναι τοξικό .",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2 ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Πυροδυναμωτικα,δηλητηριώδη και τ";
mostCurrent._clv2._addtextitem /*String*/ ("Πυροδυναμωτικα,δηλητηριώδη και τοξικα. ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Σε χώρους που δεν αερίζονται υπά";
mostCurrent._clv2._addtextitem /*String*/ ("Σε χώρους που δεν αερίζονται υπάρχει κίνδυνος ασφυξίας. ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑ";
mostCurrent._clv2._addtextitem /*String*/ ("ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑΣ.Αυλοί οροφής,εδάφους  ή άλλοι τηλεκατευθυνόμενοι έιναι ιδανικοί",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Άμεσος αποκλεισμός του χώρου σε";
mostCurrent._clv2._addtextitem /*String*/ ("Άμεσος αποκλεισμός του χώρου σε απόσταση 100 εώς 800 μέτρων σε μικρή πυρκαγιά και σε περίπτωση μεγάλης απόσταση 1600 μέτρων",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράν";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράνος,περισκελίδα,επενδύτη,γαντια και αναπνευστική συσκευή",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"Η προσβολή γίνεται απο την πλευρ";
mostCurrent._clv2._addtextitem /*String*/ ("Η προσβολή γίνεται απο την πλευρά που φυσάει ο άνεμος.Πάντα με την πλάτη στον άνεμο.Καλυφθείτε απο κάποιο εμπόδιο,τοίχο,όχημα ανάχωμα κτλ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"Μήν διασκορπίζετε την πυρκαγιά μ";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 196;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 198;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 180;BA.debugLine="StartActivity(\"Main\")";
...
public static String  _ililabel_click() throws Exception{
 ...
 //BA.debugLineNum = 212;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 213;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 194;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 190;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 183;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 185;BA.debugLine="Sub pixi_Click";
