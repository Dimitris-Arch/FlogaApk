...
public class petrelaio extends Activity implements B4AActivity{
	public static petrelaio mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.petrelaio");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (petrelaio).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.petrelaio");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.petrelaio", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (petrelaio) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (petrelaio) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (petrelaio) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 48;BA.debugLine="Activity.LoadLayout(\"petrelaio.bal\")";
mostCurrent._activity.LoadLayout("petrelaio.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,petrelaio.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Το πετρέλαιο ντήζελ (diesel) και";
mostCurrent._clv2._addtextitem /*String*/ ("Το πετρέλαιο ντήζελ (diesel) και το πετρέλαιο θέρμανσης UN-1202 είναι μίγμα υδρογονανθράκων.",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 3 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 3 ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Κίνδυνος ανάφλεξης από σπινθήρα";
mostCurrent._clv2._addtextitem /*String*/ ("Κίνδυνος ανάφλεξης από σπινθήρα ή στατικό ηλεκτρισμό.",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Πολύ διαδεδομένες ουσίες.\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Πολύ διαδεδομένες ουσίες.",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"Το πετρέλαιο και οι ατμοί του ει";
mostCurrent._clv2._addtextitem /*String*/ ("Το πετρέλαιο και οι ατμοί του ειναι πολύ εύφλεκτα  ",(Object)(""));
...
public static String  _ililabel_click() throws Exception{
 ...
 //BA.debugLineNum = 225;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 213;BA.debugLine="StartActivity(\"simanseis\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 228;BA.debugLine="Sub simansi_Click";
