...
public class egavma extends Activity implements B4AActivity{
	public static egavma mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.egavma");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (egavma).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.egavma");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.egavma", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (egavma) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (egavma) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (egavma) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="Activity.LoadLayout(\"egavma.bal\")";
mostCurrent._activity.LoadLayout("egavma.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,egavma.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Μετά τον έλεγχο της σκηνής και τ";
mostCurrent._clv2._addtextitem /*String*/ ("Μετά τον έλεγχο της σκηνής και του τραυματισμένου ατόμου :",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Ανάλογα με την ζημιά που προκαλε";
mostCurrent._clv2._addtextitem /*String*/ ("Ανάλογα με την ζημιά που προκαλείται στο σώμα, (έκταση, σοβαρότητα), τα εγκαύματα χωρίζονται σε τρεις κατηγορίες:",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"1ου βαθμού - όταν το κάψιμο περι";
mostCurrent._clv2._addtextitem /*String*/ ("1ου βαθμού - όταν το κάψιμο περιορίζεται στην επιφάνεια, το δέρμα φαίνεται κόκκινο, είναι θερμό όταν το αγγίζουμε και δεν υπάρχουν φουσκάλες.",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"2ου βαθμού - όταν το κάψιμο έχει";
mostCurrent._clv2._addtextitem /*String*/ ("2ου βαθμού - όταν το κάψιμο έχει πάει βαθύτερα, το δέρμα είναι κατακόκκινο, έχει κάνει φουσκάλες και προκαλεί δυνατό πόνο.",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"3ου βαθμού - όταν το κάψιμο φτάν";
mostCurrent._clv2._addtextitem /*String*/ ("3ου βαθμού - όταν το κάψιμο φτάνει μέχρι το υποδόριο λίπος και τα οστά και προκαλούνται βλάβες στα νεύρα, στα αιμοφόρα αγγεία, στους μυς και το δέρμα είναι ξηρό και σκληρό. .",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Αντιμετώπηση εγκαύματος.\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Αντιμετώπηση εγκαύματος.",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Απομάκρυνση από την πηγή θερμότη";
mostCurrent._clv2._addtextitem /*String*/ ("Απομάκρυνση από την πηγή θερμότητας",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Δροσίστε το έγκαυμα με κρύο τρεχ";
mostCurrent._clv2._addtextitem /*String*/ ("Δροσίστε το έγκαυμα με κρύο τρεχούμενο νερό τουλάχιστον έως ότου ανακουφιστεί κάπως απο τον πόνο .Το νερό θα πρέπει να είναι κρύο,αλλά όχι παγωμένο.Σκουπίζουμε προσεκτικά με καθαρό πανί αν όχι αποστειρωμένη γάζα,ΔΕΝ σπάμε ή ανοίγουμε τις φουσκάλες.",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"Αν είναι διαθέσιμη καλύπτουμε με";
mostCurrent._clv2._addtextitem /*String*/ ("Αν είναι διαθέσιμη καλύπτουμε με αλουμινοκουβέρτα αν όχι απλή κουβέρτα για να διατηριθει η θερμοκρασία",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"Καλύψτε με το χαλαρά αποστειρωμέ";
mostCurrent._clv2._addtextitem /*String*/ ("Καλύψτε με το χαλαρά αποστειρωμένη γάζα ή πανί. Δίνουμε να πιεί νερό με αλάτι,σιγα σιγα Καλέστε το 166 εάν το έγκαυμα είναι σοβαρό ή άλλη απειλητικη για τη ζωή συνθήκη επικρατεί .Μην βάλετε λάδια, αλοιφές, οδοντόκρεμες",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"Μην σπάτε τις φουσκάλες.Μην βάζε";
mostCurrent._clv2._addtextitem /*String*/ ("Μην σπάτε τις φουσκάλες.Μην βάζετε αντισηπτικά υγρά.Αν έχει κολλήσει ύφασμα στο έγκαυμα δεν το τραβάμε. Προσεκτικά κόβουμε με ψαλίδι το ύφασμα που είναι ελεύθερο .Τα εγκαύματα στο πρόσωπο, στις παλάμες και στα πέλματα (πατούσες)θεωρούνται από τα πιο σοβαρά και χρειάζεται άμεση μεταφορά στο νοσοκομείο",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 207;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 185;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 167;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 201;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
 //BA.debugLineNum = 202;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Sub katigor_Click";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 195;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
 //BA.debugLineNum = 196;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 177;BA.debugLine="StartActivity(\"thlefona\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 192;BA.debugLine="StartActivity(\"thlefona\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("thlefona"));
 //BA.debugLineNum = 193;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 169;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 170;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Sub ousialabel_Click";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 173;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 189;BA.debugLine="StartActivity(\"karpa\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 204;BA.debugLine="StartActivity(\"karpa\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("karpa"));
