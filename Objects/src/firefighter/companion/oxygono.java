...
public class oxygono extends Activity implements B4AActivity{
	public static oxygono mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.oxygono");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (oxygono).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.oxygono");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.oxygono", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (oxygono) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (oxygono) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (oxygono) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 46;BA.debugLine="Activity.LoadLayout(\"oxygono.bal\")";
mostCurrent._activity.LoadLayout("oxygono.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,oxygono.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"Το οξυγόνο UN-1072 είναι πυροδυν";
mostCurrent._clv2._addtextitem /*String*/ ("Το οξυγόνο UN-1072 είναι πυροδυναμωτικό αέριο.Είναι αέριο άχρωμο, άοσμο.ΕΙΝΑΙ ΤΟ ΤΡΙΤΟ ΣΤΟΙΧΕΊΟ ΤΟΥ ΤΡΙΓΩΝΟΥ ΤΗΣ ΦΩΤΙΑΣ. ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Σταματήστε τη διαρροή οξυγόνου α";
...
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2 ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Ευφλεκτα,πυροδυναμωτικα. \", \"\")";
