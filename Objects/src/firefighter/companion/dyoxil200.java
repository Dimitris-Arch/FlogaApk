...
public class dyoxil200 extends Activity implements B4AActivity{
	public static dyoxil200 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dyoxil200");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dyoxil200).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dyoxil200");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dyoxil200", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dyoxil200) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dyoxil200) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dyoxil200) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dyoxil200.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"   2186	Κατηγορία 2	Υδροχλώριο ,";
mostCurrent._clv2._addtextitem /*String*/ ("   2186	Κατηγορία 2	Υδροχλώριο , κατεψυγμένο, υγρό	     ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"   2187	Κατηγορία 2	Το διοξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("   2187	Κατηγορία 2	Το διοξείδιο  άνθρακα , κατεψυγμένο, υγρό	  ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"  2188	Κατηγορία 2	Αρσίνη";
mostCurrent._clv2._addtextitem /*String*/ ("  2188	Κατηγορία 2	Αρσίνη	     ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"  2189	Κατηγορία 2	Διχλωροσιλάν";
mostCurrent._clv2._addtextitem /*String*/ ("  2189	Κατηγορία 2	Διχλωροσιλάνιο	     ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"  2190	Κατηγορία 2	Διφθοριούχο";
mostCurrent._clv2._addtextitem /*String*/ ("  2190	Κατηγορία 2	Διφθοριούχο οξυγόνο , συμπιεσμένο	     ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"  2191	Κατηγορία 2	Σουλφουριλοφ";
mostCurrent._clv2._addtextitem /*String*/ ("  2191	Κατηγορία 2	Σουλφουριλοφθοριδίου	     ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"   2192	Κατηγορία 2	Σχετικός";
mostCurrent._clv2._addtextitem /*String*/ ("   2192	Κατηγορία 2	Σχετικός	     ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"   2193	Κατηγορία 2	Εξαφθοροαιθά";
mostCurrent._clv2._addtextitem /*String*/ ("   2193	Κατηγορία 2	Εξαφθοροαιθάνιο , συμπιεσμένα ή ψυκτικό αέριο R 116	  ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"   2194	Κατηγορία 2	Σελήνιο εξαφ";
mostCurrent._clv2._addtextitem /*String*/ ("   2194	Κατηγορία 2	Σελήνιο εξαφθοριούχο	     ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"   2195	Κατηγορία 2	Τελλούριο εξ";
mostCurrent._clv2._addtextitem /*String*/ ("   2195	Κατηγορία 2	Τελλούριο εξαφθοριούχο	     ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"   2196	Κατηγορία 2	Tungsten εξα";
mostCurrent._clv2._addtextitem /*String*/ ("   2196	Κατηγορία 2	Tungsten εξαφθοριούχο	     ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"   2197	Κατηγορία 2	Υδροϊώδιο ,";
mostCurrent._clv2._addtextitem /*String*/ ("   2197	Κατηγορία 2	Υδροϊώδιο , άνυδρο	     ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"   2198	Κατηγορία 2	Πενταφθοριού";
mostCurrent._clv2._addtextitem /*String*/ ("   2198	Κατηγορία 2	Πενταφθοριούχος φωσφόρος , συμπιεσμένο	     ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"   2199	Κατηγορία 2	Η φωσφίνη";
mostCurrent._clv2._addtextitem /*String*/ ("   2199	Κατηγορία 2	Η φωσφίνη	     ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"   2200	Κατηγορία 2	Προπαδιενίου";
mostCurrent._clv2._addtextitem /*String*/ ("   2200	Κατηγορία 2	Προπαδιενίου , αναστέλλεται	   ",(Object)(""));
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 144;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 147;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 148;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 149;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 150;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 151;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 152;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 153;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 154;BA.debugLine="chk.Initialize(\"\")";
...
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 157;BA.debugLine="lbl.Gravity = Bit.OR(Gravity.CENTER_VERTICAL, Gra";
...
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 159;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 160;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 161;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 162;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 163;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 164;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 165;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 195;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 197;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 179;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 213;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 214;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 192;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 193;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 189;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub listabel_Click";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 182;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 209;BA.debugLine="Sub ousialabel_Click";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Sub pixi_Click";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub simanseislabel_Click";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Sub simansi_Click";
