...
public class xilia900 extends Activity implements B4AActivity{
	public static xilia900 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.xilia900");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (xilia900).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.xilia900");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.xilia900", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (xilia900) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (xilia900) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (xilia900) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,xilia900.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 123;BA.debugLine="clv2.AddTextItem(\"1801	ΚΑΤΗΓΟΡΙΑ 8	Οκτυλοτριχλωροσ";
mostCurrent._clv2._addtextitem /*String*/ ("1801	ΚΑΤΗΓΟΡΙΑ 8	Οκτυλοτριχλωροσιλανίου	",(Object)(""));
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"1802	ΚΑΤΗΓΟΡΙΑ 8	Υπερχλωρικό οξύ";
mostCurrent._clv2._addtextitem /*String*/ ("1802	ΚΑΤΗΓΟΡΙΑ 8	Υπερχλωρικό οξύ ",(Object)(""));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"1803	ΚΑΤΗΓΟΡΙΑ 8	Φαινολοσουλφονι";
mostCurrent._clv2._addtextitem /*String*/ ("1803	ΚΑΤΗΓΟΡΙΑ 8	Φαινολοσουλφονικού οξέος , υγρό	",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"1804	ΚΑΤΗΓΟΡΙΑ 8	Phenyltrichloro";
mostCurrent._clv2._addtextitem /*String*/ ("1804	ΚΑΤΗΓΟΡΙΑ 8	Phenyltrichlorosilane	   ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"1805	ΚΑΤΗΓΟΡΙΑ 8	Φωσφορικό οξύ";
mostCurrent._clv2._addtextitem /*String*/ ("1805	ΚΑΤΗΓΟΡΙΑ 8	Φωσφορικό οξύ	   ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"1805	ΚΑΤΗΓΟΡΙΑ 8	Phosphorsure, f";
mostCurrent._clv2._addtextitem /*String*/ ("1805	ΚΑΤΗΓΟΡΙΑ 8	Phosphorsure, fest	   ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"1806	ΚΑΤΗΓΟΡΙΑ 8	Προστέθηκε πεντ";
mostCurrent._clv2._addtextitem /*String*/ ("1806	ΚΑΤΗΓΟΡΙΑ 8	Προστέθηκε πενταχλωριούχος φωσφόρος	   ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"1807	ΚΑΤΗΓΟΡΙΑ 8	Πεντοξείδιο  φω";
mostCurrent._clv2._addtextitem /*String*/ ("1807	ΚΑΤΗΓΟΡΙΑ 8	Πεντοξείδιο  φωσφόρου	   ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"1808	ΚΑΤΗΓΟΡΙΑ 8	Φωσφόρο τριβρωμ";
mostCurrent._clv2._addtextitem /*String*/ ("1808	ΚΑΤΗΓΟΡΙΑ 8	Φωσφόρο τριβρωμιούχο	   ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"1809	ΚΑΤΗΓΟΡΙΑ 6.1	Τριχλωριούχος";
mostCurrent._clv2._addtextitem /*String*/ ("1809	ΚΑΤΗΓΟΡΙΑ 6.1	Τριχλωριούχος φωσφόρος	   ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"1810	ΚΑΤΗΓΟΡΙΑ 8	Οξυχλωριούχου φ";
mostCurrent._clv2._addtextitem /*String*/ ("1810	ΚΑΤΗΓΟΡΙΑ 8	Οξυχλωριούχου φωσφόρου	   ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"1811	ΚΑΤΗΓΟΡΙΑ 8	Hydrogendifluor";
mostCurrent._clv2._addtextitem /*String*/ ("1811	ΚΑΤΗΓΟΡΙΑ 8	Hydrogendifluoride κάλιο 	   ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"1812	ΚΑΤΗΓΟΡΙΑ 8	Φθοριούχο κάλιο";
mostCurrent._clv2._addtextitem /*String*/ ("1812	ΚΑΤΗΓΟΡΙΑ 8	Φθοριούχο κάλιο	  ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"1813	ΚΑΤΗΓΟΡΙΑ 8	Υδροξείδιο  καλ";
mostCurrent._clv2._addtextitem /*String*/ ("1813	ΚΑΤΗΓΟΡΙΑ 8	Υδροξείδιο  καλίου , στερεό	   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"1814	ΚΑΤΗΓΟΡΙΑ 8	Διάλυμα υδροξει";
mostCurrent._clv2._addtextitem /*String*/ ("1814	ΚΑΤΗΓΟΡΙΑ 8	Διάλυμα υδροξειδίου  καλίου	   ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"1815	ΚΑΤΗΓΟΡΙΑ 3	Προπιονυλοχλωρί";
mostCurrent._clv2._addtextitem /*String*/ ("1815	ΚΑΤΗΓΟΡΙΑ 3	Προπιονυλοχλωρίδιο	   ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"1816	ΚΑΤΗΓΟΡΙΑ 8	Propyltrichloro";
mostCurrent._clv2._addtextitem /*String*/ ("1816	ΚΑΤΗΓΟΡΙΑ 8	Propyltrichlorosilane	   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"1817	ΚΑΤΗΓΟΡΙΑ 8	Pyrosulfuryl χλ";
mostCurrent._clv2._addtextitem /*String*/ ("1817	ΚΑΤΗΓΟΡΙΑ 8	Pyrosulfuryl χλωριούχο	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"1818	ΚΑΤΗΓΟΡΙΑ 8	Τετραχλωριούχου";
mostCurrent._clv2._addtextitem /*String*/ ("1818	ΚΑΤΗΓΟΡΙΑ 8	Τετραχλωριούχου πυριτίου	   ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"1819	ΚΑΤΗΓΟΡΙΑ 8	Αργιλικό νάτριο";
mostCurrent._clv2._addtextitem /*String*/ ("1819	ΚΑΤΗΓΟΡΙΑ 8	Αργιλικό νάτριο , διάλυμα	   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"1823	ΚΑΤΗΓΟΡΙΑ 8	Υδροξείδιο  νατ";
mostCurrent._clv2._addtextitem /*String*/ ("1823	ΚΑΤΗΓΟΡΙΑ 8	Υδροξείδιο  νατρίου , στερεό	   ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"1824	ΚΑΤΗΓΟΡΙΑ 8	Διάλυμα υδροξει";
mostCurrent._clv2._addtextitem /*String*/ ("1824	ΚΑΤΗΓΟΡΙΑ 8	Διάλυμα υδροξειδίου  νατρίου	   ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"1825	ΚΑΤΗΓΟΡΙΑ 8	Μονοξείδιο  νατ";
mostCurrent._clv2._addtextitem /*String*/ ("1825	ΚΑΤΗΓΟΡΙΑ 8	Μονοξείδιο  νατρίου	   ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"1826	ΚΑΤΗΓΟΡΙΑ 8	Οξέος νίτρωσης";
mostCurrent._clv2._addtextitem /*String*/ ("1826	ΚΑΤΗΓΟΡΙΑ 8	Οξέος νίτρωσης μείγματα",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"1827	ΚΑΤΗΓΟΡΙΑ 8	Χλωριούχου κασσ";
mostCurrent._clv2._addtextitem /*String*/ ("1827	ΚΑΤΗΓΟΡΙΑ 8	Χλωριούχου κασσιτέρου , άνυδρο	 ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"1828	ΚΑΤΗΓΟΡΙΑ 8	Χλωρίδια θείου";
mostCurrent._clv2._addtextitem /*String*/ ("1828	ΚΑΤΗΓΟΡΙΑ 8	Χλωρίδια θείου	   ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"1829	ΚΑΤΗΓΟΡΙΑ 8	Τριοξείδιο  θεί";
mostCurrent._clv2._addtextitem /*String*/ ("1829	ΚΑΤΗΓΟΡΙΑ 8	Τριοξείδιο  θείου ή τριοξείδιο  θείου	   ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"1830	ΚΑΤΗΓΟΡΙΑ 8	Το θειικό οξύ μ";
mostCurrent._clv2._addtextitem /*String*/ ("1830	ΚΑΤΗΓΟΡΙΑ 8	Το θειικό οξύ με περισσότερο από 51 τοις εκατό οξύ	   ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"1831	ΚΑΤΗΓΟΡΙΑ 8	Θειικό οξύ, ατμ";
mostCurrent._clv2._addtextitem /*String*/ ("1831	ΚΑΤΗΓΟΡΙΑ 8	Θειικό οξύ, ατμίζον",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"1832	ΚΑΤΗΓΟΡΙΑ 8	Θειικό οξύ	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("1832	ΚΑΤΗΓΟΡΙΑ 8	Θειικό οξύ	   ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"1833	ΚΑΤΗΓΟΡΙΑ 8	Θειώδες οξύ";
mostCurrent._clv2._addtextitem /*String*/ ("1833	ΚΑΤΗΓΟΡΙΑ 8	Θειώδες οξύ	   ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"1834	ΚΑΤΗΓΟΡΙΑ 8	Σουλφουρυλο χλω";
mostCurrent._clv2._addtextitem /*String*/ ("1834	ΚΑΤΗΓΟΡΙΑ 8	Σουλφουρυλο χλωρίδιο	",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"1835	ΚΑΤΗΓΟΡΙΑ 8	Υδροξείδιο τετρ";
mostCurrent._clv2._addtextitem /*String*/ ("1835	ΚΑΤΗΓΟΡΙΑ 8	Υδροξείδιο τετραμεθυλαμμωνίου	",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"1836	ΚΑΤΗΓΟΡΙΑ 8	Θειονυλοχλωρίδι";
mostCurrent._clv2._addtextitem /*String*/ ("1836	ΚΑΤΗΓΟΡΙΑ 8	Θειονυλοχλωρίδιο	   ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"1837	ΚΑΤΗΓΟΡΙΑ 8	Θειοφωσφορυλο χ";
mostCurrent._clv2._addtextitem /*String*/ ("1837	ΚΑΤΗΓΟΡΙΑ 8	Θειοφωσφορυλο χλωριούχο	   ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"1838	ΚΑΤΗΓΟΡΙΑ 8	Τετραχλωριούχο";
mostCurrent._clv2._addtextitem /*String*/ ("1838	ΚΑΤΗΓΟΡΙΑ 8	Τετραχλωριούχο τιτάνιο	   ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"1839	ΚΑΤΗΓΟΡΙΑ 8	Τριχλωροξικό οξ";
mostCurrent._clv2._addtextitem /*String*/ ("1839	ΚΑΤΗΓΟΡΙΑ 8	Τριχλωροξικό οξύ	   ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"1840	ΚΑΤΗΓΟΡΙΑ 8	Χλωριούχου ψευδ";
mostCurrent._clv2._addtextitem /*String*/ ("1840	ΚΑΤΗΓΟΡΙΑ 8	Χλωριούχου ψευδαργύρου , λύση	",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"1841	ΚΑΤΗΓΟΡΙΑ 9	Η ακεταλδεΰδη α";
mostCurrent._clv2._addtextitem /*String*/ ("1841	ΚΑΤΗΓΟΡΙΑ 9	Η ακεταλδεΰδη αμμωνία	   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"1843	ΚΑΤΗΓΟΡΙΑ 6.1	Αμμώνιο dintr";
mostCurrent._clv2._addtextitem /*String*/ ("1843	ΚΑΤΗΓΟΡΙΑ 6.1	Αμμώνιο dintro-ο-κρεζολικό	   ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"1845	ΚΑΤΗΓΟΡΙΑ 9	Διοξείδιο  άνθρ";
mostCurrent._clv2._addtextitem /*String*/ ("1845	ΚΑΤΗΓΟΡΙΑ 9	Διοξείδιο  άνθρακα , στερεό, που ονομάζεται επίσης Ξηρός πάγος	 ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"1846	ΚΑΤΗΓΟΡΙΑ 8	Τετραχλωράνθρακ";
mostCurrent._clv2._addtextitem /*String*/ ("1846	ΚΑΤΗΓΟΡΙΑ 8	Τετραχλωράνθρακας	   ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"1847	ΚΑΤΗΓΟΡΙΑ 8	Θειούχο κάλιο ,";
mostCurrent._clv2._addtextitem /*String*/ ("1847	ΚΑΤΗΓΟΡΙΑ 8	Θειούχο κάλιο , ένυδρο	   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"1848	ΚΑΤΗΓΟΡΙΑ 8	Το προπιονικό ο";
mostCurrent._clv2._addtextitem /*String*/ ("1848	ΚΑΤΗΓΟΡΙΑ 8	Το προπιονικό οξύ	   ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"1849	ΚΑΤΗΓΟΡΙΑ 6.1	Θειούχο νάτρι";
mostCurrent._clv2._addtextitem /*String*/ ("1849	ΚΑΤΗΓΟΡΙΑ 6.1	Θειούχο νάτριο , ένυδρο με όχι λιγότερο από 30 τοις εκατό νερό",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"1851	ΚΑΤΗΓΟΡΙΑ 6.1	Φάρμακο , υγρ";
mostCurrent._clv2._addtextitem /*String*/ ("1851	ΚΑΤΗΓΟΡΙΑ 6.1	Φάρμακο , υγρό, τοξικό, nos	   ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"1854	ΚΑΤΗΓΟΡΙΑ 4.2	Βαρίου κράματ";
mostCurrent._clv2._addtextitem /*String*/ ("1854	ΚΑΤΗΓΟΡΙΑ 4.2	Βαρίου κράματα , πυροφορικά	   ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"1855	ΚΑΤΗΓΟΡΙΑ 2	Ασβέστιο , πυρο";
mostCurrent._clv2._addtextitem /*String*/ ("1855	ΚΑΤΗΓΟΡΙΑ 2	Ασβέστιο , πυροφορικά ή ασβεστίου κράματα, πυροφορικά	   ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"1858	ΚΑΤΗΓΟΡΙΑ 2	Εξαφθωροπροπυλέ";
mostCurrent._clv2._addtextitem /*String*/ ("1858	ΚΑΤΗΓΟΡΙΑ 2	Εξαφθωροπροπυλένιο , συμπιεσμένα ή ψυκτικό αέριο R 1216	   ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"1859	ΚΑΤΗΓΟΡΙΑ 2	Τετραφθοριούχο";
mostCurrent._clv2._addtextitem /*String*/ ("1859	ΚΑΤΗΓΟΡΙΑ 2	Τετραφθοριούχο πυρίτιο , συμπιεσμένο	   ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"1860	ΚΑΤΗΓΟΡΙΑ 3	Φθοριούχο βινύλ";
mostCurrent._clv2._addtextitem /*String*/ ("1860	ΚΑΤΗΓΟΡΙΑ 3	Φθοριούχο βινύλιο 	   ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"1862	ΚΑΤΗΓΟΡΙΑ 3	Αιθύλιο κροτονι";
mostCurrent._clv2._addtextitem /*String*/ ("1862	ΚΑΤΗΓΟΡΙΑ 3	Αιθύλιο κροτονικό	   ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"1863	ΚΑΤΗΓΟΡΙΑ 3	Καυσίμων , αερο";
mostCurrent._clv2._addtextitem /*String*/ ("1863	ΚΑΤΗΓΟΡΙΑ 3	Καυσίμων , αεροπορία, στροβιλοκινητήρα	   ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"1865	ΚΑΤΗΓΟΡΙΑ 3	Νιτρικό Ν-Προπυ";
mostCurrent._clv2._addtextitem /*String*/ ("1865	ΚΑΤΗΓΟΡΙΑ 3	Νιτρικό Ν-Προπυλ	   ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"1866	ΚΑΤΗΓΟΡΙΑ 3	Διάλυμα ρητίνης";
mostCurrent._clv2._addtextitem /*String*/ ("1866	ΚΑΤΗΓΟΡΙΑ 3	Διάλυμα ρητίνης, εύφλεκτο	   ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"1868	ΚΑΤΗΓΟΡΙΑ 4.1	Δεκαβοράνιο";
mostCurrent._clv2._addtextitem /*String*/ ("1868	ΚΑΤΗΓΟΡΙΑ 4.1	Δεκαβοράνιο	   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"1869	ΚΑΤΗΓΟΡΙΑ 4.3	Μαγνήσιο ή κρ";
mostCurrent._clv2._addtextitem /*String*/ ("1869	ΚΑΤΗΓΟΡΙΑ 4.3	Μαγνήσιο ή κράματα μαγνησίου, ρινίσματα, ή κορδέλες	",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"1870	ΚΑΤΗΓΟΡΙΑ 4.1	Βοροϋδριδίου";
mostCurrent._clv2._addtextitem /*String*/ ("1870	ΚΑΤΗΓΟΡΙΑ 4.1	Βοροϋδριδίου  καλίου	   ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"1871	ΚΑΤΗΓΟΡΙΑ 5.1	Υδριδίου  τιτ";
mostCurrent._clv2._addtextitem /*String*/ ("1871	ΚΑΤΗΓΟΡΙΑ 5.1	Υδριδίου  τιτανίου	   ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"1872	ΚΑΤΗΓΟΡΙΑ 5.1	Διοξείδιο  μο";
mostCurrent._clv2._addtextitem /*String*/ ("1872	ΚΑΤΗΓΟΡΙΑ 5.1	Διοξείδιο  μολύβδου	   ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"1873	ΚΑΤΗΓΟΡΙΑ 6.1	Υπερχλωρικό ο";
mostCurrent._clv2._addtextitem /*String*/ ("1873	ΚΑΤΗΓΟΡΙΑ 6.1	Υπερχλωρικό οξύ 	   ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"1884	ΚΑΤΗΓΟΡΙΑ 6.1	Οξείδιο  βαρί";
mostCurrent._clv2._addtextitem /*String*/ ("1884	ΚΑΤΗΓΟΡΙΑ 6.1	Οξείδιο  βαρίου	   ",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"1885	ΚΑΤΗΓΟΡΙΑ 6.1	Βενζιδίνη";
mostCurrent._clv2._addtextitem /*String*/ ("1885	ΚΑΤΗΓΟΡΙΑ 6.1	Βενζιδίνη	   ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"1886	ΚΑΤΗΓΟΡΙΑ 6.1	Βενζυλιδεν χλ";
mostCurrent._clv2._addtextitem /*String*/ ("1886	ΚΑΤΗΓΟΡΙΑ 6.1	Βενζυλιδεν χλωριούχο	",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"1887	ΚΑΤΗΓΟΡΙΑ 6.1	Βρωμοχλωρομεθ";
mostCurrent._clv2._addtextitem /*String*/ ("1887	ΚΑΤΗΓΟΡΙΑ 6.1	Βρωμοχλωρομεθάνιο	",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"1888	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωροφόρμιο";
mostCurrent._clv2._addtextitem /*String*/ ("1888	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωροφόρμιο	   ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"1889	ΚΑΤΗΓΟΡΙΑ 6.1	Βρωμιούχο κυά";
mostCurrent._clv2._addtextitem /*String*/ ("1889	ΚΑΤΗΓΟΡΙΑ 6.1	Βρωμιούχο κυάνιο	   ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"1891	ΚΑΤΗΓΟΡΙΑ 6.1	Βρωμιούχο αιθ";
mostCurrent._clv2._addtextitem /*String*/ ("1891	ΚΑΤΗΓΟΡΙΑ 6.1	Βρωμιούχο αιθύλιο	   ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"1892	ΚΑΤΗΓΟΡΙΑ 6.1	Αιθυλοδιχλωρο";
mostCurrent._clv2._addtextitem /*String*/ ("1892	ΚΑΤΗΓΟΡΙΑ 6.1	Αιθυλοδιχλωροαρσίνη	   ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"1894	ΚΑΤΗΓΟΡΙΑ 6.1	Φαινυλυδράργυ";
mostCurrent._clv2._addtextitem /*String*/ ("1894	ΚΑΤΗΓΟΡΙΑ 6.1	Φαινυλυδράργυρο υδροξείδιο	   ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"1895	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτρικός φαιν";
mostCurrent._clv2._addtextitem /*String*/ ("1895	ΚΑΤΗΓΟΡΙΑ 6.1	Νιτρικός φαινυλυδράργυρος	   ",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"1897	ΚΑΤΗΓΟΡΙΑ 6.1	Tetrachloroet";
mostCurrent._clv2._addtextitem /*String*/ ("1897	ΚΑΤΗΓΟΡΙΑ 6.1	Tetrachloroethylene	   ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"1898	ΚΑΤΗΓΟΡΙΑ 8	Ακετυλο ιωδίδιο";
mostCurrent._clv2._addtextitem /*String*/ ("1898	ΚΑΤΗΓΟΡΙΑ 8	Ακετυλο ιωδίδιο",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 275;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 250;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 252;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 233;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 234;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 247;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 248;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 244;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 236;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 237;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 239;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 240;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 271;BA.debugLine="Sub simansi_Click";
