...
public class dyoxil900 extends Activity implements B4AActivity{
	public static dyoxil900 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dyoxil900");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dyoxil900).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dyoxil900");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dyoxil900", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dyoxil900) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dyoxil900) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dyoxil900) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dyoxil900.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"2801	Κατηγορία 8	Βαφές , υγρά, δ";
mostCurrent._clv2._addtextitem /*String*/ ("2801	Κατηγορία 8	Βαφές , υγρά, διαβρωτικά, ε.α.ο. ή Dye ενδιάμεσα, υγρά, διαβρωτικά, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"2802	Κατηγορία 8	Χλωριούχου χαλκ";
mostCurrent._clv2._addtextitem /*String*/ ("2802	Κατηγορία 8	Χλωριούχου χαλκού	      ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"2803	Κατηγορία 8	Γάλλιο	      \"";
mostCurrent._clv2._addtextitem /*String*/ ("2803	Κατηγορία 8	Γάλλιο	      ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"2805	Κατηγορία 4.3	Υδρίδιο  λιθί";
mostCurrent._clv2._addtextitem /*String*/ ("2805	Κατηγορία 4.3	Υδρίδιο  λιθίου , συντηγμένο στερεό	      ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"2806	Κατηγορία 4.3	Νιτρίδιο  λιθ";
mostCurrent._clv2._addtextitem /*String*/ ("2806	Κατηγορία 4.3	Νιτρίδιο  λιθίου	      ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"2807	Κατηγορία 9	Μαγνητισμένο υλ";
mostCurrent._clv2._addtextitem /*String*/ ("2807	Κατηγορία 9	Μαγνητισμένο υλικό	      ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"2809	Κατηγορία 8	Ερμής ή Ερμής π";
mostCurrent._clv2._addtextitem /*String*/ ("2809	Κατηγορία 8	Ερμής ή Ερμής που περιέχονται σε βιομηχανικά είδη	      ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"2810	Κατηγορία 6.1	Τοξικό, υγρά,";
mostCurrent._clv2._addtextitem /*String*/ ("2810	Κατηγορία 6.1	Τοξικό, υγρά, οργανικά, ε.α.ο. ή τοξικές, υγρά, οργανικά, ε.α.ο. Εισπνοή κινδύνου, ομάδα συσκευασίας I, Ζώνη Α ή Β	      ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"2811	Κατηγορία 6.1	Τοξικά στερεά";
mostCurrent._clv2._addtextitem /*String*/ ("2811	Κατηγορία 6.1	Τοξικά στερεά, οργανικά, ε.α.ο.	      ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"2812	Κατηγορία 8	Αργιλικό νάτριο";
mostCurrent._clv2._addtextitem /*String*/ ("2812	Κατηγορία 8	Αργιλικό νάτριο , στερεά	      ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"2813	Κατηγορία 4.3	Αντιδρούν με";
mostCurrent._clv2._addtextitem /*String*/ ("2813	Κατηγορία 4.3	Αντιδρούν με  νερό στερεά, ε.α.ο.	      ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"2814	Κατηγορία 6.2	Μολυσματική ύ";
mostCurrent._clv2._addtextitem /*String*/ ("2814	Κατηγορία 6.2	Μολυσματική ύλη, που προσβάλλει τον άνθρωπο	      ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"2814	Κατηγορία 6.2	Μολυσματική ύ";
mostCurrent._clv2._addtextitem /*String*/ ("2814	Κατηγορία 6.2	Μολυσματική ύλη, που προσβάλλει τους ανθρώπους (Κινδύνων  Ομίλου Κατηγορία 2).	      ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"2815	Κατηγορία 8	Ν-αμινοαιθυλπιπ";
mostCurrent._clv2._addtextitem /*String*/ ("2815	Κατηγορία 8	Ν-αμινοαιθυλπιπεραζίνη	      ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"2817	Κατηγορία 8	Hydrogendiflour";
mostCurrent._clv2._addtextitem /*String*/ ("2817	Κατηγορία 8	Hydrogendiflouride αμμώνιο , λύση	      ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"2818	Κατηγορία 8	Πολυσουλφίδιο α";
mostCurrent._clv2._addtextitem /*String*/ ("2818	Κατηγορία 8	Πολυσουλφίδιο αμμωνίου , λύση	      ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"2819	Κατηγορία 8	Αμυλεστέρας φωσ";
mostCurrent._clv2._addtextitem /*String*/ ("2819	Κατηγορία 8	Αμυλεστέρας φωσφορικό οξύ	      ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"2820	Κατηγορία 8	Βουτυρικό οξύ";
mostCurrent._clv2._addtextitem /*String*/ ("2820	Κατηγορία 8	Βουτυρικό οξύ	     ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"2821	Κατηγορία 6.1	Η φαινόλη   \"";
mostCurrent._clv2._addtextitem /*String*/ ("2821	Κατηγορία 6.1	Η φαινόλη   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"2822	Κατηγορία 6.1	Κατηγορία 2-χ";
mostCurrent._clv2._addtextitem /*String*/ ("2822	Κατηγορία 6.1	Κατηγορία 2-χλωροπυριδίνη	      ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"2823	Κατηγορία 8	Κροτονικού οξέο";
mostCurrent._clv2._addtextitem /*String*/ ("2823	Κατηγορία 8	Κροτονικού οξέος υγρό ή κροτωνικό οξύ στερεό	    ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"2826	Κατηγορία 8	Ethyl χλωροθειο";
mostCurrent._clv2._addtextitem /*String*/ ("2826	Κατηγορία 8	Ethyl χλωροθειομυρμηκικού	      ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"2829	Κατηγορία 8	Καπροϊκό οξύ";
mostCurrent._clv2._addtextitem /*String*/ ("2829	Κατηγορία 8	Καπροϊκό οξύ	      ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"2830	Κατηγορία 4.3	ΣιδηροπυρΙτιο";
mostCurrent._clv2._addtextitem /*String*/ ("2830	Κατηγορία 4.3	ΣιδηροπυρΙτιο λιθίου	      ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"2831	Κατηγορία 6.1";
mostCurrent._clv2._addtextitem /*String*/ ("2831	Κατηγορία 6.1              Tριχλωροαιθάνιο	      ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"2834	Κατηγορία 8	Φωσφορώδες οξύ";
mostCurrent._clv2._addtextitem /*String*/ ("2834	Κατηγορία 8	Φωσφορώδες οξύ	      ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"2835	Κατηγορία 4.3	Νάτριο υδριδί";
mostCurrent._clv2._addtextitem /*String*/ ("2835	Κατηγορία 4.3	Νάτριο υδριδίου αργιλίου	      ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"2837	Κατηγορία 8	Διθειικό , υδατ";
mostCurrent._clv2._addtextitem /*String*/ ("2837	Κατηγορία 8	Διθειικό , υδατικό διάλυμα	      ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"2838	Κατηγορία 3	Βουτυρικό βινύλ";
mostCurrent._clv2._addtextitem /*String*/ ("2838	Κατηγορία 3	Βουτυρικό βινύλιο    ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"2839	Κατηγορία 6.1	Αλδολικές";
mostCurrent._clv2._addtextitem /*String*/ ("2839	Κατηγορία 6.1	Αλδολικές	      ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"2840	Κατηγορία 3	Butyraldoxime";
mostCurrent._clv2._addtextitem /*String*/ ("2840	Κατηγορία 3	Butyraldoxime	    ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"2841	Κατηγορία 3	Δι-κ-αμυλαμίνη";
mostCurrent._clv2._addtextitem /*String*/ ("2841	Κατηγορία 3	Δι-κ-αμυλαμίνη	   ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"2842	Κατηγορία 3	Νιτροαιθάνιο";
mostCurrent._clv2._addtextitem /*String*/ ("2842	Κατηγορία 3	Νιτροαιθάνιο	   ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"2844	Κατηγορία 4.3	Ασβέστιο πυρι";
mostCurrent._clv2._addtextitem /*String*/ ("2844	Κατηγορία 4.3	Ασβέστιο πυριτίου μαγγάνιο	      ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"2845	Κατηγορία 4.2	Πυροφορικά υγ";
mostCurrent._clv2._addtextitem /*String*/ ("2845	Κατηγορία 4.2	Πυροφορικά υγρά, οργανικά, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"2846	Κατηγορία 4.2	Πυροφορικά στ";
mostCurrent._clv2._addtextitem /*String*/ ("2846	Κατηγορία 4.2	Πυροφορικά στερεά, οργανικά, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"2849	Κατηγορία 6.1	Xλωροπροπανόλ";
mostCurrent._clv2._addtextitem /*String*/ ("2849	Κατηγορία 6.1	Xλωροπροπανόλη	      ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"2850	Κατηγορία 3	Τετραμερές προπ";
mostCurrent._clv2._addtextitem /*String*/ ("2850	Κατηγορία 3	Τετραμερές προπυλένιο	   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"2851	Κατηγορία 8	Βόριο τριφθοριο";
mostCurrent._clv2._addtextitem /*String*/ ("2851	Κατηγορία 8	Βόριο τριφθοριούχο διένυδρο	      ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"2852	Κατηγορία 4.1	Διπικρύλιο σο";
mostCurrent._clv2._addtextitem /*String*/ ("2852	Κατηγορία 4.1	Διπικρύλιο σουλφίδιο , βρεγμένο με όχι λιγότερο από 10 τοις εκατό νερό, κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"2853	Κατηγορία 6.1	Φθοριοπυρι μα";
mostCurrent._clv2._addtextitem /*String*/ ("2853	Κατηγορία 6.1	Φθοριοπυρι μαγνήσιο	      ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"2854	Κατηγορία 6.1	Φθοροπυριτικό";
mostCurrent._clv2._addtextitem /*String*/ ("2854	Κατηγορία 6.1	Φθοροπυριτικό αμμώνιο	      ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"2855	Κατηγορία 6.1	Φθοριοπυρι ψε";
mostCurrent._clv2._addtextitem /*String*/ ("2855	Κατηγορία 6.1	Φθοριοπυρι ψευδαργύρου	      ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"2856	Κατηγορία 6.1	Φθοροπυριτικά";
mostCurrent._clv2._addtextitem /*String*/ ("2856	Κατηγορία 6.1	Φθοροπυριτικά , ε.α.ο.	      ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"2857	Κατηγορία 2	Ψυκτικές μηχανέ";
mostCurrent._clv2._addtextitem /*String*/ ("2857	Κατηγορία 2	Ψυκτικές μηχανές , που περιέχουν μη εύφλεκτο, μη τοξικό, υγροποιημένο αέριο ή διάλυμα αμμωνίας (UN2672)	   ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"2858	Κατηγορία 4.1	Ζιρκόνιο , ξη";
mostCurrent._clv2._addtextitem /*String*/ ("2858	Κατηγορία 4.1	Ζιρκόνιο , ξηρό, περιτυλιγμένα σύρμα   ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"2859	Κατηγορία 6.1	Μεταβαναδικό";
mostCurrent._clv2._addtextitem /*String*/ ("2859	Κατηγορία 6.1	Μεταβαναδικό αμμώνιο	      ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"2860	Κατηγορία 6.1	Βαναδίου τριο";
mostCurrent._clv2._addtextitem /*String*/ ("2860	Κατηγορία 6.1	Βαναδίου τριοξείδιο	      ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"2861	Κατηγορία 6.1	Polyvanadate";
mostCurrent._clv2._addtextitem /*String*/ ("2861	Κατηγορία 6.1	Polyvanadate αμμώνιο	      ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"2862	Κατηγορία 6.1	Πεντοξείδιο";
mostCurrent._clv2._addtextitem /*String*/ ("2862	Κατηγορία 6.1	Πεντοξείδιο  βαναδίου , άτηκτες μορφή	      ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"2863	Κατηγορία 6.1	Νάτριο βαναδι";
mostCurrent._clv2._addtextitem /*String*/ ("2863	Κατηγορία 6.1	Νάτριο βαναδικού αμμωνίου	      ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"2864	Κατηγορία 6.1	Μεταβαναδικό";
mostCurrent._clv2._addtextitem /*String*/ ("2864	Κατηγορία 6.1	Μεταβαναδικό κάλιο	      ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"2865	Κατηγορία 8	Θειικής υδροξυλ";
mostCurrent._clv2._addtextitem /*String*/ ("2865	Κατηγορία 8	Θειικής υδροξυλαμίνης	      ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"2869	Κατηγορία 8	Τριχλωριούχο τι";
mostCurrent._clv2._addtextitem /*String*/ ("2869	Κατηγορία 8	Τριχλωριούχο τιτάνιο μείγματα	    ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"2870	Κατηγορία 4.2	Βοροϋδρίδιο α";
mostCurrent._clv2._addtextitem /*String*/ ("2870	Κατηγορία 4.2	Βοροϋδρίδιο αλουμινίου ή βοροϋδρίδιο αλουμινίου σε συσκευές	   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"2870	Κατηγορία 4.2	Aluminiumborh";
mostCurrent._clv2._addtextitem /*String*/ ("2870	Κατηγορία 4.2	Aluminiumborhydrid σε Gerten	      ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"2871	Κατηγορία 6.1	Αντιμόνιο σε";
mostCurrent._clv2._addtextitem /*String*/ ("2871	Κατηγορία 6.1	Αντιμόνιο σε σκόνη	      ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"2872	Κατηγορία 6.1	Dibromochloro";
mostCurrent._clv2._addtextitem /*String*/ ("2872	Κατηγορία 6.1	Dibromochloropropane	    ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"2873	Κατηγορία 6.1	Dibutylaminoe";
mostCurrent._clv2._addtextitem /*String*/ ("2873	Κατηγορία 6.1	Dibutylaminoethanol	   ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"2874	Κατηγορία 6.1	Φουρφουρυλική";
mostCurrent._clv2._addtextitem /*String*/ ("2874	Κατηγορία 6.1	Φουρφουρυλική αλκοόλ	   ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"2875	Κατηγορία 6.1	Εξαχλωροφαίνι";
mostCurrent._clv2._addtextitem /*String*/ ("2875	Κατηγορία 6.1	Εξαχλωροφαίνιο	      ",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"2876	Κατηγορία 6.1	Resorcinol";
mostCurrent._clv2._addtextitem /*String*/ ("2876	Κατηγορία 6.1	Resorcinol	      ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"2878	Κατηγορία 4.1	Τιτανίου κόκκ";
mostCurrent._clv2._addtextitem /*String*/ ("2878	Κατηγορία 4.1	Τιτανίου κόκκους ή σκόνες σφουγγάρι σφουγγάρι τιτανίου	    ",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"2879	Κατηγορία 8	Σελήνιο οξυχλωρ";
mostCurrent._clv2._addtextitem /*String*/ ("2879	Κατηγορία 8	Σελήνιο οξυχλωριούχου	      ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"2880	Κατηγορία 5.1	Υποχλωριώδες";
mostCurrent._clv2._addtextitem /*String*/ ("2880	Κατηγορία 5.1	Υποχλωριώδες ασβέστιο   ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"2881	Κατηγορία 4.2	Μεταλλικό κατ";
mostCurrent._clv2._addtextitem /*String*/ ("2881	Κατηγορία 4.2	Μεταλλικό καταλύτη , ξηρό	      ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"2900	Κατηγορία 6.2	Μολυσματικ";
mostCurrent._clv2._addtextitem /*String*/ ("2900	Κατηγορία 6.2	Μολυσματική ύλη, που προσβάλλει ζώα	    ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 273;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 195;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 196;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 199;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 200;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 201;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 202;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 203;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 204;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 205;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 206;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 207;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 208;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 209;BA.debugLine="lbl.Gravity = Bit.OR(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 210;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 211;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 212;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 213;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 214;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 215;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 216;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 247;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 249;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 231;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 264;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 265;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 266;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 244;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 245;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 258;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 240;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 241;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 255;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 256;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
 //BA.debugLineNum = 257;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 233;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 234;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 261;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 262;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 //BA.debugLineNum = 263;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 236;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 237;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 252;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 253;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 254;BA.debugLine="End Sub";
return "";
}
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 268;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 269;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
