...
public class ydroxlorio extends Activity implements B4AActivity{
	public static ydroxlorio mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.ydroxlorio");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ydroxlorio).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.ydroxlorio");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.ydroxlorio", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ydroxlorio) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ydroxlorio) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ydroxlorio) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 46;BA.debugLine="Activity.LoadLayout(\"ydroxlorio.bal\")";
mostCurrent._activity.LoadLayout("ydroxlorio.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,ydroxlorio.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Το υδροχλωρικό οξύ UN-1789 ή σε";
mostCurrent._clv2._addtextitem /*String*/ ("Το υδροχλωρικό οξύ UN-1789 ή σε αερια μορφή σαν υδροχλώριο είναι άχρωμο με πνηγιρή οσμή.Ειναι τοξική και διαβρωτική ουσία",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Προκαλεί σοβαρά εγκαύματα στο δέ";
mostCurrent._clv2._addtextitem /*String*/ ("Προκαλεί σοβαρά εγκαύματα στο δέρμα, ενώ η εισπνοή αερίου προκαλλεί σοβαρές βλάβες στο αναπνευστικό σύστημα. ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Αντιδράει με τα μέταλλα απελευθε";
mostCurrent._clv2._addtextitem /*String*/ ("Αντιδράει με τα μέταλλα απελευθερώνοντας εύφλεκτο υδρογόνο.",(Object)(""));
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 220;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Sub ililabel_Click";
...
public static String  _katigor_click() throws Exception{
 ...
 //BA.debugLineNum = 199;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 210;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 ...
 //BA.debugLineNum = 195;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Sub listabel_Click";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 213;BA.debugLine="Sub ousialabel_Click";
