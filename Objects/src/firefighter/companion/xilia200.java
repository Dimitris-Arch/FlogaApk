...
public class xilia200 extends Activity implements B4AActivity{
	public static xilia200 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.xilia200");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (xilia200).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.xilia200");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.xilia200", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (xilia200) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (xilia200) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (xilia200) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,xilia200.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"1104	ΚΑΤΗΓΟΡΙΑ 3	Οξικά Αμυλεστέρ";
mostCurrent._clv2._addtextitem /*String*/ ("1104	ΚΑΤΗΓΟΡΙΑ 3	Οξικά Αμυλεστέρας	   ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"1105	ΚΑΤΗΓΟΡΙΑ 3	Πεντανόλες	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("1105	ΚΑΤΗΓΟΡΙΑ 3	Πεντανόλες	   ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"1106	ΚΑΤΗΓΟΡΙΑ 3	Amylamines	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("1106	ΚΑΤΗΓΟΡΙΑ 3	Amylamines	   ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"1107	ΚΑΤΗΓΟΡΙΑ 3	Χλωριούχα Αμυλε";
mostCurrent._clv2._addtextitem /*String*/ ("1107	ΚΑΤΗΓΟΡΙΑ 3	Χλωριούχα Αμυλεστέρας	   ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"1108	ΚΑΤΗΓΟΡΙΑ 3	Πεντένιο n αμυλ";
mostCurrent._clv2._addtextitem /*String*/ ("1108	ΚΑΤΗΓΟΡΙΑ 3	Πεντένιο n αμυλένιο	   ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"1109	ΚΑΤΗΓΟΡΙΑ 3	Φορμικά Αμυλεστ";
mostCurrent._clv2._addtextitem /*String*/ ("1109	ΚΑΤΗΓΟΡΙΑ 3	Φορμικά Αμυλεστέρας	   ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"1110	ΚΑΤΗΓΟΡΙΑ 3	η-αμυλο μεθυλοκ";
mostCurrent._clv2._addtextitem /*String*/ ("1110	ΚΑΤΗΓΟΡΙΑ 3	η-αμυλο μεθυλοκετόνη	   ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"1111	ΚΑΤΗΓΟΡΙΑ 3	Μερκαπτάνες Αμυ";
mostCurrent._clv2._addtextitem /*String*/ ("1111	ΚΑΤΗΓΟΡΙΑ 3	Μερκαπτάνες Αμυλεστέρας	   ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"1112	ΚΑΤΗΓΟΡΙΑ 3	Νιτρικό άλας";
mostCurrent._clv2._addtextitem /*String*/ ("1112	ΚΑΤΗΓΟΡΙΑ 3	Νιτρικό άλας	   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"1113	ΚΑΤΗΓΟΡΙΑ 3	Νιτρώδη Αμυλεστ";
mostCurrent._clv2._addtextitem /*String*/ ("1113	ΚΑΤΗΓΟΡΙΑ 3	Νιτρώδη Αμυλεστέρας	   ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"1114	ΚΑΤΗΓΟΡΙΑ 3	Βενζόλιο	   \" ,";
mostCurrent._clv2._addtextitem /*String*/ ("1114	ΚΑΤΗΓΟΡΙΑ 3	Βενζόλιο	   ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"1120	ΚΑΤΗΓΟΡΙΑ 2	Βουτανόλες	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("1120	ΚΑΤΗΓΟΡΙΑ 2	Βουτανόλες	   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"1123	ΚΑΤΗΓΟΡΙΑ 3	Βουτύλιο οξικά";
mostCurrent._clv2._addtextitem /*String*/ ("1123	ΚΑΤΗΓΟΡΙΑ 3	Βουτύλιο οξικά	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"1125	ΚΑΤΗΓΟΡΙΑ 3	κ-βουτυλαμίνη";
mostCurrent._clv2._addtextitem /*String*/ ("1125	ΚΑΤΗΓΟΡΙΑ 3	κ-βουτυλαμίνη	   ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"1126	ΚΑΤΗΓΟΡΙΑ 3	Βρωμοβουτάνιο";
mostCurrent._clv2._addtextitem /*String*/ ("1126	ΚΑΤΗΓΟΡΙΑ 3	Βρωμοβουτάνιο	   ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"1127	ΚΑΤΗΓΟΡΙΑ 3	Chlorobutanes";
mostCurrent._clv2._addtextitem /*String*/ ("1127	ΚΑΤΗΓΟΡΙΑ 3	Chlorobutanes	   ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"1128	ΚΑΤΗΓΟΡΙΑ 3	η-Βουτυλο μυρμη";
mostCurrent._clv2._addtextitem /*String*/ ("1128	ΚΑΤΗΓΟΡΙΑ 3	η-Βουτυλο μυρμηκικό	   ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"1129	ΚΑΤΗΓΟΡΙΑ 3	Βουτυραλδεϋδη";
mostCurrent._clv2._addtextitem /*String*/ ("1129	ΚΑΤΗΓΟΡΙΑ 3	Βουτυραλδεϋδη	   ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"1130	ΚΑΤΗΓΟΡΙΑ 3	Καμφορέλαιο";
mostCurrent._clv2._addtextitem /*String*/ ("1130	ΚΑΤΗΓΟΡΙΑ 3	Καμφορέλαιο	   ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"1131	ΚΑΤΗΓΟΡΙΑ 3	Διθειάνθρακα";
mostCurrent._clv2._addtextitem /*String*/ ("1131	ΚΑΤΗΓΟΡΙΑ 3	Διθειάνθρακα	   ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"1133	ΚΑΤΗΓΟΡΙΑ 3	Κόλλες , που πε";
mostCurrent._clv2._addtextitem /*String*/ ("1133	ΚΑΤΗΓΟΡΙΑ 3	Κόλλες , που περιέχει ένα εύφλεκτο υγρό	   ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"1134	ΚΑΤΗΓΟΡΙΑ 3	Χλωροβενζένιο";
mostCurrent._clv2._addtextitem /*String*/ ("1134	ΚΑΤΗΓΟΡΙΑ 3	Χλωροβενζένιο	   ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"1135	ΚΑΤΗΓΟΡΙΑ 6.1	Αιθυλένιο χλω";
mostCurrent._clv2._addtextitem /*String*/ ("1135	ΚΑΤΗΓΟΡΙΑ 6.1	Αιθυλένιο χλωρυδρίνη	   ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"1136	ΚΑΤΗΓΟΡΙΑ 3	Η πίσσα από άνθ";
mostCurrent._clv2._addtextitem /*String*/ ("1136	ΚΑΤΗΓΟΡΙΑ 3	Η πίσσα από άνθρακα αποσταγμάτων, εύφλεκτο	   ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"1139	ΚΑΤΗΓΟΡΙΑ 3	Διάλυμα επίστρω";
mostCurrent._clv2._addtextitem /*String*/ ("1139	ΚΑΤΗΓΟΡΙΑ 3	Διάλυμα επίστρωσης ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"1143	ΚΑΤΗΓΟΡΙΑ 6.1	Κροτωναλδεΰδη";
mostCurrent._clv2._addtextitem /*String*/ ("1143	ΚΑΤΗΓΟΡΙΑ 6.1	Κροτωναλδεΰδη , σταθεροποιημένο	   ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"1144	ΚΑΤΗΓΟΡΙΑ 3	Crotonylene";
mostCurrent._clv2._addtextitem /*String*/ ("1144	ΚΑΤΗΓΟΡΙΑ 3	Crotonylene	   ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"1145	ΚΑΤΗΓΟΡΙΑ 3	Κυκλοεξάνιο";
mostCurrent._clv2._addtextitem /*String*/ ("1145	ΚΑΤΗΓΟΡΙΑ 3	Κυκλοεξάνιο	   ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"1146	ΚΑΤΗΓΟΡΙΑ 3	Κυκλοπεντάνιο";
mostCurrent._clv2._addtextitem /*String*/ ("1146	ΚΑΤΗΓΟΡΙΑ 3	Κυκλοπεντάνιο	   ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"1147	ΚΑΤΗΓΟΡΙΑ 3	Δεκαϋδροναφθαλέ";
mostCurrent._clv2._addtextitem /*String*/ ("1147	ΚΑΤΗΓΟΡΙΑ 3	Δεκαϋδροναφθαλένιο	   ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"1148	ΚΑΤΗΓΟΡΙΑ 3	Διακετονοαλκοόλ";
mostCurrent._clv2._addtextitem /*String*/ ("1148	ΚΑΤΗΓΟΡΙΑ 3	Διακετονοαλκοόλη	   ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"1149	ΚΑΤΗΓΟΡΙΑ 3	Αιθέρες διβουτυ";
mostCurrent._clv2._addtextitem /*String*/ ("1149	ΚΑΤΗΓΟΡΙΑ 3	Αιθέρες διβουτυλο	   ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"1150	ΚΑΤΗΓΟΡΙΑ 3	Διχλωροαιθυλένι";
mostCurrent._clv2._addtextitem /*String*/ ("1150	ΚΑΤΗΓΟΡΙΑ 3	Διχλωροαιθυλένιο	   ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"1152	ΚΑΤΗΓΟΡΙΑ 3	Dichloropentane";
mostCurrent._clv2._addtextitem /*String*/ ("1152	ΚΑΤΗΓΟΡΙΑ 3	Dichloropentanes	   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"1153	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλενο γλυκολ";
mostCurrent._clv2._addtextitem /*String*/ ("1153	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλενο γλυκολο διαιθυλο αιθέρα	",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"1154	ΚΑΤΗΓΟΡΙΑ 3	Διαιθυλαμίνη";
mostCurrent._clv2._addtextitem /*String*/ ("1154	ΚΑΤΗΓΟΡΙΑ 3	Διαιθυλαμίνη	   ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"1155	ΚΑΤΗΓΟΡΙΑ 3	Διαιθυλ αιθέρας";
mostCurrent._clv2._addtextitem /*String*/ ("1155	ΚΑΤΗΓΟΡΙΑ 3	Διαιθυλ αιθέρας ή Αιθυλαιθέρας	",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"1156	ΚΑΤΗΓΟΡΙΑ 3	Διαιθυλ κετόνη";
mostCurrent._clv2._addtextitem /*String*/ ("1156	ΚΑΤΗΓΟΡΙΑ 3	Διαιθυλ κετόνη	   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"1157	ΚΑΤΗΓΟΡΙΑ 3	Διισοβουτυλοκετ";
mostCurrent._clv2._addtextitem /*String*/ ("1157	ΚΑΤΗΓΟΡΙΑ 3	Διισοβουτυλοκετόνη	   ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"1158	ΚΑΤΗΓΟΡΙΑ 3	Διισοπροπυλαμίν";
mostCurrent._clv2._addtextitem /*String*/ ("1158	ΚΑΤΗΓΟΡΙΑ 3	Διισοπροπυλαμίνη	   ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"1159	ΚΑΤΗΓΟΡΙΑ 3	Διισοπροπυλαιθέ";
mostCurrent._clv2._addtextitem /*String*/ ("1159	ΚΑΤΗΓΟΡΙΑ 3	Διισοπροπυλαιθέρα	   ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"1160	ΚΑΤΗΓΟΡΙΑ 3	Διμεθυλαμίνης δ";
mostCurrent._clv2._addtextitem /*String*/ ("1160	ΚΑΤΗΓΟΡΙΑ 3	Διμεθυλαμίνης διάλυμα	   ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"1161	ΚΑΤΗΓΟΡΙΑ 3	Ανθρακικού διμε";
mostCurrent._clv2._addtextitem /*String*/ ("1161	ΚΑΤΗΓΟΡΙΑ 3	Ανθρακικού διμεθυλίου	   ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"1162	ΚΑΤΗΓΟΡΙΑ 3	Διμεθυλοδιχλωρο";
mostCurrent._clv2._addtextitem /*String*/ ("1162	ΚΑΤΗΓΟΡΙΑ 3	Διμεθυλοδιχλωροσιλάνιο	   ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"1163	ΚΑΤΗΓΟΡΙΑ 6.1	Διμεθυλοϋδραζ";
mostCurrent._clv2._addtextitem /*String*/ ("1163	ΚΑΤΗΓΟΡΙΑ 6.1	Διμεθυλοϋδραζίνη , ασύμμετρη	 ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"1164	ΚΑΤΗΓΟΡΙΑ 3	Διμεθυλοσουλφίδ";
mostCurrent._clv2._addtextitem /*String*/ ("1164	ΚΑΤΗΓΟΡΙΑ 3	Διμεθυλοσουλφίδιο	   ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"1165	ΚΑΤΗΓΟΡΙΑ 3	Διοξάνιο	   \" ,";
mostCurrent._clv2._addtextitem /*String*/ ("1165	ΚΑΤΗΓΟΡΙΑ 3	Διοξάνιο	   ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"1166	ΚΑΤΗΓΟΡΙΑ 3	Διοξολάνη	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("1166	ΚΑΤΗΓΟΡΙΑ 3	Διοξολάνη	   ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"1167	ΚΑΤΗΓΟΡΙΑ 3	Διβινυλαιθέρα ,";
mostCurrent._clv2._addtextitem /*String*/ ("1167	ΚΑΤΗΓΟΡΙΑ 3	Διβινυλαιθέρα , παρεμπόδισε	   ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"1169	ΚΑΤΗΓΟΡΙΑ 3	Εκχυλίσματα, αρ";
mostCurrent._clv2._addtextitem /*String*/ ("1169	ΚΑΤΗΓΟΡΙΑ 3	Εκχυλίσματα, αρωματικό υγρό	   ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"1170	ΚΑΤΗΓΟΡΙΑ 3	Αιθανόλη αιθυλι";
mostCurrent._clv2._addtextitem /*String*/ ("1170	ΚΑΤΗΓΟΡΙΑ 3	Αιθανόλη αιθυλική αλκοόλη ή διάλυμα αιθανόλης αιθυλικής αλκοόλης	   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"1171	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλενο γλυκόλ";
mostCurrent._clv2._addtextitem /*String*/ ("1171	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλενο γλυκόλης μονοαιθυλ αιθέρας	   ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"1172	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλενογλυκόλη";
mostCurrent._clv2._addtextitem /*String*/ ("1172	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλενογλυκόλης οξικό μονοαιθυλ αιθέρας	   ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"1173	ΚΑΤΗΓΟΡΙΑ 3	Οξικό αιθυλεστέ";
mostCurrent._clv2._addtextitem /*String*/ ("1173	ΚΑΤΗΓΟΡΙΑ 3	Οξικό αιθυλεστέρα	   ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"1175	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλβενζένιο";
mostCurrent._clv2._addtextitem /*String*/ ("1175	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλβενζένιο	   ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"1176	ΚΑΤΗΓΟΡΙΑ 3	Ethyl βορικό";
mostCurrent._clv2._addtextitem /*String*/ ("1176	ΚΑΤΗΓΟΡΙΑ 3	Ethyl βορικό	   ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"1177	ΚΑΤΗΓΟΡΙΑ 3	Οξικό αιθυλβουτ";
mostCurrent._clv2._addtextitem /*String*/ ("1177	ΚΑΤΗΓΟΡΙΑ 3	Οξικό αιθυλβουτυλιο		",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"1178	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλοβουτυραλδ";
mostCurrent._clv2._addtextitem /*String*/ ("1178	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλοβουτυραλδεϋδη	 ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"1179	ΚΑΤΗΓΟΡΙΑ 3	Αιθύλιο βουτυλα";
mostCurrent._clv2._addtextitem /*String*/ ("1179	ΚΑΤΗΓΟΡΙΑ 3	Αιθύλιο βουτυλαιθέρα	",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"1180	ΚΑΤΗΓΟΡΙΑ 3	Βουτυρικός αιθυ";
mostCurrent._clv2._addtextitem /*String*/ ("1180	ΚΑΤΗΓΟΡΙΑ 3	Βουτυρικός αιθυλεστέρας	 ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"1181	ΚΑΤΗΓΟΡΙΑ 6.1	Ethyl χλωροακ";
mostCurrent._clv2._addtextitem /*String*/ ("1181	ΚΑΤΗΓΟΡΙΑ 6.1	Ethyl χλωροακετικό	   ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"1182	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωροφορμικό";
mostCurrent._clv2._addtextitem /*String*/ ("1182	ΚΑΤΗΓΟΡΙΑ 6.1	Χλωροφορμικό αιθύλιο	   ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"1184	ΚΑΤΗΓΟΡΙΑ 3	Διχλωριούχο αιθ";
mostCurrent._clv2._addtextitem /*String*/ ("1184	ΚΑΤΗΓΟΡΙΑ 3	Διχλωριούχο αιθυλένιο	   ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"1185	ΚΑΤΗΓΟΡΙΑ 6.1	Εθυλενιμίνη ,";
mostCurrent._clv2._addtextitem /*String*/ ("1185	ΚΑΤΗΓΟΡΙΑ 6.1	Εθυλενιμίνη , αναστέλλεται	   ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"1188	ΚΑΤΗΓΟΡΙΑ 3	Μονομεθυλ αιθέρ";
mostCurrent._clv2._addtextitem /*String*/ ("1188	ΚΑΤΗΓΟΡΙΑ 3	Μονομεθυλ αιθέρα αιθυλενογλυκόλης	   ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"1189	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλενογλυκόλη";
mostCurrent._clv2._addtextitem /*String*/ ("1189	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλενογλυκόλη μονομεθυλ αιθέρας οξικής	",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"1190	ΚΑΤΗΓΟΡΙΑ 3	Μυρμηκικός αιθυ";
mostCurrent._clv2._addtextitem /*String*/ ("1190	ΚΑΤΗΓΟΡΙΑ 3	Μυρμηκικός αιθυλεστέρας	   ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"1191	ΚΑΤΗΓΟΡΙΑ 3	Οκτυλική αλδεΰδ";
mostCurrent._clv2._addtextitem /*String*/ ("1191	ΚΑΤΗΓΟΡΙΑ 3	Οκτυλική αλδεΰδες	   ",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"1192	ΚΑΤΗΓΟΡΙΑ 3	Γαλακτικό αιθύλ";
mostCurrent._clv2._addtextitem /*String*/ ("1192	ΚΑΤΗΓΟΡΙΑ 3	Γαλακτικό αιθύλιο	   ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"1193	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλ μεθυλ κετ";
mostCurrent._clv2._addtextitem /*String*/ ("1193	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλ μεθυλ κετόνη ή μεθυλ-αιθυλο-κετόνη",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"1194	ΚΑΤΗΓΟΡΙΑ 3	Ethyl νιτρικό λ";
mostCurrent._clv2._addtextitem /*String*/ ("1194	ΚΑΤΗΓΟΡΙΑ 3	Ethyl νιτρικό λύσεις	   ",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"1195	ΚΑΤΗΓΟΡΙΑ 3	Ethyl προπιονικ";
mostCurrent._clv2._addtextitem /*String*/ ("1195	ΚΑΤΗΓΟΡΙΑ 3	Ethyl προπιονικό	   ",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="clv2.AddTextItem(\"1196	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλοτριχλωροσ";
mostCurrent._clv2._addtextitem /*String*/ ("1196	ΚΑΤΗΓΟΡΙΑ 3	Αιθυλοτριχλωροσιλάνιο	   ",(Object)(""));
 //BA.debugLineNum = 201;BA.debugLine="clv2.AddTextItem(\"1197	ΚΑΤΗΓΟΡΙΑ 3	Εκχυλίσματα, αρ";
mostCurrent._clv2._addtextitem /*String*/ ("1197	ΚΑΤΗΓΟΡΙΑ 3	Εκχυλίσματα, αρωματικά, υγρά	   ",(Object)(""));
 //BA.debugLineNum = 202;BA.debugLine="clv2.AddTextItem(\"1198	ΚΑΤΗΓΟΡΙΑ 3	Φορμαλδεΰδη , δ";
mostCurrent._clv2._addtextitem /*String*/ ("1198	ΚΑΤΗΓΟΡΙΑ 3	Φορμαλδεΰδη , διαλύματα, εύφλεκτο	   ",(Object)(""));
 //BA.debugLineNum = 203;BA.debugLine="clv2.AddTextItem(\"1199	ΚΑΤΗΓΟΡΙΑ 6.1	Φουραλδευδες";
mostCurrent._clv2._addtextitem /*String*/ ("1199	ΚΑΤΗΓΟΡΙΑ 6.1	Φουραλδευδες	 ",(Object)(""));
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 208;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 211;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 212;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 213;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 214;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 215;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 216;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 217;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 218;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 219;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 220;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 221;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 222;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 223;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 224;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 225;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 226;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 227;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 228;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 229;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 260;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 262;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 244;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 277;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 278;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 279;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 257;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 258;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 271;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 253;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 254;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 268;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 269;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
 //BA.debugLineNum = 270;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 246;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 247;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 274;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 275;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 //BA.debugLineNum = 276;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 249;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 250;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 265;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 266;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 267;BA.debugLine="End Sub";
return "";
}
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 281;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 282;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
