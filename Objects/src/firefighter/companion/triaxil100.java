...
public class triaxil100 extends Activity implements B4AActivity{
	public static triaxil100 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.triaxil100");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (triaxil100).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.triaxil100");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.triaxil100", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (triaxil100) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (triaxil100) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (triaxil100) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,triaxil100.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"3005	Κατηγορία 6.1	Θειοκαρβαμ";
mostCurrent._clv2._addtextitem /*String*/ ("3005	Κατηγορία 6.1	Θειοκαρβαμικού παρασιτοκτόνα, υγρά, τοξικά, εύφλεκτα, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	   ",(Object)(""));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"3006	Κατηγορία 6.1	Θειοκαρβαμ";
mostCurrent._clv2._addtextitem /*String*/ ("3006	Κατηγορία 6.1	Θειοκαρβαμιδικό παρασιτοκτόνο, υγρό, τοξικό	     ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"3009	Κατηγορία 6.1	Χαλκός φυτ";
mostCurrent._clv2._addtextitem /*String*/ ("3009	Κατηγορία 6.1	Χαλκός φυτοφάρμακα βάση, υγρό, τοξικό, εύφλεκτο, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	 ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"3010	Κατηγορία 6.1	Χαλκός παρ";
mostCurrent._clv2._addtextitem /*String*/ ("3010	Κατηγορία 6.1	Χαλκός παρασιτοκτόνα με βάση υγρό, τοξικό	    ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"3011	Κατηγορία 6.1	Ο υδράργυρ";
mostCurrent._clv2._addtextitem /*String*/ ("3011	Κατηγορία 6.1	Ο υδράργυρος φυτοφάρμακα που βασίζονται, υγρό, τοξικό, εύφλεκτο, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	    ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"3012	Κατηγορία 6.1	Ο υδράργυρ";
mostCurrent._clv2._addtextitem /*String*/ ("3012	Κατηγορία 6.1	Ο υδράργυρος φυτοφάρμακα που βασίζονται, υγρά, τοξικά	    ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"3013	Κατηγορία 6.1	Υποκαταστη";
mostCurrent._clv2._addtextitem /*String*/ ("3013	Κατηγορία 6.1	Υποκαταστημένα νιτροφαινόλη φυτοφάρμακα, υγρό, τοξικό, εύφλεκτο, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	 ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"3014	Κατηγορία 6.1	Υποκατεστη";
mostCurrent._clv2._addtextitem /*String*/ ("3014	Κατηγορία 6.1	Υποκατεστημένες φυτοφάρμακα νιτροφαινόλης, υγρά, τοξικά	    ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"3015	Κατηγορία 6.1	Bipyridili";
mostCurrent._clv2._addtextitem /*String*/ ("3015	Κατηγορία 6.1	Bipyridilium παρασιτοκτόνα, υγρά, τοξικά, εύφλεκτα, σημείο ανάφλεξης όχι μικρότερο από 23 ° C ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"3016	Κατηγορία 6.1	Bipyridili";
mostCurrent._clv2._addtextitem /*String*/ ("3016	Κατηγορία 6.1	Bipyridilium παρασιτοκτόνα, υγρά, τοξικά	    ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"3017	Κατηγορία 6.1	Οργανοφωσφ";
mostCurrent._clv2._addtextitem /*String*/ ("3017	Κατηγορία 6.1	Οργανοφωσφορικές φυτοφάρμακα, υγρό, τοξικό, εύφλεκτο, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	    ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"3018	Κατηγορία 6.1	Οργανοφωσφ";
mostCurrent._clv2._addtextitem /*String*/ ("3018	Κατηγορία 6.1	Οργανοφωσφορικές φυτοφάρμακα, υγρά, τοξικά	    ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"3019	Κατηγορία 6.1	Οργανοκασσ";
mostCurrent._clv2._addtextitem /*String*/ ("3019	Κατηγορία 6.1	Οργανοκασσιτερικές φυτοφάρμακα, υγρό, τοξικό, εύφλεκτο, σημείο ανάφλεξης όχι μικρότερο από 23 ° C	    ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"3020	Κατηγορία 6.1	Οργανοκασσ";
mostCurrent._clv2._addtextitem /*String*/ ("3020	Κατηγορία 6.1	Οργανοκασσιτερικές φυτοφάρμακα, υγρό, τοξικό	    ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"3021	Κατηγορία 3	Φυτοφάρμακα,";
mostCurrent._clv2._addtextitem /*String*/ ("3021	Κατηγορία 3	Φυτοφάρμακα, υγρό, εύφλεκτο, τοξικό, σημείο ανάφλεξης μικρότερο από 23 ° C	    ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"3022	Κατηγορία 3	Κατηγορία 1,";
mostCurrent._clv2._addtextitem /*String*/ ("3022	Κατηγορία 3	Κατηγορία 1,Κατηγορία 2-βουτυλενοξείδιο , σταθεροποιημένο	    ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"3023	Κατηγορία 6.1	Κατηγορία";
mostCurrent._clv2._addtextitem /*String*/ ("3023	Κατηγορία 6.1	Κατηγορία 2-μεθυλ-Κατηγορία 2-επτανοθειόλη	    ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"3024	Κατηγορία 3	Η κουμαρίνη";
mostCurrent._clv2._addtextitem /*String*/ ("3024	Κατηγορία 3	Η κουμαρίνη παράγωγο παρασιτοκτόνα, υγρά, εύφλεκτα, τοξικά, σημείο ανάφλεξης μικρότερο από 23 ° C	 ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"3025	Κατηγορία 6.1	Παράγωγο κ";
mostCurrent._clv2._addtextitem /*String*/ ("3025	Κατηγορία 6.1	Παράγωγο κουμαρίνης παρασιτοκτόνα, υγρά, τοξικά, εύφλεκτα, σημείο ανάφλεξης όχι μικρότερο από 23 ° C ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"3026	Κατηγορία 6.1	Παράγωγο κ";
mostCurrent._clv2._addtextitem /*String*/ ("3026	Κατηγορία 6.1	Παράγωγο κουμαρίνης παρασιτοκτόνα, υγρά, τοξικά	    ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"3027	Κατηγορία 6.1	Παράγωγο κ";
mostCurrent._clv2._addtextitem /*String*/ ("3027	Κατηγορία 6.1	Παράγωγο κουμαρίνης παρασιτοκτόνα, στερεά, τοξικά	    ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"3028	Κατηγορία 8	Μπαταρίες ,";
mostCurrent._clv2._addtextitem /*String*/ ("3028	Κατηγορία 8	Μπαταρίες , ξηρά, που περιέχουν υδροξείδιο του καλίου στερεό, ηλεκτρικό, αποθήκευση	    ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"3048	Κατηγορία 6.1	Φωσφορούχο";
mostCurrent._clv2._addtextitem /*String*/ ("3048	Κατηγορία 6.1	Φωσφορούχο αλουμίνιο φυτοφάρμακα	    ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"3049	Κατηγορία 4.2	Μεταλλικά";
mostCurrent._clv2._addtextitem /*String*/ ("3049	Κατηγορία 4.2	Μεταλλικά αλκυλο αλογονίδια , αντιδρώντα με νερό, ε.α.ο. ή μέταλλο αρυλο αλογονίδια, αντιδρούν  ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"3052	Κατηγορία 4.2	Aλκυλαλογο";
mostCurrent._clv2._addtextitem /*String*/ ("3052	Κατηγορία 4.2	Aλκυλαλογονίδια	    ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"3053	Κατηγορία 4.2";
mostCurrent._clv2._addtextitem /*String*/ ("3053	Κατηγορία 4.2              Μαγνήσιο 	    ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"3054	Κατηγορία 3	Κυκλοεξυλο μ";
mostCurrent._clv2._addtextitem /*String*/ ("3054	Κατηγορία 3	Κυκλοεξυλο μερκαπτάνη	    ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"3055	Κατηγορία 8	Aμινοαιθοξυ";
mostCurrent._clv2._addtextitem /*String*/ ("3055	Κατηγορία 8	Aμινοαιθοξυ αιθανόλη	    ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"3056	Κατηγορία 3	Kεπταλδεΰδη";
mostCurrent._clv2._addtextitem /*String*/ ("3056	Κατηγορία 3	Kεπταλδεΰδη	   ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"3057	Κατηγορία 2	Τριφθοροακετ";
mostCurrent._clv2._addtextitem /*String*/ ("3057	Κατηγορία 2	Τριφθοροακετυλ χλωρίδιο	    ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"3064	Κατηγορία 3	Νιτρογλυκερί";
mostCurrent._clv2._addtextitem /*String*/ ("3064	Κατηγορία 3	Νιτρογλυκερίνη , διάλυμα σε αλκοόλη, ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"3065	Κατηγορία 3	Αλκοολούχα π";
mostCurrent._clv2._addtextitem /*String*/ ("3065	Κατηγορία 3	Αλκοολούχα ποτά	    ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"3066	Κατηγορία 8	Paint ή σχετ";
mostCurrent._clv2._addtextitem /*String*/ ("3066	Κατηγορία 8	Paint ή σχετιζόμενο με χρώμα, υλικό	    ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"3070	Κατηγορία 2.2	Οξείδιο το";
mostCurrent._clv2._addtextitem /*String*/ ("3070	Κατηγορία 2.2	Οξείδιο του αιθυλενίου και διχλωροδιφθορομεθάνιο  ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"3071	Κατηγορία 6.1	Μερκαπτάνε";
mostCurrent._clv2._addtextitem /*String*/ ("3071	Κατηγορία 6.1	Μερκαπτάνες , υγρό, τοξικό, εύφλεκτο ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"3072	Κατηγορία 9	Σωστικά, δεν";
mostCurrent._clv2._addtextitem /*String*/ ("3072	Κατηγορία 9	Σωστικά, δεν φουσκώνει περιέχουν επικίνδυνα εμπορεύματα, όπως ο εξοπλισμός	   ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"3073	Κατηγορία 6.1	Βινυλοπυρι";
mostCurrent._clv2._addtextitem /*String*/ ("3073	Κατηγορία 6.1	Βινυλοπυριδίνες , αναστέλλεται	    ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"3076	Κατηγορία 4.2	Aλουμινίο";
mostCurrent._clv2._addtextitem /*String*/ ("3076	Κατηγορία 4.2	Aλουμινίο αλκυλο υδρίδια 	    ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"3077	Κατηγορία 9	Επικίνδυνη γ";
mostCurrent._clv2._addtextitem /*String*/ ("3077	Κατηγορία 9	Επικίνδυνη για το περιβάλλον ουσία, στερεό, NOS δεν συμπεριλαμβάνονται τα απορρίμματα	    ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"3078	Κατηγορία 4.3	Δημήτριο ,";
mostCurrent._clv2._addtextitem /*String*/ ("3078	Κατηγορία 4.3	Δημήτριο , ρινίσματα ή λιθίαση σκόνη	    ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"3079	Κατηγορία 3	Μεθακρυλονιτ";
mostCurrent._clv2._addtextitem /*String*/ ("3079	Κατηγορία 3	Μεθακρυλονιτρίλ , αναστέλλεται	   ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"3082	Κατηγορία 9	Επικίνδυνη γ";
mostCurrent._clv2._addtextitem /*String*/ ("3082	Κατηγορία 9	Επικίνδυνη για το περιβάλλον ουσία, υγρό, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"3083	Κατηγορία 2.3	Υπερχλωρυλ";
mostCurrent._clv2._addtextitem /*String*/ ("3083	Κατηγορία 2.3	Υπερχλωρυλοφθορίδιο	    ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"3084	Κατηγορία 8	Διαβρωτικό σ";
mostCurrent._clv2._addtextitem /*String*/ ("3084	Κατηγορία 8	Διαβρωτικό στερεά, οξειδωτικά, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"3085	Κατηγορία 5.1	Οξειδωτικό";
mostCurrent._clv2._addtextitem /*String*/ ("3085	Κατηγορία 5.1	Οξειδωτικό στερεά, διαβρωτικά, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"3086	Κατηγορία 6.1	Τοξικά στε";
mostCurrent._clv2._addtextitem /*String*/ ("3086	Κατηγορία 6.1	Τοξικά στερεά, οξειδωτικά, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"3087	Κατηγορία 5.1	Οξειδωτικέ";
mostCurrent._clv2._addtextitem /*String*/ ("3087	Κατηγορία 5.1	Οξειδωτικές στερεές, τοξικές, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"3088	Κατηγορία 4.2	Αυτο-θέρμα";
mostCurrent._clv2._addtextitem /*String*/ ("3088	Κατηγορία 4.2	Αυτο-θέρμανση στερεά, οργανικά, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"3089	Κατηγορία 4.1	Μέταλλο σε";
mostCurrent._clv2._addtextitem /*String*/ ("3089	Κατηγορία 4.1	Μέταλλο σε σκόνη, εύφλεκτο, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"3090	Κατηγορία 9	Μπαταρίες λι";
mostCurrent._clv2._addtextitem /*String*/ ("3090	Κατηγορία 9	Μπαταρίες λιθίου	    ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"3091	Κατηγορία 9	Mπαταρίες λι";
mostCurrent._clv2._addtextitem /*String*/ ("3091	Κατηγορία 9	Mπαταρίες λιθίου που περιέχονται στον εξοπλισμό	    ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"3092	Κατηγορία 3	Mεθοξυ-προπα";
mostCurrent._clv2._addtextitem /*String*/ ("3092	Κατηγορία 3	Mεθοξυ-προπανόλη ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"3093	Κατηγορία 8	Διαβρωτικό υ";
mostCurrent._clv2._addtextitem /*String*/ ("3093	Κατηγορία 8	Διαβρωτικό υγρό, οξειδωτικά, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"3094	Κατηγορία 8	Διαβρωτικό υ";
mostCurrent._clv2._addtextitem /*String*/ ("3094	Κατηγορία 8	Διαβρωτικό υγρό, αντιδρούν με το νερό, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"3095	Κατηγορία 8	Διαβρωτικό σ";
mostCurrent._clv2._addtextitem /*String*/ ("3095	Κατηγορία 8	Διαβρωτικό στερεό, αυτο-θέρμανσης, ε.α.ο.	   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"3096	Κατηγορία 8	Διαβρωτικών";
mostCurrent._clv2._addtextitem /*String*/ ("3096	Κατηγορία 8	Διαβρωτικών στερεών, αντιδρούν με το νερό, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"3097	Κατηγορία 4.1	Εύφλεκτα σ";
mostCurrent._clv2._addtextitem /*String*/ ("3097	Κατηγορία 4.1	Εύφλεκτα στερεά, οξειδωτικά, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"3098	Κατηγορία 5.1	Οξειδωτικό";
mostCurrent._clv2._addtextitem /*String*/ ("3098	Κατηγορία 5.1	Οξειδωτικό υγρό, διαβρωτικό, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"3099	Κατηγορία 5.1	Οξειδωτικό";
mostCurrent._clv2._addtextitem /*String*/ ("3099	Κατηγορία 5.1	Οξειδωτικό υγρό, τοξικό, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"3100	Κατηγορία 5.1	Οξειδωτικό";
mostCurrent._clv2._addtextitem /*String*/ ("3100	Κατηγορία 5.1	Οξειδωτικό στερεό, αυτο-θέρμανσης, ε.α.ο.	  ",(Object)(""));
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 188;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 191;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 192;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 193;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 194;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 195;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 196;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 197;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 198;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 199;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 200;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 201;BA.debugLine="lbl.Gravity = Bit.OR(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 202;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 203;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 204;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 205;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 206;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 207;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 208;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 209;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 238;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 240;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 222;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 255;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 256;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 257;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 235;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 236;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 249;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 250;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
 //BA.debugLineNum = 251;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 231;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 232;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 246;BA.debugLine="Sub listabel_Click";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 224;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 225;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 252;BA.debugLine="Sub ousialabel_Click";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 227;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 228;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Sub simanseislabel_Click";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 259;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 260;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
