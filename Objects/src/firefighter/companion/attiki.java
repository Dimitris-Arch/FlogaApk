...
public class attiki extends Activity implements B4AActivity{
	public static attiki mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.attiki");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (attiki).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.attiki");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.attiki", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (attiki) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (attiki) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (attiki) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._mple.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 112;BA.debugLine="clv2.Initialize(Me, \"clv2\")";
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,attiki.getObject(),"clv2");
 //BA.debugLineNum = 113;BA.debugLine="Panel2.AddView(clv2.AsView, 0.5%x, 0%y,93%x ,57.5";
mostCurrent._panel2.AddView((android.view.View)(mostCurrent._clv2._asview /*anywheresoftware.b4a.objects.ConcreteViewWrapper*/ ().getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0.5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (93),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 114;BA.debugLine="Panel2.Top = 33%y";
mostCurrent._panel2.setTop(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 115;BA.debugLine="Panel2.Left = 3%x";
mostCurrent._panel2.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (3),mostCurrent.activityBA));
 //BA.debugLineNum = 116;BA.debugLine="Panel2.Width = 94%x";
mostCurrent._panel2.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (94),mostCurrent.activityBA));
 //BA.debugLineNum = 117;BA.debugLine="Panel2.height = 57.5%y";
mostCurrent._panel2.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 118;BA.debugLine="clv2.DefaultTextBackgroundColor = Colors.DarkGray";
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 120;BA.debugLine="clv2.AddTextItem(\"1ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩ";
mostCurrent._clv2._addtextitem /*String*/ ("1ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 213-2157500 "));
 //BA.debugLineNum = 121;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΣΑΡΡΗ\", \"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΣΑΡΡΗ",(Object)("Τηλ: 210-3214003"));
 //BA.debugLineNum = 122;BA.debugLine="clv2.AddTextItem(\"2ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩ";
mostCurrent._clv2._addtextitem /*String*/ ("2ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 210-5155566"));
 //BA.debugLineNum = 123;BA.debugLine="clv2.AddTextItem(\"4ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩ";
mostCurrent._clv2._addtextitem /*String*/ ("4ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 210-7783590"));
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"ΕΘΕΛΟΝΤΙΚΟ ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙ";
mostCurrent._clv2._addtextitem /*String*/ ("ΕΘΕΛΟΝΤΙΚΟ ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΠΕΝΤΕΛΗΣ",(Object)("Τηλ: 210-8044999"));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"5ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩ";
mostCurrent._clv2._addtextitem /*String*/ ("5ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 210-9418466"));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"6ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩ";
mostCurrent._clv2._addtextitem /*String*/ ("6ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 210-2431051"));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΠΟΛΥΔΕΝΔΡ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΠΟΛΥΔΕΝΔΡΙΟΥ",(Object)("Τηλ: 22950-54199"));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"7ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩ";
mostCurrent._clv2._addtextitem /*String*/ ("7ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 210-9735810"));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"8ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩ";
mostCurrent._clv2._addtextitem /*String*/ ("8ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 210-9626611"));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"ΣΤΕΓΑΣΜΕΝΟ ΠΕΡΙΠΟΛΙΚΟ ΒΟΥΛΙΑΓΜΕ";
mostCurrent._clv2._addtextitem /*String*/ ("ΣΤΕΓΑΣΜΕΝΟ ΠΕΡΙΠΟΛΙΚΟ ΒΟΥΛΙΑΓΜΕΝΗΣ (8-21)",(Object)("Τηλ: 210-9671222"));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"9ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩ";
mostCurrent._clv2._addtextitem /*String*/ ("9ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 210-6829850"));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"10ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝ";
mostCurrent._clv2._addtextitem /*String*/ ("10ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 210-5790100"));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"12ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝ";
mostCurrent._clv2._addtextitem /*String*/ ("12ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΑΘΗΝΩΝ",(Object)("Τηλ: 210-6663800"));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"ΜΟΝΑΔΑ ΒΑΡΕΩΝ ΟΧΗΜΑΤΩΝ (Μ.Β.Ο.)";
mostCurrent._clv2._addtextitem /*String*/ ("ΜΟΝΑΔΑ ΒΑΡΕΩΝ ΟΧΗΜΑΤΩΝ (Μ.Β.Ο.)",(Object)("Τηλ: 210-9814000"));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"1ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΠΕΙΡΑ";
mostCurrent._clv2._addtextitem /*String*/ ("1ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΠΕΙΡΑΙΑ",(Object)("Τηλ: 213-2158401"));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΕΛΕΥΣΙΝΑΣ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΕΛΕΥΣΙΝΑΣ",(Object)("Τηλ: 213-2158300"));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΜΑΡΚΟΠΟΥΛ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΜΑΡΚΟΠΟΥΛΟΥ",(Object)("Τηλ: 22993-20800"));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"2ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΠΕΙΡΑ";
mostCurrent._clv2._addtextitem /*String*/ ("2ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΠΕΙΡΑΙΑ",(Object)("Τηλ: 213-2158401"));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"3ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΠΕΙΡΑ";
mostCurrent._clv2._addtextitem /*String*/ ("3ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΠΕΙΡΑΙΑ",(Object)("Τηλ: 210-4612148"));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΙΓΙΝΑΣ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΙΓΙΝΑΣ",(Object)("Τηλ: 22970-22171"));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"4ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΠΕΙΡΑ";
mostCurrent._clv2._addtextitem /*String*/ ("4ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΠΕΙΡΑΙΑ",(Object)("Τηλ: 210-4005965"));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΠΕΡΑΜΑΤΟΣ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΠΕΡΑΜΑΤΟΣ",(Object)("Τηλ: 210-4413031"));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΣΑΛΑΜΙΝΑΣ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΣΑΛΑΜΙΝΑΣ",(Object)("Τηλ: 210-4687010"));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"5ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΛΙΜΕΝ";
mostCurrent._clv2._addtextitem /*String*/ ("5ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΛΙΜΕΝΑ ΠΕΙΡΑΙΑ",(Object)("Τηλ: 210-4517373"));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΒΙΛΛΙΩΝ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΒΙΛΛΙΩΝ",(Object)("Τηλ: 22630-23718"));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΜΕΓΑΡΩΝ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΜΕΓΑΡΩΝ",(Object)("Τηλ: 22960-89344"));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΚΡΩΠΙΑΣ (";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΚΡΩΠΙΑΣ (ΚΟΡΩΠΙΟΥ)",(Object)("Τηλ: 210-6627393"));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΛΑΥΡΙΟΥ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΛΑΥΡΙΟΥ",(Object)("Τηλ: 22920-23123"));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΝΕΑΣ ΜΑΚΡ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΝΕΑΣ ΜΑΚΡΗΣ",(Object)("Τηλ: 22940-91788"));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΡΑΦΗΝΑΣ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΡΑΦΗΝΑΣ",(Object)("Τηλ: 22940-79199"));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΔΙΕΘΝΟΥΣ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΔΙΕΘΝΟΥΣ ΑΕΡΟΛΙΜΕΝΑ ΑΘΗΝΩΝ",(Object)("210-3538514 "));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"1η ΕΙΔΙΚΗ ΜΟΝΑΔΑ ΑΝΤΙΜΕΤΩΠΙΣΗΣ";
mostCurrent._clv2._addtextitem /*String*/ ("1η ΕΙΔΙΚΗ ΜΟΝΑΔΑ ΑΝΤΙΜΕΤΩΠΙΣΗΣ ΚΑΤΑΣΤΡΟΦΩΝ ",(Object)("2105582880"));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΜΟΥΣΕΙΟ\", \"Τηλ: 21";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΜΟΥΣΕΙΟ",(Object)("Τηλ: 210-6034273"));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΣΥΝΕΡΓΕΙΟ\", \"Τηλ:";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΣΥΝΕΡΓΕΙΟ",(Object)("Τηλ: 2296-440970"));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"ΜΗΧΑΝΟΚΙΝΗΤΟ ΤΜΗΜΑ (ΜΕΤΠΕ)\", \"Τ";
mostCurrent._clv2._addtextitem /*String*/ ("ΜΗΧΑΝΟΚΙΝΗΤΟ ΤΜΗΜΑ (ΜΕΤΠΕ)",(Object)("Τηλ: 210-5593822 "));
...
int _result = 0;
 //BA.debugLineNum = 172;BA.debugLine="Sub clv2_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 173;BA.debugLine="Activity.Title = Value";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(_value));
 //BA.debugLineNum = 175;BA.debugLine="Dim p As PhoneCalls";
_p = new anywheresoftware.b4a.phone.Phone.PhoneCalls();
 //BA.debugLineNum = 181;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 182;BA.debugLine="result = Msgbox2(Value, \"  \", \"Κλήση\", \"\", \"Κλείσι";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence(_value),BA.ObjectToCharSequence("  "),"Κλήση","","Κλείσιμο",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"thl.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 183;BA.debugLine="If result = DialogResponse.Positive Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 185;BA.debugLine="StartActivity(p.Call(Value))";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 189;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 190;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 191;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 192;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 193;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 194;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 195;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 196;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 197;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 198;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 199;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 200;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 201;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 202;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 203;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 204;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 205;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 206;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
_p.AddView((android.view.View)(_chk.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (280)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 207;BA.debugLine="Return p";
if (true) return _p;
...
public static String  _ili_click() throws Exception{
 ...
 //BA.debugLineNum = 221;BA.debugLine="StartActivity(\"firstaid\")";
...
public static String  _ililabel_click() throws Exception{
 ...
 //BA.debugLineNum = 255;BA.debugLine="StartActivity(\"firstaid\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("firstaid"));
...
public static String  _katigor_click() throws Exception{
 ...
 //BA.debugLineNum = 235;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _lista_click() throws Exception{
 ...
 //BA.debugLineNum = 231;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _listabel_click() throws Exception{
 ...
 //BA.debugLineNum = 246;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
...
public static String  _ousia_click() throws Exception{
 ...
 //BA.debugLineNum = 224;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 ...
 //BA.debugLineNum = 252;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 257;BA.debugLine="Sub simansi_Click";
