...
public class egkefaliko extends Activity implements B4AActivity{
	public static egkefaliko mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.egkefaliko");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (egkefaliko).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.egkefaliko");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.egkefaliko", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (egkefaliko) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (egkefaliko) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (egkefaliko) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="Activity.LoadLayout(\"egkefaliko.bal\")";
mostCurrent._activity.LoadLayout("egkefaliko.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,egkefaliko.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"Το εγκεφαλικό επεισόδιο είναι έν";
mostCurrent._clv2._addtextitem /*String*/ ("Το εγκεφαλικό επεισόδιο είναι ένα αιφνίδιο γεγονός που προκύπτει από ξαφνική βλάβη στη ροή του αίματος στον εγκέφαλο.",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"Συμπτώματα εγκεφαλικού επεισόδιο";
mostCurrent._clv2._addtextitem /*String*/ ("Συμπτώματα εγκεφαλικού επεισόδιου:",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Αιφνίδια αδυναμία στο πρόσωπο, χ";
mostCurrent._clv2._addtextitem /*String*/ ("Αιφνίδια αδυναμία στο πρόσωπο, χέρι ή πόδι, ειδικά στη μια πλευρά του σώματος",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Αιφνίδια σύγχυση, δυσκολία στην";
mostCurrent._clv2._addtextitem /*String*/ ("Αιφνίδια σύγχυση, δυσκολία στην ομιλία ή στην κατανόηση",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Αιφνίδιο πρόβλημα όρασης στο ένα";
mostCurrent._clv2._addtextitem /*String*/ ("Αιφνίδιο πρόβλημα όρασης στο ένα ή και στα δυο μάτια",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Αιφνίδιο πρόβλημα στη βάδιση, ζα";
mostCurrent._clv2._addtextitem /*String*/ ("Αιφνίδιο πρόβλημα στη βάδιση, ζαλάδα, απώλεια ισορροπίας ή συντονισμού",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Αιφνίδιο δυνατό πονοκέφαλο αγνώσ";
mostCurrent._clv2._addtextitem /*String*/ ("Αιφνίδιο δυνατό πονοκέφαλο αγνώστου αιτίας",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Αιφνίδια έναρξη σπασμών\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Αιφνίδια έναρξη σπασμών",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Αιφνίδια απώλεια συνείδησης\", \"\"";
mostCurrent._clv2._addtextitem /*String*/ ("Αιφνίδια απώλεια συνείδησης",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Αντιμετώπιση εγκεφαλικού επεισοδ";
mostCurrent._clv2._addtextitem /*String*/ ("Αντιμετώπιση εγκεφαλικού επεισοδίου",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"Η άμεση αντιμετώπιση μπορεί να σ";
mostCurrent._clv2._addtextitem /*String*/ ("Η άμεση αντιμετώπιση μπορεί να σώσει ζωές και να μειώσει την αναπηρία",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"Γρήγορη μεταφορά του θύματος σε";
mostCurrent._clv2._addtextitem /*String*/ ("Γρήγορη μεταφορά του θύματος σε εξειδικευμένο κέντρο ή καλέστε το 166",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"Βάλτε το θύμα να ξαπλώσει.\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Βάλτε το θύμα να ξαπλώσει.",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"Με αυτόν τον τρόπο διευκολύνεται";
mostCurrent._clv2._addtextitem /*String*/ ("Με αυτόν τον τρόπο διευκολύνεται η παροχή αίματος στον εγκέφαλο.",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"Να μην φάει ή να πιει οτιδήποτε.";
mostCurrent._clv2._addtextitem /*String*/ ("Να μην φάει ή να πιει οτιδήποτε.",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"Εάν κάνει εμετό, γυρίστε το κεφά";
mostCurrent._clv2._addtextitem /*String*/ ("Εάν κάνει εμετό, γυρίστε το κεφάλι και το σώμα του στο πλάι.",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"Εάν χάσει τις αισθήσεις του, αρχ";
mostCurrent._clv2._addtextitem /*String*/ ("Εάν χάσει τις αισθήσεις του, αρχίστε την παροχή πρώτων βοηθειών ΚΑΡΠΑ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"Δεν πρέπει να χορηγηθεί ασπιρίνη";
mostCurrent._clv2._addtextitem /*String*/ ("Δεν πρέπει να χορηγηθεί ασπιρίνη ή υπογλώσσια στον άρρωστο με εγκεφαλικό γιατί αν είναι αιμορραγικό τότε θα του αυξήσει την αιμορραγία. ",(Object)(""));
...
mostCurrent._imageview7 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 55;BA.debugLine="Dim clv2 As CustomListView";
mostCurrent._clv2 = new firefighter.companion.customlistview();
 //BA.debugLineNum = 57;BA.debugLine="Dim Panel2 As Panel";
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 64;BA.debugLine="End Sub";
return "";
}
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 191;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 173;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 207;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
 //BA.debugLineNum = 208;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 187;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub katigorlabel_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 183;BA.debugLine="StartActivity(\"thlefona\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 198;BA.debugLine="StartActivity(\"thlefona\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("thlefona"));
 //BA.debugLineNum = 199;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 175;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 176;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 204;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
 //BA.debugLineNum = 205;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 179;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 195;BA.debugLine="StartActivity(\"karpa\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 209;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 210;BA.debugLine="StartActivity(\"karpa\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("karpa"));
