...
public class amonia extends Activity implements B4AActivity{
	public static amonia mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.amonia");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (amonia).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.amonia");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.amonia", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (amonia) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (amonia) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (amonia) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 45;BA.debugLine="Activity.LoadLayout(\"amonia.bal\")";
mostCurrent._activity.LoadLayout("amonia.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,amonia.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"Η αμμωνία UN-1005 είναι αέριο, ά";
mostCurrent._clv2._addtextitem /*String*/ ("Η αμμωνία UN-1005 είναι αέριο, άχρωμο,πνιγηρό, ελαφρύτερο του αέρα.Η υγρή αμμωνία είναι ψυκτικό υγρό και προκαλεί σοβαρά εγκαύματα.Η άνυδρη αμμωνία είναι διαβρωτικό και εξαιρετικά τοξικό για την υγεία και το σώμα. Σε χώρους που δεν αερίζονται καλά δημιουργεί εκρήξεις. ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"ΧΡΗΣΙΜΟΠΟΙΗΣΤΕ ΣΤΟΛΗ ΧΗΜΙΚΗΣ ΠΡΟ";
mostCurrent._clv2._addtextitem /*String*/ ("ΧΡΗΣΙΜΟΠΟΙΗΣΤΕ ΣΤΟΛΗ ΧΗΜΙΚΗΣ ΠΡΟΣΤΑΣΙΑΣ ΚΛΕΙΣΤΟΥ ΤΥΠΟΥ ΜΕ ΠΛΗΡΗ ΑΠΟΜΟΝΩΣΗ.",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2 ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Ευφλεκτα,πυροδυναμωτικα,δηλητηρι";
mostCurrent._clv2._addtextitem /*String*/ ("Ευφλεκτα,πυροδυναμωτικα,δηλητηριώδη και τοξικα. ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Σε χώρους που δεν αερίζονται υπά";
...
mostCurrent._clv2._addtextitem /*String*/ ("Τα εργαλεία που χρησιμοποιούνται δεν θα πρέπει να προκαλούν σπινθήρες ή στατικό ηλεκτρισμό.Μην χρησιμοποιείτε κοντά στην φωτιά κινητά τηλέφωνα ή ασύρματο",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"Η προσβολή γίνεται απο την πλευρ";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 216;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
public static String  _clv1_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 145;BA.debugLine="Sub clv1_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 146;BA.debugLine="Activity.Title = Value";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 149;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 150;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 151;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 152;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 153;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 154;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 155;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 156;BA.debugLine="chk.Initialize(\"\")";
_chk.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 157;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 158;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 159;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 160;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 161;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 162;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 163;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 164;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 165;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 166;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 199;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 181;BA.debugLine="StartActivity(\"Main\")";
...
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 195;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 190;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 191;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub pixi_Click";
