...
public class katagma extends Activity implements B4AActivity{
	public static katagma mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.katagma");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (katagma).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.katagma");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.katagma", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (katagma) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (katagma) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (katagma) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 68;BA.debugLine="Activity.LoadLayout(\"katagma.bal\")";
mostCurrent._activity.LoadLayout("katagma.bal",mostCurrent.activityBA);
...
mostCurrent._mple.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 136;BA.debugLine="clv2.Initialize(Me, \"clv2\")";
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,katagma.getObject(),"clv2");
 //BA.debugLineNum = 137;BA.debugLine="Panel2.AddView(clv2.AsView, 0.5%x, 0%y,93%x ,57.5";
mostCurrent._panel2.AddView((android.view.View)(mostCurrent._clv2._asview /*anywheresoftware.b4a.objects.ConcreteViewWrapper*/ ().getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0.5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (93),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 138;BA.debugLine="Panel2.Top = 33%y";
mostCurrent._panel2.setTop(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 139;BA.debugLine="Panel2.Left = 3%x";
mostCurrent._panel2.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (3),mostCurrent.activityBA));
 //BA.debugLineNum = 140;BA.debugLine="Panel2.Width = 94%x";
mostCurrent._panel2.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (94),mostCurrent.activityBA));
 //BA.debugLineNum = 141;BA.debugLine="Panel2.Height = 57.5%y";
mostCurrent._panel2.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 142;BA.debugLine="clv2.DefaultTextBackgroundColor = Colors.DarkGray";
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Κάταγμα είναι ένα σπασμένο οστό";
mostCurrent._clv2._addtextitem /*String*/ ("Κάταγμα είναι ένα σπασμένο οστό . Απαιτεί ιατρική φροντίδα . Αν το σπασμένο οστό είναι το αποτέλεσμα σοβαρού τραυματισμού ή ζημιάς , καλέστε το 166.",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Το άκρο του τραυματισμένου χεριο";
mostCurrent._clv2._addtextitem /*String*/ ("Το άκρο του τραυματισμένου χεριού ή του ποδιού , όπως ένα δάχτυλο του ποδιού ή των δακτύλων , είναι μουδιασμένο ή μπλε στην άκρη .",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Ακόμη και απαλή πίεση ή κίνηση π";
mostCurrent._clv2._addtextitem /*String*/ ("Ακόμη και απαλή πίεση ή κίνηση προκαλεί πόνο .",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Μην μετακινείτε το άτομο , εκτός";
mostCurrent._clv2._addtextitem /*String*/ ("Μην μετακινείτε το άτομο , εκτός εάν είναι απαραίτητο για να αποφευχθεί η περαιτέρω ζημία . Πάρτε τις δράσεις αυτές αμέσως , ενώ περιμένετε για ιατρική βοήθεια :",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Σταματήστε οποιαδήποτε αιμορραγί";
mostCurrent._clv2._addtextitem /*String*/ ("Σταματήστε οποιαδήποτε αιμορραγία . Ασκήστε πίεση στην πληγή με έναν αποστειρωμένο επίδεσμο , ένα καθαρό πανί ή με ένα καθαρό ρούχο .",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Ακινητοποιήστε την τραυματισμένη";
mostCurrent._clv2._addtextitem /*String*/ ("Ακινητοποιήστε την τραυματισμένη περιοχή . ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"Μην προσπαθήσετε να σπρώξετε το";
mostCurrent._clv2._addtextitem /*String*/ ("Μην προσπαθήσετε να σπρώξετε το οστό ή ένα κόκαλο έχει βγεί. ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"Εφαρμόστε ένα νάρθηκα στην περιο";
mostCurrent._clv2._addtextitem /*String*/ ("Εφαρμόστε ένα νάρθηκα στην περιοχή πάνω και κάτω από τις θέσεις του κατάγματος . Μπορεί να βοηθήσει να μειωθεί ο πόνος .",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"Εφαρμόστε παγοκύστες για να περι";
mostCurrent._clv2._addtextitem /*String*/ ("Εφαρμόστε παγοκύστες για να περιορίσει το πρήξιμο και να βοηθήσει να ανακουφίσει τον πόνο μέχρι να έρθει το προσωπικό έκτακτης ανάγκης . Μην εφαρμόζετε πάγο απευθείας στο δέρμα - τυλίξτε τον πάγο σε μια πετσέτα , κομμάτι ύφασμα ή κάποιο άλλο υλικό .",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"Πάρτε μέτρα για σοκ . Αν το άτομ";
mostCurrent._clv2._addtextitem /*String*/ ("Πάρτε μέτρα για σοκ . Αν το άτομο αισθάνεται λιποθυμία ή αναπνέει με λίγα λόγια, γρήγορες αναπνοές , τοποθετείστε το πρόσωπο προς τα κάτω με το κεφάλι ελαφρώς χαμηλότερα από τον κορμό και , αν είναι δυνατόν , να ανυψώσει τα πόδια .",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"Ενθαρρύνετε το άτομο να υποστηρί";
mostCurrent._clv2._addtextitem /*String*/ ("Ενθαρρύνετε το άτομο να υποστηρίξει τη ζημία με το χέρι του , ή να χρησιμοποιήσετε ένα μαξιλάρι ή τα είδη ένδυσης για την αποφυγή περιττής κίνησης .",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"Το συντομότερο δυνατόν , καλέστε";
mostCurrent._clv2._addtextitem /*String*/ ("Το συντομότερο δυνατόν , καλέστε το 166, εάν είναι σοβαρό το περιστατικό.",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"Συνεχίστε την υποστήριξη της ζημ";
mostCurrent._clv2._addtextitem /*String*/ ("Συνεχίστε την υποστήριξη της ζημίας μέχρι να έρθει βοήθεια .",(Object)(""));
...
mostCurrent._imageview9 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 60;BA.debugLine="Dim clv2 As CustomListView";
mostCurrent._clv2 = new firefighter.companion.customlistview();
 //BA.debugLineNum = 62;BA.debugLine="Dim Panel2 As Panel";
