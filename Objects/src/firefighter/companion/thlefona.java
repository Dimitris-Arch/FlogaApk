...
public class thlefona extends Activity implements B4AActivity{
	public static thlefona mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.thlefona");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (thlefona).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.thlefona");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.thlefona", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (thlefona) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (thlefona) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (thlefona) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
int _height = 0;
 ...
 //BA.debugLineNum = 79;BA.debugLine="Activity.LoadLayout(\"thlefona.bal\")";
mostCurrent._activity.LoadLayout("thlefona.bal",mostCurrent.activityBA);
 //BA.debugLineNum = 80;BA.debugLine="sc.initialize(1000dip)";
mostCurrent._sc.Initialize(mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1000)));
 //BA.debugLineNum = 81;BA.debugLine="Activity.AddView(sc,3%x,33%y,94%x,57.5%y)";
...
public ResumableSub_Activity_Resume(firefighter.companion.thlefona parent) {
this.parent = parent;
}
firefighter.companion.thlefona parent;
String _permission = "";
...
//C
this.state = -1;
 //BA.debugLineNum = 378;BA.debugLine="rp.CheckAndRequest(rp.PERMISSION_CALL_PHONE)";
parent._rp.CheckAndRequest(processBA,parent._rp.PERMISSION_CALL_PHONE);
 //BA.debugLineNum = 379;BA.debugLine="Wait For Activity_PermissionResult (Permission As";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 408;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 410;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 386;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 387;BA.debugLine="StartActivity(\"firstaid\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 430;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 431;BA.debugLine="StartActivity(\"firstaid\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("firstaid"));
...
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 404;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 405;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 422;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 423;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 399;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 400;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 418;BA.debugLine="Sub listabel_Click";
...
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 390;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 391;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 426;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 427;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 394;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 395;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 414;BA.debugLine="Sub simanseislabel_Click";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 434;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 435;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
...
public static String  _textpin1_click() throws Exception{
 //BA.debugLineNum = 479;BA.debugLine="Sub textpin1_Click";
 //BA.debugLineNum = 480;BA.debugLine="StartActivity(\"anthraki\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("anthraki"));
 //BA.debugLineNum = 481;BA.debugLine="End Sub";
return "";
}
public static String  _textpin10_click() throws Exception{
 //BA.debugLineNum = 476;BA.debugLine="Sub textpin10_Click";
 //BA.debugLineNum = 477;BA.debugLine="StartActivity(\"sterea\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("sterea"));
 //BA.debugLineNum = 478;BA.debugLine="End Sub";
return "";
}
public static String  _textpin11_click() throws Exception{
 //BA.debugLineNum = 473;BA.debugLine="Sub textpin11_Click";
 //BA.debugLineNum = 474;BA.debugLine="StartActivity(\"dytellada\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dytellada"));
 //BA.debugLineNum = 475;BA.debugLine="End Sub";
return "";
}
public static String  _textpin12_click() throws Exception{
 //BA.debugLineNum = 470;BA.debugLine="Sub textpin12_Click";
 //BA.debugLineNum = 471;BA.debugLine="StartActivity(\"pelloponiso\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pelloponiso"));
 //BA.debugLineNum = 472;BA.debugLine="End Sub";
return "";
}
public static String  _textpin13_click() throws Exception{
 //BA.debugLineNum = 467;BA.debugLine="Sub textpin13_Click";
 //BA.debugLineNum = 468;BA.debugLine="StartActivity(\"kriti\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("kriti"));
 //BA.debugLineNum = 469;BA.debugLine="End Sub";
return "";
}
public static String  _textpin2_click() throws Exception{
 //BA.debugLineNum = 464;BA.debugLine="Sub textpin2_Click";
 //BA.debugLineNum = 465;BA.debugLine="StartActivity(\"kentrikimak\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("kentrikimak"));
 //BA.debugLineNum = 466;BA.debugLine="End Sub";
return "";
}
public static String  _textpin3_click() throws Exception{
 //BA.debugLineNum = 461;BA.debugLine="Sub textpin3_Click";
 //BA.debugLineNum = 462;BA.debugLine="StartActivity(\"dytmak\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("dytmak"));
 //BA.debugLineNum = 463;BA.debugLine="End Sub";
return "";
}
public static String  _textpin4_click() throws Exception{
 //BA.debugLineNum = 458;BA.debugLine="Sub textpin4_Click";
 //BA.debugLineNum = 459;BA.debugLine="StartActivity(\"hpeiros\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("hpeiros"));
 //BA.debugLineNum = 460;BA.debugLine="End Sub";
return "";
}
public static String  _textpin5_click() throws Exception{
 //BA.debugLineNum = 455;BA.debugLine="Sub textpin5_Click";
 //BA.debugLineNum = 456;BA.debugLine="StartActivity(\"voreioaig\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("voreioaig"));
 //BA.debugLineNum = 457;BA.debugLine="End Sub";
return "";
}
public static String  _textpin6_click() throws Exception{
 //BA.debugLineNum = 452;BA.debugLine="Sub textpin6_Click";
 //BA.debugLineNum = 453;BA.debugLine="StartActivity(\"thessalia\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("thessalia"));
 //BA.debugLineNum = 454;BA.debugLine="End Sub";
return "";
}
public static String  _textpin7_click() throws Exception{
 //BA.debugLineNum = 449;BA.debugLine="Sub textpin7_Click";
 //BA.debugLineNum = 450;BA.debugLine="StartActivity(\"ioniopel\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ioniopel"));
 //BA.debugLineNum = 451;BA.debugLine="End Sub";
return "";
}
public static String  _textpin8_click() throws Exception{
 //BA.debugLineNum = 446;BA.debugLine="Sub textpin8_Click";
 //BA.debugLineNum = 447;BA.debugLine="StartActivity(\"notioaig\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("notioaig"));
 //BA.debugLineNum = 448;BA.debugLine="End Sub";
return "";
}
public static String  _textpin9_click() throws Exception{
 //BA.debugLineNum = 443;BA.debugLine="Sub textpin9_Click";
 //BA.debugLineNum = 444;BA.debugLine="StartActivity(\"attiki\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("attiki"));
