...
public class dyoxil700 extends Activity implements B4AActivity{
	public static dyoxil700 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dyoxil700");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dyoxil700).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dyoxil700");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dyoxil700", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dyoxil700) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dyoxil700) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dyoxil700) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dyoxil700.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"2601	Κατηγορία 2	Κυκλοβουτανο";
mostCurrent._clv2._addtextitem /*String*/ ("2601	Κατηγορία 2	Κυκλοβουτανο	   ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"2602	Κατηγορία 2	Διχλωροδιφθοριο";
mostCurrent._clv2._addtextitem /*String*/ ("2602	Κατηγορία 2	Διχλωροδιφθοριομεθάνιο και διφθοροαιθανίου   ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"2603	Κατηγορία 3	Κυκλοεπτατριενο";
mostCurrent._clv2._addtextitem /*String*/ ("2603	Κατηγορία 3	Κυκλοεπτατριενο	    ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"2604	Κατηγορία 8	Τριφθοριούχο βό";
mostCurrent._clv2._addtextitem /*String*/ ("2604	Κατηγορία 8	Τριφθοριούχο βόριο αιθερικός διαιθυλεστέρας	    ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"2605	Κατηγορία 3	Ισοκυανικό Μεθο";
mostCurrent._clv2._addtextitem /*String*/ ("2605	Κατηγορία 3	Ισοκυανικό Μεθοξυμεθυλο	  ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"2606	Κατηγορία 6.1	Μεθυλο ορθοπυ";
mostCurrent._clv2._addtextitem /*String*/ ("2606	Κατηγορία 6.1	Μεθυλο ορθοπυριτικό	    ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"2607	Κατηγορία 3	Ακρολείνη διμερ";
mostCurrent._clv2._addtextitem /*String*/ ("2607	Κατηγορία 3	Ακρολείνη διμερές , σταθεροποιημένο	    ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"2608	Κατηγορία 3	Nitropropanes";
mostCurrent._clv2._addtextitem /*String*/ ("2608	Κατηγορία 3	Nitropropanes	    ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"2609	Κατηγορία 6.1	Τριαλλυλ βορι";
mostCurrent._clv2._addtextitem /*String*/ ("2609	Κατηγορία 6.1	Τριαλλυλ βορικό	    ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"2610	Κατηγορία 3	Τριαλλυλαμίνη";
mostCurrent._clv2._addtextitem /*String*/ ("2610	Κατηγορία 3	Τριαλλυλαμίνη	    ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"2611	Κατηγορία 6.1	Προπυλενοχλωρ";
mostCurrent._clv2._addtextitem /*String*/ ("2611	Κατηγορία 6.1	Προπυλενοχλωρυδρίνη	    ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"2612	Κατηγορία 3	Μεθυλ προπυλαιθ";
mostCurrent._clv2._addtextitem /*String*/ ("2612	Κατηγορία 3	Μεθυλ προπυλαιθέρα	    ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"2614	Κατηγορία 3	Μεθαλλυλο αλκοό";
mostCurrent._clv2._addtextitem /*String*/ ("2614	Κατηγορία 3	Μεθαλλυλο αλκοόλ	    ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"2615	Κατηγορία 3	Αιθυλ προπυλ αι";
mostCurrent._clv2._addtextitem /*String*/ ("2615	Κατηγορία 3	Αιθυλ προπυλ αιθέρας	   ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"2616	Κατηγορία 3	Τριισοπροπυλ βο";
mostCurrent._clv2._addtextitem /*String*/ ("2616	Κατηγορία 3	Τριισοπροπυλ βορικό	    ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"2617	Κατηγορία 3	Methylcyclohexa";
mostCurrent._clv2._addtextitem /*String*/ ("2617	Κατηγορία 3	Methylcyclohexanols , εύφλεκτο	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"2618	Κατηγορία 3	Vinyltoluenes ,";
mostCurrent._clv2._addtextitem /*String*/ ("2618	Κατηγορία 3	Vinyltoluenes , αναστέλλεται	    ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"2619	Κατηγορία 8	Βενζυλδιμεθυλαμ";
mostCurrent._clv2._addtextitem /*String*/ ("2619	Κατηγορία 8	Βενζυλδιμεθυλαμίνη	    ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"2620	Κατηγορία 3	Βουτυρικοί Αμυλ";
mostCurrent._clv2._addtextitem /*String*/ ("2620	Κατηγορία 3	Βουτυρικοί Αμυλεστέρας	 ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"2621	Κατηγορία 3	Ακετυλο μεθυλο-";
mostCurrent._clv2._addtextitem /*String*/ ("2621	Κατηγορία 3	Ακετυλο μεθυλο-καρβινόλη	 ",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"2622	Κατηγορία 3	Glycidaldehyde";
mostCurrent._clv2._addtextitem /*String*/ ("2622	Κατηγορία 3	Glycidaldehyde ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"2623	Κατηγορία 4.1	Προσανάμματα";
mostCurrent._clv2._addtextitem /*String*/ ("2623	Κατηγορία 4.1	Προσανάμματα , στερεά με εύφλεκτο υγρό ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"2624	Κατηγορία 4.3	Πυριτιούχο μα";
mostCurrent._clv2._addtextitem /*String*/ ("2624	Κατηγορία 4.3	Πυριτιούχο μαγνήσιο ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"2626	Κατηγορία 5.1	Οξύ χλωρικό υ";
mostCurrent._clv2._addtextitem /*String*/ ("2626	Κατηγορία 5.1	Οξύ χλωρικό υδατικό διάλυμα, με όχι περισσότερο από 10 τοις εκατό χλωρικό οξύ	    ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"2627	Κατηγορία 5.1	Νιτρώδη , ανό";
mostCurrent._clv2._addtextitem /*String*/ ("2627	Κατηγορία 5.1	Νιτρώδη , ανόργανα, ε.α.ο.	    ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"2628	Κατηγορία 6.1	Φθοριοοξικού";
mostCurrent._clv2._addtextitem /*String*/ ("2628	Κατηγορία 6.1	Φθοριοοξικού κάλιο	    ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"2629	Κατηγορία 6.1	Φθοριοοξικού";
mostCurrent._clv2._addtextitem /*String*/ ("2629	Κατηγορία 6.1	Φθοριοοξικού νάτριο	 ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"2630	Κατηγορία 6.1	Σεληνικ ή Σελ";
mostCurrent._clv2._addtextitem /*String*/ ("2630	Κατηγορία 6.1	Σεληνικ ή Σεληνιώδες ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"2642	Κατηγορία 6.1	Φθοραιθανικό";
mostCurrent._clv2._addtextitem /*String*/ ("2642	Κατηγορία 6.1	Φθοραιθανικό οξύ	    ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"2643	Κατηγορία 6.1	Βρωμοοξεικό";
mostCurrent._clv2._addtextitem /*String*/ ("2643	Κατηγορία 6.1	Βρωμοοξεικό	    ",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"2644	Κατηγορία 6.1	Ιωδιούχο μεθύ";
mostCurrent._clv2._addtextitem /*String*/ ("2644	Κατηγορία 6.1	Ιωδιούχο μεθύλιο	    ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"2645	Κατηγορία 6.1	Φαινακυλοβρωμ";
mostCurrent._clv2._addtextitem /*String*/ ("2645	Κατηγορία 6.1	Φαινακυλοβρωμίδιο	    ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"2646	Κατηγορία 6.1	Εξαχλωροκυκλο";
mostCurrent._clv2._addtextitem /*String*/ ("2646	Κατηγορία 6.1	Εξαχλωροκυκλοπενταδιενίου	   ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"2647	Κατηγορία 6.1	Μηλονονιτρίλι";
mostCurrent._clv2._addtextitem /*String*/ ("2647	Κατηγορία 6.1	Μηλονονιτρίλιο	    ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"2648	Κατηγορία 6.1	Dibromobutan";
mostCurrent._clv2._addtextitem /*String*/ ("2648	Κατηγορία 6.1	Dibromobutan	    ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"2649	Κατηγορία 6.1	Διχλωροακετόν";
mostCurrent._clv2._addtextitem /*String*/ ("2649	Κατηγορία 6.1	Διχλωροακετόνη	 ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"2650	Κατηγορία 6.1	Κατηγορία 1,Κ";
mostCurrent._clv2._addtextitem /*String*/ ("2650	Κατηγορία 6.1	Κατηγορία 1,Κατηγορία 1-διχλωρο-Κατηγορία 1-νιτροαιθάνιο",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"2651	Κατηγορία 6.1	Κατηγορία 4,4";
mostCurrent._clv2._addtextitem /*String*/ ("2651	Κατηγορία 6.1	Κατηγορία 4,4'-Διαμινοδιφαινυλομεθάνιο	  ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"2653	Κατηγορία 6.1	Ιωδιούχο Βενζ";
mostCurrent._clv2._addtextitem /*String*/ ("2653	Κατηγορία 6.1	Ιωδιούχο Βενζυλική	   ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"2655	Κατηγορία 6.1	Φθοριοπυρι κά";
mostCurrent._clv2._addtextitem /*String*/ ("2655	Κατηγορία 6.1	Φθοριοπυρι κάλιο	",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"2656	Κατηγορία 6.1	Κινολίνης";
mostCurrent._clv2._addtextitem /*String*/ ("2656	Κατηγορία 6.1	Κινολίνης	   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"2657	Κατηγορία 6.1	Το σελήνιο δι";
mostCurrent._clv2._addtextitem /*String*/ ("2657	Κατηγορία 6.1	Το σελήνιο δισουλφιδίου	   ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"2659	Κατηγορία 6.1	Χλωροακετικό";
mostCurrent._clv2._addtextitem /*String*/ ("2659	Κατηγορία 6.1	Χλωροακετικό νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"2660	Κατηγορία 6.1	Nitrotoluidin";
mostCurrent._clv2._addtextitem /*String*/ ("2660	Κατηγορία 6.1	Nitrotoluidines (μονο)	  ",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"2661	Κατηγορία 6.1	Εξαχλωροακετό";
mostCurrent._clv2._addtextitem /*String*/ ("2661	Κατηγορία 6.1	Εξαχλωροακετόνη	   ",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"2662	Κατηγορία 6.1	Υδροκινόνη";
mostCurrent._clv2._addtextitem /*String*/ ("2662	Κατηγορία 6.1	Υδροκινόνη	   ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"2664	Κατηγορία 6.1	Διβρωμιομεθαν";
mostCurrent._clv2._addtextitem /*String*/ ("2664	Κατηγορία 6.1	Διβρωμιομεθανίου	  ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"2667	Κατηγορία 6.1	Butyltoluenes";
mostCurrent._clv2._addtextitem /*String*/ ("2667	Κατηγορία 6.1	Butyltoluenes	   ",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"2668	Κατηγορία 6.1	Χλωριοακετονι";
mostCurrent._clv2._addtextitem /*String*/ ("2668	Κατηγορία 6.1	Χλωριοακετονιτρίλιο	   ",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"2669	Κατηγορία 6.1	Chlorocresols";
mostCurrent._clv2._addtextitem /*String*/ ("2669	Κατηγορία 6.1	Chlorocresols , υγρό ή Chlorocresols, στερεά	",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"2670	Κατηγορία 8	Το κυανιούχο χλ";
mostCurrent._clv2._addtextitem /*String*/ ("2670	Κατηγορία 8	Το κυανιούχο χλώριο	   ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"2671	Κατηγορία 6.1	Αμινοπυριδίνα";
mostCurrent._clv2._addtextitem /*String*/ ("2671	Κατηγορία 6.1	Αμινοπυριδίναι ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"2672	Κατηγορία 8	Αμμωνία διάλυμα";
mostCurrent._clv2._addtextitem /*String*/ ("2672	Κατηγορία 8	Αμμωνία διάλυμα",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"2673	Κατηγορία 6.1	Κατηγορία 2-α";
mostCurrent._clv2._addtextitem /*String*/ ("2673	Κατηγορία 6.1	Κατηγορία 2-αμινο-Κατηγορία 4-χλωροφαινόλη	   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"2674	Κατηγορία 6.1	Φθοροπυριτικό";
mostCurrent._clv2._addtextitem /*String*/ ("2674	Κατηγορία 6.1	Φθοροπυριτικό νάτριο	  ",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"2676	Κατηγορία 2	Stibine	 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("2676	Κατηγορία 2	Stibine	 ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"2677	Κατηγορία 8	Υδροξείδιο  ρου";
mostCurrent._clv2._addtextitem /*String*/ ("2677	Κατηγορία 8	Υδροξείδιο  ρουβιδίου ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"2678	Κατηγορία 8	Υδροξείδιο  ρου";
mostCurrent._clv2._addtextitem /*String*/ ("2678	Κατηγορία 8	Υδροξείδιο  ρουβιδίου	 ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"2679	Κατηγορία 8	Lithiumhydroxid";
mostCurrent._clv2._addtextitem /*String*/ ("2679	Κατηγορία 8	Lithiumhydroxidl",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"2680	Κατηγορία 8	Υδροξείδιο  λιθ";
mostCurrent._clv2._addtextitem /*String*/ ("2680	Κατηγορία 8	Υδροξείδιο  λιθίου , μονοένυδρο ή υδροξείδιο  λιθίου, στερεό	",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"2681	Κατηγορία 8	Υδροξείδιο  και";
mostCurrent._clv2._addtextitem /*String*/ ("2681	Κατηγορία 8	Υδροξείδιο  καισίου λύση	 ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"2682	Κατηγορία 8	Υδροξείδιο  και";
mostCurrent._clv2._addtextitem /*String*/ ("2682	Κατηγορία 8	Υδροξείδιο  καισίου	   ",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"2683	Κατηγορία 8	Σουλφίδιο  αμμω";
mostCurrent._clv2._addtextitem /*String*/ ("2683	Κατηγορία 8	Σουλφίδιο  αμμωνίου λύση	 ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"2684	Κατηγορία 3	Διαιθυλαμινοπρο";
mostCurrent._clv2._addtextitem /*String*/ ("2684	Κατηγορία 3	Διαιθυλαμινοπροπυλαμίνη	   ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"2685	Κατηγορία 8	Ν, Ν-διαιθυλαιθ";
mostCurrent._clv2._addtextitem /*String*/ ("2685	Κατηγορία 8	Ν, Ν-διαιθυλαιθυλενοδιαμίνη	   ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"2686	Κατηγορία 8	Κατηγορία 2-δια";
mostCurrent._clv2._addtextitem /*String*/ ("2686	Κατηγορία 8	Κατηγορία 2-διαιθυλαμινοαιθανόλης	  ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"2687	Κατηγορία 4.1	Νιτρικό δικυκ";
mostCurrent._clv2._addtextitem /*String*/ ("2687	Κατηγορία 4.1	Νιτρικό δικυκλοεξυλαμμωνίου	   ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"2688	Κατηγορία 6.1	1χλωρο-βρωμοπ";
mostCurrent._clv2._addtextitem /*String*/ ("2688	Κατηγορία 6.1	1χλωρο-βρωμοπροπάνιο	 ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"2689	Κατηγορία 6.1	Γλυκερόλη άλφ";
mostCurrent._clv2._addtextitem /*String*/ ("2689	Κατηγορία 6.1	Γλυκερόλη άλφα-monochlorohydrin	   ",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"2690	Κατηγορία 6.1	Νη-Βουτυλ ιμι";
mostCurrent._clv2._addtextitem /*String*/ ("2690	Κατηγορία 6.1	Νη-Βουτυλ ιμιδαζόλη	   ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"2691	Κατηγορία 8	Πενταβρωμιούχο";
mostCurrent._clv2._addtextitem /*String*/ ("2691	Κατηγορία 8	Πενταβρωμιούχο φωσφόρο	   ",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"2692	Κατηγορία 8	Τριβρωμιούχο βό";
mostCurrent._clv2._addtextitem /*String*/ ("2692	Κατηγορία 8	Τριβρωμιούχο βόριο	   ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"2693	Κατηγορία 8	Διθειώδη , υδατ";
mostCurrent._clv2._addtextitem /*String*/ ("2693	Κατηγορία 8	Διθειώδη , υδατικά διαλύματα, nos	  ",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"2698	Κατηγορία 8	Τετραϋδροφθαλικ";
mostCurrent._clv2._addtextitem /*String*/ ("2698	Κατηγορία 8	Τετραϋδροφθαλικό ανυδρίτες με περισσότερο από 0,05 τοις εκατό  μηλεϊνικού ανυδρίτη	",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"2699	Κατηγορία 8	Τριφθοροξικό οξ";
mostCurrent._clv2._addtextitem /*String*/ ("2699	Κατηγορία 8	Τριφθοροξικό οξύ	",(Object)(""));
