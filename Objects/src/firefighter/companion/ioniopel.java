...
public class ioniopel extends Activity implements B4AActivity{
	public static ioniopel mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.ioniopel");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ioniopel).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.ioniopel");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.ioniopel", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ioniopel) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ioniopel) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ioniopel) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 46;BA.debugLine="Activity.LoadLayout(\"tadr.bal\")";
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,ioniopel.getObject(),"clv2");
 //BA.debugLineNum = 114;BA.debugLine="Panel2.AddView(clv2.AsView, 0.5%x, 0%y,93%x ,57.5";
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 121;BA.debugLine="clv2.AddTextItem(\"1ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΚΕΡΚΥΡ";
mostCurrent._clv2._addtextitem /*String*/ ("1ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ ΚΕΡΚΥΡΑΣ",(Object)("Τηλ: 26613-65300 "));
 //BA.debugLineNum = 123;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΘΥΝΑΛΙΩΝ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΘΥΝΑΛΙΩΝ",(Object)("Τηλ: 26630-64599"));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΓΑΪΟΥ - ΠΑ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΓΑΪΟΥ - ΠΑΞΩΝ",(Object)("Τηλ: 26620-31199"));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΡΓΥΡΑΔΩΝ\"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΡΓΥΡΑΔΩΝ",(Object)("Τηλ: 26620-52199"));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"2ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ Κ/Α ΚΕ";
mostCurrent._clv2._addtextitem /*String*/ ("2ος ΠΥΡΟΣΒΕΣΤΙΚΟΣ ΣΤΑΘΜΟΣ Κ/Α ΚΕΡΚΥΡΑΣ",(Object)("Τηλ: 26610-21791"));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΛΕΥΚΑΔΑΣ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΛΕΥΚΑΔΑΣ",(Object)("Τηλ: 26450-20350"));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΠΟΛΛΩΝΙΩΝ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΠΟΛΛΩΝΙΩΝ",(Object)("Τηλ: 26450-31199"));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΑΡΓΟΣΤΟΛΙΟ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΑΡΓΟΣΤΟΛΙΟΥ",(Object)("Τηλ: 26710-23464"));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΣΑΜΗΣ\", \"Τ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΣΑΜΗΣ",(Object)("Τηλ: 26740-23333"));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΙΘΑΚΗΣ\", \"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΙΘΑΚΗΣ",(Object)("Τηλ: 26740-33499 "));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΛΗΞΟΥΡΙΟΥ\"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΛΗΞΟΥΡΙΟΥ",(Object)("Τηλ: 26710-94376"));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΖΑΚΥΝΘΟΥ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΖΑΚΥΝΘΟΥ",(Object)("Τηλ: 26950-22191"));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΕΛΑΤΕΙΩΝ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΕΛΑΤΕΙΩΝ",(Object)("Τηλ: 26950-31255"));
 //BA.debugLineNum = 158;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 250;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 251;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
int _result = 0;
 //BA.debugLineNum = 160;BA.debugLine="Sub clv2_ItemClick (Index As Int, Value As Object)";
 //BA.debugLineNum = 161;BA.debugLine="Activity.Title = Value";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(_value));
 //BA.debugLineNum = 163;BA.debugLine="Dim p As PhoneCalls";
_p = new anywheresoftware.b4a.phone.Phone.PhoneCalls();
 //BA.debugLineNum = 170;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 171;BA.debugLine="result = Msgbox2(Value, \"  \", \"Κλήση\", \"\", \"Κλείσι";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence(_value),BA.ObjectToCharSequence("  "),"Κλήση","","Κλείσιμο",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"thl.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 172;BA.debugLine="If result = DialogResponse.Positive Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 173;BA.debugLine="StartActivity(p.Call(Value))";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 177;BA.debugLine="Sub CreateListItem(Text As String, Width As Int, H";
 //BA.debugLineNum = 178;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 179;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 180;BA.debugLine="p.Color = Colors.Black";
_p.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 181;BA.debugLine="Dim b As Button";
_b = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 182;BA.debugLine="b.Initialize(\"button\") 'all buttons click events";
_b.Initialize(mostCurrent.activityBA,"button");
 //BA.debugLineNum = 183;BA.debugLine="Dim chk As CheckBox";
_chk = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 184;BA.debugLine="chk.Initialize(\"\")";
...
_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 187;BA.debugLine="lbl.Gravity = Bit.Or(Gravity.CENTER_VERTICAL, Gra";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Bit.Or(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL,anywheresoftware.b4a.keywords.Common.Gravity.LEFT));
 //BA.debugLineNum = 188;BA.debugLine="lbl.Text = Text";
_lbl.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 189;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 190;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 191;BA.debugLine="b.Text = \"Click\"";
_b.setText(BA.ObjectToCharSequence("Click"));
 //BA.debugLineNum = 192;BA.debugLine="p.AddView(lbl, 5dip, 2dip, 150dip, Height - 4dip)";
_p.AddView((android.view.View)(_lbl.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (150)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 193;BA.debugLine="p.AddView(b, 155dip, 2dip, 110dip, Height - 4dip)";
_p.AddView((android.view.View)(_b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (155)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_height-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 194;BA.debugLine="p.AddView(chk, 280dip, 2dip, 50dip, Height - 4dip";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 225;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 227;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 208;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 209;BA.debugLine="StartActivity(\"firstaid\")";
...
public static String  _ililabel_click() throws Exception{
 ...
 //BA.debugLineNum = 243;BA.debugLine="StartActivity(\"firstaid\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("firstaid"));
 //BA.debugLineNum = 244;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 222;BA.debugLine="Sub katigor_Click";
...
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 218;BA.debugLine="Sub lista_Click";
...
public static String  _listabel_click() throws Exception{
 ...
 //BA.debugLineNum = 234;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
 //BA.debugLineNum = 235;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 211;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 212;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 ...
 //BA.debugLineNum = 240;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
 //BA.debugLineNum = 241;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 214;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 215;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub simanseislabel_Click";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 245;BA.debugLine="Sub simansi_Click";
