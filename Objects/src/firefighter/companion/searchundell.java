...
public class searchundell extends Activity implements B4AActivity{
	public static searchundell mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.searchundell");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (searchundell).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.searchundell");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.searchundell", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (searchundell) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (searchundell) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (searchundell) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public firefighter.companion.searchview _sv = null;
...
anywheresoftware.b4a.objects.collections.List _cities = null;
 //BA.debugLineNum = 43;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 44;BA.debugLine="Activity.LoadLayout(\"adrSearch.bal\")";
mostCurrent._activity.LoadLayout("adrSearch.bal",mostCurrent.activityBA);
 //BA.debugLineNum = 45;BA.debugLine="Panel2.Top = 33%y";
mostCurrent._panel2.setTop(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 46;BA.debugLine="Panel2.Left = 3%x";
mostCurrent._panel2.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (3),mostCurrent.activityBA));
 //BA.debugLineNum = 47;BA.debugLine="Panel2.Width = 94%x";
mostCurrent._panel2.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (94),mostCurrent.activityBA));
 //BA.debugLineNum = 48;BA.debugLine="Panel2.Height = 57.5%y";
mostCurrent._panel2.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 50;BA.debugLine="Panel2.Color= Colors.DarkGray";
mostCurrent._panel2.setColor(anywheresoftware.b4a.keywords.Common.Colors.DarkGray);
 //BA.debugLineNum = 51;BA.debugLine="Panel2.SendToBack";
...
mostCurrent._mple.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 113;BA.debugLine="delete.top = 33.5%y + 20dip";
mostCurrent._delete.setTop((int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33.5),mostCurrent.activityBA)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))));
 //BA.debugLineNum = 114;BA.debugLine="delete.left = 91%x";
mostCurrent._delete.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (91),mostCurrent.activityBA));
 //BA.debugLineNum = 115;BA.debugLine="delete.width = 5%x";
mostCurrent._delete.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 116;BA.debugLine="delete.height = 20dip";
mostCurrent._delete.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 119;BA.debugLine="sv.Initialize(Me, \"sv\")";
mostCurrent._sv._initialize /*String*/ (mostCurrent.activityBA,searchundell.getObject(),"sv");
 //BA.debugLineNum = 120;BA.debugLine="sv.AddToParent(Activity, 3%x, 33%y,94%x ,57.5%y)";
mostCurrent._sv._addtoparent /*String*/ ((anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(mostCurrent._activity.getObject())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (3),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (94),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 122;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 123;BA.debugLine="Dim cities As List";
_cities = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 124;BA.debugLine="cities = File.ReadList(File.DirAssets, \"uns.txt\"";
_cities = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"uns.txt");
 //BA.debugLineNum = 125;BA.debugLine="index = sv.SetItems(cities)";
_index = mostCurrent._sv._setitems /*Object*/ (_cities);
 }else {
 //BA.debugLineNum = 127;BA.debugLine="sv.SetIndex(index)";
mostCurrent._sv._setindex /*String*/ (_index);
 };
 //BA.debugLineNum = 131;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 190;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
...
public static String  _delete_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub delete_Click";
 //BA.debugLineNum = 199;BA.debugLine="sv.ClearSearchBox";
mostCurrent._sv._clearsearchbox /*String*/ ();
 //BA.debugLineNum = 200;BA.debugLine="StartActivity(searchun)";
...
mostCurrent._panel = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Dim sv As SearchView";
mostCurrent._sv = new firefighter.companion.searchview();
 //BA.debugLineNum = 39;BA.debugLine="Dim Panel2 As Panel";
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 40;BA.debugLine="Private delete As Button";
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 168;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 150;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(\"ilika\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ilika"));
 //BA.debugLineNum = 185;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 164;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 177;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 178;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
 //BA.debugLineNum = 179;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 159;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 160;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 175;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
 //BA.debugLineNum = 176;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 153;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Sub ousialabel_Click";
...
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 156;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Dim index As Object";
_index = new Object();
 //BA.debugLineNum = 10;BA.debugLine="End Sub";
return "";
}
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Sub simanseislabel_Click";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Sub simansi_Click";
...
public static String  _sv_itemclick(String _value) throws Exception{
 //BA.debugLineNum = 135;BA.debugLine="Sub sv_ItemClick(Value As String)";
 //BA.debugLineNum = 136;BA.debugLine="ToastMessageShow(Value, True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.True);
