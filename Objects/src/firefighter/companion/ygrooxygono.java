...
public class ygrooxygono extends Activity implements B4AActivity{
	public static ygrooxygono mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.ygrooxygono");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ygrooxygono).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.ygrooxygono");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.ygrooxygono", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ygrooxygono) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ygrooxygono) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ygrooxygono) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="Activity.LoadLayout(\"ygrooxygono.bal\")";
mostCurrent._activity.LoadLayout("ygrooxygono.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,ygrooxygono.getObject(),"clv2");
...
mostCurrent._panel2.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 126;BA.debugLine="clv2.DefaultTextBackgroundColor = Colors.DarkGray";
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"Το υγρό οξυγόνο UN-1073 β";
mostCurrent._clv2._addtextitem /*String*/ ("Το υγρό οξυγόνο UN-1073 βρίσκεται σε πολύ χαμηλή θερμοκρασία και υπάρχει μεγάλος κίνδυνος κρύων εγκαυμάτων.",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Είναι αέριο άχρωμο, άοσμο. Το οξ";
mostCurrent._clv2._addtextitem /*String*/ ("Είναι αέριο άχρωμο, άοσμο. Το οξυγόνο είναι πυροδυναμωτικό αέριο.ΕΙΝΑΙ ΤΟ ΤΡΙΤΟ ΣΤΟΙΧΕΊΟ ΤΟΥ ΤΡΙΓΩΝΟΥ ΤΗΣ ΦΩΤΙΑΣ. ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Σταματήστε τη διαρροή οξυγόνου α";
mostCurrent._clv2._addtextitem /*String*/ ("Σταματήστε τη διαρροή οξυγόνου αν μπορεί να γίνει με ασφάλεια.Αν αυτό δεν είναι δυνατό διασκορπίστε την διαρροή με βολή ομίχλης",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2 ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"Εφλεκτα,πυροδυναμωτικα. \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Εφλεκτα,πυροδυναμωτικα. ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"ΕΚΡΗΞΗ ΕΞΑΙΤΙΑΣ ΤΗΣ ΥΨΗΛΗΣ ΠΙΕΣ";
...
public static String  _ililabel_click() throws Exception{
 ...
 //BA.debugLineNum = 220;BA.debugLine="StartActivity(\"ilika\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 208;BA.debugLine="StartActivity(\"simanseis\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Sub simansi_Click";
