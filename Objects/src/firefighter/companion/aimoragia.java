...
public class aimoragia extends Activity implements B4AActivity{
	public static aimoragia mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.aimoragia");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (aimoragia).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.aimoragia");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.aimoragia", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (aimoragia) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (aimoragia) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (aimoragia) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._panel2.AddView((android.view.View)(mostCurrent._clv2._asview /*anywheresoftware.b4a.objects.ConcreteViewWrapper*/ ().getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0.5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (93),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 137;BA.debugLine="Panel2.Top = 33%y";
mostCurrent._panel2.setTop(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 138;BA.debugLine="Panel2.Left = 3%x";
mostCurrent._panel2.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (3),mostCurrent.activityBA));
 //BA.debugLineNum = 139;BA.debugLine="Panel2.Width = 94%x";
mostCurrent._panel2.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (94),mostCurrent.activityBA));
 //BA.debugLineNum = 140;BA.debugLine="Panel2.Height = 57.5%y";
mostCurrent._panel2.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (57.5),mostCurrent.activityBA));
 //BA.debugLineNum = 141;BA.debugLine="clv2.DefaultTextBackgroundColor = Colors.DarkGray";
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"Μετά τον έλεγχο της σκηνής κα";
mostCurrent._clv2._addtextitem /*String*/ ("Μετά τον έλεγχο της σκηνής και του τραυματισμένου ατόμου ",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Ανυψώστε το μέλος που αιμορραγεί";
mostCurrent._clv2._addtextitem /*String*/ ("Ανυψώστε το μέλος που αιμορραγεί ψηλότερα από το επίπεδο της καρδιάς",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"Καθαρίστε καλα την περιοχη με αν";
mostCurrent._clv2._addtextitem /*String*/ ("Καθαρίστε καλα την περιοχη με αντισυπτικο υγρό,ξεπλύνετε και ξανακαθαρίστε",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Καλύψτε το τραύμα με έναν αποστε";
mostCurrent._clv2._addtextitem /*String*/ ("Καλύψτε το τραύμα με έναν αποστειρωμένο επίδεσμο ή καθαρό πανί αν δεν υπάρχει επίδεσμος .",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Πίεση στο τράυμα μέχρι σταματήσε";
mostCurrent._clv2._addtextitem /*String*/ ("Πίεση στο τράυμα μέχρι σταματήσει η αιμορραγία",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Ελέγξτε για κυκλοφορία πέρα από";
mostCurrent._clv2._addtextitem /*String*/ ("Ελέγξτε για κυκλοφορία πέρα από τον τραυματισμό.",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"Αν η αιμορραγία δεν σταματά \", \"";
mostCurrent._clv2._addtextitem /*String*/ ("Αν η αιμορραγία δεν σταματά ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"■ Καλέστε το 166, αν δεν έχει γί";
mostCurrent._clv2._addtextitem /*String*/ ("■ Καλέστε το 166, αν δεν έχει γίνει ήδη .",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"■ Εφαρμογή περισσότερων επιδέσμω";
mostCurrent._clv2._addtextitem /*String*/ ("■ Εφαρμογή περισσότερων επιδέσμων .",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"■ Συνεχίστε πρόσθετες πιέσεις .\"";
mostCurrent._clv2._addtextitem /*String*/ ("■ Συνεχίστε πρόσθετες πιέσεις .",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"■ Να ληφθούν μέτρα για την ελαχι";
mostCurrent._clv2._addtextitem /*String*/ ("■ Να ληφθούν μέτρα για την ελαχιστοποίηση των κραδασμών .",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"ΣΥΜΒΟΥΛΗ  Πλύνετε τα χέρια σας κ";
mostCurrent._clv2._addtextitem /*String*/ ("ΣΥΜΒΟΥΛΗ  Πλύνετε τα χέρια σας καλά με σαπούνι και νερό μετά την παροχή φροντίδας",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"ΔΕΝ ΑΦΑΙΡΟΥΜΕ ΠΟΤΕ ΜΟΝΟΙ ΜΑΣ ΞΕΝ";
mostCurrent._clv2._addtextitem /*String*/ ("ΔΕΝ ΑΦΑΙΡΟΥΜΕ ΠΟΤΕ ΜΟΝΟΙ ΜΑΣ ΞΕΝΟ ΑΝΤΙΚΕΙΜΕΝΟ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"Σε περίπτωση απλής ρυνορραγίας,";
mostCurrent._clv2._addtextitem /*String*/ ("Σε περίπτωση απλής ρυνορραγίας, πιέζουμε την μύτη για 10 λεπτά και βάζουμε το άτομο να σκύβει προς τα μπροστά.Όχι ανασήκωση του κεφαλιού, προς αποφυγή κατάποσης αίματος",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"Έπειτα φράζουμε την μύτη με πανί";
mostCurrent._clv2._addtextitem /*String*/ ("Έπειτα φράζουμε την μύτη με πανί ή γάζα",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"Τριχοειδή αιμορραγία \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Τριχοειδή αιμορραγία ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"Το άιμα ρέει από το δέρμα λόγω ε";
mostCurrent._clv2._addtextitem /*String*/ ("Το άιμα ρέει από το δέρμα λόγω εκδοράς.Δεν αποτελεί άμεσο κύνδινο για την υγεία",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"Φλεβική αιμορραγία\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Φλεβική αιμορραγία",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"Το αίμα ρέει συνεχόμενα με σταθε";
mostCurrent._clv2._addtextitem /*String*/ ("Το αίμα ρέει συνεχόμενα με σταθερή χαμηλή πίεση και το χρώμα είναι σκούρο κόκκινο",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"Αρτηριακή αιμορραγία\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Αρτηριακή αιμορραγία",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"Το αίμα εκτόξευεται ανάλογα με τ";
mostCurrent._clv2._addtextitem /*String*/ ("Το αίμα εκτόξευεται ανάλογα με τον ρυθμό της καρδιάς με μεγάλη πίεση και σε μεγάλη ποσότητα.Το χρώμα είναι έντονο κόκκινο",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"Εσωτερική αιμορραγία\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Εσωτερική αιμορραγία",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"Δεν είναι εμφανης αλλα είναι πολ";
mostCurrent._clv2._addtextitem /*String*/ ("Δεν είναι εμφανης αλλα είναι πολύ επικίνδυνη.Καλέστε το 166 ή μεταφέρετε  το θύμα στα επείγοντα αμέσως ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"Συμπτώματα που μπορεί να υποδηλώ";
mostCurrent._clv2._addtextitem /*String*/ ("Συμπτώματα που μπορεί να υποδηλώνουν εσωτερική αιμορραγία",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"Βήχας με αφρώδες κόκκινο αίμα.\",";
mostCurrent._clv2._addtextitem /*String*/ ("Βήχας με αφρώδες κόκκινο αίμα.",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"Εμετός με κόκκινο ή καφέ σκούρο";
mostCurrent._clv2._addtextitem /*String*/ ("Εμετός με κόκκινο ή καφέ σκούρο υλικό.",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"Μαύρη κένωση ή κένωση με αίμα.\",";
mostCurrent._clv2._addtextitem /*String*/ ("Μαύρη κένωση ή κένωση με αίμα.",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"Καστανόμαυρα ή κόκκινα ούρα.\", \"";
mostCurrent._clv2._addtextitem /*String*/ ("Καστανόμαυρα ή κόκκινα ούρα.",(Object)(""));
...
mostCurrent._imageview2 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 47;BA.debugLine="Private ImageView3 As ImageView";
mostCurrent._imageview3 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 48;BA.debugLine="Private ImageView4 As ImageView";
mostCurrent._imageview4 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 49;BA.debugLine="Private ImageView5 As ImageView";
mostCurrent._imageview5 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 50;BA.debugLine="Private ImageView6 As ImageView";
mostCurrent._imageview6 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 51;BA.debugLine="Private ImageView7 As ImageView";
mostCurrent._imageview7 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 52;BA.debugLine="Private ImageView8 As ImageView";
mostCurrent._imageview8 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 53;BA.debugLine="Private ImageView9 As ImageView";
mostCurrent._imageview9 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 57;BA.debugLine="Dim clv2 As CustomListView";
mostCurrent._clv2 = new firefighter.companion.customlistview();
 //BA.debugLineNum = 59;BA.debugLine="Dim Panel2 As Panel";
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 65;BA.debugLine="End Sub";
return "";
}
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 201;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 203;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Sub ili_Click";
 //BA.debugLineNum = 185;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 218;BA.debugLine="Sub ililabel_Click";
 //BA.debugLineNum = 219;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
 //BA.debugLineNum = 220;BA.debugLine="End Sub";
return "";
}
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub katigor_Click";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 213;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
 //BA.debugLineNum = 214;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 195;BA.debugLine="StartActivity(\"thlefona\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 209;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 210;BA.debugLine="StartActivity(\"thlefona\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("thlefona"));
 //BA.debugLineNum = 211;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 188;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 216;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
 //BA.debugLineNum = 217;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 190;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 191;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 207;BA.debugLine="StartActivity(\"karpa\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Sub simansi_Click";
 //BA.debugLineNum = 222;BA.debugLine="StartActivity(\"karpa\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("karpa"));
