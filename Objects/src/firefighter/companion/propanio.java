...
public class propanio extends Activity implements B4AActivity{
	public static propanio mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.propanio");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (propanio).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.propanio");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.propanio", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (propanio) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (propanio) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (propanio) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 48;BA.debugLine="Activity.LoadLayout(\"propanio.bal\")";
mostCurrent._activity.LoadLayout("propanio.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,propanio.getObject(),"clv2");
...
mostCurrent._clv2._addtextitem /*String*/ ("To υγραέριο είναι μίγμα υδρογονανθράκων, αποτελείται από πολλές ουσίες και μίγματα αυτών. Προπάνιο, βουτάνιο, μίγμα προπάνιου-βουτανίου και αέρια πετρελαίου είναι μερικές",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"•Προπάνιο UN-1078\", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("•Προπάνιο UN-1078",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Το υγραέριο είναι άοσμο και άχρ";
mostCurrent._clv2._addtextitem /*String*/ ("Το υγραέριο είναι άοσμο και άχρωμο, εύφλεκτο και σε χώρους που δεν αερίζονται υπάρχει κίνδυνος ασφυξίας.",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"Είναι βαρύτερο του αέρα και συγκ";
mostCurrent._clv2._addtextitem /*String*/ ("Είναι βαρύτερο του αέρα και συγκεντρώνεται χαμηλά Για να ξεχωρίζει στην όσφρηση, προσθέτουν ουσία για τον έλεγχο διαρροής. ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 2.1 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 2.1 ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"Ευφλεκτα,πυροδυναμωτικα,δηλητηρ";
mostCurrent._clv2._addtextitem /*String*/ ("Ευφλεκτα,πυροδυναμωτικα,δηλητηριώδη και τοξικα. ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"ΕΚΡΗΞΗ ΕΞΑΙΤΙΑΣ ΤΗΣ ΥΨΗΛΗΣ ΠΙΕΣ";
mostCurrent._clv2._addtextitem /*String*/ ("ΕΚΡΗΞΗ ΕΞΑΙΤΙΑΣ ΤΗΣ ΥΨΗΛΗΣ ΠΙΕΣΗΣ ΣΤΑ ΔΟΧΕΙΑ-ΒΥΤΙΑ ΠΟΥ ΒΡΙΣΚΟΝΤΑΙ. ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"Σε χώρους που δεν αερίζονται υπά";
mostCurrent._clv2._addtextitem /*String*/ ("Σε χώρους που δεν αερίζονται υπάρχει κίνδυνος ασφυξίας. ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"Έκρηξη σε περίπτωση διαρροής. \",";
mostCurrent._clv2._addtextitem /*String*/ ("Έκρηξη σε περίπτωση διαρροής. ",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"ΠΟΛΥ ΥΨΗΛΟΣ ΚΙΝΔΥΝΟΣ ΑΠΌΤΟΜΗΣ Έ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΟΛΥ ΥΨΗΛΟΣ ΚΙΝΔΥΝΟΣ ΑΠΌΤΟΜΗΣ ΈΚΡΗΞΗΣ,ΔΟΧΕΊΩΝ Ή ΒΥΤΙΩΝ ΣΕ ΠΕΡΊΠΤΩΣΗ ΑΝΑΡΡΌΦΗΣΗΣ ΟΤΑΝ ΑΔΙΑΖΟΥΝ ΚΑΙ Η ΕΞΩΤΕΡΙΚΗ ΠΙΕΣΗ ΕΙΝΑΙ ΜΕΓΑΛΥΤΕΡΗ ΤΗΣ ΕΣΩΤΕΡΙΚΗΣ ",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑ";
mostCurrent._clv2._addtextitem /*String*/ ("ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑΣ.Αυλοί οροφής,εδάφους  ή άλλοι τηλεκατευθυνόμενοι έιναι ιδανικοί",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"Άμεσος αποκλεισμός του χώρου σε";
mostCurrent._clv2._addtextitem /*String*/ ("Άμεσος αποκλεισμός του χώρου σε απόσταση 100 εώς 800 μέτρων σε μικρή πυρκαγιά και σε περίπτωση μεγάλης απόσταση 1600 μέτρων",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράν";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΑΝΤΑ ΦΟΡΑΤΕ ΠΛΗΡΗ ΕΞΑΡΤΗΣΗ,κράνος,περισκελίδα,επενδύτη,γαντια και αναπνευστική συσκευή",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"Φορέστε στολή χημικής προστασίας";
mostCurrent._clv2._addtextitem /*String*/ ("Φορέστε στολή χημικής προστασίας με αναπνευστική συσκευή (πλήρης απομόνωση από το εξωτερικό περιβάλλον)  ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"Τα εργαλεία που χρησιμοποιούνται";
mostCurrent._clv2._addtextitem /*String*/ ("Τα εργαλεία που χρησιμοποιούνται δεν θα πρέπει να προκαλούν σπινθήρες ή στατικό ηλεκτρισμό.Μην χρησιμοποιείτε κοντά στην φωτιά κινητά τηλέφωνα ή ασύρματο",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"Η προσβολή γίνεται απο την πλευρ";
mostCurrent._clv2._addtextitem /*String*/ ("Η προσβολή γίνεται απο την πλευρά που φυσάει ο άνεμος.Πάντα με την πλάτη στον άνεμο.Καλυφθείτε απο κάποιο εμπόδιο,τοίχο,όχημα ανάχωμα κτλ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"ΚΛΕΙΣΤΕ ΤΗΝ ΤΕΛΕΥΤΑΙΑ ΒΑΝΑ ΠΡΙΝ";
mostCurrent._clv2._addtextitem /*String*/ ("ΚΛΕΙΣΤΕ ΤΗΝ ΤΕΛΕΥΤΑΙΑ ΒΑΝΑ ΠΡΙΝ ΑΠΟ ΤΗΝ ΔΙΑΡΡΟΗ.Ψύψετε όλους τους σωλήνες. Επιχειρήστε αποκοπή της φλόγας με υψηλή πίεση στο σημείο διαρροής.",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"Μήν διασκορπίζετε την πυρκαγιά μ";
mostCurrent._clv2._addtextitem /*String*/ ("Μήν διασκορπίζετε την πυρκαγιά με συμπαγή βολή,Αν είναι δυνατό καλύψτε με C02,ξηρά σκόνη ή αφρό",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"Κατάσβεση όλων των πηγών ανάφλεξ";
mostCurrent._clv2._addtextitem /*String*/ ("Κατάσβεση όλων των πηγών ανάφλεξης, ακόμα και τις μικρότερες.Επίσης πρέπει να επιχειρείται μείωση της θερμοκρασίας",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"Σταματήστε και απομακρυνθείτε εά";
mostCurrent._clv2._addtextitem /*String*/ ("Σταματήστε και απομακρυνθείτε εάν η φωτιά φτάσει στο βυτίο-δεξαμενή ή υπάρχει μεγάλη θερμοκρασία δίπλα που δεν εξουδετερώνεται ,υπάρχει μεγάλος κίνδυνος έκρηξης",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"Προσπαθήστε να περιορίσετε την ε";
