...
public class triaxil400 extends Activity implements B4AActivity{
	public static triaxil400 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.triaxil400");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (triaxil400).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.triaxil400");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.triaxil400", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (triaxil400) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (triaxil400) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (triaxil400) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,triaxil400.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 123;BA.debugLine="clv2.AddTextItem(\"3301	Κατηγορία 8	Διαβρωτικό υγρό";
mostCurrent._clv2._addtextitem /*String*/ ("3301	Κατηγορία 8	Διαβρωτικό υγρό, αυτο-θέρμανσης, 	   ",(Object)(""));
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"3302	Κατηγορία 6.1	Κατηγορία 2-δ";
mostCurrent._clv2._addtextitem /*String*/ ("3302	Κατηγορία 6.1	Κατηγορία 2-διμεθυλαμινοαιθυλ ακρυλικό	   ",(Object)(""));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"3303	Κατηγορία 2.3	Συμπιεσμένο α";
mostCurrent._clv2._addtextitem /*String*/ ("3303	Κατηγορία 2.3	Συμπιεσμένο αέριο, τοξικά, οξειδωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"3304	Κατηγορία 2.3	Συμπιεσμένο α";
mostCurrent._clv2._addtextitem /*String*/ ("3304	Κατηγορία 2.3	Συμπιεσμένο αέριο, τοξικά, διαβρωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"3305	Κατηγορία 2.3	Συμπιεσμένο α";
mostCurrent._clv2._addtextitem /*String*/ ("3305	Κατηγορία 2.3	Συμπιεσμένο αέριο, τοξικά, εύφλεκτα, διαβρωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"3306	Κατηγορία 2.3	Συμπιεσμένο α";
mostCurrent._clv2._addtextitem /*String*/ ("3306	Κατηγορία 2.3	Συμπιεσμένο αέριο, τοξικά, οξειδωτικά, διαβρωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"3307	Κατηγορία 2.3	Υγροποιημένα";
mostCurrent._clv2._addtextitem /*String*/ ("3307	Κατηγορία 2.3	Υγροποιημένα αέρια, τοξικά, οξειδωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"3308	Κατηγορία 2.3	Υγροποιημένα";
mostCurrent._clv2._addtextitem /*String*/ ("3308	Κατηγορία 2.3	Υγροποιημένα αέρια, τοξικά, διαβρωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"3309	Κατηγορία 2.3	Υγροποιημένα";
mostCurrent._clv2._addtextitem /*String*/ ("3309	Κατηγορία 2.3	Υγροποιημένα αέρια, τοξικά, εύφλεκτα, διαβρωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"3310	Κατηγορία 2.3	Υγροποιημένα";
mostCurrent._clv2._addtextitem /*String*/ ("3310	Κατηγορία 2.3	Υγροποιημένα αέρια, τοξικά, οξειδωτικά, διαβρωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"3311	Κατηγορία 2.2	Αερίου, κατεψ";
mostCurrent._clv2._addtextitem /*String*/ ("3311	Κατηγορία 2.2	Αερίου, κατεψυγμένο, υγρό, οξειδωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"3312	Κατηγορία 2.1	Αερίου, ψυγεί";
mostCurrent._clv2._addtextitem /*String*/ ("3312	Κατηγορία 2.1	Αερίου, ψυγείο υγρό, εύφλεκτο, 	   ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"3313	Κατηγορία 4.2	Οργανικές χρω";
mostCurrent._clv2._addtextitem /*String*/ ("3313	Κατηγορία 4.2	Οργανικές χρωστικές, αυτο-θέρμανσης	   ",(Object)(""));
 //BA.debugLineNum = 136;BA.debugLine="clv2.AddTextItem(\"3314	Κατηγορία 9	Ένωση πλαστικού";
mostCurrent._clv2._addtextitem /*String*/ ("3314	Κατηγορία 9	Ένωση πλαστικού καλουπώματος σε ζύμη   ",(Object)(""));
 //BA.debugLineNum = 137;BA.debugLine="clv2.AddTextItem(\"3315	Κατηγορία 6.1	Χημικό δείγμα";
mostCurrent._clv2._addtextitem /*String*/ ("3315	Κατηγορία 6.1	Χημικό δείγμα, τοξικό	   ",(Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="clv2.AddTextItem(\"3316	Κατηγορία 9	Chemical kit ή";
mostCurrent._clv2._addtextitem /*String*/ ("3316	Κατηγορία 9	Chemical kit ή το κιτ πρώ βοηθειών περιέχει επικίνδυνα εμπορεύματα	   ",(Object)(""));
 //BA.debugLineNum = 139;BA.debugLine="clv2.AddTextItem(\"3317	Κατηγορία 4.1	Αμινο-δινιτρο";
mostCurrent._clv2._addtextitem /*String*/ ("3317	Κατηγορία 4.1	Αμινο-δινιτροφαινόλη	   ",(Object)(""));
 //BA.debugLineNum = 140;BA.debugLine="clv2.AddTextItem(\"3318	Κατηγορία 2.3	Αμμωνία διάλυ";
mostCurrent._clv2._addtextitem /*String*/ ("3318	Κατηγορία 2.3	Αμμωνία διάλυμα	   ",(Object)(""));
 //BA.debugLineNum = 141;BA.debugLine="clv2.AddTextItem(\"3319	Κατηγορία 4.1	Η νιτρογλυκερ";
mostCurrent._clv2._addtextitem /*String*/ ("3319	Κατηγορία 4.1	Η νιτρογλυκερίνη μείγμα, απευαισθητοποιημένοι",(Object)(""));
 //BA.debugLineNum = 142;BA.debugLine="clv2.AddTextItem(\"3320	Κατηγορία 8	Βοροϋδριδίου το";
mostCurrent._clv2._addtextitem /*String*/ ("3320	Κατηγορία 8	Βοροϋδριδίου του νατρίου και υδροξείδιο του νατρίου",(Object)(""));
 //BA.debugLineNum = 143;BA.debugLine="clv2.AddTextItem(\"3321	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3321	Κατηγορία 7	Ραδιενεργό υλικό, χαμηλή σχετική δραστικότητα LSA-II) , μη-σχάσιμο ή σχάσιμο εξαιρούμενο",(Object)(""));
 //BA.debugLineNum = 144;BA.debugLine="clv2.AddTextItem(\"3322	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3322	Κατηγορία 7	Ραδιενεργό υλικό, χαμηλή σχετική δραστικότητα LSA-III) , μη-σχάσιμο ή σχάσιμο εξαιρούμενο",(Object)(""));
 //BA.debugLineNum = 145;BA.debugLine="clv2.AddTextItem(\"3323	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3323	Κατηγορία 7	Ραδιενεργό υλικό, κόλου Τύπου C , μη-σχάσιμο ή σχάσιμο εξαιρούμενο	   ",(Object)(""));
 //BA.debugLineNum = 146;BA.debugLine="clv2.AddTextItem(\"3324	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3324	Κατηγορία 7	Ραδιενεργό υλικό, χαμηλή σχετική δραστικότητα LSA-II) , σχάσιμο	   ",(Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="clv2.AddTextItem(\"3325	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3325	Κατηγορία 7	Ραδιενεργό υλικό, χαμηλή σχετική δραστικότητα LSA-III) , σχάσιμο	   ",(Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="clv2.AddTextItem(\"3326	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3326	Κατηγορία 7	Ραδιενεργό υλικό, επιφανειακά μολυσμένα αντικείμενα SCO-I ή SCO-II) , σχάσιμο	   ",(Object)(""));
 //BA.debugLineNum = 149;BA.debugLine="clv2.AddTextItem(\"3327	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3327	Κατηγορία 7	Ραδιενεργό υλικό, κόλο Τύπου Α , σχάσιμο , μη ειδικό έντυπο	   ",(Object)(""));
 //BA.debugLineNum = 150;BA.debugLine="clv2.AddTextItem(\"3328	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3328	Κατηγορία 7	Ραδιενεργό υλικό, Τύπου B U συσκευασία , σχάσιμο	   ",(Object)(""));
 //BA.debugLineNum = 151;BA.debugLine="clv2.AddTextItem(\"3329	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3329	Κατηγορία 7	Ραδιενεργό υλικό, Τύπου B M συσκευασία , σχάσιμο	   ",(Object)(""));
 //BA.debugLineNum = 152;BA.debugLine="clv2.AddTextItem(\"3330	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3330	Κατηγορία 7	Ραδιενεργό υλικό, κόλου Τύπου C , σχάσιμο	   ",(Object)(""));
 //BA.debugLineNum = 153;BA.debugLine="clv2.AddTextItem(\"3331	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3331	Κατηγορία 7	Ραδιενεργό υλικό, μεταφέρονται υπό ειδικές ρυθμίσεις, σχάσιμο	   ",(Object)(""));
 //BA.debugLineNum = 154;BA.debugLine="clv2.AddTextItem(\"3332	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3332	Κατηγορία 7	Ραδιενεργό υλικό, κόλο Τύπου Α , ειδική μορφή, μη-σχάσιμο ή σχάσιμο εξαιρούμενο	",(Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="clv2.AddTextItem(\"3333	Κατηγορία 7	Ραδιενεργό υλικ";
mostCurrent._clv2._addtextitem /*String*/ ("3333	Κατηγορία 7	Ραδιενεργό υλικό, κόλο Τύπου Α , ειδική μορφή, σχάσιμο	   ",(Object)(""));
 //BA.debugLineNum = 156;BA.debugLine="clv2.AddTextItem(\"3334	Κατηγορία 9	Αεροπορίας ρυθμ";
mostCurrent._clv2._addtextitem /*String*/ ("3334	Κατηγορία 9	Αεροπορίας ρυθμιζόμενη υγρό, 	   ",(Object)(""));
 //BA.debugLineNum = 157;BA.debugLine="clv2.AddTextItem(\"3335	Κατηγορία 9	Της πολιτικής α";
mostCurrent._clv2._addtextitem /*String*/ ("3335	Κατηγορία 9	Της πολιτικής αεροπορίας ρυθμίζονται στερεά, 	   ",(Object)(""));
 //BA.debugLineNum = 158;BA.debugLine="clv2.AddTextItem(\"3336	Κατηγορία 3	Μερκαπτάνες , υ";
mostCurrent._clv2._addtextitem /*String*/ ("3336	Κατηγορία 3	Μερκαπτάνες , υγρό, εύφλεκτο,  ή μερκαπτάνη μίγμα, υγρό, εύφλεκτο, 	   ",(Object)(""));
 //BA.debugLineNum = 159;BA.debugLine="clv2.AddTextItem(\"3337	Κατηγορία 2.2	Ψυκτικό αέριο";
mostCurrent._clv2._addtextitem /*String*/ ("3337	Κατηγορία 2.2	Ψυκτικό αέριο R404A	   ",(Object)(""));
 //BA.debugLineNum = 160;BA.debugLine="clv2.AddTextItem(\"3338	Κατηγορία 2.2	Ψυκτικό αέριο";
mostCurrent._clv2._addtextitem /*String*/ ("3338	Κατηγορία 2.2	Ψυκτικό αέριο R407A	   ",(Object)(""));
 //BA.debugLineNum = 161;BA.debugLine="clv2.AddTextItem(\"3339	Κατηγορία 2.2	Ψυκτικό αέριο";
mostCurrent._clv2._addtextitem /*String*/ ("3339	Κατηγορία 2.2	Ψυκτικό αέριο R407B	   ",(Object)(""));
 //BA.debugLineNum = 162;BA.debugLine="clv2.AddTextItem(\"3340	Κατηγορία 2.2	Ψυκτικό αέριο";
mostCurrent._clv2._addtextitem /*String*/ ("3340	Κατηγορία 2.2	Ψυκτικό αέριο R407C	   ",(Object)(""));
 //BA.debugLineNum = 163;BA.debugLine="clv2.AddTextItem(\"3341	Κατηγορία 4.2	Διοξείδιο Θει";
mostCurrent._clv2._addtextitem /*String*/ ("3341	Κατηγορία 4.2	Διοξείδιο Θειουρία	   ",(Object)(""));
 //BA.debugLineNum = 164;BA.debugLine="clv2.AddTextItem(\"3342	Κατηγορία 4.2	Ξανθάτες	   \"";
mostCurrent._clv2._addtextitem /*String*/ ("3342	Κατηγορία 4.2	Ξανθάτες	   ",(Object)(""));
 //BA.debugLineNum = 165;BA.debugLine="clv2.AddTextItem(\"3343	Κατηγορία 3	Νιτρογλυκερίνη";
mostCurrent._clv2._addtextitem /*String*/ ("3343	Κατηγορία 3	Νιτρογλυκερίνη   ",(Object)(""));
 //BA.debugLineNum = 166;BA.debugLine="clv2.AddTextItem(\"3344	Κατηγορία 4.1	Πενταερυθριτό";
mostCurrent._clv2._addtextitem /*String*/ ("3344	Κατηγορία 4.1	Πενταερυθριτόλη τετρανιτρικό   ",(Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="clv2.AddTextItem(\"3345	Κατηγορία 6.1	Φαινοξυοξικού";
mostCurrent._clv2._addtextitem /*String*/ ("3345	Κατηγορία 6.1	Φαινοξυοξικού οξέος φυτοφαρμάκων , στερεά, τοξικά	   ",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="clv2.AddTextItem(\"3346	Κατηγορία 3	Φαινοξυοξικού π";
mostCurrent._clv2._addtextitem /*String*/ ("3346	Κατηγορία 3	Φαινοξυοξικού παράγωγο παρασιτοκτόνο , υγρό, εύφλεκτο, τοξικό σημείο ανάφλεξης μικρότερο από 23 ° C	",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="clv2.AddTextItem(\"3347	Κατηγορία 6.1	Φαινοξυοξικό";
mostCurrent._clv2._addtextitem /*String*/ ("3347	Κατηγορία 6.1	Φαινοξυοξικό οξύ παράγωγο φυτοφάρμακο , υγρά, τοξικά, εύφλεκτα σημείο ανάφλεξης 23 ° C ή περισσότερο",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="clv2.AddTextItem(\"3348	Κατηγορία 6.1	Φαινοξυοξικού";
mostCurrent._clv2._addtextitem /*String*/ ("3348	Κατηγορία 6.1	Φαινοξυοξικού παράγωγο παρασιτοκτόνο , υγρό, τοξικό	   ",(Object)(""));
 //BA.debugLineNum = 171;BA.debugLine="clv2.AddTextItem(\"3349	Κατηγορία 6.1	Πυρεθροειδή φ";
mostCurrent._clv2._addtextitem /*String*/ ("3349	Κατηγορία 6.1	Πυρεθροειδή φυτοφαρμάκων , στερεά, τοξικά	   ",(Object)(""));
 //BA.debugLineNum = 172;BA.debugLine="clv2.AddTextItem(\"3350	Κατηγορία 3	    Πυρεθροειδή";
mostCurrent._clv2._addtextitem /*String*/ ("3350	Κατηγορία 3	    Πυρεθροειδή παρασιτοκτόνο , υγρό, εύφλεκτο, τοξικό σημείο ανάφλεξης μικρότερο από 23 ° C	",(Object)(""));
 //BA.debugLineNum = 173;BA.debugLine="clv2.AddTextItem(\"3351	Κατηγορία 6.1	Πυρεθροειδή π";
mostCurrent._clv2._addtextitem /*String*/ ("3351	Κατηγορία 6.1	Πυρεθροειδή παρασιτοκτόνο , υγρό, τοξικό, εύφλεκτο σημείο ανάφλεξης 23 ° C ή περισσότερο",(Object)(""));
 //BA.debugLineNum = 174;BA.debugLine="clv2.AddTextItem(\"3352	Κατηγορία 6.1	Πυρεθροειδή π";
mostCurrent._clv2._addtextitem /*String*/ ("3352	Κατηγορία 6.1	Πυρεθροειδή παρασιτοκτόνο , υγρό, τοξικό	      ",(Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="clv2.AddTextItem(\"3354	Κατηγορία 2.1	Εντομοκτόνο α";
mostCurrent._clv2._addtextitem /*String*/ ("3354	Κατηγορία 2.1	Εντομοκτόνο αέριο, εύφλεκτο, 	   ",(Object)(""));
 //BA.debugLineNum = 176;BA.debugLine="clv2.AddTextItem(\"3355	Κατηγορία 2.3	Εντομοκτόνο α";
mostCurrent._clv2._addtextitem /*String*/ ("3355	Κατηγορία 2.3	Εντομοκτόνο αέριο, τοξικό, εύφλεκτο, 	   ",(Object)(""));
 //BA.debugLineNum = 177;BA.debugLine="clv2.AddTextItem(\"3356	Κατηγορία 5.1	Οξυγόνο γεννή";
mostCurrent._clv2._addtextitem /*String*/ ("3356	Κατηγορία 5.1	Οξυγόνο γεννήτρια, χημικά	   ",(Object)(""));
 //BA.debugLineNum = 178;BA.debugLine="clv2.AddTextItem(\"3357	Κατηγορία 3	    Nιτρογλυκερ";
mostCurrent._clv2._addtextitem /*String*/ ("3357	Κατηγορία 3	    Nιτρογλυκερίνη μείγμα   ",(Object)(""));
 //BA.debugLineNum = 179;BA.debugLine="clv2.AddTextItem(\"3358	Κατηγορία 2.1	Ψυκτικές μηχα";
mostCurrent._clv2._addtextitem /*String*/ ("3358	Κατηγορία 2.1	Ψυκτικές μηχανές, που περιέχουν εύφλεκτα, μη-τοξικά, υγροποιημένο αέριο	",(Object)(""));
 //BA.debugLineNum = 180;BA.debugLine="clv2.AddTextItem(\"3359	Κατηγορία 9	   Σε υποκαπνισ";
mostCurrent._clv2._addtextitem /*String*/ ("3359	Κατηγορία 9	   Σε υποκαπνισμό μονάδα	   ",(Object)(""));
 //BA.debugLineNum = 181;BA.debugLine="clv2.AddTextItem(\"3360	Κατηγορία 4.1	Ίνες, λαχανικ";
mostCurrent._clv2._addtextitem /*String*/ ("3360	Κατηγορία 4.1	Ίνες, λαχανικών, ξηρών	   ",(Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="clv2.AddTextItem(\"3361	Κατηγορία 6.1	Χλωροσιλάνι ,";
mostCurrent._clv2._addtextitem /*String*/ ("3361	Κατηγορία 6.1	Χλωροσιλάνι , τοξικά, διαβρωτικά, 	   ",(Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="clv2.AddTextItem(\"3362	Κατηγορία 6.1	Χλωροσιλανίων";
mostCurrent._clv2._addtextitem /*String*/ ("3362	Κατηγορία 6.1	Χλωροσιλανίων , τοξικά, διαβρωτικά, εύφλεκτα, 	   ",(Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="clv2.AddTextItem(\"3363	Κατηγορία 9	    Επικίνδυνα";
mostCurrent._clv2._addtextitem /*String*/ ("3363	Κατηγορία 9	    Επικίνδυνα εμπορεύματα σε μηχανήματα ή επικίνδυνα εμπορεύματα σε συσκευή	   ",(Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="clv2.AddTextItem(\"3364	Κατηγορία 4.1	Τρινιτροφαινό";
mostCurrent._clv2._addtextitem /*String*/ ("3364	Κατηγορία 4.1	Τρινιτροφαινόλη  πικρικό οξύ ), βρεγμένη με όχι λιγότερο από 10% νερό κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="clv2.AddTextItem(\"3365	Κατηγορία 4.1	Τρινιτροχλωρο";
mostCurrent._clv2._addtextitem /*String*/ ("3365	Κατηγορία 4.1	Τρινιτροχλωροβενζόλιο  πικρυλοχλωρίδιο ), βρεγμένη με όχι λιγότερο από 10% νερό κατά βάρος	",(Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="clv2.AddTextItem(\"3366	Κατηγορία 4.1	Τρινιτροτολου";
mostCurrent._clv2._addtextitem /*String*/ ("3366	Κατηγορία 4.1	Τρινιτροτολουένιο TNT), βρεγμένη με όχι λιγότερο από 10% νερό κατά μάζα	   ",(Object)(""));
 //BA.debugLineNum = 188;BA.debugLine="clv2.AddTextItem(\"3367	Κατηγορία 4.1	Τρινιτροβενζό";
mostCurrent._clv2._addtextitem /*String*/ ("3367	Κατηγορία 4.1	Τρινιτροβενζόλιο , βρεγμένο με όχι λιγότερο από 10% νερό κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 189;BA.debugLine="clv2.AddTextItem(\"3368	Κατηγορία 4.1	Τρινιτροβενζο";
mostCurrent._clv2._addtextitem /*String*/ ("3368	Κατηγορία 4.1	Τρινιτροβενζοϊκό οξύ , βρεγμένο με όχι λιγότερο από 10% νερό κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 190;BA.debugLine="clv2.AddTextItem(\"3369	Κατηγορία 4.1	Δινιτρο-ο-κρε";
mostCurrent._clv2._addtextitem /*String*/ ("3369	Κατηγορία 4.1	Δινιτρο-ο-κρεζολικό νάτριο , βρεγμένο με όχι λιγότερο από 10% νερό κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 191;BA.debugLine="clv2.AddTextItem(\"3370	Κατηγορία 4.1	Νιτρική ουρία";
mostCurrent._clv2._addtextitem /*String*/ ("3370	Κατηγορία 4.1	Νιτρική ουρία , βρεγμένη με όχι λιγότερο από 10% νερό κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="clv2.AddTextItem(\"3371	Κατηγορία 3	    Mεθυλβουταν";
mostCurrent._clv2._addtextitem /*String*/ ("3371	Κατηγορία 3	    Mεθυλβουτανάλης	   ",(Object)(""));
 //BA.debugLineNum = 193;BA.debugLine="clv2.AddTextItem(\"3373	Κατηγορία 6.2	Βιολογική ουσ";
mostCurrent._clv2._addtextitem /*String*/ ("3373	Κατηγορία 6.2	Βιολογική ουσία,  Β	   ",(Object)(""));
 //BA.debugLineNum = 194;BA.debugLine="clv2.AddTextItem(\"3374	Κατηγορία 2.1	Ακετυλένιο ,";
mostCurrent._clv2._addtextitem /*String*/ ("3374	Κατηγορία 2.1	Ακετυλένιο , χωρίς διαλύτες	   ",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="clv2.AddTextItem(\"3375	Κατηγορία 5.1	Νιτρικό αμμών";
mostCurrent._clv2._addtextitem /*String*/ ("3375	Κατηγορία 5.1	Νιτρικό αμμώνιο γαλάκτωμα ή αναστολή ή τζελ	   ",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="clv2.AddTextItem(\"3376	Κατηγορία 4.1	Κατηγορία 4-ν";
mostCurrent._clv2._addtextitem /*String*/ ("3376	Κατηγορία 4.1	Κατηγορία 4-νιτροφαινυλο , με όχι λιγότερο από 30% νερό κατά βάρος	   ",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="clv2.AddTextItem(\"3377	Κατηγορία 5.1	Μονοένυδρο υπ";
mostCurrent._clv2._addtextitem /*String*/ ("3377	Κατηγορία 5.1	Μονοένυδρο υπερβορικό νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 198;BA.debugLine="clv2.AddTextItem(\"3378	Κατηγορία 5.1	Υπεροξυένυδρο";
mostCurrent._clv2._addtextitem /*String*/ ("3378	Κατηγορία 5.1	Υπεροξυένυδρο ανθρακικό νάτριο	   ",(Object)(""));
 //BA.debugLineNum = 199;BA.debugLine="clv2.AddTextItem(\"3379  Κατηγορία 3	    Απευαισθητ";
mostCurrent._clv2._addtextitem /*String*/ ("3379  Κατηγορία 3	    Απευαισθητοποιημένες εκρηκτικά , υγρό, 	   ",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="clv2.AddTextItem(\"3380	Κατηγορία 4.1	Απευαισθητοπο";
mostCurrent._clv2._addtextitem /*String*/ ("3380	Κατηγορία 4.1	Απευαισθητοποιημένες εκρηκτικά, στερεά, 	",(Object)(""));
 //BA.debugLineNum = 201;BA.debugLine="clv2.AddTextItem(\"3381	Κατηγορία 6.1	Τοξικό με εισ";
mostCurrent._clv2._addtextitem /*String*/ ("3381	Κατηγορία 6.1	Τοξικό με εισπνοή liquid   ",(Object)(""));
 //BA.debugLineNum = 202;BA.debugLine="clv2.AddTextItem(\"3382	Κατηγορία 6.1	Τοξικό υγρό α";
mostCurrent._clv2._addtextitem /*String*/ ("3382	Κατηγορία 6.1	Τοξικό υγρό από εισπνοή, ",(Object)(""));
 //BA.debugLineNum = 203;BA.debugLine="clv2.AddTextItem(\"3383	Κατηγορία 6.1	Τοξικό όταν ε";
mostCurrent._clv2._addtextitem /*String*/ ("3383	Κατηγορία 6.1	Τοξικό όταν εισπνέεται υγρό, εύφλεκτο",(Object)(""));
 //BA.debugLineNum = 204;BA.debugLine="clv2.AddTextItem(\"3384	Κατηγορία 6.1	Τοξικό όταν ε";
mostCurrent._clv2._addtextitem /*String*/ ("3384	Κατηγορία 6.1	Τοξικό όταν εισπνέεται υγρό, εύφλεκτο",(Object)(""));
 //BA.debugLineNum = 205;BA.debugLine="clv2.AddTextItem(\"3385	Κατηγορία 6.1	Τοξικό υγρό α";
mostCurrent._clv2._addtextitem /*String*/ ("3385	Κατηγορία 6.1	Τοξικό υγρό από εισπνοή, αντιδρούν με το νερo	",(Object)(""));
 //BA.debugLineNum = 206;BA.debugLine="clv2.AddTextItem(\"3387	Κατηγορία 6.1	Τοξικό υγρό α";
mostCurrent._clv2._addtextitem /*String*/ ("3387	Κατηγορία 6.1	Τοξικό υγρό από εισπνοή, οξειδωτικά	",(Object)(""));
 //BA.debugLineNum = 207;BA.debugLine="clv2.AddTextItem(\"3388	Κατηγορία 6.1	Τοξικό υγρό ε";
mostCurrent._clv2._addtextitem /*String*/ ("3388	Κατηγορία 6.1	Τοξικό υγρό εισπνοή, οξειδωτικά	   	",(Object)(""));
 //BA.debugLineNum = 208;BA.debugLine="clv2.AddTextItem(\"3391	Κατηγορία 4.2	Οργανομεταλλι";
mostCurrent._clv2._addtextitem /*String*/ ("3391	Κατηγορία 4.2	Οργανομεταλλικοί ουσία, στερεά, πυροφορικά	",(Object)(""));
 //BA.debugLineNum = 209;BA.debugLine="clv2.AddTextItem(\"3392	Κατηγορία 4.2	Οργανομεταλλι";
mostCurrent._clv2._addtextitem /*String*/ ("3392	Κατηγορία 4.2	Οργανομεταλλικοί ουσία, υγρό, πυροφορικά	",(Object)(""));
 //BA.debugLineNum = 210;BA.debugLine="clv2.AddTextItem(\"3393	Κατηγορία 4.2	Οργανομεταλλι";
mostCurrent._clv2._addtextitem /*String*/ ("3393	Κατηγορία 4.2	Οργανομεταλλικοί ουσία, στερεά, πυροφορικό , αντιδρούν με το νερό	",(Object)(""));
 //BA.debugLineNum = 211;BA.debugLine="clv2.AddTextItem(\"3394	Κατηγορία 4.2	Οργανομεταλλι";
mostCurrent._clv2._addtextitem /*String*/ ("3394	Κατηγορία 4.2	Οργανομεταλλικοί ουσία, υγρό, πυροφορικό , αντιδρούν με το νερό	",(Object)(""));
 //BA.debugLineNum = 212;BA.debugLine="clv2.AddTextItem(\"3395	Κατηγορία 4.3	Οργανομεταλλι";
mostCurrent._clv2._addtextitem /*String*/ ("3395	Κατηγορία 4.3	Οργανομεταλλικοί ουσία, στερεά, αντιδρούν με το νερό	",(Object)(""));
 //BA.debugLineNum = 213;BA.debugLine="clv2.AddTextItem(\"3396	Κατηγορία 4.3	Οργανομεταλλι";
mostCurrent._clv2._addtextitem /*String*/ ("3396	Κατηγορία 4.3	Οργανομεταλλικοί ουσία, στερεά, αντιδρούν με το νερό, εύφλεκτο	",(Object)(""));
 //BA.debugLineNum = 214;BA.debugLine="clv2.AddTextItem(\"3397	Κατηγορία 4.3	Οργανομεταλλι";
mostCurrent._clv2._addtextitem /*String*/ ("3397	Κατηγορία 4.3	Οργανομεταλλικοί ουσία, στερεά, αντιδρούν με το νερό, αυτο-θέρμανσης	",(Object)(""));
 //BA.debugLineNum = 215;BA.debugLine="clv2.AddTextItem(\"3398	Κατηγορία 4.3	Οργανομεταλλι";
mostCurrent._clv2._addtextitem /*String*/ ("3398	Κατηγορία 4.3	Οργανομεταλλικό ουσία, υγρό, αντιδρούν με το νερό	",(Object)(""));
 //BA.debugLineNum = 216;BA.debugLine="clv2.AddTextItem(\"3399	Κατηγορία 4.3	Οργανομεταλλι";
mostCurrent._clv2._addtextitem /*String*/ ("3399	Κατηγορία 4.3	Οργανομεταλλικοί ουσία, υγρό, αντιδρούν με το νερό, εύφλεκτο	",(Object)(""));
 //BA.debugLineNum = 217;BA.debugLine="clv2.AddTextItem(\"3400	Κατηγορία 4.3	Οργανομετα";
mostCurrent._clv2._addtextitem /*String*/ ("3400	Κατηγορία 4.3	Οργανομεταλλικό ουσία, υγρό, αντιδρούν με το νερό, αυτο-θέρμανση	",(Object)(""));
