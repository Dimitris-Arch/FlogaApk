...
public class dytmak extends Activity implements B4AActivity{
	public static dytmak mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.dytmak");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dytmak).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.dytmak");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.dytmak", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dytmak) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dytmak) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dytmak) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,dytmak.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 119;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΚΟΖΑΝΗΣ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΚΟΖΑΝΗΣ",(Object)("Τηλ: 24613-53300"));
 //BA.debugLineNum = 120;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΝΕΑΠΟΛΗΣ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΝΕΑΠΟΛΗΣ",(Object)("Τηλ: 24680-23383"));
 //BA.debugLineNum = 121;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΣΕΡΒΙΩΝ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΣΕΡΒΙΩΝ",(Object)("Τηλ: 24640-21198"));
 //BA.debugLineNum = 122;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΠΤΟΛΕΜΑΙΔΑ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΠΤΟΛΕΜΑΙΔΑΣ",(Object)("Τηλ: 24630-81445-6"));
 //BA.debugLineNum = 123;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΦΛΩΡΙΝΑΣ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΦΛΩΡΙΝΑΣ",(Object)("Τηλ: 23850-22444"));
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΚΑΣΤΟΡΙΑΣ\"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΚΑΣΤΟΡΙΑΣ",(Object)("Τηλ: 24670-82464-5"));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΝΕΣΤΟΡΙΟΥ\"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΝΕΣΤΟΡΙΟΥ",(Object)("Τηλ: 24670-31135"));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΡΓΟΥΣ ΟΡΕ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΡΓΟΥΣ ΟΡΕΣΤΙΚΟΥ",(Object)("Τηλ: 24670-43111"));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΕΠΤΑΧΩΡΙΟΥ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΕΠΤΑΧΩΡΙΟΥ",(Object)("Τηλ: 24670-82628"));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΓΡΕΒΕΝΩΝ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΓΡΕΒΕΝΩΝ",(Object)("Τηλ: 24620-23451"));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΔΕΣΚΑΤΗΣ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΔΕΣΚΑΤΗΣ",(Object)("Τηλ: 24620-34368"));
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 155;BA.debugLine="StartActivity(p.Call(Value))";
...
public static String  _ili_click() throws Exception{
 ...
 //BA.debugLineNum = 191;BA.debugLine="StartActivity(\"firstaid\")";
...
public static String  _ililabel_click() throws Exception{
 ...
 //BA.debugLineNum = 225;BA.debugLine="StartActivity(\"firstaid\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("firstaid"));
...
public static String  _katigorlabel_click() throws Exception{
 ...
 //BA.debugLineNum = 219;BA.debugLine="StartActivity(\"pixida\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("pixida"));
...
public static String  _listabel_click() throws Exception{
 ...
 //BA.debugLineNum = 216;BA.debugLine="StartActivity(\"camera\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("camera"));
...
public static String  _ousia_click() throws Exception{
 ...
 //BA.debugLineNum = 194;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 ...
 //BA.debugLineNum = 222;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
...
public static String  _simanseislabel_click() throws Exception{
 ...
 //BA.debugLineNum = 213;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
 //BA.debugLineNum = 214;BA.debugLine="End Sub";
return "";
}
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 227;BA.debugLine="Sub simansi_Click";
