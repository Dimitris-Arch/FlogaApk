...
public class notioaig extends Activity implements B4AActivity{
	public static notioaig mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.notioaig");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (notioaig).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.notioaig");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.notioaig", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (notioaig) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (notioaig) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (notioaig) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,notioaig.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 118;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΕΡΜΟΥΠΟΛΗΣ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΕΡΜΟΥΠΟΛΗΣ",(Object)("Τηλ: 22813-61901 "));
 //BA.debugLineNum = 119;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΝΔΡΟΥ\", \"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΝΔΡΟΥ",(Object)("Τηλ: 22820-42099"));
 //BA.debugLineNum = 120;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΠΑΡΟΥ\", \"Τ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΠΑΡΟΥ",(Object)("Τηλ: 22840-24850"));
 //BA.debugLineNum = 121;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΝΑΞΟΥ\", \"Τ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΝΑΞΟΥ",(Object)("Τηλ: 22850-32899"));
 //BA.debugLineNum = 122;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΘΗΡΑΣ (ΣΑΝ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΘΗΡΑΣ (ΣΑΝΤΟΡΙΝΗ)",(Object)("Τηλ: 22860-33087"));
 //BA.debugLineNum = 123;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΤΗΝΟΥ\", \"Τ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΤΗΝΟΥ",(Object)("Τηλ: 22830-23129"));
 //BA.debugLineNum = 124;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΡΟΔΟΥ\", \"Τ";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΡΟΔΟΥ",(Object)("Τηλ: 22410-23333-4"));
 //BA.debugLineNum = 125;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΛΙΝΔΟΥ\", \"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΛΙΝΔΟΥ",(Object)("Τηλ: 22440-61198"));
 //BA.debugLineNum = 126;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΚΑΡΠΑΘΟΥ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΚΑΡΠΑΘΟΥ",(Object)("Τηλ: 22450-23676"));
 //BA.debugLineNum = 127;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΠΟΛΛΩΝΑ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΑΠΟΛΛΩΝΑ",(Object)("Τηλ: 22460-91099 "));
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ Κ/Α ΡΟΔΟΥ\"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ Κ/Α ΡΟΔΟΥ",(Object)("Τηλ: 22410-82320"));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΚΩ\", \"Τηλ:";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ ΚΩ",(Object)("Τηλ: 22420-26183"));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ Κ/Α ΚΩ\", \"";
mostCurrent._clv2._addtextitem /*String*/ ("ΠΥΡΟΣΒΕΣΤΙΚΗ ΥΠΗΡΕΣΙΑ Κ/Α ΚΩ",(Object)("Τηλ: 22420-51200"));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"ΕΘΕΛΟΝΤΙΚΟ ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ";
mostCurrent._clv2._addtextitem /*String*/ ("ΕΘΕΛΟΝΤΙΚΟ ΠΥΡΟΣΒΕΣΤΙΚΟ ΚΛΙΜΑΚΙΟ ΕΜΠΩΝΑΣ",(Object)("Τηλ: 22463-60199 "));
 //BA.debugLineNum = 145;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 237;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 238;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 160;BA.debugLine="StartActivity(p.Call(Value))";
...
public static String  _ili_click() throws Exception{
 ...
 //BA.debugLineNum = 196;BA.debugLine="StartActivity(\"firstaid\")";
...
public static String  _katigor_click() throws Exception{
 ...
 //BA.debugLineNum = 210;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _lista_click() throws Exception{
 ...
 //BA.debugLineNum = 206;BA.debugLine="StartActivity(\"camera\")";
...
public static String  _ousia_click() throws Exception{
 ...
 //BA.debugLineNum = 199;BA.debugLine="StartActivity(\"gpssignal\")";
...
public static String  _ousialabel_click() throws Exception{
 ...
 //BA.debugLineNum = 227;BA.debugLine="StartActivity(\"gpssignal\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("gpssignal"));
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 232;BA.debugLine="Sub simansi_Click";
