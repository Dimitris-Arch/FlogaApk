...
public class ydroxidiodialima extends Activity implements B4AActivity{
	public static ydroxidiodialima mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "firefighter.companion", "firefighter.companion.ydroxidiodialima");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (ydroxidiodialima).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "firefighter.companion", "firefighter.companion.ydroxidiodialima");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "firefighter.companion.ydroxidiodialima", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (ydroxidiodialima) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (ydroxidiodialima) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (ydroxidiodialima) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            ydroxidiodialima mc = mostCurrent;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="Activity.LoadLayout(\"ydroxidiodialima.bal\")";
mostCurrent._activity.LoadLayout("ydroxidiodialima.bal",mostCurrent.activityBA);
...
mostCurrent._clv2._initialize /*String*/ (mostCurrent.activityBA,ydroxidiodialima.getObject(),"clv2");
...
mostCurrent._clv2._defaulttextbackgroundcolor /*int*/  = anywheresoftware.b4a.keywords.Common.Colors.DarkGray;
 //BA.debugLineNum = 128;BA.debugLine="clv2.AddTextItem(\"Το υδροξείδιο του νατρίου ώς διά";
mostCurrent._clv2._addtextitem /*String*/ ("Το υδροξείδιο του νατρίου ώς διάλυμα UN-1824 είναι διαβρωτική ουσία ",(Object)(""));
 //BA.debugLineNum = 129;BA.debugLine="clv2.AddTextItem(\"Σε επαφή με το νερό απελευθερώνε";
mostCurrent._clv2._addtextitem /*String*/ ("Σε επαφή με το νερό απελευθερώνει θερμότητα.Προκαλεί σοβαρά εγκαύματα στο σώμα και στο αναπνευστικό προκαλλεί ερεθισμό.",(Object)(""));
 //BA.debugLineNum = 130;BA.debugLine="clv2.AddTextItem(\"Δεν είναι εύφλεκτο,ομώς λυώνει ο";
mostCurrent._clv2._addtextitem /*String*/ ("Δεν είναι εύφλεκτο,ομώς λυώνει οταν θερμανθεί. Αντιδρά έντονα με οξέα.",(Object)(""));
 //BA.debugLineNum = 131;BA.debugLine="clv2.AddTextItem(\"Έαν έρθει σε επαφη με το σώμα πλ";
mostCurrent._clv2._addtextitem /*String*/ ("Έαν έρθει σε επαφη με το σώμα πλυνετε με άφθονο νερο.",(Object)(""));
 //BA.debugLineNum = 132;BA.debugLine="clv2.AddTextItem(\"Κατηγορία 8 \", \"\")";
mostCurrent._clv2._addtextitem /*String*/ ("Κατηγορία 8 ",(Object)(""));
 //BA.debugLineNum = 133;BA.debugLine="clv2.AddTextItem(\"ΔΙΑΒΡΩΤΙΚΕΣ ΟΥΣΙΕΣ ΚΑΙ ΤΟΞΙΚΕΣ\",";
mostCurrent._clv2._addtextitem /*String*/ ("ΔΙΑΒΡΩΤΙΚΕΣ ΟΥΣΙΕΣ ΚΑΙ ΤΟΞΙΚΕΣ",(Object)(""));
 //BA.debugLineNum = 134;BA.debugLine="clv2.AddTextItem(\"Διαβρωτικές ουσίες με κίνδυνο";
mostCurrent._clv2._addtextitem /*String*/ ("Διαβρωτικές ουσίες με κίνδυνο φωτιάς.Προκαλούν μεγάλη βλάβη στην υγεία. ",(Object)(""));
 //BA.debugLineNum = 135;BA.debugLine="clv2.AddTextItem(\"Μερικές ουσίες είναι εκρηκτικές";
mostCurrent._clv2._addtextitem /*String*/ ("Μερικές ουσίες είναι εκρηκτικές και δημιουργούνται τοξικά αέρια.Επίσης υπάρχει κίνδυνος αλυσιδωτής αντίδρασης",(Object)(""));
...
public static String  _gpss_click() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub gpss_Click";
 //BA.debugLineNum = 205;BA.debugLine="StartActivity(\"gpssingal\")";
...
public static String  _ili_click() throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub ili_Click";
...
public static String  _ililabel_click() throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Sub ililabel_Click";
...
public static String  _katigor_click() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub katigor_Click";
 //BA.debugLineNum = 201;BA.debugLine="StartActivity(\"katigoriess\")";
...
public static String  _katigorlabel_click() throws Exception{
 //BA.debugLineNum = 214;BA.debugLine="Sub katigorlabel_Click";
 //BA.debugLineNum = 215;BA.debugLine="StartActivity(\"katigoriess\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("katigoriess"));
 //BA.debugLineNum = 216;BA.debugLine="End Sub";
return "";
}
public static String  _lista_click() throws Exception{
 //BA.debugLineNum = 196;BA.debugLine="Sub lista_Click";
 //BA.debugLineNum = 197;BA.debugLine="StartActivity(\"listaousies\")";
...
public static String  _listabel_click() throws Exception{
 //BA.debugLineNum = 211;BA.debugLine="Sub listabel_Click";
 //BA.debugLineNum = 212;BA.debugLine="StartActivity(\"listaousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("listaousies"));
 //BA.debugLineNum = 213;BA.debugLine="End Sub";
return "";
}
public static String  _ousia_click() throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Sub ousia_Click";
 //BA.debugLineNum = 190;BA.debugLine="StartActivity(\"ousies\")";
...
public static String  _ousialabel_click() throws Exception{
 //BA.debugLineNum = 217;BA.debugLine="Sub ousialabel_Click";
 //BA.debugLineNum = 218;BA.debugLine="StartActivity(\"ousies\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("ousies"));
 //BA.debugLineNum = 219;BA.debugLine="End Sub";
return "";
}
public static String  _pixi_click() throws Exception{
 //BA.debugLineNum = 192;BA.debugLine="Sub pixi_Click";
 //BA.debugLineNum = 193;BA.debugLine="StartActivity(\"pixida\")";
...
public static String  _simanseislabel_click() throws Exception{
 //BA.debugLineNum = 208;BA.debugLine="Sub simanseislabel_Click";
 //BA.debugLineNum = 209;BA.debugLine="StartActivity(\"simanseis\")";
...
public static String  _simansi_click() throws Exception{
 //BA.debugLineNum = 224;BA.debugLine="Sub simansi_Click";
