...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("oxygonopiesi.bal")
...
clv2.AddTextItem("Το οξυγόνο UN-1073 είναι πυροδυναμωτικό αέριο.ΕΙΝΑΙ ΤΟ ΤΡΙΤΟ ΣΤΟΙΧΕΊΟ ΤΟΥ ΤΡΙΓΩΝΟΥ ΤΗΣ ΦΩΤΙΑΣ. ", "")
...
clv2.AddTextItem("Σε κατάσταση ψύξης υπάρχει μεγάλος κίνδυνος εγκάυματος ", "")
clv2.AddTextItem("Κατηγορία 2 ", "")
	clv2.AddTextItem("Εφλεκτα,πυροδυναμοτικα. ", "")
