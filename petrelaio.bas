...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("petrelaio.bal")
...
clv2.AddTextItem("Το πετρέλαιο ντήζελ (diesel) και το πετρέλαιο θέρμανσης UN-1202 είναι μίγμα υδρογονανθράκων.", "")
clv2.AddTextItem("Κατηγορία 3 ", "")

	clv2.AddTextItem("Κίνδυνος ανάφλεξης από σπινθήρα ή στατικό ηλεκτρισμό.", "")


clv2.AddTextItem("Πολύ διαδεδομένες ουσίες.", "")
clv2.AddTextItem("Το πετρέλαιο και οι ατμοί του ειναι πολύ εύφλεκτα  ", "")
clv2.AddTextItem("Προσπαθήστε απομόνωση των αερίων απο το οξυγόνο καλύπτοντας με αφρό", "")
