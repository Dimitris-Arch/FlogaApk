...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("enniabal.bal")
	'PRWTO PANW aristera
pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
...
clv2.AddTextItem("Κατηγορία 9 ", "")
	clv2.AddTextItem("ΔΙΑΦΟΡΕΣ ΤΟΞΙΚΕΣ ΕΦΛΕΚΤΕΣ ΟΥΣΙΕΣ", "")
	clv2.AddTextItem("Πολύ μεγάλος κίνδυνος για την υγεία κατά την αναπνοή", "")
clv2.AddTextItem("Τοξικά,δηλητηριώδη και ευφλεκτα αέρια.", "")
clv2.AddTextItem("Κίνδυνος έκρηξης 	", "")
