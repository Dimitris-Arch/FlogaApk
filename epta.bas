...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("eptabal.bal")
	'PRWTO PANW aristera
pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
...
clv2.AddTextItem("Κατηγορία 7.1 ", "")
clv2.AddTextItem("ΡΑΔΙΕΝΕΡΓΑ ΥΛΙΚΑ", "")
	clv2.AddTextItem("Οι ουσίες αυτές αν και δεν αναφλέγονται εύκολα, αλλάζουν τις ιδιότητες των υλικών όταν θερμανθούν(πλην του ουράνιου και του θορίου που είναι εύφλεκτα και με παρουσία οξυγόνου υπάρχει κίνδυνος αυτανάφλεξης)", "")
clv2.AddTextItem("Κατά την ένωση τους με το νερό δημιουργείτε υδροφθόριο που είναι εξαιρετικά τοξικό και βλαβερό", "")
clv2.AddTextItem("Η ραδιενέργεια είναι θανατηφόρα", "")
...
clv2.AddTextItem("ΜΗΝ ΜΕΝΕΤΕ ΚΟΝΤΑ ΣΤΗΝ ΡΑΔΙΕΝΕΡΓΕΙΑ ΧΩΡΙΣ ΛΟΓΟ  ", "")
