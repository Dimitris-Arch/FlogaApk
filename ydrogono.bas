...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("ydrogono.bal")
...
clv2.AddTextItem("Το υδρογόνο UN-1049 είναι εύφλεκτο, άχρωμο, άοσμο. Δεν είναι τοξικό τυχόν διαρροή του δεν γίνεται εύκολα αντιληπτή και υπάρχει μεγάλος κίνδυνος ασφυξίας σε χώρους που δεν αερίζονται. Είναι ελαφρύτερο από τον αέρα και συσσωρεύεται ψηλά.", "")
clv2.AddTextItem("Καίγεται χωρίς να φαίνεται η φλόγα του,χωρίς να γίνετε αντιληπτή. ", "")
clv2.AddTextItem("ΜΕΓΑΛΟΣ ΚΙΝΔΥΝΟΣ ΑΝΑΦΛΕΞΗΣ ΑΠΟ ΣΤΑΤΙΚΟ ΗΛΕΚΤΡΙΣΜΟ Η ΣΠΙΝΘΡΗΡΑ", "")
clv2.AddTextItem("Σε περίπτωση πυρκαγιάς ψύξτε ΤΗΝ ΦΥΆΛΗ-ΒΥΤΙΟ ΜΕ ΒΟΛΗ ΟΜΙΧΛΗΣ ΑΠΟ ΑΠΟΣΤΑΣΗ ΑΛΛΑ ΜΗΝ ΠΡΟΣΠΑΘΗΣΕΤΕ ΝΑ ΣΒΗΣΕΤΕ ΤΗΝ ΦΛΟΓΑ ΠΟΥ ΔΙΑΡΡΕΕΙ ΥΠΑΡΧΕΙ ΜΕΓΑΛΟΣ ΚΙΝΔΥΝΟΣ ΒΙΑΙΗΣ ΑΝΑΦΛΕΞΗΣ.", "")
clv2.AddTextItem("ΠΡΟΣΠΑΘΗΣΤΕ ΝΑ ΚΛΕΙΣΕΤΕ ΤΗΝ ΠΑΡΟΧΗ ΑΠΟ ΒΑΝΑ Η ΣΩΛΗΝΑ .", "")
clv2.AddTextItem("Κατα την καύση του δημιουργεί θερμοκρασίες άνω 2.500C.", "")
clv2.AddTextItem("Κατηγορία 2 ", "")
clv2.AddTextItem("Ευφλεκτα,πυροδυναμωτικα. ", "")
...
Sub pin1_Click
	Dim result As Int
result = Msgbox2("Επιστροφή στο μενού", "  ", "Ναί ", "", "Όχι ", LoadBitmap (File.DirAssets, "1049.png"))
