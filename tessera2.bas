...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("tessera2.bal")
	'PRWTO PANW aristera
pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
...
clv2.AddTextItem("Κατηγορία 4.2 ", "")
clv2.AddTextItem("Εκρηκτικές ουσίες που αναδύουν τοξικά αέρια κατά την καύση ", "")
clv2.AddTextItem("Κίνδυνος αυτανάφλεξης κατα την επαφή τους με τον ατμοσφαιρικό αέρα.Δεν απαιτείται θερμότητα ή φλόγα ", "")
clv2.AddTextItem("Κίνδυνος κατά την επαφή τους με το νερό ", "")
