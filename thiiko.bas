...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("thiiko.bal")
...
clv2.AddTextItem("Το θειικό οξύ-βιτριόλι UN-1830 είναι παχύρευστο υγρό, άοσμο, άχρωμο και είναι διαβρωτικό και τοξικό", "") 
clv2.AddTextItem("Το νερό δεν πρέπει να χρησιμοποιηθεί χωρίς έγκριση ειδικού.", "")
