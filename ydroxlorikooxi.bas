...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("ydroxlorikooxi.bal")
...
clv2.AddTextItem("Το υδροχλωρικό οξύ UN-1789 είναι πνιγηρό,δηλητηριώδες.", "")
clv2.AddTextItem("Είναι τοξικό και πολύ επικίνδυνο και για το περιβάλλον. Προκαλεί εγκαύματα με την επαφή. εισπνεόμενο προκαλλεί ακόμα και θάνατο.", "")
