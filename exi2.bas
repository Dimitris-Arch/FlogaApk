...
mple.height = 7%y
  ...
  Panel2.Height = 57.5%y
	...
	clv2.AddTextItem("Κατηγορία 6.2 ", "")
	clv2.AddTextItem("Δηλητηριώδεις τοξικές και μολυσματικές ουσίες", "")
clv2.AddTextItem("Μεγάλος κίνδυνος πυρκαγιάς", "")
