...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("ygrooxygono.bal")
...
mple.height = 7%y
  ...
  Panel2.Height = 57.5%y
	...
	clv2.DefaultTextBackgroundColor = Colors.DarkGray
       ...
       clv2.AddTextItem("Το υγρό οξυγόνο UN-1073 βρίσκεται σε πολύ χαμηλή θερμοκρασία και υπάρχει μεγάλος κίνδυνος κρύων εγκαυμάτων.", "")
                   
clv2.AddTextItem("Είναι αέριο άχρωμο, άοσμο. Το οξυγόνο είναι πυροδυναμωτικό αέριο.ΕΙΝΑΙ ΤΟ ΤΡΙΤΟ ΣΤΟΙΧΕΊΟ ΤΟΥ ΤΡΙΓΩΝΟΥ ΤΗΣ ΦΩΤΙΑΣ. ", "")
clv2.AddTextItem("Σταματήστε τη διαρροή οξυγόνου αν μπορεί να γίνει με ασφάλεια.Αν αυτό δεν είναι δυνατό διασκορπίστε την διαρροή με βολή ομίχλης", "")
clv2.AddTextItem("Κατηγορία 2 ", "")
	clv2.AddTextItem("Εφλεκτα,πυροδυναμωτικα. ", "")
