...
clv2.AddTextItem("Ασφυξία σε χώρους που δεν αερίζονται.Οι περισσότερες ουσίες είναι βαρύτερες από τον αέρα.", "")
clv2.AddTextItem("Ακόμα και τα άδεια δοχεία-βυτία είναι επικίνδυνα.", "")
