...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("venzini.bal")
...
mple.height = 7%y
  ...
  Panel2.Height = 57.5%y
	...
	clv2.AddTextItem("H βενζίνη UN-1203 είναι μίγμα υδρογονανθράκων μαζί με διάφορες προσθήκες.", "")
clv2.AddTextItem("Πολύ διαδεδομένη ουσία.", "")
clv2.AddTextItem("Η βενζίνη και οι ατμοί της ειναι εξαιρετικά εύφλεκτη  ", "")
