...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("exibal.bal")
	'PRWTO PANW aristera
pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
...
clv2.AddTextItem("Κατηγορία 6.1 ", "")
	
	clv2.AddTextItem("Δηλητηριώδεις, τοξικές, βλαβερές για την υγεία και μολυσματικές.", "")
	
	clv2.AddTextItem("Μερικές ουσίες της κατηγορίας, κατα την ένωση τους με το νερό, αναδύονται εκρηκτικά αέρια.", "")
