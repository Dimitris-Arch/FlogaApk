...
clv2.AddTextItem("1.6 Σχεδόν καθόλου κίνδυνος έκρηξης.", "")
	clv2.AddTextItem("ΚΡΑΤΗΣΤΕ ΠΑΝΤΑ ΑΠΌΣΤΑΣΗ ΑΣΦΑΛΕΊΑΣ.Αυλοί οροφής,εδάφους  ή αλλοί τηλεκατευθηνόμενοι έιναι ιδανικοί", "")
...
clv2.AddTextItem("Μήν διασκορπίζετε την πυρκαγία με συμπαγή βολή,Αν είναι δυνατό καλύψτε με C02,ξηρά σκόνη ή αφρό", "")
clv2.AddTextItem("Κατάσβεση όλων των πηγών ανάφλεξης, ακόμα και τις μικρότερες.Επίσης πρέπει να επιχειρήται μείωση της θερμοκρασίας", "")
