...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("teserabal.bal")
	'PRWTO PANW aristera
pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
...
pin1.BringToFront
  ...
  Panel2.Height = 57.5%y
	...
	clv2.AddTextItem("Κατηγορία 4.1 ", "")
clv2.AddTextItem("Πολύ εύφλεκτα στερεά, εκρηκτικά ", "")
clv2.AddTextItem("Κίνδυνος ανάφλεξης με τριβή με θερμότητα ή ακτινοβολία", "")
clv2.AddTextItem("Πιθανή αυτανάφλεξη", "")
