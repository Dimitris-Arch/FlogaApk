...
Sub Activity_Create(FirstTime As Boolean)
	Activity.LoadLayout("pente2.bal")
	'PRWTO PANW aristera
pin1.Top = 3%y
pin1.left = 3%x
pin1.height = 28%y
...
clv2.AddTextItem("Κατηγορία 5.2 ", "")

	
	clv2.AddTextItem("Ουσίες εύφλεκτες και τοξικές, ασταθής σε περίπτωση πυρκαγιάς ", "")
clv2.AddTextItem("Εκρηκτικές που πυροδοτούνται και με την τριβή ή βίαια χτυπήματα  ", "")
